...
class SystemSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('system_settings')->insert(array(
            ...
            51 =>
                array(
                    'setting_name' => 'rb_base_dir',
                    'setting_value' => '[(base_path)]assets/',
                ),
            52 =>
                array(
                    'setting_name' => 'rb_base_url',
                    'setting_value' => 'assets/',
                ),
            53 =>
                array(
                    'setting_name' => 'filemanager_path',
                    'setting_value' => '[(base_path)]',
                ),
            54 =>
                array(
                    'setting_name' => 'pwd_hash_algo',
                    'setting_value' => '0',
                ),
            55 =>
                array(
            ...
            56 =>
                array(
                    'setting_name' => 'friendly_url_suffix',
                    'setting_value' => '/',
                ),
            57 =>
                array(
                    'setting_name' => 'enable_filter',
                    'setting_value' => '0',
                ),
            58 =>
                array(
                    'setting_name' => 'enable_at_syntax',
                    'setting_value' => '0',
                ),
            59 =>
                array(
                    'setting_name' => 'server_protocol',
                    'setting_value' => 'https',
                ),
            60 =>
                array(
                    'setting_name' => 'enable_robot_indexing',
                    'setting_value' => '0',
                ),
        ));
    }
