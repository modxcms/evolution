...
if (isset($_SESSION['mgrValidated'])) {
    ...
    if ($show) {
        ...
        if (isset($_SESSION['mgrValidated'])) {
            ...
            $qm = new Qm($modx, $loadmanagerjq, $loadfrontendjq, $noconflictjq, $loadtb, $tbwidth, $tbheight, $hidefields, $hidetabs, $hidesections, $addbutton, $tpltype, $tplid, $custombutton, $managerbutton, $logout, $autohide, $editbuttons, $editbclass, $newbuttons, $newbclass, $tvbuttons, $tvbclass);
        }
    }
}
