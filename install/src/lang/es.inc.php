...
$_lang["cant_write_config_file"] = 'Evo no pudo escribir al archivo de configuración. Por favor copia lo siguiente en el archivo. ';
$_lang["cant_write_config_file_note"] = 'Una vez que se ha hecho eso, puedes entrar al sistema administrativo de Evo al poner en tu navegador la dirección YourSiteName.com/[+MGR_DIR+]/.';
...
$_lang["connection_screen_database_connection_note"] = 'Favor de escribir el nombre de la base de datos creada para Evo.  Si no existe una base de datos todavía, el instalador tratará de crear una para ti.  Esto puede fallar dependiendo de la configuración de MySQL o de los permisos del usuario de bases de datos para tu dominio/instalación.';
...
$_lang["connection_screen_default_admin_note"] = 'Ahora necesitarás escribir algunos detalles para la cuenta principal del administrador de Evo.  Puedes llenar tu nombre y una contraseña que no se te vaya a olvidar.  Necesitarás esta información para entrar al administrador una vez que la configuración esté completa.';
...
$_lang["default_language_description"] = 'Este es el idioma prefijado que será usado en el panel de control del Administrador de Evo.';
...
$_lang["help_title"] = 'Asistencia para la instalación en los foros de Evo';
$_lang["iagree_box"] = 'Estoy de acuerdo con los términos de <a href="../assets/docs/license.txt" target="_blank">la licencia de Evo</a>.  Para las traducciones de la licencia GPL version 2, por favor visitar <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0-translations.html" target="_blank">el sitio del Sistema Operativo GNU</a>.';
...
$_lang["installation_note"] = '<strong>Nota:</strong> Después de entrar al sistema de administración de Evo, debes de editar y guardar las configuraciones del sistema antes de navegar por el sitio al ir a <strong>Herramientas</strong> -> Configuración del Sistema en el administrador de Evo.';
...
$_lang["modx_footer1"] = '&copy; 2005-[+current_year+] del proyecto de <a href="http://modx.com/" target="_blank" style="color: green; text-decoration:underline">Evo</a> Content Management Framework (CMF). Todos los derechos reservados. Evo tiene licencia GPL de GNU.';
...
$_lang["setup_couldnt_install"] = 'El configurador de Evo no pudo instalar/alterar algunas tablas dentro de la base de datos seleccionada.';
...
$_lang["to_log_into_content_manager"] = 'Para entrar al sistema de administración de Evo ([+MGR_DIR+]/index.php) dando clic en el botón de `Cerrar`.';
...
$_lang["visit_forum"] = 'visita los <a href="http://forums.modx.com/" target="_blank">Foros de Evo</a>.';
...
$_lang["welcome_message_welcome"] = 'Bienvenido al programa de instalación de Evo.';
