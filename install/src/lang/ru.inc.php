...
$_lang["checking_pgsql_version"] = 'Проверка версии PostgreSQL: ';
...
$_lang["connection_screen_database_connection_note"] = 'Введите имя базы данных, созданной для Evolution CMS. Если у вас еще нет базы данных, то программа установки попытается создать базу данных для вас. В зависимости от конфигурации MySQL или прав пользователя базы данных процесс может завершиться неудачей.';
$_lang["connection_screen_database_host"] = 'Хост базы данных:';
$_lang["connection_screen_database_type"] = 'Тип базы данных:';
...
$_lang["default_language_description"] = 'Это язык, который будет по умолчанию использоваться менеджером в административной панели Evolution CMS.';
...
$_lang["installation_note"] = '<strong>Внимание:</strong> После входа в панель управления вы должны отредактировать и сохранить системную конфигурацию Evolution CMS, прежде чем смотреть сайт, выбрав <strong>Инструменты</strong> -> Конфигурация в панели управления.';
...
$_lang["setup_couldnt_install"] = 'Программа установки Evolution CMS не смогла установить/изменить некоторые таблицы базы данных.';
...
$_lang["strict_mode_error"] = 'Некоторые возможности Evolution CMS не могут работать должным образом, если режим sql_mode STRICT_TRANS_TABLES не отключен. Вы можете задать режим через внесения изменений в my.cnf файл или связаться с администратором базы данных.';
...
$_lang["visit_forum"] = ', посетите <a href="http://modx.im" target="_blank">форум Evolution CMS</a>.';
...
$_lang["welcome_message_welcome"] = 'Добро пожаловать в программу установки Evolution CMS.';
