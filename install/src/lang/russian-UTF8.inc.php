...
$_lang["connection_screen_database_connection_note"] = 'Введите имя базы данных, созданной для EVO. Если у вас еще нет базы данных, то программа установки попытается создать базу данных для вас. В зависимости от конфигурации MySQL или прав пользователя базы данных процесс может завершиться неудачей.';
...
$_lang["default_language_description"] = 'Это язык, который будет по умолчанию использоваться менеджером в административной панели EVO.';
...
$_lang["installation_note"] = '<strong>Внимание:</strong> После входа в панель управления вы должны отредактировать и сохранить системную конфигурацию EVO, прежде чем смотреть сайт, выбрав <strong>Инструменты</strong> -> Конфигурация в панели управления.';
...
$_lang["modx_footer1"] = '&copy; 2005-[+current_year+] <a href="http://evo.im/" target="_blank" style="color: green; text-decoration:underline">EVO</a> Content Mangement Framework (CMF) project. Все права защищены. EVO лицензирован GNU GPL.';
$_lang["modx_footer2"] = 'EVO &mdash; свободное программное обеспечение. Мы поощряем вас быть творческими и использовать EVO как вы считаете целесообразным. Если вы внесете изменения и решите распространять ваш измененный вариант EVO, то должны сохранять и распространять исходный код бесплатно.';
$_lang["modx_install"] = 'EVO &raquo; Установка';
$_lang["modx_requires_php"] = ', а EVO необходим PHP [+min_version+] или более поздний';
...
$_lang["visit_forum"] = ', посетите <a href="http://modx.im" target="_blank">форум EVO</a>.';
