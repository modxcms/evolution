...
$_lang["cant_write_config_file"] = 'ClipperCMS n\'a pas pu écrire le fichier de configuration. Veuillez copier/coller ceci dans le fichier ';
$_lang["cant_write_config_file_note"] = 'Une fois l\'opération effectuée, vous pouvez vous connecter à l\'interface d\'administration de ClipperCMS en utilisant l\'adresse  VotreSite.com/manager/.';
...
$_lang["connection_screen_database_connection_note"] = 'Veuillez saisir le nom de la base de données créée pour ClipperCMS. Si la base est inexistante, le programme d\'installation tentera de la créer pour vous. Cette opération est susceptible d\'échouer en fonction des autorisations de l\'utilisateur MySQL.';
...
$_lang["default_language_description"] = 'Ceci est la langue par défaut qui sera utilisée dans l\'interface d\'administration de votre Gestionnaire de Contenu ClipperCMS.';
...
$_lang["installation_note"] = '<strong>NOTE:</strong> Après vous être connecté au Gestionnaire, vous devez éditer et sauvegarder les paramètres de configuration système avant de visiter le site en sélectionnant <strong>Outils</strong> -> Configuration dans le Gestionnaire ClipperCMS.';
...
$_lang["modx_footer2"] = 'ClipperCMS est un logiciel libre. Nous vous encourageons à être créatifs et à utiliser ClipperCMS comme bon il vous semble. Votre seule obligation est de redistribuer sous licence libre votre version modifiée de ClipperCMS.';
$_lang["modx_install"] = 'ClipperCMS &raquo; Installation';
$_lang["modx_requires_php"] = ', alors que ClipperCMS nécessite PHP 5 ou supérieur';
...
$_lang["strict_mode_error"] = 'ClipperCMS nécessite que le mode strict de MySQL soit désactivé. Vous pouvez changer le mode strict en éditant le fichier my.cnf de MySQL ou alors contacter l\'administrateur de votre serveur.';
...
$_lang["welcome_message_welcome"] = 'Bienvenue dans le programme d\'installation de ClipperCMS.';
