...
$_lang["cant_write_config_file"] = 'MODx ei voinut kirjoittaa asetukset tiedostoa (config). Ole hyvä ja kopioi seuraava asetustiedostoon ';
$_lang["cant_write_config_file_note"] = 'Kun tämä on tehty, voit kirjautua MODx hallintaan osoitteessa sinunosoite.fi/manager/.';
$_lang["checkbox_select_options"] = 'Valitse valintaruuduista:';
$_lang["checking_if_cache_exist"] = 'Tarkistetaan onko kansio <span class=\"mono\">/assets/cache</span> olemassa: ';
...
$_lang["checking_if_cache_file_writable"] = 'Tarkisteaan voiko tiedostoon <span class=\"mono\">/assets/cache/siteCache.idx.php</span> kirjoittaa: ';
$_lang["checking_if_cache_writable"] = 'Tarkistetaan voiko kansioon <span class=\"mono\">/assets/cache</span> luoda uusia tiedostoja: ';
$_lang["checking_if_config_exist_and_writable"] = 'Tarkistetaan onko tiedosto <span class=\"mono\">manager/includes/config.inc.php</span> olemassa ja voiko siihen kirjoittaa: ';
...
$_lang["connection_screen_connection_information"] = 'Yhteysasetukset';
$_lang["connection_screen_connection_method"] = 'Yhteystyyppi:';
$_lang["connection_screen_database_connection_information"] = 'Tietokannan asetukset';
...
$_lang["database_use_failed_note"] = 'Ole hyvä ja tarkista tietokantaoikeudet asetetulle käyttäjälle ja yritä uudelleen.';
...
$_lang["iagree_box"] = 'Hyväksyn <a href="../assets/docs/license.txt" target="_blank">MODx lisenssin</a> ehdot. GPL versio 2 lisenssin käännökset löytyvät <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0-translations.html" target="_blank">GNU Operating System internetsivuilta</a>.';
...
$_lang["installation_install_new_copy"] = 'Asenna uusi kopio resurssista ';
...
$_lang["modx_footer1"] = '&copy; 2005-2009 <a href="http://www.modxcms.com/" target="_blank" style="color: green; text-decoration:underline">MODx</a> Content Mangement Framework (CMF). Kaikki oikeudet pidätetään. MODx on lisensoitu GNU GPL lisenssillä.';
