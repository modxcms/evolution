...
$_lang["cant_write_config_file"] = 'ClipperCMS ei voinut kirjoittaa asetukset tiedostoa. Ole hyvä ja kopioi seuraava asetustiedostoon ';
$_lang["cant_write_config_file_note"] = 'Kun tämä on tehty, voit kirjautua ClipperCMS hallintaan osoitteessa sinunosoite.fi/manager/.';
...
$_lang["checking_registerglobals_note"] = 'Tämä asetus tekee sivustostasi alttiimman XSS hyökkäyksille (Cross Site Scripting). Sinun tulisi kehottaa palveluntarjoajaasi kytkemään tämä asetus pois käytöstä. Useimmiten tämän asetuksen voi kytkeä pois muokkaamalla palvelimen php.ini tiedostoa. Jos se ei ole mahdollista, voit koittaa kytkeä sen pois .htaccess tiedostossa, joka sijaitsee ClipperCMS asennuksen juuri kansiossa. Jos tämäkään ei ole mahdollista, voit viimeisenä vaihtoehtona koittaa asettaa jokaiseen ClipperCMS asennuksen sisällä olevaan kansioon muokatun php.ini tiedoston, joka yliajaa asetukset palvelimen jaetusta php.ini tiedostosta, mutta kansioita ClipperCMS asennuksessa on tosin huomattava määrä. Voit kuitenkin asentaa ClipperCMS järjestelmän tästä asetuksesta huolimatta, mutta sinua on varoitettu.'; //Look at changing this to provide a solution.
...
$_lang["config_permissions_note"] = 'Jos olet asentamassa järjestelmää Linux / Unix palvelimeen, luo kansioon <span class=\"mono\">manager/includes/</span> tyhjä tiedosto nimeltä <span class=\"mono\">config.inc.php</span> ja aseta tiedostoon 0666 oikeudet.';
...
$_lang["connection_screen_database_connection_note"] = 'Ole hyvä ja syötä tietokannan nimi, jota ClipperCMS:n tulee käyttää. Jos tietokantaa ei ole vielä luotu, asennusohjelma yrittää luodan sen. Tämä voi epäonnistua riippuen MySQL asetuksista ja/tai tietokannan käyttäjän käyttöoikeuksista.';
...
$_lang["default_language_description"] = 'Tämä asetetaan ClipperCMS ylläpidon oletus kieleksi.';
...
$_lang["help_title"] = 'Asennustukea ClipperCMS keskustelufoorumilla';
$_lang["iagree_box"] = 'Hyväksyn <a href="../assets/docs/license.txt" target="_blank">ClipperCMS lisenssin</a> ehdot. GPL lisenssin versio 2:en käännökset löytyvät <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0-translations.html" target="_blank">GNU Operating System internetsivuilta</a>.';
...
$_lang["modx_footer2"] = 'ClipperCMS on ilmainen ohjelmisto. Kehoitamme sinua olemaan luova ja käyttämään ClipperCMS järjestelmää siten, miten sinä sen parhaaksi näet. Jos teet muutoksia järjestelmään ja päätät jakaa muokattua ClipperCMS järjestelmää eteenpäin, muista pitää muokattu lähdekoodi vapaasti saatavilla!';
$_lang["modx_install"] = 'ClipperCMS &raquo; Asennus';
$_lang["modx_requires_php"] = ', ja ClipperCMS vaatii PHP:stä version 5 tai uudemman';
...
$_lang["setup_couldnt_install"] = 'ClipperCMS asennus ei voinut asentaa/muokata joitain tietokannan tauluja.';
...
$_lang["strict_mode_error"] = 'Tietyt ClipperCMS:n toiminnot ei toimi oikein jos "STRICT_TRANS_TABLES sql_mode" ei kytketä pois käytöstä. Voit asettaa kyseisen MySQL asetuksen muokkaamalla my.cnf tiedostoa tai ottamalla yhteyttä palveluntarjoajaasi.';
...
$_lang["to_log_into_content_manager"] = 'Kirjautuaksesi sisällönhallintajärjestelmään (manager/index.php) napsauta `Sulje` painiketta.';
...
$_lang["visit_forum"] = ', vieraile <a href="http://clippercms.com/forum/" target="_blank">ClipperCMS keskustelufoorumilla</a>.';
...
$_lang["welcome_message_welcome"] = 'Tervetuloa ClipperCMS asennusohjelmaan.';
