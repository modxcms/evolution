...
$_lang["cant_write_config_file"] = 'ClipperCMS kunne ikke skrive konfigurasjonsfilen. Kopier f&oslash;lgende til filen ';
$_lang["cant_write_config_file_note"] = 'N&aring;r det er klart kan du logge inn i ClipperCMS administrasjonskontoen ved &aring; g&aring; til adressen DittDomene.xx/manager/ i din nettleser.';
...
$_lang["checking_registerglobals_note"] = 'Denne konfigurasjonen gj&oslash;r din nettside betydelig mer s&aring;rbar for webkodeinjeksjon (Cross Site Scripting - XSS). Du b&oslash;r kontakte din webhost og be om &aring; f&aring; inaktivert denne instillingen. Vanligvis lar det seg gj&oslash;re p&aring; tre f&oslash;lgende m&aring;ter: modifisering av den globale php.ini-filen, tillegg av regler i en .htaccess-fil i roten p&aring; din ClipperCMS-installasjon eller gjennom &aring; legge til en tilpasset php.ini-fil (som tilsidesetter den globale filen) i alla kataloger i din installasjon (og det finns masser av dem). Du kan fremdeles installere ClipperCMS, men ta denne advarselen p&aring; alvor.'; //Look at changing this to provide a solution.
...
$_lang["chunks"] = 'Chunks';
$_lang["config_permissions_note"] = 'For nye installasjoner i Linux/Unix-milj&oslash; m&aring; en tom fil med navnet <span class="mono">config.inc.php</span> opprettes i katalogen <span class="mono">manager/includes/</span> med skriverrettighetene satt til 666.';
...
$_lang["connection_screen_database_connection_note"] = 'Angi navnet p&aring; databasen som ble opprettet for ClipperCMS. Om det ikke finnes en database fra f&oslash;r, kommer installasjonsprogrammet til &aring; pr&oslash;ve &aring; opprette en for deg. Dette kan mislykkes avhengig av MySQL-konfigurasjonen eller databasens tilgangsrettigheter for ditt domene/installasjon.';
...
$_lang["modx_footer1"] = '&copy; 2012 the <a href="http://clippercms.com" target="_blank" >ClipperCMS</a> Content Mangement Framework (CMF) project. Med enerett. ClipperCMS er lisensiert under GNU GPL.';
$_lang["modx_footer2"] = 'ClipperCMS er fri programvare. Vi oppmuntrer deg til &aring; v&aelig;re kreativ og bruke ClipperCMS p&aring; hvilken m&aring;te du vil. V&aelig;r bare n&oslash;ye med &aring; beholde kildekoden fri om du gj&oslash;r endringer og siden velger &aring; omdistribuere din modifiserte versjon av ClipperCMS.';
$_lang["modx_install"] = 'ClipperCMS &raquo; Installasjon';
$_lang["modx_requires_php"] = ', og ClipperCMS krever PHP 5 eller senere.';
...
$_lang["setup_couldnt_install"] = 'ClipperCMS installasjonsprogramet kunne ikke legge til/endre noen tabeller i den valgte databasen.';
...
$_lang["strict_mode_error"] = 'ClipperCMS krever at strict mode er utkoblet. Du kan sette MySQL tilstanden ved &aring; endre my.cnf filen eller ved &aring; kontakte din serveradministrator.';
...
$_lang["to_log_into_content_manager"] = 'Du kan logge inn i inneholdsh&aring;ndtereren (manager/index.php)ved &aring; klikke p&aring; \"Lukk\"-knappen.';
$_lang["toggle"] = 'Skift';
