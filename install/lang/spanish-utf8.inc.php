...
$_lang["cant_write_config_file"] = 'ClipperCMS no pudo escribir al archivo de configuración. Por favor copia lo siguiente en el archivo. ';
$_lang["cant_write_config_file_note"] = 'Una vez que se ha hecho eso, puedes entrar al sistema administrativo de ClipperCMS al poner en tu navegador la dirección YourSiteName.com/manager/.';
...
$_lang["connection_screen_database_connection_note"] = 'Favor de escribir el nombre de la base de datos creada para ClipperCMS.  Si no existe una base de datos todavía, el instalador tratará de crear una para ti.  Esto puede fallar dependiendo de la configuración de MySQL o de los permisos del usuario de bases de datos para tu dominio/instalación.';
...
$_lang["connection_screen_default_admin_note"] = 'Ahora necesitarás escribir algunos detalles para la cuenta principal del administrador de ClipperCMS.  Puedes llenar tu nombre y una contraseña que no se te vaya a olvidar.  Necesitarás esta información para entrar al administrador una vez que la configuración esté completa.';
...
$_lang["default_language_description"] = 'Este es el idioma prefijado que será usado en el panel de control del Administrador de ClipperCMS.';
...
$_lang["help_title"] = 'Asistencia para la instalación en los foros de ClipperCMS';
$_lang["iagree_box"] = 'Estoy de acuerdo con los términos de <a href="../assets/docs/license.txt" target="_blank">la licencia de ClipperCMS</a>.  Para las traducciones de la licencia GPL version 2, por favor visitar <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0-translations.html" target="_blank">el sitio del Sistema Operativo GNU</a>.';
...
$_lang["installation_note"] = '<strong>Nota:</strong> Después de entrar al sistema de administración de ClipperCMS, debes de editar y guardar las configuraciones del sistema antes de navegar por el sitio al ir a <strong>Herramientas</strong> -> Configuración del Sistema en el administrador de ClipperCMS.';
...
$_lang["modx_footer1"] = '&copy; 2012 del proyecto de <a href="http://clippercms.com" target="_blank" >ClipperCMS</a>. Todos los derechos reservados. ClipperCMS tiene licencia GPL de GNU.';
$_lang["modx_footer2"] = 'ClipperCMS es software gratuito.  Te invitamos a ser creativo y usarlo de cualquier manera que se te antoje. Sólo asegura que si haces cambios y decides distribuir una versión modificada de ClipperCMS que el código fuente siga siendo gratis.';
$_lang["modx_install"] = 'ClipperCMS &raquo; Instalar';
$_lang["modx_requires_php"] = ', y ClipperCMS requiere de PHP versión 5 o mayor';
...
$_lang["setup_couldnt_install"] = 'El configurador de ClipperCMS no pudo instalar/alterar algunas tablas dentro de la base de datos seleccionada.';
...
$_lang["strict_mode_error"] = 'Algunas características de ClipperCMS pueden no trabajar apropiadamente a no se de que el modo STRICT_TRANS_TABLES sql_mode esté habilitado.  Puedes configurar el modo de MySQL al editar el archivo my.cnf o contactar al administrador de tu servidor.';
...
$_lang["to_log_into_content_manager"] = 'Para entrar al sistema de administración de ClipperCMS (manager/index.php) dando clic en el botón de `Cerrar`.';
...
$_lang["visit_forum"] = 'visita los <a href="http://clippercms.com/forum/" target="_blank">Foros de ClipperCMS</a>.';
...
$_lang["welcome_message_welcome"] = 'Bienvenido al programa de instalación de ClipperCMS.';
