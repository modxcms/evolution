...
$_lang["cant_write_config_file"] = 'ClipperCMS nemohl zapsat konfigurační soubor. Následující obsah vložte do souboru ';
$_lang["cant_write_config_file_note"] = 'Až bude tento obsah uložen v souboru, můžete se přihlásit do ClipperCMS správce obsahu na adrese AdresaVasichStranek.cz/manager/.';
...
$_lang["connection_screen_database_connection_note"] = 'Zadejte název databáze, kterou chcete použít nebo kterou chcete vytvořit pro tuto instalaci systému ClipperCMS. Pokud databáze neexistuje pokusí se ji instalátor vytvořit. Toto se nemusí povést v závislosti na nastavení MySQL nebo na uživatelských právech pro vaši doménu/instalaci.';
...
$_lang["default_language_description"] = 'Toto bude výchozí jazyk, který bude použit v ClipperCMS správci obsahu.';
...
$_lang["modx_footer2"] = 'ClipperCMS je free software. Doporučujeme Vám být kreativní a používat ClipperCMS jak jen uznáte za vhodné. Pouze se ujistěte, že pokud uděláte nějaké změny a budete chtít upravený ClipperCMS distribuovat dál, musí být zdrojové kódy volně přístupné!!';
$_lang["modx_install"] = 'ClipperCMS &raquo; Instalace';
$_lang["modx_requires_php"] = ', a ClipperCMS vyžaduje PHP 5 nebo novější';
...
$_lang["php_security_notice"] = '<legend>Bezpečnostní oznámení</legend><p>Dokud bude běžet ClipperCMS na verzi PHP (%s), nedoporučujeme vám ClipperCMS v této verzi používat. Vaše verze PHP je zranitelná mnoha bezpečnostními dírami. Aktualizujte PHP na verzi 4.3.11 nebo novější, které obsahují záplaty těchto děr. Dopuručujeme Vám aktualizovat na tuto verzi pro zvýšení bezpečnosti Vašich vlastních webových stránek.</p>';
...
$_lang["setup_couldnt_install"] = 'ClipperCMS instalátor nemůže instalovat/změnit některé tabulky ve zvolené databázi.';
...
$_lang["strict_mode_error"] = 'Určité vlastnosti systému ClipperCMS nemusí fungovat správně jestliže je STRICT_TRANS_TABLES sql_mode neaktivní. MySQL mód lze změnit úpravou souboru "my.cnf" nebo kontaktujte administrátora serveru.';
...
$_lang["system_configuration_validate_referer_description"] = 'Nastavení <strong>Ověřit hlavičky HTTP_REFERER</strong> je doporučeno a může ochránit Váš portál před útoky CSRF, ale na některých serverech může zapříčinit nedostupnost ClipperCMS správce obsahu.';
...
$_lang["welcome_message_welcome"] = 'Vítejte v instalačním programu systému ClipperCMS.';
