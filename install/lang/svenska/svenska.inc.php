...
$_lang["welcome_message_welcome"] = 'Välkommen till installationsprogrammet för MODx.';
$_lang["welcome_message_text"] = 'Det här programmet kommer att vägleda dig genom hela installationen.';
...
$_lang["connection_screen_connection_note"] = 'Ange namnet på databasen som skapats för MODx. Om det inte finns någon databas än kommer installationsprogrammet att försöka skapa en åt dig. Det här kan komma att misslyckas beroende på MySQL-konfigurationen eller databasens åtkomsträttigheter för din domän/installation.';
...
$_lang["connection_screen_database_info"] = 'Ange inloggningsuppgifterna för din databas.';
...
$_lang["table_prefix_not_exist"] = ' - Tabellprefixet finns inte i den här databsen!';
...
$_lang["modx_footer1"] = '&copy; 2005-2007 the <a href="http://www.modxcms.com/" target="_blank" style="color: green; text-decoration:underline">MODx</a> Content Mangement Framework (CMF) project. Med ensamrätt. MODx är licensierad under GNU GPL.';
...
$_lang["remove_install_folder_auto"] = 'Ta bort installations-katalogen och -filerna från min webbplats<br />&nbsp;(Den här operationen kräver att raderingsrättigheter är angivna för installationskatalogen).';
...
$_lang["installation_note"] = '<strong>Notera:</strong> Efter att ha loggat in i innehållshanteraren bör du redigera och spara dina systeminställningar innan du börjar arbeta med din webbplats. Gå till Verktyg -> Konfiguration i innehållshanteraren.';
