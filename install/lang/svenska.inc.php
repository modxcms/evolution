...
$_lang["cant_write_config_file"] = 'ClipperCMS kunde inte skriva konfigurationsfilen. Kopiera följande till filen ';
$_lang["cant_write_config_file_note"] = 'När det är klart kan du logga in i ClipperCMS administrationsdel genom att ange adressen DinWebbplats.se/manager/ i din webbläsare.';
...
$_lang["connection_screen_database_connection_note"] = 'Ange namnet på den databas som ska användas eller som du vill skapa för denna ClipperCMS-installation. Om det inte finns någon databas kommer installationsprogrammet att försöka skapa en. Det här kan misslyckas beroende på hur MySQLs åtkomsträttigheter är konfigurerade.';
...
$_lang["default_language_description"] = 'Det här är det standardspråk som kommer att användas i ClipperCMS hanterare.';
...
$_lang["help_title"] = 'Installationshjälp i ClipperCMS forum';
$_lang["iagree_box"] = 'Jag godkänner <a href="../assets/docs/license.txt" target="_blank">licensvillkoren för ClipperCMS</a>.<br />Om du vill läsa en översättning av GPL-licensen, version 2, hittar du den på <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0-translations.html" target="_blank">operativsystemet GNUs webbplats</a>.';
...
$_lang["modx_footer1"] = '&copy; 2012 the <a href="http://clippercms.com" target="_blank" >ClipperCMS</a> Content Mangement Framework (CMF) project. Med ensamrätt. ClipperCMS är licensierad under GNU GPL.';
$_lang["modx_footer2"] = 'ClipperCMS är fri programvara. Vi uppmuntrar dig att vara kreativ och använda ClipperCMS på vilket sätt du vill. Vara bara noga med att bevara källkoden fri om du gör ändringar och sedan väljer att omdistribuera din modifierade version av ClipperCMS.';
$_lang["modx_install"] = 'ClipperCMS &raquo; Installation';
$_lang["modx_requires_php"] = ', och ClipperCMS kräver PHP 5 eller senare.';
...
$_lang["php_security_notice"] = '<legend>Säkerhetsmeddelande</legend><p>Även om ClipperCMS kommer att fungera med din PHP-version, så rekommenderas det inte att använda ClipperCMS med den versionen. Din PHP-version är sårbar för ett antal säkerhetshål. Uppgradera till PHP-version 4.3.8 eller senare, vilket åtgärdar de här hålen. Det rekommenderas att du uppgraderar till den här versionen för att få en bättre säkerhet på din webbplats.</p>';
...
$_lang["setup_couldnt_install"] = 'ClipperCMS installationsprogram kunde inte lägga till/ändra några tabeller i den valda databasen.';
...
$_lang["strict_mode_error"] = 'Det är möjligt att vissa funktioner i ClipperCMS inte kommer att fungera som de ska om inte STRICT_TRANS_TABLES sql_mode är inaktiverat. Du kan ställa in MySQLs läge genom att redigera filen my.cnf eller genom att kontakta din serveradministratör.';
...
$_lang["visit_forum"] = ', så besök <a href="http://clippercms.com/forum/" target="_blank">ClipperCMS forum</a>.';
...
$_lang["welcome_message_welcome"] = 'Välkommen till ClipperCMS installationsprogram';
