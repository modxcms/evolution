...
$_lang["to_log_into_content_manager"] = 'על מנת להתחבר למערכת הניהול (manager/index.php) ניתן ללחוץ על כפתור `סגור`.';
...
$_lang["visit_forum"] = ', בקרו ב <a href="http://clippercms.comindex.php/board,360.0.html" target="_blank">פורומים בעברית</a>.';
$_lang["warning"] = 'אזהרה!';
