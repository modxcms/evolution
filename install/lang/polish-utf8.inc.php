...
$_lang["cant_write_config_file_note"] = 'Po zakończeniu instalacji będziesz mógł zalogować się do Menedżera EVO znajdującego się pod adresem: twojadomena.com/[+MGR_DIR+]/';
...
$_lang["default_language_description"] = 'Domyślny język dla Menedżera EVO.';
...
$_lang["help_title"] = 'Pomoc dotyczącą instalacji EVO';
$_lang["iagree_box"] = 'Akceptuję warunki <a href="../assets/docs/license.txt" target="_blank">licencji EVO</a>. Tłumaczenia licencji GPL w wersji 2 znajdziesz <a href="http://www.gnu.org/licenses/old-licenses/gpl-2.0-translations.html" target="_blank">na stronie GNU Operating System</a>.';
...
$_lang["installation_note"] = '<strong>Uwaga:</strong> Zanim zaczniesz przeglądać zasoby swojej strony zaloguj się do Menedżera i zapisz konfigurację. Do konfiguracji systemu w Menedżerze EVO dostaniesz się wybierając zakładkę: <strong>Ustawienia</strong> -> Konfiguracja systemu.';
...
$_lang["modx_footer1"] = '&copy; 2005-[+current_year+] the <a href="https://evo.im/" target="_blank" style="color: green; text-decoration:underline">EVO</a> Content Management Framework (CMF) project. Wszystkie prawa zastrzeżone. EVO działa na licencji GNU GPL.';
...
$_lang["modx_requires_php"] = ', EVO wymaga PHP w wersji [+min_version+] lub nowszej';
...
$_lang["php_security_notice"] = '<legend>Informacja dotycząca bezpieczeństwa</legend><p>Co prawda EVO będzie działać na Twojej wersji PHP, jednak używanie EVO na tej wersji nie jest zalecane. Używana przez Ciebie wersja PHP posiada wiele błędów związanych z bezpieczeństwem. Zaktualizuj PHP do wersji 5.4 lub nowszej, w której wyżej wymienione błędy nie występują. Zalecamy aktualizację ze względu na bezpieczeństwo Twojej strony internetowej.</p>';
...
$_lang["strict_mode_error"] = 'Niektóre z funkcji EVO mogą działać niepoprawnie gdy tryb STRICT_TRANS_TABLES sql_mode jest włączony. Możesz zmienić tryb MySQL edytując plik my.cnf lub kontaktując się z administratorem.';
...
$_lang["visit_forum"] = ', odwiedź <a href="https://evo.im/" target="_blank">Forum EVO</a>.';
$_lang["warning"] = 'UWAGA!';
