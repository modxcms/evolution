...
$_lang["cant_write_config_file_note"] = 'Po zakończeniu instalacji będziesz mógł zalogować się do Menedżera ClipperCMSa znajdującego się pod adresem: TwojaNazwaDomeny.com/manager/';
...
$_lang["chunks"] = 'Chunki';
$_lang["config_permissions_note"] = 'Dla nowych instalacji na systemach Linux/Unix utwórz pusty plik o nazwie <span class="mono">config.inc.php</span> w folderze <span class="mono">/manager/includes/</span> i ustaw dla niego prawa dostępu na 0666.';
...
$_lang["connection_screen_database_connection_note"] = 'Wybierz nazwę bazy danych, którą chcesz użyć dla tej instalacji ClipperCMSa. Jeśli baza danych nie istnieje, instalator podejmie próbę utworzenia jej. Utworzenie nowej bazy danych może się nie powieść, jeśli użytkownik MySQL nie ma wystarczających uprawnień.';
...
$_lang["connection_screen_default_admin_note"] = 'Teraz musisz skonfigurować konto administratora. Podaj nazwę oraz hasło, które na pewno zapamiętasz. Będziesz potrzebował tych danych aby zalogować się do Menedżera ClipperCMSa po zakończeniu procesu instalacji.';
...
$_lang["default_language_description"] = 'Domyślny język dla Menedżera ClipperCMSa.';
...
$_lang["help_title"] = 'Pomoc dotyczącą instalacji można uzyskać na forum ClipperCMSa';
$_lang["iagree_box"] = 'Akceptuję warunki <a href=\"../assets/docs/license.txt\" target=\"_blank\">licencji ClipperCMSa</a>. Tłumaczenia licencji GPL w wersji 2 znajdziesz <a href=\"http://www.gnu.org/licenses/old-licenses/gpl-2.0-translations.html\" target=\"_blank\">na stronie GNU Operating System</a>.';
...
$_lang["installation_note"] = '<strong>Uwaga:</strong> Zanim zaczniesz przeglądać zasoby swojej strony zaloguj się do Menedżera i zapisz konfigurację. Do modułu konfiguracji systemu w Menedżerze ClipperCMSa dostaniesz się wybierając zakładkę: <strong>Narzędzia</strong> -> Konfiguracja systemu.';
...
$_lang["modx_footer1"] = '&copy; 2012 <a href="http://clippercms.com" target="_blank" >ClipperCMS</a> Content Management Framework (CMF) project. Wszystkie prawa zastrzeżone. ClipperCMS jest objęty licencją GNU GPL.';
$_lang["modx_footer2"] = 'ClipperCMS jest wolnym oprogramowaniem. Zachęcamy Cię, abyś kreatywnie wykorzystywał ClipperCMSa w jakikolwiek sposób, który uznasz za przydatny. Prosimy jedynie, abyś pozostawił kod źródłowy otwartym i darmowym w przypadku gdy zdecydujesz się na redystrybucję ClipperCMSa w zmodyfikowanej przez siebie wersji!';
$_lang["modx_install"] = 'ClipperCMS &raquo; Instalacja';
$_lang["modx_requires_php"] = ', ClipperCMS wymaga PHP w wersji 5 lub nowszej';
$_lang["mysql_5051"] = ' MySQL w wersji 5.0.51!';
$_lang["mysql_5051_warning"] = 'Wersja 5.0.51 MySQL posiada wiele dobrze znanych błędów, które mogą przyczynić się do nieprawidłowego działania ClipperCMSa. Zalecamy uaktualnienie MySQL przed kontynuowaniem instalacji.';
...
$_lang["php_security_notice"] = '<legend>Informacja dotycząca bezpieczeństwa</legend><p>Co prawda ClipperCMS będzie działał na Twojej wersji PHP, jednak używanie ClipperCMSa z tą akurat wersją nie jest zalecane. Używana przez Ciebie wersja PHP posiada wiele błędów związanych z bezpieczeństwem. Zaktualizuj PHP do wersji 4.3.8 lub nowszej, w której wyżej wymienione błędy nie występują. Zalecamy aktualizację ze względu na bezpieczeństwo Twojej strony internetowej.</p>';
...
$_lang["remove_install_folder_manual"] = 'Pamiętaj aby usunąć folder &quot;<b>install</b>&quot; przed zalogowaniem się do Menedżera ClipperCMSa.';
...
$_lang["setup_couldnt_install"] = 'Instalator ClipperCMSa nie mógł zainstalować/zmodyfikować niektórych tabel w wybranej bazie danych.';
...
$_lang["strict_mode_error"] = 'Niektóre z funkcji ClipperCMSa mogą działać niepoprawnie gdy tryb STRICT_TRANS_TABLES sql_mode jest włączony. Możesz zmienić tryb MySQL edytując plik my.cnf lub kontaktując się z administratorem.';
...
$_lang["system_configuration_validate_referer_description"] = 'Włączenie <strong>weryfikacji nagłówków HTTP_REFERER</strong> jest rekomendowane aby zmniejszyć prawdopodobieństwo ataków CSRF, jednak przy niektórych konfiguracjach serwera może spowodować, że Menedżer ClipperCMSa będzie niedostępny.';
$_lang["table_prefix_already_inuse"] = '- Tabele o tym prefiksie już istnieją w wybranej bazie danych!';
$_lang["table_prefix_already_inuse_note"] = 'Nie można zainstalować ClipperCMSa w wybranej bazie danych, ponieważ zawiera ona już tabele z określonym prefiksem. Wybierz inny prefiks dla tabeli i uruchom instalatora ponownie.';
$_lang["table_prefix_not_exist"] = '- Tabele o tym prefiksie nie istnieją w wybranej bazie danych!';
$_lang["table_prefix_not_exist_note"] = 'Nie można zaktualizować ClipperCMSa w wybranej bazie danych, ponieważ nie zawiera ona tabel z określonym prefiksem. Wybierz prefiks, który został zastosowany dla istniejących już tabel i uruchom instalatora ponownie.';
$_lang["templates"] = 'Szablony';
$_lang["to_log_into_content_manager"] = 'Po kliknięciu w przycisk `Zamknij` będziesz mógł zalogować się do Menedżera ClipperCMSa (manager/index.php).';
...
$_lang["upgrade_note"] = '<strong>Uwaga:</strong> Przed rozpoczęciem przeglądania swojej strony zaloguj się jako administrator do Menedżera ClipperCMSa, a następnie sprawdź i zapisz konfigurację systemu.';
$_lang["upgraded"] = 'Zaktualizowano';
$_lang["validate_referer_title"] = 'Weryfikuj nagłówki HTTP_REFERER?';
$_lang["visit_forum"] = ', odwiedź <a href="http://clippercms.com/forum/" target="_blank">Forum ClipperCMSa</a>.';
$_lang["warning"] = 'UWAGA!';
...
$_lang["welcome_message_welcome"] = 'Witamy w instalatorze ClipperCMSa.';
