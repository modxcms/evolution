...
$_lang["cant_write_config_file_note"] = 'Po zakończeniu instalacji będziesz mógł zalogować się do Menedżera MODxa znajdującego się pod adresem: TwojaNazwaDomeny.com/manager/';
...
$_lang["modx_footer1"] = '&copy; 2005-2009 <a href="http://www.modxcms.com/" target="_blank" style="color: green; text-decoration:underline">MODx</a> Content Management Framework (CMF) project. Wszystkie prawa zastrzeżone. MODx jest objęty licencją GNU GPL.';
...
$_lang["to_log_into_content_manager"] = 'Po kliknięciu w przycisk `Zamknij` będziesz mógł zalogować się do Menedżera MODxa (manager/index.php).';
