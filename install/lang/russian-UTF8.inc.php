...
$_lang["checking_registerglobals_note"] = 'Конфигурация PHP делает ваш сайт более восприимчивым к XSS-атакам. Вы должны самостоятельно, или связавшись с администрацией хостинга, выключить Register_Globals. Обычно это делается одним из следующих путей: вносятся исправления в php.ini файл, добавляются правила в файл .htaccess, который находится в корне папки ClipperCMS, или добавлением своего php.ini в каждую папку внутри папки ClipperCMS (их очень много). Вы можете продолжить установку ClipperCMS, но обдумайте это предупреждение.';
...
$_lang["connection_screen_database_connection_note"] = 'Введите имя базы данных, созданной для ClipperCMS. Если у вас еще нет базы данных, то программа установки попытается создать базу данных для вас. В зависимости от конфигурации MySQL или прав пользователя базы данных процесс может завершиться неудачей.';
...
$_lang["default_language_description"] = 'Это язык, который будет по умолчанию использоваться менеджером в административной панели ClipperCMS.';
...
$_lang["failed"] = 'ОШИБКА!';
$_lang["help"] = 'Помощь!';
$_lang["help_link"] = 'http://clippercms.comindex.php/board,42.0.html';
$_lang["help_title"] = 'Помощь в установке на форумах ClipperCMS';
...
$_lang["installation_note"] = '<strong>Внимание:</strong> После входа в панель управления вы должны отредактировать и сохранить системную конфигурацию ClipperCMS, прежде чем смотреть сайт, выбрав <strong>Инструменты</strong> -> Конфигурация в панели управления.';
...
$_lang["modx_footer1"] = '&copy; 2012 <a href="http://clippercms.com" target="_blank" >ClipperCMS</a> Content Mangement Framework (CMF) project. Все права защищены. ClipperCMS лицензирован GNU GPL.';
$_lang["modx_footer2"] = 'ClipperCMS &mdash; свободное программное обеспечение. Мы поощряем вас быть творческими и использовать ClipperCMS как вы считаете целесообразным. Если вы внесете изменения и решите распространять ваш измененный вариант ClipperCMS, то должны сохранять и распространять исходный код бесплатно.';
$_lang["modx_install"] = 'ClipperCMS &raquo; Установка';
$_lang["modx_requires_php"] = ', а ClipperCMS необходим PHP 5 или более поздний';
...
$_lang["setup_couldnt_install"] = 'Программа установки ClipperCMS не смогла установить/изменить некоторые таблицы базы данных.';
...
$_lang["strict_mode_error"] = 'Некоторые возможности ClipperCMS не могут работать должным образом, если режим sql_mode STRICT_TRANS_TABLES не отключен. Вы можете задать режим через внесения изменений в my.cnf файл или связаться с администратором базы данных.';
...
$_lang["visit_forum"] = ', посетите <a href="http://clippercms.comforums/" target="_blank">форум ClipperCMS</a>.';
...
$_lang["welcome_message_welcome"] = 'Добро пожаловать в программу установки ClipperCMS.';
