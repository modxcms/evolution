...
$_lang["installation_install_new_note"] = 'すでにClipperCMSをインストールしている場合はデータを上書きします。<br />※Tableプリフィクスが異なる場合を除く';
...
$_lang["loading"] = '処理中...';
$_lang["modules"] = 'モジュール';
$_lang["modx_footer1"] = '&copy; 2012 the <a href="http://clippercms.com" target="_blank" >ClipperCMS</a> Content Management Framework (CMF) project. All rights reserved. ClipperCMS is licensed under the GNU GPL.';
...
$_lang["modx_install"] = 'ClipperCMS &raquo; インストール';
...
$_lang["optional_items_note"] = 'オプションを選択してください:<br /><br />初めてClipperCMSを試す人は、全てチェックを入れましょう。<br />※日本チームより：「サンプルサイト」は内容が古く、検証も不十分です。興味がある場合のみ、参考程度にお試しください。';
$_lang["php_security_notice"] = '<legend>セキュリティ警告</legend><p>このサーバ上で稼働しているPHPには重大な問題があります。ClipperCMSの稼働自体には問題はありませんが、このバージョンのPHPには報告されている脆弱性がいくつか存在し、ClipperCMSに限らずさまざまなPHPアプリを通じて多数の攻撃にさらされてきました。バージョン4.3.8より古いPHPは深刻な脆弱性を抱えています。この機会にPHPのアップデートをおすすめします。</p>';
...
$_lang["sample_web_site_note"] = '<span style="font-style:normal;">※このサンプルサイトは内容が古く検証も不十分なので、現状ではClipperCMSの仕組みの理解にはあまり役立ちません。テスト目的のダミーコンテンツなどとして、必要に応じてお試しください。</span>';
...
$_lang["welcome_message_welcome"] = 'ClipperCMSのインストールを開始します。';
