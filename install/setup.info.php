...
#:::::::::::::::::::::::::::::::::::::::::
	...
	$mp[] = array("QM+","<strong>1.3.3</strong> Enables QuickManager front end content editing support.",0,"$setupPath/plugin.qm.tpl","&jqpath=Path to jQuery;text;assets/js/jquery-1.3.2.min.js &loadmanagerjq=Load jQuery in manager;list;true,false;true &loadfrontendjq=Load jQuery in front-end;list;true,false;true &noconflictjq=jQuery noConflict mode in front-end;list;true,false;true &loadtb=Load modal box in front-end;list;true,false;true &tbwidth=Modal box window width;text;80% &tbheight=Modal box window height;text;80% &hidefields=Hide document fields from front-end editors;text;parent &hidetabs=Hide document tabs from front-end editors;text; &hidesections=Hide document sections from front-end editors;text; &addbutton=Show add document here button;list;true,false;true &tpltype=New document template type;list;parent,id,selected;parent &tplid=New document template id;int;3  &custombutton=Custom buttons;textarea; &managerbutton=Show go to manager button;list;true,false;true &logout=Logout to;list;manager,front-end;manager &disabled=Plugin disabled on documents;text;","OnWebPagePrerender,OnDocFormPrerender,OnDocFormSave,OnManagerPageInit");
    ...
    $mp[] = array("ManagerManager", "<strong>0.3.5</strong> - Bespoke Manager customizing tool",0,"$setupPath/plugin.mm.tpl","&config_chunk=Configuration Chunk;text; &remove_deprecated_tv_types_pref=Remove deprecated TV types;list;yes,no;yes &which_jquery=jQuery source;list;local (assets/js),remote (google code),manual url (specify below);local (assets/js) &js_src_type=jQuery URL override;text;
	","OnDocFormRender,OnDocFormPrerender,OnPluginFormRender,OnTVFormRender");
