...
#:::::::::::::::::::::::::::::::::::::::::
	...
	$mp[] = array("QuickEdit","Front-end Content Editor.",0,"$setupPath/quickedit.plugin.tpl","&plugin_path=QuickEdit Path (from site root);string;assets/plugins/quick_edit &show_manager_link=Show Manager Link;int;1 &show_help_link=Show Help Link;int;1 &editable=Editable Fields;string;pagetitle,longtitle,description,content,alias,introtext,menutitle,published,hidemenu,menuindex,searchable,cacheable","OnParseDocument,OnWebPagePrerender","f888bac76e1537ca8e0cbec772b4624a");
