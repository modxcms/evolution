...
// delete variable
$modx->getDatabase()->delete($modx->getFullTableName('site_tmplvars'), "id='{$id}'");

// delete variable's content values
$modx->getDatabase()->delete($modx->getFullTableName('site_tmplvar_contentvalues'), "tmplvarid='{$id}'");

// delete variable's template access
$modx->getDatabase()->delete($modx->getFullTableName('site_tmplvar_templates'), "tmplvarid='{$id}'");

// delete variable's access permissions
$modx->getDatabase()->delete($modx->getFullTableName('site_tmplvar_access'), "tmplvarid='{$id}'");
