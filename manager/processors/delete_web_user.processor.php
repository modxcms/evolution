...
$username = $modx->getDatabase()->getValue($modx->getDatabase()->select('username', $modx->getFullTableName('web_users'), "id='{$id}'"));
...
// delete user groups
$modx->getDatabase()->delete($modx->getFullTableName('web_groups'), "webuser='{$id}'");

// delete the attributes
$modx->getDatabase()->delete($modx->getFullTableName('web_user_attributes'), "internalKey='{$id}'");
