...
?>
	...
	case '88' : // edit user
		...
		if (!$rs) {
			$modx->webAlertAndQuit("An error occurred while attempting to update the user's data.");
		}
		$field = array();
		...
		if (!$rs) {
			$modx->webAlertAndQuit("An error occurred while attempting to update the user's attributes.");
		}
