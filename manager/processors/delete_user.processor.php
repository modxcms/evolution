...
$username = $modx->getDatabase()->getValue($modx->getDatabase()->select('username', $modx->getFullTableName('manager_users'), "id='{$id}'"));
...
// delete the user.
$modx->getDatabase()->delete($modx->getFullTableName('manager_users'), "id='{$id}'");

$modx->getDatabase()->delete($modx->getFullTableName('member_groups'), "member='{$id}'");

// delete user settings
$modx->getDatabase()->delete($modx->getFullTableName('user_settings'), "user='{$id}'");

// delete the attributes
$modx->getDatabase()->delete($modx->getFullTableName('user_attributes'), "internalKey='{$id}'");
