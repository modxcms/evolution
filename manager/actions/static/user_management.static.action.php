...
<div class="sectionHeader"><img src='media/images/misc/dot.gif' alt="." />&nbsp;<?php echo $_lang['user_management_title']; ?></div><div class="sectionBody">
	...
	<div class="searchbar">
		<table border="0" style="width:100%">
			<tr>
			<td><a class="searchtoolbarbtn" href="index.php?a=11"><img src="media/images/icons/save.gif"  align="absmiddle" /> <?php echo $_lang['new_user']; ?></a></td>
			<td nowrap="nowrap">
	...
	$grd->colTypes="template:<a class='gridRowIcon' href='#' onclick='return showContentMenu([+id+],event);' title='".$_lang["click_to_context"]."'><img src='media/images/icons/user.gif' width='18' height='18' /></a>||template:<a href='index.php?a=12&id=[+id+]' title='".$_lang["click_to_edit_title"]."'>[+value+]</a>";
