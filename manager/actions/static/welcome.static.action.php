...
<div class="subTitle" style="margin-bottom:0px">
	<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><img src="media/images/icons/home.gif" align="absmiddle" />&nbsp;<?php echo $_lang["home"]; ?></span>
</div>
...
<?php if($modx->hasPermission('messages')) { ?>		
		<a href="index.php?a=10"><img src="media/images/icons/mail_generic.gif" align="absmiddle" border=0></a>
...
<?php 	if($modx->hasPermission('new_user')||$modx->hasPermission('edit_user')) { ?>					
	  <td align="center"><a class="hometblink" href="index.php?a=75"><img src="media/images/icons/security.gif" width="32" height="32" alt="<?php echo $_lang['user_management_title']; ?>" /><br /><?php echo $_lang['security']; ?></a></td>
	  <td style="color:silver">|</td>
<?php 	} ?>	  
<?php 	if($modx->hasPermission('new_web_user')||$modx->hasPermission('edit_web_user')) { ?>
	  <td align="center"><a class="hometblink" href="index.php?a=99"><img src="media/images/icons/web_users.gif" width="32" height="32" alt="<?php echo $_lang['web_user_management_title']; ?>" /><br /><?php echo $_lang['web_users']; ?></a></td>
	  <td style="color:silver">|</td>
<?php 	} ?>	  
<?php 	if($modx->hasPermission('new_module') || $modx->hasPermission('edit_module') || $modx->hasPermission('exec_module')) { ?>					
	  <td align="center"><a class="hometblink" href="index.php?a=106"><img src="media/images/icons/modules.gif" width="32" height="32" alt="<?php echo $_lang['manage_modules']; ?>" /><br /><?php echo $_lang['modules']; ?></a></td>
	  <td style="color:silver">|</td>
<?php 	} ?>	  
<?php if($modx->hasPermission('new_template') || $modx->hasPermission('edit_template') || $modx->hasPermission('new_snippet') || $modx->hasPermission('edit_snippet') || $modx->hasPermission('new_plugin') || $modx->hasPermission('edit_plugin') || $modx->hasPermission('manage_metatags')) { ?>					
	  <td align="center"><a class="hometblink" href="index.php?a=76"><img src="media/images/icons/resources.gif" width="32" height="32" alt="<?php echo $_lang['resource_management']; ?>" /><br /><?php echo $_lang['resources']; ?></a></td>
	  <td style="color:silver" width="50">|</td>
<?php 	} ?>
<?php if($modx->hasPermission('bk_manager')) { ?>		
	  <td align="center"><a class="hometblink" href="index.php?a=93"><img src="media/images/icons/backup.gif" width="32" height="32" alt="<?php echo $_lang['bk_manager']; ?>" /><br /><?php echo $_lang['backup']; ?></a></td>
<?php 	} ?>
	</tr>
</table>
</div>
...
<div class="tab-pane" id="welcomePane" style="border:0px"> 
	...
	<div class="tab-page" id="tabcheck" style="padding-left:0px; padding-right:0px"> 
		...
		<script type="text/javascript">tpPane.addTabPage( document.getElementById( "tabcheck" ) );</script> 
			...
			<img src="media/images/icons/event2.gif" align="absmiddle" />
