...
<input type="hidden" name="params" value="<?php echo htmlspecialchars($content['display_params'], ENT_QUOTES, $modx->config['modx_charset']);?>">
...
<table>
  <tr>
    ...
    <td>[*&nbsp;<input name="name" type="text" maxlength="50" value="<?php echo htmlspecialchars($content['name'], ENT_QUOTES, $modx->config['modx_charset']);?>" class="inputBox" style="width:250px;" onchange="documentDirty=true;">*]&nbsp; <span class="warning" id='savingMessage'>&nbsp;</span></td>
  </tr>
  <tr>
    <th><?php echo $_lang['tmplvars_caption']; ?>:</th>
    <td><input name="caption" type="text" maxlength="80" value="<?php echo htmlspecialchars($content['caption'], ENT_QUOTES, $modx->config['modx_charset']);?>" class="inputBox" style="width:300px;" onchange="documentDirty=true;"></td>
  </tr>
...
<?php endif;?>
  ...
  <tr>
	...
	<td nowrap="nowrap"><textarea name="elements" maxlength="65535" class="inputBox textarea" onchange="documentDirty=true;"><?php echo htmlspecialchars($content['elements'], ENT_QUOTES, $modx->config['modx_charset']);?></textarea><img src="<?php echo $_style["icons_tooltip_over"]?>" onmouseover="this.src='<?php echo $_style["icons_tooltip"]?>';" onmouseout="this.src='<?php echo $_style["icons_tooltip_over"]?>';" alt="<?php echo $_lang['tmplvars_binding_msg']; ?>" onclick="alert(this.alt);" style="cursor:help" /></td>
  </tr>
  <tr>
    <th><?php echo $_lang['tmplvars_default']; ?>:&nbsp;&nbsp;</th>
    <td nowrap="nowrap"><textarea name="default_text" type="text" class="inputBox" rows="5" style="width:300px;" onchange="documentDirty=true;"><?php echo htmlspecialchars($content['default_text'], ENT_QUOTES, $modx->config['modx_charset']);?></textarea><img src="<?php echo $_style["icons_tooltip_over"]?>" onmouseover="this.src='<?php echo $_style["icons_tooltip"]?>';" onmouseout="this.src='<?php echo $_style["icons_tooltip_over"]?>';" alt="<?php echo $_lang['tmplvars_binding_msg']; ?>" onclick="alert(this.alt);" style="cursor:help" /></td>
  </tr>
  <tr>
