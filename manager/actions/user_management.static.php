...
<h1 class="pagetitle">
  ...
  <span class="pagetitle-text">
    <?php echo $_lang['user_management_title']; ?>
  </span>
</h1>
<div class="section">
<div class="sectionBody">
	...
	<div class="searchbar">
        <table border="0" style="width:100%" class="actionButtons actionButtons--tableheader">
			<tr>
                <td><a href="index.php?a=11"><i class="<?php echo $_style["actions_new"] ?> hide4desktop" aria-hidden="true"></i> <span><?php echo $_lang['new_user']; ?></span></a></td>
			<td nowrap="nowrap">
