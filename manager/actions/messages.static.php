						...
						<tr>
							<td colspan="2">
								<ul class="actionButtons">
									<li id="Button1"><a href="index.php?a=10&t=c&m=rp&id=<?php echo $message['id']; ?>">
											<img src="<?php echo $_style["icons_message_reply"] ?>" /> <?php echo $_lang['messages_reply']; ?></a>
									</li>
									<li id="Button2">
										<a href="index.php?a=10&t=c&m=f&id=<?php echo $message['id']; ?>">
											<img src="<?php echo $_style["icons_message_forward"] ?>" /> <?php echo $_lang['messages_forward']; ?></a></li>
									<li id="Button3"><a href="index.php?a=65&id=<?php echo $message['id']; ?>"><i class="<?php echo $_style["actions_delete"] ?>"></i> <?php echo $_lang['delete']; ?></a></li>
		...
		<table border=0 cellpadding=0 cellspacing=0 class="sortabletable sortable-onload-5 rowstyle-even" id="table-1" width='100%'>
			...
			while($message = $modx->db->getRow($rs)) {
				...
				<tr>
					...
					<td class="<?php echo $messagestyle; ?>" style="cursor: pointer;" onClick="window.location.href='index.php?a=10&id=<?php echo $message['id']; ?>&m=r';"><?php echo $message['subject']; ?></td>
	...
	<div class="sectionBody">
		...
		<form action="index.php?a=66" method="post" name="messagefrm">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>
							...
							<input type="radio" name="sendto" value="a" onClick='hideSpans(3);'><?php echo $_lang['messages_all']; ?>
							<div id='userspan' style="display:block;"> <?php echo $_lang['messages_select_user']; ?>:&nbsp;
								<?php
								// get all usernames
							...
							<div id='groupspan' style="display:none;"> <?php echo $_lang['messages_select_group']; ?>:&nbsp;
								<?php
								// get all usernames
			...
			<fieldset>
				...
				<ul class="actionButtons">
					<li id="Button1">
						<a href="javascript:;" onclick="documentDirty=false; document.messagefrm.submit();"><i class="<?php echo $_style["actions_save"] ?>"></i> <?php echo $_lang['messages_send']; ?></a>
					</li>
					<li id="Button5">
						<a href="index.php?a=10&t=c"><i class="<?php echo $_style["actions_cancel"] ?>"></i> <?php echo $_lang['cancel']; ?></a>
					</li>
				</ul>
