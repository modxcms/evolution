	...
	<!-- Site Settings -->
      <div class="tab-page" id="tabPage2">
        ...
        <table border="0" cellspacing="0" cellpadding="3">
            <tr>
              <td nowrap class="warning"><?php echo htmlspecialchars($_lang["sitename_title"], ENT_QUOTES, $modx->config['modx_charset']) ?></td>
              <td ><input onchange="documentDirty=true;" type='text' maxlength='255' style="width: 200px;" name="site_name" value="<?php echo isset($site_name) ? htmlspecialchars($site_name, ENT_QUOTES, $modx->config['modx_charset']) : "My MODX Site" ; ?>" /></td>
            </tr>
            <tr>
              <td width="200">&nbsp;</td>
      ...
      <?php echo $_lang["cache_type_2"]?><br /> 
          ...
          <tr>
            ...
            <tr>
              ...
              <td ><input onchange="documentDirty=true;" type='text' maxlength='255' style="width: 200px;" name="valid_hostnames" value="<?php echo isset($valid_hostnames) ? htmlspecialchars($valid_hostnames, ENT_QUOTES, $modx->config['modx_charset']) : "" ; ?>" /></td>
            </tr>
            <tr>
              <td width="200">&nbsp;</td>
