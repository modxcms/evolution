...
if(isset($resources->items['site_plugins'])) { ?>
	<div class="tab-page" id="tabPlugins">
		...
		<ul class="actionButtons">
            ...
            <?php if($modx->hasPermission('new_plugin'))  { ?><li><a href="index.php?a=101"><i class="<?php echo $_style["actions_new"] ?>" aria-hidden="true"></i><span><?php echo $_lang['new_plugin']; ?></span></a></li><?php } ?>
			<?php if($modx->hasPermission('save_plugin')) { ?><li><a href="index.php?a=100"><i class="<?php echo $_style["actions_sort"] ?>" aria-hidden="true"></i><span><?php echo $_lang['plugin_priority']; ?></span></a></li><?php } ?>
            ...
            <li><a href="#" id="plugins-help"><i class="<?php echo $_style["actions_help"] ?>" aria-hidden="true"></i><span><?php echo $_lang['help']; ?></span></a></li>
