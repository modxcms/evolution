...
if(isset($resources->items['site_templates'])) { ?>
	<div class="tab-page" id="tabTemplates">
		...
		<div id="template-info" class="msg-container" style="display:none">
			<p class="element-edit-message"><?= $_lang['template_management_msg'] ?></p>
			<p class="viewoptions-message"><?= $_lang['view_options_msg'] ?></p>
		</div>

		<form class="form-group row form-inline filterButtons">
			<div class="col-xs-12">
				<div class="input-group input-group-sm">
					<input class="form-control" type="text" size="30" placeholder="<?= $_lang['element_filter_msg'] ?>" id="site_templates_search" />
