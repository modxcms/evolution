...
if(isset($resources->items['site_snippets'])) { ?>
	<div class="tab-page" id="tabSnippets">
		...
		<div id="snippets-info" class="msg-container" style="display:none">
			<p class="element-edit-message"><?= $_lang['snippet_management_msg'] ?></p>
		...
		<form class="form-group row filterButtons">
			<div class="col-xs-12">
				<div class="input-group input-group-sm">
					<input class="form-control" type="text" placeholder="<?= $_lang['element_filter_msg'] ?>" id="site_snippets_search" />
