      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td colspan="4">
            <ul class="actionButtons">
              <li>
                <a class="default" href="#" onClick="document.searchform.submitok.click();"><i class="<?php echo $_style["actions_search"] ?>" aria-hidden="true"></i> <span><?php echo $_lang['search'] ?></span>
                </a>
              </li>
              <li>
