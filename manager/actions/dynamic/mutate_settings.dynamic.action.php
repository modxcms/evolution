...
<div class="subTitle"> 
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			<td id="Button1" onclick="documentDirty=false; document.settings.submit();"><img src="media/images/icons/save.gif" align="absmiddle"> <?php echo $_lang['save']; ?></td>
				<script>createButton(document.getElementById("Button1"));</script>
			<td id="Button5" onclick="document.location.href='index.php?a=2';"><img src="media/images/icons/cancel.gif" align="absmiddle"> <?php echo $_lang['cancel']; ?></td>
      ...
      <div class="tab-page" id="tabPage4"> 
        ...
        <table border="0" cellspacing="0" cellpadding="3"> 
          ...
          <tr> 
            ...
            <td> <textarea name="signupemail_message" style="width:100%; height: 120px;"><?php echo isset($signupemail_message) ? $signupemail_message : "Hello [+uid+] \n\nHere are your login details for [+sname+] Content Manager:\n\nUsername: [+uid+]\nPassword: [+pwd+]\n\nOnce you log into the Content Manager, you can change your password.\n\nRegards,\nSite Administrator" ; ?></textarea> </td> 
          </tr>
          <tr> 
            <td width="200">&nbsp;</td> 
          ...
          <tr> 
            ...
            <td> <textarea name="websignupemail_message" style="width:100%; height: 120px;"><?php echo isset($websignupemail_message) ? $websignupemail_message : "Hello [+uid+] \n\nHere are your login details for [+sname+]:\n\nUsername: [+uid+]\nPassword: [+pwd+]\n\nOnce you log into [+sname+], you can change your password.\n\nRegards,\nSite Administrator" ; ?></textarea> </td> 
          </tr>
          <tr> 
            <td width="200">&nbsp;</td> 
          ...
          <tr> 
            ...
            <td> <textarea name="webpwdreminder_message" style="width:100%; height: 120px;"><?php echo isset($webpwdreminder_message) ? $webpwdreminder_message : "Hello [+uid+]\n\nTo active you new password click the following link:\n\n[+surl+]\n\nIf successful you can use the following password to login:\n\nPassword:[+pwd+]\n\nIf you did not request this email then please ignore it.\n\nRegrads,\nSite Administrator" ; ?></textarea> </td> 
          </tr>
          <tr> 
            <td width="200">&nbsp;</td> 
