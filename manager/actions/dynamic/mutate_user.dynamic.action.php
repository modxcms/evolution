...
<!-- Tab Start -->
<div class="sectionHeader"><img src='media/style/<?php echo $manager_theme ? "$manager_theme/":""; ?>images/misc/dot.gif' alt="." />&nbsp;<?php echo $_lang['user_title']; ?></div><div class="sectionBody">
