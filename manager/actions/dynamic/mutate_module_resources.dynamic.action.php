...
if(!$modx->hasPermission('edit_module') && $_REQUEST['a']==113) {	
	$e->setError(3);
	$e->dumpError();	
}
...
<div class="subTitle">
	<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $_lang['module_resource_title']; ?></span>

	<table cellpadding="0" cellspacing="0">
		<td id="Button4" onclick="document.location.href='index.php?a=106';"><img src="media/images/icons/cancel.gif" align="absmiddle"> <?php echo $_lang['close']; ?></td>
...
<div class="sectionHeader"><img src='media/images/misc/dot.gif' alt="." />&nbsp;<?php echo $content["name"]." - ".$_lang['module_resource_title']; ?></div><div class="sectionBody">
<p><img src='media/images/icons/modules.gif' alt="." width="32" height="32" align="left" hspace="10" /><?php echo $_lang['module_resource_msg']; ?></p>
<br />
<!-- Dependencies -->
	 <table width="100%" border="0" cellspacing="1" cellpadding="2">
	  <tr>
		...
		<td valign="top" width="120" style="background-color:#eeeeee">
			<a class="searchtoolbarbtn" style="float:left;width:120px;margin-bottom:10px;" href="javascript:;" style="margin-top:2px;width:102px" onclick="removeDependencies();return false;"><img src="media/images/icons/delete.gif" align="absmiddle" /> <?php echo $_lang['remove']; ?></a><br />
			<a class="searchtoolbarbtn" style="float:left;width:120px;" href="javascript:;" style="margin-top:2px;width:102px" onclick="addSnippet();return false;"><img src="media/images/icons/save.gif" align="absmiddle" /> <?php echo $_lang['add_snippet']; ?></a><br />
			<a class="searchtoolbarbtn" style="float:left;width:120px;" href="javascript:;" style="margin-top:2px;width:102px" onclick="addDocument();return false;"><img src="media/images/icons/save.gif" align="absmiddle" /> <?php echo $_lang['add_doc']; ?></a><br />
			<a class="searchtoolbarbtn" style="float:left;width:120px;" href="javascript:;" style="margin-top:2px;width:102px" onclick="addChunk();return false;"><img src="media/images/icons/save.gif" align="absmiddle" /> <?php echo $_lang['add_chunk']; ?></a><br />
			<a class="searchtoolbarbtn" style="float:left;width:120px;" href="javascript:;" style="margin-top:2px;width:102px" onclick="addPlugin();return false;"><img src="media/images/icons/save.gif" align="absmiddle" /> <?php echo $_lang['add_plugin']; ?></a><br />
			<a class="searchtoolbarbtn" style="float:left;width:120px;" href="javascript:;" style="margin-top:2px;width:102px" onclick="addTV();return false;"><img src="media/images/icons/save.gif" align="absmiddle" /> <?php echo $_lang['add_tv']; ?></a><br />
			<a class="searchtoolbarbtn" style="float:left;width:120px;" href="javascript:;" style="margin-top:2px;width:102px" onclick="addTemplate();return false;"><img src="media/images/icons/save.gif" align="absmiddle" /> <?php echo $_lang['add_template']; ?></a><br />
		</td>
	  </tr>
	</table>
</div>
