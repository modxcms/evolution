...
$cm->addItem($_lang["view_log"],"js:menuAction(1)","media/images/icons/save.gif");
$cm->addSeparator();
$cm->addItem($_lang["delete"], "js:menuAction(2)","media/images/icons/delete.gif",(!$modx->hasPermission('delete_eventlog') ? 1:0));
echo $cm->render();
...
<div class="sectionHeader"><img src='media/images/misc/dot.gif' alt="." />&nbsp;<?php echo $_lang['eventlog_viewer']; ?></div><div class="sectionBody">
	<!-- load modules -->
	<p><img src='media/images/icons/eventlog.gif' alt="." width="32" height="32" align="left" hspace="10" /><?php echo $_lang['eventlog_msg']; ?></p>		
	<div class="searchbar">
		<table border="0" style="width:100%">
			<tr>
			<td><a class="searchtoolbarbtn" href="index.php?a=116&cls=1"><img src="media/images/icons/delete.gif"  align="absmiddle" /> <?php echo $_lang['clear_log']; ?></a></td>
			<td nowrap="nowrap">
