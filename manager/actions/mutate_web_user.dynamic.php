...
<form action="index.php?a=89" method="post" name="userform">
  ...
  <div id="actions">
    <ul class="actionButtons">
      ...
      <?php } ?>
      <li id="Button5"><a href="#" onclick="documentDirty=false;document.location.href='index.php?a=99';"><img src="<?php echo $_style["icons_cancel"] ?>" /> <?php echo $_lang['cancel']; ?></a></li>
    </ul>
  </div>
      ...
      <div class="tab-page" id="tabPhoto">
        ...
        <table border="0" cellspacing="0" cellpadding="3" class="table table--edit table--editUser">
          ...
          <tr>
            ...
            <td><input onchange="documentDirty=true;" type='text' maxlength='255' name="photo" value="<?php echo $modx->htmlspecialchars(isset($_POST['photo']) ? $_POST['photo'] : $userdata['photo']); ?>" /> <input type="button" value="<?php echo $_lang['insert']; ?>" onclick="BrowseServer();" /></td>
          </tr>
