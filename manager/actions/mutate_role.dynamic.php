	...
	<form action="index.php?a=36" method="post" name="userform" enctype="multipart/form-data">
		...
		<div id="actions">
			<ul class="actionButtons">
				<li id="Button1" class="transition"><a href="javascript:;" onclick="documentDirty=false; form_save=true; document.userform.save.click();"><i class="<?php echo $_style["actions_save"] ?>"></i> <span><?php echo $_lang['save']; ?></span></a></li>
				...
				<li id="Button5" class="transition"><a href="javascript:;" onclick="documentDirty=false;document.location.href='index.php?a=86';"><i class="<?php echo $_style["actions_cancel"] ?>"></i> <span><?php echo $_lang['cancel'] ?></span></a></li>
			</ul>
