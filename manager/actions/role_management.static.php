...
<div class="tab-page">
	<div class="container container-body">
		<div class="form-group"><?= $_lang['role_management_msg'] ?> <a class="btn btn-secondary btn-sm" href="index.php?a=38"><i class="fa fa-plus-circle hide4desktop"></i> <?= $_lang['new_role'] ?></a></div>
