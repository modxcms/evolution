    ...
    switch ($warnings[$i][0]) {
        ...
        case $_lang['configcheck_sysfiles_mod']:
			...
			if($modx->hasPermission('settings')) {
				$warnings[$i][2] .= '<a href="index.php?a=2&b=resetSysfilesChecksum" style="float:right" onclick="return confirm(\'' . $_lang["reset_sysfiles_checksum_alert"] . '\')">' . $_lang["remove_notice"] . '</a>';
			}
