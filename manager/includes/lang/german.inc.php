...
$_lang["access_permissions_link_to_group"] = 'zur Dokumentgruppe';
...
$_lang["captcha_message"] = 'Aktivieren Sie Captcha-Validierung, um die Sicherheit zu steigern.';
...
$_lang["change_password_message"] = 'Bitte geben Sie Ihr neues Passwort ein und bestätigen Sie dieses. Das Passwort muss zwischen 6 und 15 Zeichen lang sein.';
$_lang["change_password_new"] = 'Neues Passwort';
$_lang["charset_message"] = 'Bitte wählen Sie die Zeichenkodierung die Sie verwenden möchten. Bitte beachten Sie, dass MODx nicht mit allen Kodierungstypen (Encodings) getestet wurde. Falls die Kodierung nicht wie gewünscht funktioniert, wählen Sie ISO-8859-1.';
...
$_lang["click_to_view_details"] = 'Hier klicken, um Details anzuzeigen';
...
$_lang["configcheck_configinc_msg"] = 'Böswillige Menschen könnten möglicherweise verheerende Schäden an Ihrer Website und allem was damit verbunden ist anrichten. <strong>Wichtig:</strong> Bitte ändern Sie die Zugriffsrechte der Konfigurationsdatei (/assets/config.inc.php) auf nur-lesen!';
...
$_lang["configcheck_unauthorizedpage_unavailable"] = 'Die Seite \'unautorisierter Zugriff\' wurde nicht veröffentlicht oder noch nicht erstellt.';
$_lang["configcheck_unauthorizedpage_unavailable_msg"] = 'Die Seite \'unautorisierter Zugriff\' ist für normale Websurfer nicht abrufbar oder existiert gar nicht. Dies kann an einer Endlosschleife und zu vielen Fehlermeldungen in Ihrem Websiteprotokoll liegen. Stellen Sie sicher, dass der Seite keine Benutzergruppen zugeordnet sind.';
$_lang["configcheck_unauthorizedpage_unpublished"] = 'Die Seite \'unautorisierter Zugriff\' aus den Einstellungen Ihrer Konfiguration ist nicht veräffentlicht.';
$_lang["configcheck_unauthorizedpage_unpublished_msg"] = 'Die Seite \'unautorisierter Zugriff\' ist der Allgemeinheit nicht zugänglich. Veröffentlichen Sie die Seite oder stellen Sie sicher, dass sie im Menü Werkzeuge &gt; Konfiguration einer vorhandenen Seite Ihrer Dokumentstruktur zugeordnet ist.';
$_lang["configcheck_warning"] = 'Konfigurationswarnung:';
$_lang["configcheck_what"] = 'Was bedeutet das?';
$_lang["confirm_block"] = 'Sind Sie sicher, dass Sie diesen Benutzer deaktivieren wollen?';
...
$_lang["confirm_delete_file"] = 'Sind Sie sicher, dass Sie diese Datei löschen wollen?\n\nDas könnte den ordnungsgemäßen Betrieb der Seite beeinflussen! Löschen Sie diese Datei nur wenn Sie ganz genau wissen, dass der Betrieb nicht beeinflusst wird.';
...
$_lang["confirm_remove_locks"] = 'Manchmal schließen Benutzer ihren Browser während sie Dokumente bearbeitet haben. Dabei bleiben dann die Dokumente in einem gesperrten Zustand. Wenn Sie OK klicken werden alle Sperren entfernt.\n\nFortfahren?';
...
$_lang["database_collation"] = 'Datenbank-Collation-Charset';
...
$_lang["database_table_clickbackup"] = 'Um ein Backup zu erstellen &amp; ausgewählte Tabellen herunter laden';
...
$_lang["files_upload_inhibited_msg"] = '<b>Datei-Upload verhindert</b> - stellen Sie sicher, dass der Upload unterstützt wird und PHP in dieses Verzeichnis schreiben darf.<br />';
...
$_lang["mail_check_timeperiod_message"] = 'Wie oft soll nach neuen Nachrichten im Manager gesucht werden, in Sekunden.';
...
$_lang["page_data_cacheable_help"] = 'Markieren Sie diese Option, falls Ihr Dokument cachebar ist. Wenn Ihr Dokument Snippets nutzt, muss diese Option deaktiviert sein.';
...
$_lang["rb_base_dir_message"] = 'Geben Sie den physischen Pfad am Fileserver zu Ihrem Ressourcenverzeichnis ein. Abhängig von Ihrem Webserver ist diese Einstellung im Normfallfall automatisch vorausgefüllt. <b>Hinweis:</b> Für die korrekte Funktion muss das Ressourcen-Verzeichnis die Unterverzeichnisse \'images\', \'docs\', \'flash\' und \'media\' beinhalten.';
...
$_lang["rb_webuser_message"] = 'Soll ein Web-Benutzer den Ressourcebrowser verwenden dürfen? <b>ACHTUNG:</b> Wenn Web-Benutzer den Ressourcebrowser verwenden dürfen, können sie alle Dateien einsehen auf die Manager-Benutzer Zugriff haben. Diese Möglichkeit sollte daher nur vertrauenswürdigen Web-Benutzern eingeräumt werden.';$_lang["recent_docs"] = 'Kürzlich bearbeitet';
$_lang["rb_webuser_title"] = 'Web-Benutzer?';
$_lang["refresh_cache"] = 'Cache: <b>%s</b> Dateien wurden im Cache-Verzeichnis gefunden. Gelöschte Dateien <b>%d</b>.<p>Der Cache wird erneuert, sobald die Seiten das erste mal angefordert werden.';
...
$_lang["resource_management"] = 'Ressourcen-Verwaltung';
$_lang["resource_name"] = 'Ressourcennamen';
$_lang["resource_selector_msg"] = 'Wählen Sie die entsprechenden Ressourcen aus und klicken anschließend auf \'einfügen\'.';
...
$_lang["tmplvars_msg"] = 'Hier können Sie Template-Variablen erstellen und bearbeiten. Die Template Variablen müssen für die jeweiligen Templates aktiviert werden, damit Snippets und Dokumente darauf wie normale Variablen zugreifen können.';
...
$_lang["unauthorizedpage_message"] = 'Geben Sie die ID jenes Dokuments an, zu welchem Benutzer bei einem unautorisierten Zugriff weitergeleitet werden. <b>Hinweis:</b>stellen Sie sicher, dass die ID gültig und öffentlich zugänglich ist!';
...
$_lang["upload_maxsize_message"] = 'Geben Sie hier die maximale Dateigröße für den Datei-Upload via Dateimanager an. Die Größenangabe ist in Bytes. <b>Achtung: je größer die Datei desto länger dauert der Upload!</b>';
...
$_lang["user_edit_self_msg"] = 'Evtl. müssen Sie sich ab- und wieder anmelden, nachdem Sie Ihre Daten geädert haben.';
...
$_lang["use_editor_message"] = 'Möchten Sie den Rich Text Editor benutzen? Wenn Sie HTML schreiben möchten, deaktivieren Sie diese Einstellung. Diese Einstellungen gilt für alle Benutzer und Dokumente.';
...
$_lang["warning_not_saved"] = 'Die Änderungen an Ihrem Dokument wurden bis jetzt nicht gespeichert. Sie können zur vorherigen Ansicht zurück wechseln oder die Ansicht verlassen. Ihre geänderten Daten gehen dann verloren.';
...
$_lang["xhtml_urls_message"] = 'Ersetzt Ampersands (&amp;) in URLs, die von MODx erzeugt werden mit validierbaren &<!-- -->amp; HTML Sonderzeichen.';
$_lang["yes"] = 'Ja';
