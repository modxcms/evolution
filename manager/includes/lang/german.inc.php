...
$_lang["actioncomplete"] = '<b>Aktion war erfolgreich!</b><br />Bitte warten Sie, bis '.CMS_NAME.' sich neu aufgebaut hat.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' kann das Cache-Verzeichnis nicht beschreiben. '.CMS_NAME.' wird wie erwartet funktionieren, das Caching ist jedoch deaktiviert. Um das Problem zu beheben, machen Sie das Verzeichnis „cache“ im Verzeichnis „assets“ beschreibbar.';
...
$_lang["configcheck_php_gdzip_msg"] = CMS_NAME.' benötigt die GD- und ZIP-PHP-Erweiterungen. '.CMS_NAME.' funktioniert zwar auch ohne diese Erweiterungen, aber Sie werden nicht das volle Potential des eingebauten Datei-Managers, Image-Editors oder Captchas für die Anmeldung ausschöpfen können.';
...
$_lang["configcheck_validate_referer_msg"] = "Die Konfigurationseinstellung <strong>HTTP_REFERER Header validieren?</strong> ist AUS. Wir empfehlen, diese anzuschalten. <a href=\"index.php?a=17\">Zu den Einstellungen</a><br /><a href=\"javascript:hideHeaderVerificationWarning();\"><em>Diese Warnung nicht mehr zeigen</em></a>";
$_lang['configcheck_error_handling_silent'] = 'Parser-Fehler werden angezeigt';
$_lang['configcheck_error_handling_silent_msg'] = 'Die Konfigurationseinstellung <strong>PHP/SQL-Fehlermeldungen auf dem Bildschirm anzeigen</strong> ist so eingestellt, dass Fehler auf dem Bildschirm ausgegeben werden. Dies ist für die Entwicklung der Website empfohlen, aber nicht für Live-Sites.';
...
$_lang["confirm_name_change"] = 'Die Änderung des Benutzernamens kann möglicherweise Auswirkungen auf die Funktion von Anwendungen Dritter haben, die Daten von '.CMS_NAME.' verwenden.\n\nSind Sie sicher, dass Sie den Benutzernamen ändern wollen?';
...
$_lang["credits_shouts_msg"] = '<p>Informationen zu '.CMS_NAME.' finden Sie unter: <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_DOMAIN.'/about/</a>.</p>';
...
$_lang["eventlog_msg"] = 'Informations-, Warn- und Fehlermeldungen des '.CMS_NAME.'-Managers werden im Systemereignisprotokoll gespeichert. Unter „Quelle“ ist das jeweils verursachende Modul angegeben.';
...
$_lang["file_folder_chmod_error"] = 'Die Rechte können nicht verändert werden. Sie müssen die Rechte außerhalb von '.CMS_NAME.' ändern.';
...
$_lang["friendly_alias_message"] = 'Wenn Sie benutzerfreundliche URLs verwenden, und die Ressource einen Alias-Eintrag hat, wird das Alias als benutzerfreundliche URL verwendet. Falls Sie keine benutzerfreundliche URLs verwenden verwenden, generiert '.CMS_NAME.' den Link mit einer durchlaufenden Nummerierung.';
$_lang["friendly_alias_title"] = 'Aliasnamen:';
$_lang["friendlyurls_message"] = 'Diese Option erlaubt Ihnen die Benutzung benutzerfreundlicher URLs auf Apache-Webservern mit aktiviertem mod_rewrite oder auf dem IIS-Webserver mit entsprechenden Modulen. Öffnen sie bei '.CMS_NAME.' enthaltene .htaccess-Datei im Root-Verzeichnis für mehr Informationen.';
...
$_lang["help"] = 'Hilfe';
$_lang["help_msg"] = 'Wenn Sie Hilfe bei der Nutzung von '.CMS_NAME.' benötigen besuchen Sie am besten das deutsche <a href="http://clippercms.de/forum/" target="_blank">'.CMS_NAME.'-Forum</a>. Falls Sie dort keine Lösung zu Ihrem Problem oder Ihrer Frage finden, stellen Sie Ihre Frage in dem entsprechendem Unterforum. Das Team wird versuchen Ihre Frage so schnell wie möglich zu beantworten.';
...
$_lang["import_site"] = 'HTML-Seite importieren';
...
$_lang["language_message"] = 'Wählen Sie die Sprache für den '.CMS_NAME.'-Manager.';
...
$_lang["loading_page"] = 'Bitte warten Sie während '.CMS_NAME.' die Seite lädt …';
...
$_lang["login_message"] = 'Bitte melden Sie sich an, um mit '.CMS_NAME.' zu arbeiten.<br />Beachten Sie bei Ihrer Eingabe die Groß- und Kleinschreibung.';
...
$_lang["manager_lockout_message"] = '<p>Sie sind gegenwärtig im '.CMS_NAME.'-Manager angemeldet. Wenn Sie Ihre Login-Session beenden wollen, klicken Sie bitte den Abmelden-Button.</p><p>Um zu Ihrer Start- oder Home-Seite zu gelangen, klicken Sie bitte den Start-Button.';
$_lang["manager_permissions"] = 'Manager-Zugriffberechtigungen';
$_lang["manager_theme"] = 'Manager-Template:';
$_lang["manager_theme_message"] = 'Wählen Sie das Template für den '.CMS_NAME.'-Manager aus.';
...
$_lang["module_group_access_msg"] = 'Wählen Sie die Benutzergruppen aus, die dieses Modul innerhalb des '.CMS_NAME.'-Managers ausführen dürfen.';
...
$_lang["modx_news"] = CMS_NAME.'-Nachrichten';
$_lang["modx_news_tab"] = CMS_NAME.'-Nachrichten';
$_lang["modx_news_title"] = CMS_NAME.'-Nachrichten';
$_lang["modx_security_notices"] = CMS_NAME.'-Sicherheitshinweise';
...
$_lang["no_edits_creates"] = 'Keine Veränderungen gefunden.';
...
$_lang["nomessages_message"] = 'Geben Sie an wie viele Nachrichten im Posteingang angezeigt werden sollen.';
...
$_lang["password_gen_gen"] = CMS_NAME.' soll ein Passwort generieren.';
...
$_lang["php_version_check"] = CMS_NAME.' ist kompatibel mit PHP 5 und höher. Dieser Server läuft mit Version %s%. Bitte installieren Sie eine neuere Version von PHP.';
$_lang["plugin"] = 'Plugin';
...
$_lang["plugin_priority_title"] = 'Reihenfolge der Ausführung der Plugins';
...
$_lang["resource_type_message"] = 'Weblinks referenzieren andere Ressourcen im Internet ebenso wie andere '.CMS_NAME.' Ressourcen, externe Websites, Bilder oder Dateien. Weblinks sollten vom Medientyp text/html sein und Inline-Content-Disposition haben.';
...
$_lang["role_chunk_management"] = 'Chunk-Verwaltung';
...
$_lang["role_logout"] = 'Abmeldung aus dem '.CMS_NAME.'-Manager';
...
$_lang["rss_url_security_message"] = 'URL des '.CMS_NAME.'-Security-Feeds eintragen.';
...
$_lang["settings_title"] = CMS_NAME.'-Konfiguration';
...
$_lang["user_edit_self_msg"] = 'Eventuell müssen Sie sich ab- und wieder anmelden, nachdem Sie Ihre Daten geändert haben.';
...
$_lang["user_mobile"] = 'Mobiltelefonnummer';
...
$_lang["web_user_management_msg"] = 'Hier können Sie auswählen, welche Web-Benutzer Sie bearbeiten möchten. Web-Benutzer können sich nur an der Website anmelden, nicht jedoch im '.CMS_NAME.'-Manager.';
...
$_lang["welcome_title"] = 'Willkommen bei '.CMS_NAME;
...
$_lang["xhtml_urls_message"] = 'Ersetzt „&amp;“-Zeichen in URLs, die von '.CMS_NAME.' erzeugt werden mit validen &<!-- -->amp; HTML-Entities.';
...
$_lang['error_handling_silent_label'] = 'PHP/SQL-Fehlermeldungen auf dem Bildschirm anzeigen.';
$_lang['error_handling_silent_0'] = 'Auf dem Bildschirm anzeigen';
$_lang['error_handling_silent_1'] = 'Nichts anzeigen. Programm-Ausführung stoppt mit einem leeren Bildschirm.';
