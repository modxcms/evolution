...
$modx_manager_charset = 'UTF-8';
	...
	$_lang["access_permissions_add_document_group"] = 'Eine neue Ressourcen-Gruppe erstellen';
	...
	$_lang["access_permissions_document_groups"] = 'Ressourcen-Gruppen';
	$_lang["access_permissions_documents_in_group"] = '<b>Ressourcen in Gruppe:</b> ';
	$_lang["access_permissions_documents_tab"] = 'Hier sehen Sie die angelegten Ressourcen-Gruppen. Sie können auch neue Gruppen anlegen, Gruppen umbenennen, Gruppen löschen und sehen welche Ressourcen in den unterschiedlichen Gruppen enthalten sind (den Namen der Ressource sehen Sie, in dem Sie mit der Maus über die ID fahren). Um eine Ressource zu einer Gruppe hinzuzufügen oder von einer Gruppe zu entfernen, ändern Sie die entsprechende Ressource direkt.';
	...
	$_lang["add_document"] = 'Ressource hinzufügen';
	...
	$_lang["confirm_delete_document"] = 'Sind Sie sicher, das Sie diese Ressource löschen möchten?\nAlle Unter-Ressourcen werden ebenfalls gelöscht.';
	...
	$_lang["confirm_duplicate_document"] = 'Sind Sie sicher, dass Sie diese Ressource duplizieren möchten?\nAlle enthaltenen Unter-Ressourcen werden ebenfalls dupliziert.';
	...
	$_lang["create_document_here"] = 'Ressource hier erstellen';
	...
	$_lang["delete_document"] = 'Ressource Löschen';
	...
	$_lang["document_alias"] = 'Ressource-Alias';
	$_lang["document_alias_help"] = 'Hier können Sie die URL der Ressource angeben um diese auch über http://beispiel.de/alias verfügbar zu machen. Funktioniert nur bei aktivierten benutzerfreundlichen URLs.';
	$_lang["document_content"] = 'Inhalt der Ressource';
	$_lang["document_description"] = 'Beschreibung';
	$_lang["document_description_help"] = 'Sie können hier eine optionale Beschreibung der Ressource eingeben.';
	$_lang["document_long_title_help"] = 'Hier können Sie einen längeren Titel für die Ressource eingeben. Der Langtitel kann für Header-Tags verwendet werden, nützlich für die Suchmaschinen-Indizierung sein und aussagekräftig Ihre Seite beschreiben.';
	$_lang["document_metatag_help"] = 'Wählen Sie jene Meta-Tags und Schlüsselwörter aus, die dieser Ressource zugeordnet werden sollen. Für eine Mehrfachauswahl halten Sie die STRG- / CTRL-Taste gedrückt.';
	$_lang["document_opt_contentdispo"] = 'Inhaltstyp';
	$_lang["document_opt_contentdispo_help"] = 'Mit diesem Feld können Sie festlegen, ob der Browser diese Ressource wie üblich im Browser-Fenster darstellt oder als Datei-Download anbietet.';
	$_lang["document_opt_emptycache"] = 'Cache leeren';
	$_lang["document_opt_emptycache_help"] = 'Eine Markierung dieses Feldes löscht den Cache für diese Ressource nach dem Speichern.';
	$_lang["document_opt_folder"] = 'Container';
	$_lang["document_opt_folder_help"] = 'Markieren Sie diese Einstellung, wenn diese Ressource als Container für andere Ressourcen zur Verfügung stehen soll. Ein Container ist wie ein Ordner für weitere Ressourcen, kann selbst aber auch Inhalte enthalten.';
	$_lang["document_opt_menu_index"] = 'Menüindex';
	$_lang["document_opt_menu_index_help"] = 'Der Menüindex kann in Menü-Snippets die Position der Ressource in Menülisten bestimmen oder auch für jeden anderen Zweck in Snippets verwendet werden.';
	$_lang["document_opt_menu_title"] = 'Menütitel';
	$_lang["document_opt_menu_title_help"] = 'Im Menütitel kann optional ein kurzer Titel angegeben werden, der für Links zu dieser Ressource in Menü-Snippets verwendet wird.';
	$_lang["document_opt_published"] = 'Veröffentlicht';
	$_lang["document_opt_published_help"] = 'Markieren Sie diese Option, wenn Ihr Ressource direkt nach dem speichern veröffentlicht werden soll.';
	$_lang["document_opt_richtext"] = 'Rich-Text';
	$_lang["document_opt_richtext_help"] = 'Markieren Sie diese Option, wenn Sie zum Bearbeiten der Ressource den Rich-Text-Editor nutzen möchten. Fall Ihr Ressource Javascript oder Formulare beinhalten soll, deaktivieren Sie diese Option, damit der HTML-Editor Ihr Ressource nicht zerstört.';
	$_lang["document_opt_show_menu"] = 'Im Menü anzeigen';
	$_lang["document_opt_show_menu_help"] = 'Aktivieren Sie diese Option um die Ressource in Menülisten anzuzeigen. Setzt voraus, dass Ihre Menü-Snippets diese Angabe interpretieren.';
	$_lang["document_opt_trackvisit_help"] = 'Besucherzugriffe auf dieser Seite protokollieren';
	$_lang["document_overview"] = 'Ressourcen-Übersicht';
	$_lang["document_parent"] = 'Container';
	$_lang["document_parent_help"] = 'Klicken Sie auf eine Ressource im Baum, um diese als übergeordnete Ressource zu wählen.';
	$_lang["document_permissions_error"] = 'Weisen Sie diese Resource mindestens einer Ressourcen-Gruppe zu, zu der Sie Zugriff haben.';
	$_lang["document_setting"] = 'Ressourcen-Eigenschaften';
	$_lang["document_summary"] = 'Zusammenfassung';
	$_lang["document_summary_help"] = 'Geben Sie eine kurze inhaltliche Zusammenfassung der Ressource ein.';
	$_lang["document_title"] = 'Titel';
	$_lang["document_title_help"] = 'Geben Sie hier den Namen/Titel der Ressource ein. Vermeiden Sie die Benutzung von Backslashes im Namen!';
	$_lang["document_to_be_moved"] = 'Ressource die verschoben werden soll';
	$_lang["document_weblink_help"] = 'Geben Sie hier die Adresse des Objekts ein, auf welches Sie verlinken möchten.';
	$_lang["documents_in_container"] = 'Ressourcen in diesem Container.';
	$_lang["documents_in_container_no"] = 'Dieser Container enthält keine Unter-Ressourcen.';
	...
	$_lang["duplicate_document"] = 'Ressource duplizieren';
	...
	$_lang["edit_document"] = 'Ressource Bearbeiten';
	$_lang["edit_document_title"] = 'Ressource erstellen/bearbeiten';
	...
	$_lang["import_parent_document"] = 'Container:';
	...
	$_lang["move_document"] = 'Ressource Verschieben';
	$_lang["move_document_message"] = 'Sie können diese Ressource und alle Unter-Ressourcen durch die Wahl eines neuen Containers verschieben. Wenn Sie eine Ressource wählen, die kein Container ist, wird diese Ressource automatisch in einen Container umgewandelt. Bitte wählen Sie einen neuen Container aus dem Ressourcen-Baum aus.';
	$_lang["move_document_new_parent"] = 'Bitte wählen Sie einen neuen Container aus dem Ressourcen-Baum aus.';
	$_lang["move_document_title"] = 'Ressource verschieben';
	$_lang["name"] = 'Name';
...
$_lang["no_edits_creates"] = 'No edits or creates found.';
	...
	$_lang["preview_document"] = 'Ressource-Vorschau';
	...
	$_lang["resource_categories"] = 'Alle Elemente';
	$_lang["resource_management"] = 'Elementen-Verwaltung';
	$_lang["resource_name"] = 'Element-Namen';
	$_lang["resource_selector_msg"] = 'Wählen Sie die entsprechenden Elemente aus und klicken anschließend auf „einfügen“.';
	$_lang["resource_selector_title"] = 'Elemente-Auswahl';
	$_lang["resources"] = 'Elemente';
	$_lang["role"] = 'Rolle';
	...
	$_lang["untitled_document"] = 'Unbenannte Ressource';
	...
	$_lang["view"] = 'Ansehen';
	$_lang["view_child_documents_in_container"] = 'Ressourcen in Container anzeigen';
