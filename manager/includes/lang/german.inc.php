 ...
 * Date:           2005/11/27
 * Modified:       2006/01/10 - Timon Reinhard (timon@netnoise.de)
...
$_lang["login_message"] = "Bitte loggen Sie sich ein, um mit MODx zu arbeiten.<br />Beachten Sie bei Ihrer Eingabe die Groß- und Kleinschreibung.";
...
$_lang["change_password"] = "Kennwort ändern";
...
$_lang["rebuild"] = "Neu aufbauen";
$_lang["menu"] = "Menü";
$_lang["tree"] = "Baum";
$_lang["manager"] = "Manager";
$_lang["test_page"] = "Testseite";
$_lang["logout"] = "Abmelden";
$_lang["nojava"] = "Java scheint deaktiviert zu sein. Klicken Sie <a href='index.php?a=1&f=9&javaDis=1'>hier</a>, um ein Menü ohne Java zu laden.";
...
$_lang["published_document"] = "Dieses Dokument ist veröffentlicht.";
$_lang["unpublished_document"] = "Dieses Dokument ist nicht veröffentlicht.";
$_lang["deleted_document"] = "Dieses Dokument wurde gelöscht.";
$_lang["published_folder"] = "Dieser Ordner ist veröffentlicht.";
$_lang["unpublished_folder"] = "Dieser Ordner ist nicht veröffentlicht.";
$_lang["deleted_folder"] = "Dieser Ordner wurde gelöscht.";
$_lang["published_weblink"] = "Dies ist ein veröffentlichter Weblink.";
$_lang["unpublished_weblink"] = "Dies ist ein unveröffentlichter Weblink.";
$_lang["deleted_weblink"] = "Dies ist ein gelöschter Weblink.";
$_lang["published_weblink_folder"] = "Dies ist ein veröffentlichter Weblinkordner.";
$_lang["unpublished_weblink_folder"] = "Dies ist ein unveröffentlichter Weblinkordner.";
$_lang["deleted_weblink_folder"] = "Dies ist ein gelöschter Weblinkordner.";
$_lang["recycle_bin"] = "Papierkorb"; // obsolete
$_lang["empty_recycle_bin"] = "Papierkorb leeren"; // changed 06 rc 2
$_lang["deleted_in_tree"] = "Gelöschtes im Baum anzeigen"; // obsolete
$_lang["deleted_in_recycle_bin"] = "Gelöschtes im Papierkorb anzeigen"; // obsolete
...
$_lang["loading_menu_tree"] = "Laden des Dokumentenbaumes und des Menüs...";
...
$_lang["welcome_messages"] = "Ihr Posteingang enthält <strong>%d</strong> Nachricht(en). <strong>%s</strong> davon sind ungelesen.";
$_lang["activity_title"] = "Kürzlich bearbeitete oder erstellte Dokumente";
$_lang["activity_message"] = "Diese Liste zeigt Ihnen die Dokumente, die Sie kürzlich bearbeitet oder erstellt haben:";
...
$_lang["configcheck_installer_msg"] = "Das Installationsverzeichnis enthält die Installationsroutinen von MODx. Stellen Sie sich vor, eine nicht berechtigte Person findet dieses Verzeichnis und startet die Installationsroutine. Wahrscheinlich wird diese Person nicht weit kommen, da die Daten zur Datenbank eingeben werden müssen, aber es ist trotzdem besser, den Ordner vom Server zu löschen.";
...
$_lang["configcheck_lang_difference_msg"] = "Die zur Zeit ausgewählte Sprache ($manager_language) enthält nicht die gleiche Anzahl an Einträgen wie die Standardsprache. Dies ist nicht wirklich ein Problem, bedeutet jedoch, das Sie die Sprachdatei updaten sollten.";
$_lang["configcheck_default_msg"] = "Which is strange. Ziemlich merwürdig."; // Never go here ;-)
$_lang["clicktopin"] = "Sektion anheften.";
$_lang["clicktounpin"] = "Sektion lösen.";
...
$_lang["serveroffset_message"] = "Wählen Sie die Anzahl der Stunden, die zwischen der Serverzeit und Ihrer Ortszeit liegen. Die derzeitige Serverzeit ist <strong>[%s]</strong>, die derzeitige Serverzeit bei Nutzung der Zeitverschiebung ist <strong>[%s]</strong>.";
...
$_lang["sitestart_message"] = "Geben Sie die ID des Dokuments ein, welches die Startseite sein soll. <strong>Hinweis:</strong> Stellen Sie sicher, dass dieses Dokument vorhanden und veröffentlicht ist!";
$_lang["errorpage_title"] = "Fehlerseite:";
$_lang["errorpage_message"] = "Geben Sie die ID des Dokuments ein, welches aufgerufen wird, wenn eine Seite angefordert wird die nicht vorhanden ist. <strong>Hinweis:</strong> Stellen Sie sicher, das dieses Dokument vorhanden und veröffentlicht ist!";
...
$_lang["friendlyurlsprefix_title"] = "Prefix für benutzerfreundliche URLs:";
$_lang["friendlyurlsprefix_message"] = "Hier können Sie ein Prefix für die benutzerfreundlichen URLs angeben. Wenn Sie z.B. 'page' als Prefix angeben, wird die URL /index.php?id=2 in /page2.html umgewandelt (vorrausgesetzt das Suffix wurde auf .html gesetzt)."; // updated 0.6 - removed htaccess warning
$_lang["friendlyurlsuffix_title"] = "Suffix für benutzerfreundliche URLs:";
$_lang["friendlyurlsuffix_message"] = "Hier können Sie ein Suffix angeben."; // updated 0.6 - removed htaccess warning
$_lang["udperms_title"] = "Benutzerzugriffskontrolle:";
$_lang["udperms_message"] = "Die Zugriffskontrolle erlaubt Ihnen festzulegen, welche Seiten von welchem Benutzer bearbeitet werden können. Diese Funktion ist noch in arbeit und ziemlich fehlerbehaftet. Aus diesem Grund ist dies Option deaktiviert."; // updated 0.6
$_lang["menutype_title"] = "Menütyp:";
$_lang["menutype_message"] = "M&uml;chten Sie mit dem erweiterten Javemenü oder dem normale Textmenü arbeiten?";
...
$_lang["graphtype_message"] = "Bei der Auswahl 'Erweitert' wird anti-aliasing für die Grafiken in den Besucherstatistiken genutzt. Dies erzeugt mehr Prozessorlast. Die Grafiken sehen dafür auch besser aus.";
...
$_lang["showtestpage_message"] = "Die  Testseite können Sie zum Testen von Snippets nutzen. Wenn Sie die Testseite nicht mehr benötigen,  müssen Sie diese vom Menü durch 'Auschecken' wieder entfernen.";
$_lang["enabledebug_title"] = "Debug aktivieren:";
$_lang["enabledebug_message"] = "Haben Sie diese Option gewählt, so werden Ihnen verschiedene Debug Informationen aus MODx angezeigt. Normalerweise sollte diese Option deaktiviert sein.";
...
$_lang['document_opt'] = "Veröffentlichung, Caching und Aufmachung";
...
$_lang['document_opt_menu_index_help'] = "Menüindex ist ein Feld zum sortieren im Menüsnippet. Sie können es in Ihren Snippets beliebig nutzen.";
...
$_lang['edit_parser_warning'] = "<strong style='color:#821517'>Die Bearbeitung dieser Datei kann Ihre Seite zerstören!</strong><br />Sie bearbeiten nun eine PHP Datei. Machen Sie ein Backup der Datei (Notepad, Kopie,...), bevor Sie mit der Arbeit beginnen!";
$_lang['change_password_message'] = "Bitte geben Sie Ihr neues Kennwort ein und bestätigen Sie dieses. Das Kennwort muss zwischen sechs und 15 Zeichen lang sein.";
$_lang['change_password_new'] = "Neues Kennwort";
$_lang['change_password_confirm'] = "Kennwort bestätigen";
...
$_lang['role_change_password'] = "Kennwort ändern";
$_lang['role_save_password'] = "Kennwort speichern";
...
$_lang['password_gen_method'] = "Wie möchten Sie das Benutzerkennwort erzeugen?";
$_lang['password_gen_gen'] = "MODx soll ein Kennwort generieren.";
$_lang['password_gen_specify'] = "Das Kennwort wird von mir eingegeben:";
$_lang['password_method'] = "Wie möchten Sie den Benutzer über sein neues Kennwort benachrichtigen?";
$_lang['password_method_email'] = "Neues Kennwort per Email senden.";
$_lang['password_method_screen'] = "Neues Kennwort am Bildschirm ausgeben.";
$_lang['password_msg'] = "Das neue Kennwort für <strong>%s</strong> ist <strong>%s</strong>.";
$_lang['user_full_name'] = "Name";
$_lang['user_email'] = "Email Adresse";
...
$_lang['refresh_published'] = "<strong>%s</strong> Dokumente wurden veröffentlicht.";
$_lang['refresh_unpublished'] = "<strong>%s</strong> Dokumente wurden unveröffentlicht.";
$_lang['refresh_cache'] = "Cache: <strong>%s</strong> Dateien wurden im Cacheverzeichnis gefunden. Gelöschte Dateien <strong>%d</strong>.<p>Der Cache wird erneuert, sobald die Seiten das erstemal angefordert werden."; // changed in 0.6
...
$_lang['credits_adodb'] = "John Lim hat diese großartige Datenbankabstraktionsebene erstellt. Etomite benutzt zwar nur MySQL, ist aber nichtsdestotrotz sehr gut!"; // obsolete
...
$_lang['credits_shouts_title'] = "<strong>Zusätzlicher Dank an: </strong>"; // obsolete
...
$_lang['files_upload_error1'] = "Die Datei ist für einen Upload zu gross.";
$_lang['files_upload_error2'] = "Die Datei ist für einen Upload zu gross.";
...
$_lang['files_upload_inhibited_msg'] = "<strong>Dateiupload verhindert</strong> - stellen Sie sicher, das der Upload unterstützt wird und PHP in dieses Verzeichnis schreiben darf.<br />";
...
$_lang['search_criteria_id_msg'] = "Geben Sie die ID des Dokuments ein, um dieses schnell zu finden.";
...
$_lang['search_empty'] = "Ihre Suche ergab keine Treffer. Bitte ädern Sie Ihre Suchanfrage und versuchen Sie es noch einmal.";
$_lang['search_results_returned_msg'] = "Ihre Suchanfrage ergab <strong>%s</strong> Treffer. Wenn zu viele Ergebnisse gefunden wurden, versuchen Sie die Suche zu verfeinern. Das erste Symbol in jeder Spalte zeigt Ihnen die Dokumentenpostion im Baum an. Ganz rechts können Sie den Dokumentenstatus ersehen.";
...
$_lang['php_version_check'] = "MODx ist kompatibel mit PHP 4.0.3 und höher. Bitte installieren Sie eine neuere PHP Version.";
$_lang['document_alias'] = "Namensabkürzung";
$_lang['document_alias_help'] = "Hier können Sie eine Namensabkürzung für Ihr Dokument definieren. Dadurch wird Ihr Dokument auch über:\n\nhttp://ihrserver/Namensabkürzung erreichbar.\n\nFunktioniert nur bei eingeschalteten 'friendly URLs'.";
...
$_lang['parser_not_writable'] = "Der Parser den Sie bearbeiten möchten ist nicht beschreibbar. Bitte machen Sie die Datei beschreibbar (über FTP oder die Einstellungen des Webhosters), bevor Sie weitermachen."; //obsolete
...
$_lang['settings_ui'] = "Benutzeroberfläche Einstellungen"; //changed 0.6 - added editor
...
$_lang['signupemail_message'] = "Hier können Sie  die Vorlage der Email eingeben, die das System automatisch an Ihre Benutzer schickt, wenn die entsprechenden Benutzerkonten erstellt werden. Folgende Platzhalter werden vom System ersetzt, wenn die Nachricht versendet wird:<br />
<br />[+sname+] - Name dieser Website<br />[+saddr+] - Emailadresse des Website Verwalters<br />[+surl+] - URL der Website<br />[+uid+] - Name des Benutzerkontos<br />[+pwd+] - Passwort des Benutzerkontos<br />[+ufn+] - Name des Benutzers<br /><br /><strong>Hinweis:</strong>Sie sollten auf jedenfall [+uid+] und [+pwd+] in der Vorlage anführen, damit Ihre Benutzer auch die entsprechenden Logindaten erhalten!";
$_lang['emailsender_title'] = "Email Adresse:";
$_lang['emailsender_message'] = "Hier können Sie die Email-Adresse angeben, die als Absender genutzt wird.";
...
$_lang['layout_message'] = "Wählen Sie dies Option zur Auswahl des MODx-Manager Layouts.";
$_lang['layout_settings_1'] = "Basis-Sidebar-Layout <br /><span class='comment'>Navigation über den Dokumentenbaum.</span>";
$_lang['layout_settings_2'] = "Top-Menü-Layout (nur IE) <br /><span class='comment'>Navigation oberhalb des Bildschirms. Funktioniert derzeit nur im IE</span>";
...
$_lang['friendly_alias_title'] = "Benutzerfreundliche Namensabkürzung:";
$_lang['friendly_alias_message'] = "Wenn Sie benutzerfreundliche URLs verwenden, und das Dokument hat eine Namensabkürzung, dann wird die Namensabkürzung als benutzerfreundliche Url verwendet. Zum Beispiel: willkommen.html statt p12.html. Falls Sie keinen Alias verwenden, generiert Ihnen MODx den Link mit einer durchlaufenden Nummerierung, z.B. `1.html` etc. pp.";
$_lang['no_stats_message'] = "Die Besucherstatistik ist nicht aktiviert.";
$_lang['welcome_visitor_stats'] = "Diese Tabelle zeigt Ihnen die Besucherstatistik. Weitere Informationen finden Sie auf der `Statistik`-Seite.<br /><br />";
$_lang['page_impressions'] = "Seitenaufrufe";
$_lang['visitors'] = "Einzelne Besucher";
$_lang['visits'] = "Besucheranzahl";
$_lang['all_time'] = "Alle Einträge";
$_lang['this_month'] = "Dieser Monat";
$_lang['today'] = "Heute";
$_lang['document_visitor_stats'] = "<br /><br />Diese Tabelle zeigt Ihnen die Besucherstatistik für dieses Dokument:<br />";
...
$_lang['stats_title'] = "Besucherstatistik für `%s` vom %s bis %s";
...
$_lang['no_logging_found'] = "Es wurden keine Protokolleinträge gefunden.";
...
$_lang['access_permission_denied'] = "Sie haben nicht die Berechtigung die Zugriffsrechte für dieses Dokument zu ändern."; // changed 0.6 RC2
...
$_lang['htmlsnippet_locked_message'] = "Dieser Chunk ist gesperrt.";
...
$_lang['access_permissions_user_group_access'] = "Dokumentengruppe auf die diese Benutzer Gruppe Zugriff hat:";
...
$_lang['access_permissions_docs_message'] = "Hier können Sie auswählen, welcher Benutzergruppe dieser Benutzer zugeordnet ist";
$_lang['access_permissions_users_message'] = "Hier können Sie auswählen welcher Dokumentengruppe dieses Dokument zugeordnet ist:";
...
$_lang['access_permissions_documents_tab'] = "Hier sehen Sie die angelegten Dokumentengruppen. Sie können auch neue Gruppen anlegen, Gruppen umbenennen, Dokumente löschen und die Zugehörigkeit der Dokumente zu Gruppen sehen (Um den Namen des Dokuments zu sehen, fahren Sie mit der Maus über die Id). Um ein Dokument einer Gruppe hinzuzufügen oder zu entfernen, ändern Sie direkt das entsprechende Dokument.";
...
$_lang["deselect_keywords"] = "Schlüsselwörter löschen";
...
$_lang["defaulttemplate_message"] = "Wählen Sie das Standard-Template das Sie für neue Dokumente verwenden möchten. Sie können auch andere Templates im Dokumenten Editor auswählen. Diese Einstellung betrefft nur die Standardeinstellung.";
$_lang["openurl_message"] = "Welche URL möchten Sie öffnen?";
$_lang["openurl"] = "Externe Seite öffnen";
...
$_lang['export_site_numberdocs'] = "<strong>%s Dokumente für den Export gefunden...</strong><p/>";
...
$_lang['illegal_parent_child'] = "Überdokumentzuweisung:\\n\\nDas Dokument ist dem gewählten Dokumen zugehörig.";
...
$_lang['tmplvar_access_msg'] = "Wählen Sie jene Dokumentengruppen aus, die diese Variable bearbeiten dürfen.";
...
$_lang["upload_maxsize_message"] ="Geben Sie hier die maximale Dateigröße für den Dateiupload via Dateimanager an. Die Größenangabe ist in Bytes. <strong>Achtung: je größer die Datei desto länger dauert der Upload!</strong>";
...
$_lang["login_allowed_ip_message"] = "Geben Sie hier jene IP Adressen an, von welchen aus der Bentzer eine Zugriffsberechtigung erhält. <strong>Hinweis: IP Adressen sind mit einem Komma (,) zu separieren.</strong>";
...
$_lang["settings_keywords"] = "Schlüsselwörter";
...
$_lang["unauthorizedpage_message"] = "Geben Sie die ID jenes Dokuments an, zu welchem Benutzer bei einem unauthorisierten Zugriff weitergeleitet werden. <strong>Hinweis:</strong>stellen Sie sicher, dass die ID gültig und öffentlich zugänglich ist!";
...
$_lang["preview_msg"] = "Dies ist eine Vorschau der zuletzt gespeicherten Änerungen. Klicken Sie hier, um zu <a href='javascript://' onclick=\"saveRefreshPreview();\"><img src='media/images/icons/save.gif' align='absmiddle' height='12'>Speichern und Aktualisieren</a>.";
...
$_lang['module_depend_msg'] = "Benutzen Sie die Schaltknöpfe auf der rechten Seite, um abhängige Ressourcen zu diesem Modul hinzuzufügen.";
...
$_lang['enable_sharedparams_msg']="<strong>Hinweis:</strong> Diese eindeutige Identifikationsnummer (GUID) wird dazu benutzt, um das Modul eindeutig zu identifizieren und entsprechende Verknüpfungen zwischen Modulen und Plugins, Snippets und gemeinsamen Parametern zu gewährleisten. ";
...
$_lang['import_params_msg']="Sie können die Parameter und Einstellungen mittels obiger DropDown-Liste importieren. <b>Hinweis:</b> Damit Module in dieser Liste aufscheinen, muß das jeweilige Plugin/Snippet in der Abhängigkeitsliste des Moduls stehen und das Modul muß die Option 'Gemeinsame Parameter' aktiviert haben. ";
...
$_lang['eventlog_viewer'] = "Ereignisprotokoll";
...
$_lang['metatag_intro'] = "In diesem Bereich können Sie HTML META-Tags erstellen, modifzieren und löschen. Um META Tags mit Dokumenten zu verknüpfen, benutzen Sie die entsprechenden Eigenschaften beim bearbeiten von Dokumenten.";
$_lang['keywords_intro'] = "Hier bearbeiten Sie Schlüsselwörter.";
$_lang['manage_metatags'] = "META-Angaben verwalten";
$_lang['metatag_message'] = "Hier bearbeiten Sie die META-Tags und Schlüsselwörtern. ";
$_lang['tag'] = "Tag";
...
$_lang['document_metatag_help'] = "Wählen Sie jene META-Tags und Schlüsselwörter aus, die diesem Dokument zugewordnet werden sollen. Für eine Mehrfachauswahl benutzen Sie die STRG Taste.";
$_lang["deselect_metatags"] = "META Tags löschen";
...
$_lang['document_opt_menu_title_help'] = "Dieses Feld können Sie benutzen, um kurze Dokumententitel innerhalb Ihrer Menüsnippets oder -module anzuzeigen.";
...
$_lang['duplicate_alias_message'] = "Wählen Sie 'ja', um zweideutige Alias-Namen zu erlauben. <strong>Hinweis:</strong> Diese Option sollte zusammen mit der Option 'Benutzerfreundliche URLs' verwendet werden, um etwaige Probleme bei der Dokumentenreferenzierung zu vermeiden.";
$_lang['public'] = 'Öffentlich';
$_lang['private'] = 'Privat';
$_lang['siteunavailable_page_title'] = "Offline-Seite:";
$_lang['siteunavailable_page_message'] = "Geben Sie die Dokumenten-ID des Dokuments ein, das beim Status 'offline' angezeigt werden soll. <strong>Achtung: stellen Sie sicher, dass die ID gültig und das Dokument publiziert ist!</strong>";
...
$_lang['layout_settings_4'] = "Einklappbares Kopf-Menü<br /><span class='comment'>Ein- und ausklappbares Menü am Seitenkopf.</span>";
$_lang['document_opt_show_menu'] = "Im Menü anzeigen";
$_lang['document_opt_show_menu_help'] = "Aktivieren Sie diese Option wenn das Dokument im Menübaum angezeigt werden soll. Achtung: ältere Menügenerationen ignorieren diese Einstellung möglicherweise.";
...
$_lang['logout_message'] = 'Sie befinden sich derzeit im Inhaltsmanager. Wenn Sie sich abmelden möchten, klicken Sie bitte den "Abmelden"-Button an.<p />Um wieder auf die Starteseite zu gelangen, klicken Sie bitte den "Start"-Button an.';
$_lang['layout_settings_5'] = "Snap-Top-Menübar-Layout<br /><span class='comment'>Popup-Navigationsbar im oberen Bereich des Dokumentenbaums und im Startfenster.</span>";
