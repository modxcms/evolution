...
$_lang["resolve_hostnames_message"] = 'Deseja que o MODx tente encontrar os nomes dos provedores (hostnames) dos seus visitantes? Isto pode causar alguma lentidão no site. Os usuários não saberão que o sistema tenta colectar esses dados.';
...
$_lang["weblink_message"] = 'Um weblink é uma referência a um documento na Internet. Pode ser uma página dentro do MODx, uma página em outro site, um arquivo, filme ou imagem de qualquer outro site na internet.';
