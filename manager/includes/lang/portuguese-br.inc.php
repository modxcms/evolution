...
$_lang["actioncomplete"] = '<b>Ação concluída!</b><br /> - Por favor aguarde enquanto o '.CMS_NAME.' atualiza a página.';
...
$_lang["configcheck_cache_msg"] = 'O sistema '.CMS_NAME.' não pode escrever o diretório de cache. O sistema '.CMS_NAME.' continuará a funcionar como esperado, mas a cache não estará activa. Para resolver isto, active a permissão de escrita no diretório do cache (/_cache/).';
...
$_lang["document_opt_emptycache_help"] = 'Deixando este campo marcado o '.CMS_NAME.' irá apagar a cache sempre que gravar este documento. Isto é importante para que os seus visitantes não vejam versões desatualizadas do documento.';
$_lang["document_opt_folder"] = 'É Pasta?';
$_lang["document_opt_folder_help"] = 'Selecione aqui para usar o documento como pasta para outros documentos. Não precisa de se preocupar muito com isto, pois o '.CMS_NAME.' geralmente encarrega-se das configurações da pasta automaticamente.';
...
$_lang["file_folder_chmod_error"] = 'Não foi possível alterar as permissões, terá que o fazer fora do '.CMS_NAME.'.';
...
$_lang["language_message"] = 'Escolha em que idioma deseja utilizar o Gestor de Conteúdos '.CMS_NAME.'.';
...
$_lang["loading_page"] = 'Aguarde um momento enquanto o '.CMS_NAME.' carrega a página...';
...
$_lang["logout"] = 'Sair';
$_lang["logo_slogan"] = 'Gestor de Conteúdos '.CMS_NAME.' - \nCrie e faça mais com menos';
...
$_lang["modx_version"] = CMS_NAME.' versão';
...
$_lang["password_gen_gen"] = 'Deixar o '.CMS_NAME.' gerar uma senha.';
...
$_lang["php_version_check"] = 'O '.CMS_NAME.' é compatível com PHP versão 4.0.3 ou superior. Por favor atualize a sua instalação de PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["rss_url_news_message"] = 'Digite o URL para o Feed de notícias '.CMS_NAME.'.';
$_lang["rss_url_news_title"] = 'Feed de Notícias RSS';
$_lang["rss_url_security_message"] = 'Digite o URL para o Feed de segurança '.CMS_NAME.'.';
$_lang["rss_url_security_title"] = 'Feed de Segurança RSS';
$_lang["modx_news"] =CMS_NAME.' Avisos de Novidades';
$_lang["modx_news_tab"] =CMS_NAME.' Notícias';
$_lang["modx_news_title"] =CMS_NAME.' Notícias';
$_lang["modx_security_notices"] =CMS_NAME.' Notícias de Segurança';
...
$_lang["settings_strip_image_paths_message"] = 'Se a opção escolhida for \'Não\', o '.CMS_NAME.' irá escrever os caminhos (src=\'...\') de imagens e arquivos como URLs absolutos. URLs relativos são úteis se desejar mover a sua instalação de '.CMS_NAME.', por exemplo de um servidor de testes para o definitivo. Se não sabe do que se trata, é melhor escolher \'Sim\'.';
...
$_lang["tree_show_protected_message"] = 'Quando marcado como "Não", as Páginas Protegidas (e todos os documentos seus descendentes) não aparecem na árvore de documentos. "Não" é a opção por padrão do '.CMS_NAME.' para compatibilidade com versões antigas.';
...
$_lang["welcome_title"] = 'Bem Vindo ao Interface de Gestão de Conteúdos do '.CMS_NAME.'!';
$_lang["which_editor_message"] = 'Aqui pode escolher qual o editor gráfico (tipo Word) de texto que deseja utilizar. Pode fazer download de editores adicionais a partir da página de downloads do '.CMS_NAME.'.';
...
$_lang["xhtml_urls_message"] = 'Subtitui os caracteres "i comercial" (&amp;) nos urls que são gerados pelo '.CMS_NAME.' pela sintaxe conforme aos standards W3C &<!-- -->amp; (entidade html)';
$_lang["yes"] = 'Sim';
...
$_lang["captcha_words_default"] = CMS_NAME.',Brasil,Entrar,Site,br,Espaço,Feriado,Estado,Novidade,Site,Página,Internet,Vai,Gol,País,Meu,www,Busca,Encontro,Astro,Estar,Mundo,Bem,Horizonte,Janeiro,Monitor,Local,Jóquei,Linda,Produção,Estabelecido,lugar,net,inter,Américas,continente,língua,estação,interpretar,Estocolmo,Tabela,Real,Cartão,Celular,Caneta,Óleo,Liberdade,Opção';
...
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' é gerenciado e mantido em <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMS.com</a>. <a href="http://'.CMS_DOMAIN.'.br/" target="_blank">Comunidade do Brasil</a></p>';
?>
