...
Żeby dodać użytkownika do grupy edytuj użytkownika i wybierz grupę (grupy) do których powinien należeć. Aby dodać dokument do grupy użytkowników, edytuj dokument i wybierz grupę (grupy) do których powinien należeć.';
...
$_lang["administrator_role_message"] = 'Ta rola nie może być edytowana czy usunięta.';
...
$_lang["change_password_message"] = 'Proszę wprowadzić nowe hasło i następnie potwierdzić je poprzez ponowne wpisanie. Hasło powinno składać się z 6-15 znaków.';
...
$_lang["configcheck_admin"] = 'Proszę skontaktować się z administratorem systemu, aby powiadomić go o tej wiadomości!';
$_lang["configcheck_cache"] = 'katalog bufora nie jest zapisywalny';
$_lang["configcheck_cache_msg"] = 'MODx nie może zapisać do katalogu bufora. MODx będzie wciąż działał poprawnie, ale strony nie będą buforowane. Aby rozwiązać ten problem, nadaj uprawnienia do zapisu dla katalogu /_cache/.';
...
Oznacza to, że Twoja strona błędu jest niedostępna dla użytkowników albo nie istnieje. Może to powodować niestabilność i wiele błędnych wpisów w logach serwisu. Upewnij się, że żadna grupa użytkowników nie jest przypisana do strony.';
...
Oznacza to, że Strona Braku Autoryzacji jest niedostępna dla odwiedzających.  Może to powodować niestabilność i wiele błędnych wpisów w logach serwisu. Upewnij się, że żadna grupa użytkowników nie jest przypisana do strony.';
...
$_lang["confirm_delete_document"] = 'Czy na pewno chcesz usunąć ten dokument?nWszystkie podrzędne dokumenty zostaną również usunięte.';
$_lang["confirm_delete_eventlog"] = 'Czy na pewno chcesz usunąć log zdarzeń?';
$_lang["confirm_delete_file"] = 'Czy na pewno chcesz usunąć ten plik?nn
...
$_lang["confirm_delete_htmlsnippet"] = 'Czy na pewno chcesz usunąć tą wlepkę?';
...
$_lang["confirm_duplicate_document"] = 'Czy na pewno chcesz zduplikować ten dokument/folder?n Podkatalogi i dokumenty również zostaną zduplikowane.';
...
$_lang["confirm_publish"] = 'nnOpublikowanie tego dokumentu spowoduje usunięcie wcześniejszych dat publikacji/zamknięcia publikacji, które mogły być ustawione. Jeśli chcesz zachować te daty wybierz \'edycję\' dokumentu.nnKontynuować?';
...
$_lang["confirm_undelete"] = 'nnWszystkie podrzędne dokumenty skasowane razem z tym dokumentem zostaną również odzyskane, lecz dokumenty podrzędne skasowane wcześniej pozostaną nadal skasowane.';
$_lang["confirm_unpublish"] = 'nnZamknięcie publikacji tego dokumentu spowoduje usunięcie wcześniejszych dat publikacji/zamknięcia publikacji, które mogły być ustawione. Jeśli chcesz zachować te daty wybierz \'edycję\' dokumentu.nnKontynuować?';
$_lang["confirm_unzip_file"] = 'Czy na pewno chcesz rozpakować ten plik? nn Istniejące pliki zostaną nadpisane.';
...
$_lang["delete"] = 'Usuń';
$_lang["delete_document"] = 'Usuń dokument';
...
$_lang["document_alias_help"] = 'Tutaj możesz wybrać alias tego dokumentu. To spowoduje dostępność dokumentu poprzez:

http://yourserver/alias

 Funkcja ta działa tylko, przy użyciu przyjaznych URL.';
$_lang["document_content"] = 'Zawartość dokumentu';
$_lang["document_description"] = 'Opis';
$_lang["document_description_help"] = 'Możesz wprowadzić dodatkowy opis dokumentu.';
$_lang["document_long_title_help"] = 'Tutaj możesz wprowadzić długi tytuł dla dokumentu. Ta opcja może być przydatna dla wyszukiwarek.';
$_lang["document_metatag_help"] = 'Wybierz META tagi lub słowa kluczowe, które chcesz przypisać do tego dokumentu. Użyj klawisza CTRL aby wybrać kilka pozycji.';
$_lang["document_opt_contentdispo"] = 'Przetwarzanie treści';
$_lang["document_opt_contentdispo_help"] = 'Użyj pola przetwarzania treści, aby określić jak ten dokument zostanie obsłużony przez przeglądarkę internetową. Dla plików do pobrania wybierz opcję: załącznik.';
$_lang["document_opt_emptycache"] = 'Opróżnić bufor?';
$_lang["document_opt_emptycache_help"] = 'Zaznaczenie tego pola spowoduje opróżnienie bufora po zapisaniu dokumentu. W ten sposób odwiedzający nie będą widzieli starszej wersji dokumentu.';
$_lang["document_opt_folder"] = 'Folder?';
$_lang["document_opt_folder_help"] = 'Zaznacz tę opcję, aby dokument pełnił również funkcję folderu dla innych dokumentów. Nie musisz się przejmować tą opcją, gdyż MODx z reguły zajmuje się ustawieniami folderów automatycznie.';
$_lang["document_opt_menu_index"] = 'Indeks w menu';
$_lang["document_opt_menu_index_help"] = 'Indeks menu to pole, którego możesz użyć do sortowania dokumentów w snippecie menu. Możesz je również wykorzystać do innych celów w swoich snipetach.';
$_lang["document_opt_menu_title"] = 'Tytuł menu';
$_lang["document_opt_menu_title_help"] = 'Tytuł menu jest polem, które możesz użyć do wyświetlenia krótkiego tytułu dla dokumentu wewnątrz snippetów menu lub modułów.';
$_lang["document_opt_published"] = 'Opublikowany?';
$_lang["document_opt_published_help"] = 'Zaznacz to pole, aby opublikować dokument natychmiast po jego zapisaniu.';
$_lang["document_opt_richtext"] = 'Edytor RTE?';
$_lang["document_opt_richtext_help"] = 'Pozostaw tę opcję zaznaczoną, aby używać edytora RTE do edycji dokumentów. Jeśli dokument zawiera JavaScript i formularze, odznacz tę opcję, aby edytować w trybie HTML, tak by edytor nie zniszczył zawartości Twojego dokumentu.';
$_lang["document_opt_show_menu"] = 'Pokaż w menu';
$_lang["document_opt_show_menu_help"] = 'Wybierz tą opcję, żeby pokazać dokument w menu witryny. Niektóre funkcje budowy menu mogą ignorować tą opcję.';
$_lang["document_opt_trackvisit_help"] = 'Zapisz w logu wizytę każdego użytkownika na stronie';
$_lang["document_overview"] = 'Szczegóły dokumentu';
$_lang["document_parent"] = 'Dokument nadrzędny';
$_lang["document_parent_help"] = 'Kliknij na powyższej ikonie folderu aby włączyć (lub wyłączyć) wybór dokumentu nadrzędnego, a następnie kliknij na dokumencie w drzewie, żeby ustawić go jako nadrzędny dla tego dokumentu.';
$_lang["document_setting"] = 'Ustawienia dokumentu';
$_lang["document_summary"] = 'Wstęp';
$_lang["document_summary_help"] = 'Wpisz krótki wstęp dla dokumentu';
$_lang["document_title"] = 'Tytuł';
$_lang["document_title_help"] = 'Wprowadź nazwę/ tytuł dokumentu. Staraj się unikać lewych ukośników w nazwie!';
$_lang["document_to_be_moved"] = 'Dokument do przeniesienia';
$_lang["document_weblink_help"] = 'Wprowadź adres obiektu, do którego chcesz się odwołać za pomocą tego odsyłacza.';
$_lang["documents_in_container"] = 'dokument(-y/-ów) w tym folderze';
$_lang["documents_in_container_no"] = 'Ten folder nie ma dokumentów podrzędnych.';
...
<p /><ul><li>Wyświetlenia stron, które zostały wyeksportowane nie zostaną zapisane.</li><li>Interaktywne snippety nie będą działać w wyeksportowanych plikach</li><li>Tylko zwykłe dokumenty zostaną wyeksportowane, odnośniki web nie.</li><li>
Proces eksportu może się nie udać jeśli Twoje dokumenty zawierają snippety z nagłówkiem przekierowania.</li><li>
Układ i wygląd strony może się różnić od zakładanego, w zależności od tego jak skonstruowałeś swoje dokumenty, arkusze stylów, obrazki. Aby to naprawić możesz spróbować przenieść wyeksportowane pliki do katalogu głównego (tam gdzie jest umieszczony główny plik MODx-a \'index.php\'.</li></ul><p />
Proszę wypełnić formularz i nacisnąć \'Eksport\' aby rozpocząć proces eksportu. Pliki zostaną zapisane w lokalizacji, którą podałeś używając aliasu dokumentu jako nazwy pliku. Podczas eksportu dobrze jest ustawić opcję konfiguracji MODx-a \'Przyjazne aliasy\' na \'Tak\'. <br>
W zależności od rozmiaru serwisu eksport może trochę potrwać. <br>
<b>Wszystkie istniejące pliki zostaną nadpisane nowymi, jeśli ich nazwy będą identyczne!</b><p />';
...
$_lang["htmlsnippet_msg"] = 'Tutaj możesz dodać/edytować wlepki. Pamiętaj, że wlepki są \'czystym\' kodem HTML, więc skrypty PHP nie zostaną przetworzone.';
$_lang["htmlsnippet_name"] = 'Nazwa wlepki';
$_lang["htmlsnippet_title"] = 'Utwórz/edytuj wlepkę';
$_lang["icon"] = 'Ikona';
$_lang["id"] = 'ID';
$_lang["illegal_parent_child"] = 'Przypisanie nadrzędne:nnDokument jest dzieckiem wybranego dokumentu.';
$_lang["illegal_parent_self"] = 'Przypisanie nadrzędne:nnWybrany dokument nie może być przypisany do samego siebie.';
...
$_lang["import_params_msg"] = 'Możesz zaimportować parametry i ustawienia modułu wybierając nazwę modułu z menu rozwijalnego.<br>
<b>Uwaga:</b> Aby moduł pojawił się na liści ta wtyczka/snippet musi być częścią listy zależności modułu oraz moduł musi mieć włączone udostępnianie parametrów. ';
...
$_lang["import_site_message"] = 'Używając tej funkcji możesz importować całe dokumenty HTML do bazy danych. Zwróć uwagę, że będziesz musiał przekopiować dokumenty HTML do folderu \'assets/import\'.<br>
Wypełnij formularz i kliknij \'Import\' aby rozpocząć importowanie. Importowane pliki będą zapisane w wybranej lokalizacji z użyciem nazwy pliku jako aliasu, tytułu strony i tytułu dokumentu.';
...
$_lang["lock_htmlsnippet"] = 'Zablokuj wlepkę do edycji';
$_lang["lock_htmlsnippet_msg"] = 'Tylko Administrator (ID Roli 1) może edytować tą wlepkę.';
...
$_lang["login_captcha_message"] = ' Administrator włączył walidację kodów Captcha, więc będziesz musiał także wprowadzić kod bezpieczeństwa.

Jeśli masz problem z odczytaniem kodu, kliknij na nim w celu wygenerowania nowego.';
$_lang["login_homepage"] = 'Strona po zalogowaniu';
$_lang["login_homepage_message"] = 'Wprowadź ID dokumentu, który chcesz pokazać użytkownikowi po jego zalogowaniu.
<b>Uwaga! Upewnij się, że ID, które wprowadziłeś jest przypisane do istniejącego dokumentu oraz, że jest opublikowane i dostępne dla danego użytkownika!</b>';
...
$_lang["manage_metatags"] = 'Zarządzaj META tagami i słowami kluczowymi';
...
$_lang["mgrlog_query_msg"] = 'Wprowadź kryteria przeglądania dziennika. Możesz wybrać wpisy wg daty, ale miej na uwadze, że wprowadzone daty nie są zawierane - aby wybrać wszystkie wpisy z 01-01-2004, ustaw "datę od" na 01-01-2004, a "datę do" na 02-01-2004.<br/><br/>
Komunikat i Akcja z reguły są takie same. Jeżeli szukasz konkretnego komunikatu, najlepiej ustaw akcję na "Dowolne/wszystkie".';
$_lang["mgrlog_results"] = 'Ilość wyników';
$_lang["mgrlog_qresults"] = 'Wyniki zapytania';
$_lang["mgrlog_searchlogs"] = 'Szukaj w dzienniku';
$_lang["mgrlog_sortinst"] = 'Możesz posortować tabelę klikając nagłówki kolumn. Jeżeli dziennik staje się zbyt obszerny, możesz go <a href="index.php?a=55">opróżnić</a>. Usunie to wszystkie wpisy aż do chwili obecnej, tej czynności nie można odwrócić!';
...
$_lang["move"] = 'Przenieś';
$_lang["move_document"] = 'Przenieś dokument';
$_lang["move_document_message"] = 'Możesz przenieść dokument wraz z dokumentami podrzędnymi poprzez zaznaczenie nowego dokumentu nadrzędnego w drzewie. Jeśli wybierzesz dokument, który nie jest folderem, zostanie on w niego zmieniony. Proszę kliknąć na nowym dokumencie nadrzędnym w drzewie.';
$_lang["move_document_new_parent"] = 'Proszę wybrać nowy dokument nadrzędny w drzewie dokumentów.';
$_lang["move_document_title"] = 'Przenieś dokument';
$_lang["name"] = 'Nazwa';
...
$_lang["page_data_cacheable_help"] = 'Zaznaczenie tego pola pozwoli na zapisywanie tego dokumentu w buforze. Jeśli dokument zawiera snippety, upewnij się że pole jest odznaczone.';
$_lang["page_data_cached"] = '<b>Źródło pobrane z bufora:</b>';
...
$_lang["page_data_notcached"] = 'Ten dokument nie został (jeszcze) zbuforowany.';
...
$_lang["php_version_check"] = 'MODx jest kompatybilny z PHP wersją 4.0.3 i wyższą. Zaktualizuj swoją instalację PHP!';
...
$_lang["preview_document"] = 'Podgląd dokumentu';
$_lang["preview_msg"] = 'To jest podgląd ostatnio dokonanych zmian. Kliknij tutaj aby <a href=\'javascript://\' onclick="saveRefreshPreview();"><img src=\'media/images/icons/save.gif\' align=\'absmiddle\' height=\'12\'>zapisać i odświeżyć</a> bieżące zmiany';
...
$_lang["rb_base_dir_message"] = 'Wprowadź fizyczną ścieżkę do katalogu zasobów. To ustawienie jest zwykle generowane automatycznie. Może nie działać na serwerze IIS. <br>
<b>Uwaga: </b> katalog zasobów musi zawierać podkatalogi: images, files, flash, media aby przeglądarka zasobów działała poprawnie.';
...
$_lang["refresh_cache"] = 'Bufor: Znaleziono <b>%s</b> plików w katalogu bufora i usunięto <b>%d</b> plików bufora.<p>Nowe pliki bufora zostaną utworzone podczas wysyłania zapytań o strony.';
...
$_lang["resolve_hostnames_message"] = 'Czy chcesz, aby MODx rozwijał nazwy hostów gości twojego serwisu? Rozwijanie nazw hostów może dodatkowo nieznacznie obciążać serwer, co nie powinno być widoczne dla odwiedzających stronę.';
...
$_lang["resource_management"] = 'Zarządzanie zasobami';
$_lang["resource_name"] = 'Nazwa zasobu';
$_lang["resource_selector_msg"] = 'Wybierz zasób lub zasoby z listy poniżej i kliknij przycisk \'Wstaw\'.';
...
$_lang["role_chunk_management"] = 'Zarządzanie wlepkami';
...
$_lang["show_preview"] = 'Pokaż okno podglądu';
...
$_lang["snippets_availabe"] = 'Snippety dostępne do włączenia na stronie';
...
$_lang["sysinfo_activity_message"] = 'Ta lista pokazuje dokumenty, które były ostatnio edytowane przez użytkowników.';
...
$_lang["undelete_document"] = 'Przywróć dokument';
$_lang["unpublish_date"] = 'Data zamknięcia publikacji';
$_lang["unpublish_document"] = 'Zakończ publikację dokumentu';
...
$_lang["use_alias_path_message"] = 'Ustawienie tej opcji na \'tak\' spowoduje wyświetlenie pełnej ścieżki do dokumentu, jeśli dokument będzie posiadał alias. Np. jeśli dokument z aliasem \'dziecko\' jest umieszczony w katalogu o aliasie \'rodzic\' wtedy pełny, wyświetlany alias będzie wyglądał tak: \'/rodzic/dziecko.html\'. <br>
<b>Uwaga: Po ustawieniu tej opcji na \'tak\' musisz linkować rzeczy (obazki, css, skrypty JS itp.) używając adresów bezwzględnych np. \'/pliki/obrazki\' a nie \'pliki/obrazki\'. W ten sposób zapobiegniesz uzupełnianiu przez przeglądarkę lub serwer przed uzupełnianiem adresów względnych.</b>';
...
$_lang["validate_referer_message"] = 'Możesz weryfikować nagłówki HTTP_REFERER aby zmniejszyć ryzyko padnięcia edytorów treści ofiarami ataków typu CSRF (Cross Site Request Forgery). Niektóre konfiguracje mogą nie mieć możliwości korzystania z tej opcji, jeżeli serwer nie wysyła nagłówków HTTP_REFERER.';
$_lang["value"] = 'Wartość';
...
$_lang["weblink_message"] = 'Odsyłacz jest odnośnikiem do obiektu w Internecie. Może być to dokument w obrębie MODx, strona innego serwisu WWW, obrazek lub inny plik w Internecie.<p>';
