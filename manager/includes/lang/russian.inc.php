...
$_lang["about_msg"] = CMS_NAME.' - это <a href="http://'.CMS_DOMAIN.'" target="_blank">PHP Application Framework и Content Management System</a>, распространяемая по лицензии <a href="../assets/docs/license.txt">GNU GPL</a>.';
$_lang["about_title"] = 'О '.CMS_NAME;
...
$_lang["actioncomplete"] = '<b>Действие успешно завершено</b><br />Пожалуйста, подождите, пока '.CMS_NAME.' произведет очистку.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' не в состоянии записывать данные в папку кэширования. Система будет работать нормально, но кэширования происходить не будет. Для решения проблемы разрешите запись в папку <b>/assets/cache<b>.';
...
$_lang["configcheck_installer_msg"] = 'Папка /install содержит инсталляционные файлы системы '.CMS_NAME.'. Злоумышленники могут воспользоваться этими файлами для взлома/повреждения сайта, так что лучше удалить папку с сервера.';
...
$_lang["configcheck_php_gdzip_msg"] = 'Для нормальной работы '.CMS_NAME.' необходимо, чтобы были разрешены GD и Zip расширения для PHP. '.CMS_NAME.' будет работать и без этих расширений, но вы не сможете использовать все возможности встроенного файл-менеджера, редактора изображений или код CAPTCHA для авторизации.'; 
...
$_lang["confirm_name_change"] = 'Изменение имени пользователя может повлиять на работу некоторых дополнений системы '.CMS_NAME.'. \n\nВы уверены, что хотите изменить имя пользователя?';
...
$_lang["credits"] = CMS_NAME.' использует';
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' поддерживается на сайте <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMS.com</a>.</p>';
...
$_lang["export_site_message"] = '<p>Эта функция позволяет экспортировать сайт в HTML файлы целиком. Имейте в виду, что статический HTML-сайт имеет очень ограниченные возможности по сравнению с '.CMS_NAME.'-сайтом:</p><ul><li>не будет записываться статистика посещений;</li><li>интерактивные сниппеты работать не будут;</li><li>веб-ссылки экспортированы не будут;</li> <li>процесс экспорта может не удастся, если ресурсы содержат сниппеты с перенаправлением;</li><li>возможна неправильная работа дизайна шаблона вашего сайта. Во избежание этого экспортированные файлы должны находиться в корневой папке (там же, где и файл index.php системы '.CMS_NAME.').</li></ul><p /><p>Пожалуйста, заполните форму и нажмите \'Начать экспорт\'. Файлы будут записаны в папку /assets/export, используя, где возможно, псевдонимы в качестве имен. При экспорте сайта рекомендуется в конфигурации '.CMS_NAME.' включить функцию \'Использовать псевдонимы в URL\'. Время экспорта зависит от размеров вашего сайта.</p><p><b>Существующие файлы с совпадающими именами будут заменены новыми.</b></p>';
...
$_lang["file_folder_chmod_error"] = 'Не удалось изменить права, необходимо установить нужные права вне '.CMS_NAME.'.';
...
$_lang["functionnotimpl_message"] = 'Эта функция еще не используется данной версией '.CMS_NAME.'.';
$_lang["go"] = 'Перейти';
...
$_lang["modx_news"] = 'Новости '.CMS_NAME;
$_lang["modx_news_tab"] = 'Новости '.CMS_NAME;
$_lang["modx_news_title"] = 'Новости '.CMS_NAME;
$_lang["modx_security_notices"] = 'Уведомления безопасности '.CMS_NAME;
$_lang["modx_version"] = 'Версия '.CMS_NAME;
$_lang["monday"] = 'Понедельник';
$_lang["move"] = 'Переместить';
$_lang["move_resource"] = 'Переместить';
$_lang["move_resource_message"] = 'Вы можете переместить ресурс и все его дочерние ресурсы, выбрав новый \'родительский\' ресурс. Если вы выберете в качестве родительского ресурс, не являющийся папкой, '.CMS_NAME.' автоматически сделает его папкой. Выберите новый \'родительский ресурс\' в дереве сайта слева.';
...
$_lang["password_gen_gen"] = 'Позволить '.CMS_NAME.' сгенерировать пароль.';
...
$_lang["php_version_check"] = 'Система '.CMS_NAME.' работает с PHP версии 4.0.3 или выше. Пожалуйста, обновите PHP';
$_lang["plugin"] = 'Плагин';
...
$_lang["resource_opt_folder_help"] = 'Отметьте, чтобы ресурс выполнял также роль папки (родителя) для других ресурсов. Не стоит особо заострять внимание на этом параметре – '.CMS_NAME.' автоматически установит для ресурса режим папки, если внутри него начнут создаваться ресурсы.';
...
$_lang["resource_type_message"] = 'Веб-ссылка на ресурс в интернете, включая другие ресурсы '.CMS_NAME.', внешние веб-страницы, изображения или другие файлы в интернете. Для ресурса должен быть задан тип содержимого text/html, а в местонахождении содержимого - отображаемое.';
...
$_lang["rss_url_news_message"] = 'Введите адрес (URL) RSS-ленты новостей '.CMS_NAME.'.';
$_lang["rss_url_news_title"] = 'Лента RSS новостей';
$_lang["rss_url_security_default"] = 'http://feeds.feedburner.com/modxsecurity';
$_lang["rss_url_security_message"] = 'Введите адрес (URL) RSS-ленты безопасности '.CMS_NAME.'.';
...
$_lang["welcome_title"] = 'Добро пожаловать в систему управления сайтом '.CMS_NAME;
$_lang["which_editor_message"] = 'Выберите HTML-редактор. вы также можете загрузить и установить редакторы из списка доступных на сайте '.CMS_NAME.'.';
