...
$_lang["access_permission_denied"] = 'У вас недостаточно прав для просмотра данного документа.';
...
$_lang["access_permissions_docs_collision"] = 'Так как группы веб-пользователей и менеджеров конфликтуют с вашей ролью, этот документ будет доступен для всех.';
...
$_lang["access_permissions_group_link"] = 'Создать новую связь группы пользователей и группы документов';
...
$_lang["account_email"] = 'Электронная почта учетной записи';
...
$_lang["document_metatag_help"] = 'Выберите META-теги или ключевые слова, которые вы хотите присвоить этому документу. Для выбора нескольких ключевых слов или МЕТА-тегов нажимайте на них мышью, удерживая Ctrl.';
$_lang["document_opt_contentdispo"] = 'Местонахождение содержимого';
$_lang["document_opt_contentdispo_help"] = 'Этот параметр определяет, как браузер должен обработать документ. Для того, чтобы документ стал доступным для скачивания, а не отображался в окне браузера, выберите "Прикрепленное".';
...
$_lang["document_opt_folder_help"] = 'Отметьте, чтобы документ выполнял также роль папки (родителя) для других документов. Не стоит особо заострять внимание на этом параметре – MODx автоматически установит для документа режим папки, если внутри него начнут создаваться документы.';
...
$_lang["document_opt_show_menu_help"] = 'Включите этот параметр для отображения документа в каком-либо меню сайта. Имейте в виду, некоторые сниппеты могут игнорировать этот параметр.';
...
$_lang["documents_in_container"] = 'документ(ов) в этом контейнере';
...
$_lang["files_upload_copyfailed"] = 'Не удалось скопировать файл в нужную папку - файл не закачан';
...
$_lang["files_upload_permissions_error"] = 'Возможно ошибка прав доступа - каталог, в который вы хотите загрузить данные, не доступен для записи на вашем сервере.';
...
$_lang["import_site_failed_db_error"] = 'Во время копирования документа произошла ошибка в базе данных: ';
...
$_lang["login_homepage_message"] = 'Введите ID документа, который загрузится после успешной авторизации пользователя. <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему документу, что этот документ опубликован и что он доступен для данного пользователя';
...
$_lang["metatag_intro"] = 'На этой странице вы можете создавать/редактировать/удалять META-теги. Чтобы привязать META-теги к документам, нажмите на вкладку <u>META Ключевые слова</u>, когда редактируете документ, и выберите нужные ключевые слова и META-теги. Для создания нового тега введите его имя и значение и нажмите "Создать тег". Для редактирования нажмите на название тега.';
...
$_lang["mgr_login_start_message"] = 'Введите ID документа, который вы хотите послать пользователю после авторизации в системе управления сайтом. <b>ПРИМЕЧАНИЕ:</b> убедитесь в том, что ID принадлежит существующему документу, который опубликован и доступен этому пользователю';
...
$_lang["mgrlog_query_msg"] = 'Пожалуйста, задайте критерии просмотра записей. ВНИМАНИЕ указанный диапазон дат не включает результаты за дату, указанную в поле "Заканчивая датой". Например, чтобы сделать выборку за 03-12-2009, укажите в поле "Начиная с даты" значение 03-12-2009, а в поле "Заканчивая датой" - значение 03-12-2009.<br /><br />Сообщение и действие обычно одинаковы. Если вы хотите найти какое-то конкретное сообщение, обычно лучше всего установить действие "Любое / Все".';
$_lang["mgrlog_results"] = 'Отображать результаты порциями по:';
$_lang["mgrlog_searchlogs"] = 'Найти лог-записи';
$_lang["mgrlog_sortinst"] = 'Вы можете отсортировать таблицу, выбрав мышью заголовок любой колонки. Если записей станет слишком много, вы можете <a href="index.php?a=55">очистить лог</a>. <i>ВНИМАНИЕ: это приведёт к удалению всех записей по сегодняшний момент!</i>';
$_lang["mgrlog_time"] = 'Время';
$_lang["mgrlog_user"] = 'Пользователь';
$_lang["mgrlog_username"] = 'Имя пользователя';
$_lang["mgrlog_value"] = 'Значение';
$_lang["mgrlog_view"] = 'Просмотр записей системы управления сайтом';
...
$_lang["page_data_publishdate_help"] = 'Если вы установите дату публикации, документ будет опубликован по наступлению этой даты. Нажмите на значок календаря, чтобы выбрать дату, либо на значок рядом, чтобы удалить дату публикации. Это будет означать, что документ не будет публиковаться автоматически.';
...
$_lang["preview_document"] = 'Просмотр';
...
$_lang["resource"] = 'Элемент';
$_lang["resource_categories"] = 'Общий просмотр';
$_lang["resource_management"] = 'Управление Элементами';
$_lang["resource_name"] = 'Название Элемента';
$_lang["resource_selector_msg"] = 'Выберите Элемент(ы) из списка внизу и нажмите кнопку "Вставить".';
$_lang["resource_selector_title"] = 'Выбор Элемента';
$_lang["resources"] = 'Элементы';
$_lang["role"] = 'Роль';
...
$_lang["sitestart_message"] = 'Введите ID документа, который вы хотите использовать как стартовую (домашнюю) страницу. <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему документу, и что этот документ опубликован';
...
$_lang["siteunavailable_page_message"] = 'Введите ID документа, который должны будут увидеть посетители, если попытаются зайти на сайт, когда он недоступен. <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему документу, и что этот документ опубликован';
...
$_lang["tree_show_protected_message"] = 'Если включено \'Нет\', то защищенные документы (включая их дочерние документы) не будут отображаться в дереве документов.';
...
$_lang["unauthorizedpage_message"] = 'Введите ID документа, который должны будут увидеть посетители, если попытаются зайти на закрытую страницу (403 – доступ запрещен). <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему документу, и что этот документ опубликован';
...
$_lang["uploadable_flash_message"] = 'Здесь вы можете ввести список файлов, которые могут быть загружены в "assets/flash/" с помощью Менеджера файлов. Введите расширения разрешенных типов флэш-файлов, разделяя их запятыми.';
$_lang["uploadable_flash_title"] = 'Разрешенные к загрузке flash-файлы:';
$_lang["uploadable_images_message"] = 'Здесь вы можете ввести список файлов, которые могут быть загружены в "assets/images/" с помощью Менеджера файлов. Введите расширения разрешенных типов графических файлов, разделяя их запятыми.';
$_lang["uploadable_images_title"] = 'Разрешенные к загрузке изображения:';
$_lang["uploadable_media_message"] = 'Здесь вы можете ввести список файлов, которые могут быть загружены в "assets/media/" с помощью Менеджера файлов. Введите расширения разрешенных типов медиа-файлов, разделяя их запятыми.';
$_lang["uploadable_media_title"] = 'Разрешенные к загрузке медиа-файлы:';
$_lang["use_alias_path_message"] = 'Включив эту функцию, вы получите вложенную структуру URL. Например, если дочерний документ называется \'дочерний\', а родительский документ называется \'родительский\', мы получим URL такого типа: http://мойсайт.ру/родительский/дочерний.<br /><b>Внимание:</b> если эта функция включена, убедитесь, что все пути к изображениям, css, java-скриптам имеют путь типа \'/assets/images/...\', а не \'assets/images/...\', либо вы всегда можете использовать приставку [(site_url)] для правильного понимания сервером пути, например, \'[(site_url)]assets/images/...\'. Также можно использовать HTML-тег &lt;BASE href=\'[(site_url)]\'&gt; в HEAD-секции <i>каждой</i> страницы сайта, тогда все относительные пути будут работать правильно.';
$_lang["use_alias_path_title"] = 'Использовать вложенные URL:';
$_lang["use_editor_message"] = 'Хотите использовать HTML-редактор? Если вы привыкли писать HTML-теги вручную, отключите данную функцию. Имейте в виду, что эта настройка применяется ко всем документам для всех менеджеров';
