...
$_lang["about_msg"] = 'MODx je <a href="http://modxcms.com/what-is-modx.html" target="_blank">PHP Application Framework and Content Management System</a> licencovaný pod <a href="http://www.gnu.cz/article/32/">GNU GPL</a>.';
...
$_lang["access_permissions_add_document_group"] = 'Vytvořit skupinu dokumentů';
...
$_lang["access_permissions_documents_in_group"] = '<b>Dokumenty ve skupině:</b> ';
...
$_lang["add_document"] = 'Nový dokument';
...
$_lang["configcheck_configinc_msg"] = 'Velmi neslušní lidé mohou potenciálně způsobit pěkný nepořádek na vašich stránkách a čemkoli spojeném s nimi. <strong>Opravdu.</strong> Prosím nastavte váš konfigurační soubor (/manager/includes/config.inc.php) jen pro čtení!';
...
$_lang["create_document_here"] = 'Zde vytvořit dokument';
...
$_lang["credits_shouts_msg"] = '<p>MODx je spravován a udržován na <a href="http://modxcms.com/about/" target="_blank">MODxCMS.com</a>.</p>';
...
$_lang["delete"] = 'Smazat';
$_lang["delete_document"] = 'Smazat dokument';
...
$_lang["document_alias"] = 'Zástupce dokumentu';
...
$_lang["document_content"] = 'Obsah';
$_lang["document_description"] = 'Popis';
$_lang["document_description_help"] = 'Sem můžete zadat podrobný popis dokumentu.';
$_lang["document_long_title_help"] = 'Zde můžete vložit dlouhý název vašeho dokumentu. Je to vhodné kvůli vyhledávání a mohl by víc charakterizovat váš dokument.';
$_lang["document_metatag_help"] = 'Vyberte META tagy nebo klíčová slova, která si přejete přiřadit k tomuto dokumentu. Při výběru více klíčových slov nebo META tagů držte zmáčknutou klávesu CTRL.';
$_lang["document_opt_contentdispo"] = 'Obsah uspořádání';
$_lang["document_opt_contentdispo_help"] = 'Použít pole \'obsah uspořádání\' k bližšímu určení, jak tento dokument bude ovládán webovým prohlížečem. Pro stažení souboru vyberte volbu Příloha.';
$_lang["document_opt_emptycache"] = 'Vyprázdnit zásobník?';
$_lang["document_opt_emptycache_help"] = 'Vyberte tuto položku, jestliže chcete, aby MODx vyprázdnil zásobník po uložení dokumentu. Vaši návštěvníci tak neuvidí starší verze tohoto dokumentu.';
$_lang["document_opt_folder"] = 'Složka?';
$_lang["document_opt_folder_help"] = 'Určete, zda se tento vytvořený dokument bude chovat jako složka dokumentů nebo jako dokument. \'Složka\' může také mít obsah.';
$_lang["document_opt_menu_index"] = 'Index&nbsp;(řazení)';
$_lang["document_opt_menu_index_help"] = 'Řazení je funkce, kterou můžete použít pro řazení dokumentů ve Vašem snippetu, vytvářejícím menu. Můžete ho použít i pro další účely, jestliže je bude Váš snippet podporovat.';
$_lang["document_opt_menu_title"] = 'Nadpis menu';
$_lang["document_opt_menu_title_help"] = 'Nadpis menu je pole, které mužete použít ke znázornění krátkého nadpisu pro dokumet umístěný ve vašem snipettu menu nebo modulech.';
$_lang["document_opt_published"] = 'Publikovat?';
$_lang["document_opt_published_help"] = 'Zatržením této volby bude dokument publikovaný hned po uložení.';
$_lang["document_opt_richtext"] = 'Externí editor?';
$_lang["document_opt_richtext_help"] = 'Nechte tuto volbu zatrženou pro použití externího editoru k úpravě dokumentů. Jestliže vaše dokumenty obsahují Javaskripty anebo formuláře, zrušte označení a můžete upravovat dokument v HTML módu.';
$_lang["document_opt_show_menu"] = 'Zobrazit v menu';
$_lang["document_opt_show_menu_help"] = 'Výběr této volby zobrazuje dokument v menu. Prosím poznamenejte si, že některé snippety typu Menu Builders mohou mít nastavení, která ignoruje tuto volbu.';
$_lang["document_opt_trackvisit_help"] = 'Zapisuj přístup každého návštěvníka na tuto stránku';
$_lang["document_overview"] = 'Přehled dokumentu';
$_lang["document_parent"] = 'Umístění dokumentu';
$_lang["document_parent_help"] = 'Klikněte v adresářovém stromě na ikonku složky pro jeho otevření (zavření), a potom na dokument v stromu, který chcete nastavit jako umístění dokumentu.';
$_lang["document_permissions_error"] = 'Přiřaďte tento dokument alespoň do jedné skupiny dokumentů, kterou můžete používat.';
$_lang["document_setting"] = 'Nastavení dokumentu';
$_lang["document_summary"] = 'Souhrn (introtext)';
$_lang["document_summary_help"] = 'Model stručného souhrnu dokumentu';
$_lang["document_title"] = 'Nadpis';
$_lang["document_title_help"] = 'Sem napíšte název anebo titulek dokumentu. Pokuste se vyvarovat použití zpětných lomítek v názvu!';
$_lang["document_to_be_moved"] = 'Dokument bude přesunut';
$_lang["document_weblink_help"] = 'Vložte adresu objektu, na který chcete odkazovat.';
$_lang["documents_in_container"] = 'dokumenty v této složce';
$_lang["documents_in_container_no"] = 'Tato složka nemá potomky';
...
$_lang["duplicate_document"] = 'Duplikovat dokument';
...
$_lang["edit"] = 'Upravit';
$_lang["edit_document"] = 'Upravit dokument';
$_lang["edit_document_title"] = 'Upravit dokument';
...
$_lang["export_site_failed_no_write"] = 'Nelze zapsat soubor.';
$_lang["export_site_html"] = 'Export do HTML';
$_lang["export_site_maxtime"] = 'Max. čas exportu:';
$_lang["export_site_maxtime_message"] = 'Zde můžete zadat počet sekund, po jakou dobu MODx může exportovat stránky (prvořadé PHP nastavení). Hodnota 0 je určená pro neomezený čas. Pamatujte prosím, že nastavení 0 je velmi vysoké, a proto může způsobovat problémy, proto se nedoporučuje.';
$_lang["export_site_message"] = 'Použitím této funkce můžete exportovat všechny stránky vašeho webu do souborů HTML. Pamatujte prosím, že při exportu přídete o mnoho funkcí zabudovaných do MODx. Mimo jiné o tyto:<p /><ul><li>Načtené stránky na export nebudou ukládané.</li><li>Interaktivní snippety nebudou pracovat v exportovaných souborech.</li><li>Exportované soubory budou jen standardní dokumenty, webové odkazy exportované nebudou.</li><li>Export může selhat, když vaše dokumenty obsahují snippety, odesílající přesměrovávací příkazy v hlavičce dokumentu.</li><li>Je důležité, jak jsou napsané a uložené vaše dokumenty, styly a obrázky, protože vzhled vašich stránek může být narušený přepsáním originálního souboru exportovaným. Abyste tomu zabránili můžete uložit nebo přemístit vaše exportované soubory tam, kde je umístěný MODx index.php.</li></ul><p />Vyplňte prosím formulář a klikněte na tlačítko "Spustit export". Vytvořené soubory budou uložené na vámi určené místo. Když to bude možné, aliasy (prezívky) nebo zjednodušené názvy dokumentu budou použité jako názvy souborů. Během exportu vašich stránek je optimální mít v konfiguraci MODx nastavenou položku \'Zjednodušené aliasy\' na \'Ano\'. V závislosti na velikosti vašich stránek bude export nějakou dobu trvat.<p /><b>Existující soubory budou přepsané exportovanými soubory v případě, že budou jejich názvy stejné!</b></p>';
$_lang["export_site_numberdocs"] = '<p><b>%s nalezených dokumentů k exportu...</b></p>';
$_lang["export_site_prefix"] = 'Předpona souboru:';
$_lang["export_site_start"] = 'Spustit export';
$_lang["export_site_success"] = 'Proběhlo úspěšně!';
$_lang["export_site_success_skip_dir"] = 'Přeskočit tuto složku.';
$_lang["export_site_success_skip_doc"] = 'Přeskočit tento dokument.';
$_lang["export_site_suffix"] = 'Přípona souboru:';
$_lang["export_site_target_unwritable"] = 'Do cílového adresáře není možné zapisovat. Prosím nastavte možnost zápisu (oprávnění 0777) a zkuste to znovu.';
$_lang["export_site_time"] = 'Export hotov. Trval celkem %s sekund.';
...
$_lang["import_files_found"] = '<b>Nalezeno %s dokument(y/ů) k importu...</b><p/>';
...
$_lang["import_parent_document"] = 'Nadřízený dokument:';
$_lang["import_site"] = 'Importovat HTML';
$_lang["import_site_failed"] = 'Selhání!';
$_lang["import_site_failed_db_error"] = 'V databázi došlo k chybě při pokusu vytvořit kopii dokumentu: ';
$_lang["import_site_failed_no_open_dir"] = 'Nelze otevřít adresář: ';
$_lang["import_site_failed_no_retrieve_file"] = 'Nepodařilo se načíst soubor: ';
$_lang["import_site_html"] = 'Import webu z HTML';
$_lang["import_site_importing_document"] = 'Importování souboru <b>%s</b> ';
$_lang["import_site_maxtime"] = 'Maximální doba importu:';
$_lang["import_site_maxtime_message"] = 'Tady můžete určit počet sekund, po které bude moci Správce obsahu importovat stránky (přepsání PHP nastavení). Vložte 0 pro neomezený čas. Pamatujte prosím, že nastavení 0 je velmi vysoké, a proto může způsobovat problémy, proto se nedoporučuje.';
$_lang["import_site_message"] = 'Použitím této funkce můžete vložit celý HTML web do databáze. Prosím všimněte si, že potřebujete nakopírovat vaše html soubory a/nebo složky do složky assets/import.<br />Prosím vyplňte formulář a stiskněte "Spustit import" k zahájení importu. Importované soubory budou uloženy do vybrané pozice, používí, když to bude možné, jména souborů jako aliasy dokumentů, název stránky jako nadpis stránky.';
$_lang["import_site_skip"] = 'Přeskočeno!';
$_lang["import_site_start"] = 'Spustit import';
$_lang["import_site_success"] = 'Proběhlo úspěšně!';
$_lang["import_site_time"] = 'Import dokončen. Import zabral %s sekund(y).';
...
$_lang["messages_forward"] = 'Předat dál';
$_lang["messages_from"] = 'Od';
$_lang["messages_group"] = 'Skupina';
$_lang["messages_inbox"] = 'Příchozí pošta';
$_lang["messages_message"] = 'Zpráva';
$_lang["messages_no_messages"] = 'Žádne zprávy v Příchozí poště.';
$_lang["messages_not_allowed_to_read"] = 'Nemáte povolení číst tuto zprávu!';
$_lang["messages_private"] = 'Soukromá';
$_lang["messages_read_message"] = 'Číst zprávu';
$_lang["messages_reply"] = 'Odpověď';
$_lang["messages_select_group"] = 'Vybrat skupinu';
$_lang["messages_select_user"] = 'Vybrat uživatele';
$_lang["messages_send"] = 'Poslat';
$_lang["messages_send_to"] = 'Adresát';
$_lang["messages_sent"] = 'Odeslané';
$_lang["messages_subject"] = 'Předmět';
$_lang["messages_system_user"] = '[System]';
$_lang["messages_title"] = 'Zprávy';
$_lang["messages_user"] = 'Uživatel';
...
$_lang["move_document"] = 'Přesunout dokument';
$_lang["move_document_message"] = 'Můžete přesunout dokument a všechny jeho potomky do nového umístění v adresářovém stromu. Jestliže vyberete dokument, který není složkou, bude změněn na složku. Klikněte na nové umístění v adresářovém stromu.';
$_lang["move_document_new_parent"] = 'Vyberte nové umístění v adresářovém stromu';
$_lang["move_document_title"] = 'Přesunout dokument';
$_lang["name"] = 'Název';
...
$_lang["password_msg"] = 'Nové heslo pro <b>%s</b> je <b>%s</b>.';
$_lang["php_version_check"] = 'MODx je kompatibilní jen s verzí PHP 4.0.3 a vyšší. Aktualizujte prosím svou PHP instalaci!';
$_lang["plugin"] = 'Plugin';
...
$_lang["preview_document"] = 'Náhled dokumentu';
...
$_lang["resource_categories"] = 'Všechny zdroje a moduly';
$_lang["resource_management"] = 'Správa zdrojů';
$_lang["resource_name"] = 'Název zdroje';
$_lang["resource_selector_msg"] = 'Vyberte zdroj(e) z níže uvedeného seznamu a klikněte na tlačítko \'Vložit\'.';
$_lang["resource_selector_title"] = 'Volič zdrojů';
...
$_lang["undelete_document"] = 'Obnovit dokument';
$_lang["unpublish_date"] = 'Datum ukončení publikování';
$_lang["unpublish_document"] = 'Ukončit publikaci';
$_lang["unpublish_events"] = 'Události - ukončení publikování';
$_lang["untitled_document"] = 'Dokument bez názvu';
...
$_lang["user_edit_self_msg"] = 'Pravděpodobně se budete muset odhlásit a přihlásit znovu kvůli kompletní aktualizaci vaších informací.</b><br />Také byste si měli nechat vygenerovat nové heslo a nechat si ho poslat e-mailem.';
