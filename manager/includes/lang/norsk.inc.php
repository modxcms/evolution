...
$_lang["configcheck_configinc_msg"] = 'En angriper kan potensielt ødelegge siden din og alt som er relatert til den. Vennligst fjern skriverettigheter til  konfigurasjonsfilen din (/manager/includes/config.inc.php) for å være sikker!';
...
$_lang["credits_webfx"] = 'MODx bruker flere javascript fra Webfx. Bra greier!';
...
$_lang["document_alias_help"] = 'Her kan du angi et alias for dokumentet. Dette gjør dokumentet mulig å nå via: http://dinserver/alias Dette bare om du har tatt i bruk vanlige adresser';
...
$_lang["document_metatag_help"] = 'Velg META-tagger og nøkkelord du vil knytte til dette dokumentet. Hold ned Ctrl for å velge flere nøkkelord eller META-tagger.';
...
$_lang["document_opt_folder_help"] = 'Marker her om dokumentet skal oppføre seg som mappe for andre dokumenter. Du trenger ikke å bry deg så mye om dette, siden MODx vanligvis tar hånd om mappeinnstillinger automatisk.';
$_lang["document_opt_menu_index"] = 'Menyindeks';
$_lang["document_opt_menu_index_help"] = 'Menyindeks er et felt du kan bruke for å sortere dokumenter i din kodesnutt som bygger menyen. Du kan også bruke det for andre formål i dine kodesnutter.';
$_lang["document_opt_menu_title"] = 'Menytittel';
$_lang["document_opt_menu_title_help"] = 'Menytittel er et felt du kan bruke for å vise en kort tittel for dokumentet i dine menykodesnutter eller moduler.';
...
$_lang["document_opt_richtext_help"] = 'La denne være avkrysset for å bruke en riktekst-editor til dokumentredigering. Om dine dokumenter inneholder javascript eller formler, ta vekk denne for å redigere i HTML-modus så editoren ikke roter til dine dokumenter.';
$_lang["document_opt_show_menu"] = 'Vis i meny';
$_lang["document_opt_show_menu_help"] = 'Velg denne innstillingen for å vise dokumentet i en webmeny. Noter at enkelte menybyggerprogram kan velge å ikke bry seg om denne innstillingen.';
$_lang["document_opt_trackvisit_help"] = 'Logg alle besøk på dette dokumentet.';
$_lang["document_parent"] = 'Dokumenteier';
$_lang["document_parent_help"] = 'Klikk på det ovenstående mappeikonet for å sette (eller fjerne) eiervalg. Klikk deretter på et dokument i dokumenttreet for å sette det som eier til dette dokumententet.';
$_lang["document_setting"] = 'Dokumentinnstillinger';
$_lang["document_summary"] = 'Sammendrag';
$_lang["document_summary_help"] = 'Skriv et kort sammendrag av dokumentet';
$_lang["document_title"] = 'Tittel';
$_lang["document_title_help"] = 'Skriv navnet/tittelen på dokumentet her. Unngå skråstrek i navnet!';
$_lang["document_to_be_moved"] = 'Dokumentet som skal flyttes';
$_lang["document_weblink_help"] = 'Angi adressen til objektet du vil referere til med denne weblinken.';
...
$_lang["export_site_maxtime_message"] = 'Her kan du spesifisere antall sekunder MODx har på seg til å eksportere webplassen (overstyrer PHPs innstillinger). Skriv 0 for ubegrenset tid. Obs: hvis 0 eller et veldig høyt nummer skrives, kan det få din server til å gjøre rare ting og anbefales derfor ikke.';
$_lang["export_site_message"] = 'Med denne funksjonen kan du ekportere hele webplassen til HTML-filer. Husk at du mister store deker av funksjonaliteten i MODx hvis du gjør dette:<p /><ul><li> Sidelesinger på eksporterte filer kommer ikke til å lagres.</li><li> Interaktive kodesnutter kommer ikke til å fungere i eksporterte filer.</li><li> Bare vanlige filer kommer til å bli eksportert. Weblinker kommer heller ikke til å bli eksporterte.</li><li> Eksportprosessen kan mislykkes om dine dokumenter inneholder kodesnutter som sender omdirigeringsanvisninger.</li><li> Avhengig av hvordan du har skrevet dokumentene dine, kan bilder og stilmaler få feil søkestier. For å fikse dette, kan du lagre eller flytte dine eksporterte filer til samme katalog som index.php for MODx befinner seg.</li></ul><p />Fyll inn i skjemaet og trykk på \'Start eksportering\' for å starte eksporteringsprosessen. Filene som lages kommer til å lagres der du har spesifisert, og når det er mulig, brukes dokumentets alias som filnavn. Når du skal eksportere din webplass er det best å ha MODx konfigurasjonsinnstilling \'Vanlige alias\' satt til \'Ja\'. Avhengig av webplassen på din site, kan eksporteringen ta en del tid.<p /><b> Allerede eksisterende filer kommer til å bli overskrevet hvis de har samme navn som en eksportert fil!</b><p />';
$_lang["export_site_numberdocs"] = '<b>Antall %s dokumenter å exportere...</b><p />';
$_lang["export_site_prefix"] = 'Filprefiks';
...
$_lang["move_document_message"] = 'Du kan flytte et dokument og alle underdokumenter ved å velge en ny eier i treet. Om du velger et dokument som ikke er en mappe, kommer det til å endres til en mappe. Klikk på den nye eieren i treet.';
...
$_lang["plugin_locked_message"] = 'Dette pluginen er låst.';
...
$_lang["resolve_hostnames_message"] = 'Vil du at MODx skal prøve å gjøre navne (host) oppslag på dine besøkendes fullverdige adresse når de besøker din webplass? Navneoppslag kan skape ektra belastning for serveren, men dine besøkende kommer ikke til å merke det på noen måte.';
$_lang["resolve_hostnames_title"] = 'Gjør navneoppslag (host navn)';
$_lang["resource"] = 'Ressurs';
$_lang["resource_categories"] = 'Kombinert overblikk';
...
$_lang["snippets_available"] = 'Kodesnutter som er tilgjengelige for deg å inkludere i dokumentet';
...
$_lang["user_edit_self_msg"] = 'Etter du har lagret kan det hende du må logge ut og inn  igjen for at dine instillinger skal oppdateres fullstendig</b><br />Om du velger å generere et nytt passord til deg selv, kommer det til å sendes til din epostadresse.';
...
$_lang["weblink_message"] = 'En weblink er en referanse til et objekt på Internett. Dette kan være ett dokument i MODx, en side på en annen webserver, et bilde, eller en annen type fil på Internett.';
