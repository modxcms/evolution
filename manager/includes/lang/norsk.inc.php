...
$_lang["configcheck_configinc_msg"] = 'Very naughty people could potentially wreak some havoc on your site and everything associated with it. <strong>Really.</strong> Please make your config file  (/assets/config.inc.php) read only!';
...
$_lang["weblink_message"] = 'En weblink er en referens til et objekt på Internett. Dette kan være ett dokument i MODx, en side på en annen webserver, et bilde, eller en annen type fil på Internett.';
