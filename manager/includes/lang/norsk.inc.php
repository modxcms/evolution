...
$_lang["actioncomplete"] = '<b>Hendelsen er utført!</b><br /> - Vent mens '.CMS_NAME.' rydder opp.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' kan ikke skrive til cache-mappen. '.CMS_NAME.' kommer fortsatt til å virke som ventet, men ingen dokumenter vil caches. For å fikse dette, gjør /_cache/-mappen skrivbar.';
...
$_lang["configcheck_installer_msg"] = 'Mappen install/ inneholdeir installasjonsprogrammet for '.CMS_NAME.'. Tenk hva som kan skjer om en angriper finner denne mappen og kjører installasjonen på nytt! Han kommer forhåpentligvis ikke så langt, ettersom databasen krever innlogging, men det er likevel best å fjerne katalogen fra serveren.';
...
$_lang["credits_dTree"] = CMS_NAME.' bruker det utmerkede dTree-scriptet fra DestroyDrop.com!';
$_lang["credits_everaldo"] = CMS_NAME.' bruker et antall ikoner fra Everaldos Crystal-samling. Toppikoner!';
$_lang["credits_mysql"] = CMS_NAME.' bruker MySQL!';
$_lang["credits_php"] = CMS_NAME.' bruker PHP!';
...
$_lang["credits_webfx"] = CMS_NAME.' bruker flere javascript fra Webfx. Bra greier!';
...
$_lang["document_opt_emptycache_help"] = 'Lar du dette feltet være markert, kommer '.CMS_NAME.' til å tømme cachen når du lagrer dokumentet. Det gjør at dine besøkende ikke kommer til å se en gammel versjon av dokumentet.';
$_lang["document_opt_folder"] = 'Mappe';
$_lang["document_opt_folder_help"] = 'Marker her om dokumentet skal oppføre seg som mappe for andre dokumenter. Du trenger ikke å bry deg så mye om dette, siden '.CMS_NAME.' vanligvis tar hånd om mappeinnstillinger automatisk.';
...
$_lang["export_site_maxtime_message"] = 'Her kan du spesifisere antall sekunder '.CMS_NAME.' har på seg til å eksportere webplassen (overstyrer PHPs innstillinger). Skriv 0 for ubegrenset tid. Obs: hvis 0 eller et veldig høyt nummer skrives, kan det få din server til å gjøre rare ting og anbefales derfor ikke.';
$_lang["export_site_message"] = 'Med denne funksjonen kan du ekportere hele webplassen til HTML-filer. Husk at du mister store deker av funksjonaliteten i '.CMS_NAME.' hvis du gjør dette:<p /><ul><li> Sidelesinger på eksporterte filer kommer ikke til å lagres.</li><li> Interaktive kodesnutter kommer ikke til å fungere i eksporterte filer.</li><li> Bare vanlige filer kommer til å bli eksportert. Weblinker kommer heller ikke til å bli eksporterte.</li><li> Eksportprosessen kan mislykkes om dine dokumenter inneholder kodesnutter som sender omdirigeringsanvisninger.</li><li> Avhengig av hvordan du har skrevet dokumentene dine, kan bilder og stilmaler få feil søkestier. For å fikse dette, kan du lagre eller flytte dine eksporterte filer til samme katalog som index.php for '.CMS_NAME.' befinner seg.</li></ul><p />Fyll inn i skjemaet og trykk på \'Start eksportering\' for å starte eksporteringsprosessen. Filene som lages kommer til å lagres der du har spesifisert, og når det er mulig, brukes dokumentets alias som filnavn. Når du skal eksportere din webplass er det best å ha '.CMS_NAME.' konfigurasjonsinnstilling \'Vanlige alias\' satt til \'Ja\'. Avhengig av webplassen på din site, kan eksporteringen ta en del tid.<p /><b> Allerede eksisterende filer kommer til å bli overskrevet hvis de har samme navn som en eksportert fil!</b><p />';
...
$_lang["filemanager_path_message"] = 'IIS fyller oftest ikke inn innstillingen document_root ordentlig. Denne brukes av filhåndtereren for å bestemme hva du får se. Hvis du har problemer med filhåndtereren, pass på at denne innstillingen peker til roten av din innstallasjon av '.CMS_NAME.'.';
...
$_lang["friday"] = 'Fredag';
$_lang["friendly_alias_message"] = 'Hvis du bruker vanlige adresser og dokumentet har et alias, kommer aliaset alltid å prioriteres i den vanlige adressen. Ved å sette denne alternativet til \'Ja\', kommer den vanliga adressens prefiks og suffiks å legges til aliaset.<br /> Eksempel: om ditt dokument med ID 1 har aliaset \'introduksjon\', prefikset er satt til \'\', suffikset til \'.html\' og du setter denne innstillingen til \'Ja\', så kommer \'introduksjon.html\' å vises. Hvis det ikke finnes noe alias, kommer '.CMS_NAME.' å generere lenken \'1.html\'.';
$_lang["friendly_alias_title"] = 'Bruk vanlige adresser';
$_lang["friendlyurls_message"] = 'Dette lar deg bruke adresser som er vennlige mot søkemotorer. Merk at detta kun virker når '.CMS_NAME.' kjøres på Apache, og du må lage en .htaccess-fil for at det skal fungere. Se .htaccess-filen som fulgte med i distribusjonen for mer informasjon.';
...
$_lang["language_message"] = 'Velg hvilket språk du vil bruke i '.CMS_NAME.' publiseringshåndterer.';
...
$_lang["loading_page"] = 'Vent mens '.CMS_NAME.' laster siden...';
...
$_lang["logo_slogan"] = 'Lag og gjør mer med mindre - '.CMS_NAME.' innholdshåndterer';
...
$_lang["password_gen_gen"] = 'Lat '.CMS_NAME.' generere et passord';
...
$_lang["php_version_check"] = CMS_NAME.' er kompatibelt med PHP version 4.0.3 eller høyere. Du må oppgradere din versjon av PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["settings_strip_image_paths_message"] = 'Settes dette på, kommer '.CMS_NAME.' til å skrive om bilders søkestier så de bli relative istede for absolutte. Dette er veldig hendig hvis du får behov for å flytte din '.CMS_NAME.'-installasjon (for eksempel fra en testserver til et produksjonsmiljø). Hvis du ikke har noen anelse om hva dette betyr, la det bare stå igjen som \'Nei\'.';
...
$_lang["welcome_title"] = 'Velkommen till '.CMS_NAME.' webpubliseringsverktøy';
$_lang["which_editor_message"] = 'Her kan du velge hvilken riktekst-editor du vil bruke. Du kan laste ned og installere flere riktekst-editorer fra '.CMS_NAME.' sin nedlastingsside.';
