...
$_lang["about_msg"] = 'EVO - это <a href="http://rtfm.modx.com/evolution/1.0/getting-started/what-is-modx" target="_blank">PHP Application Framework и Content Management System</a>, распространяемая по лицензии <a href="../assets/docs/license.txt">GNU GPL</a>.';
$_lang["about_title"] = 'О EVO';
...
$_lang["actioncomplete"] = '<b>Действие успешно завершено</b><br />Пожалуйста, подождите, пока EVO произведет очистку.';
...
$_lang["category_management"] = 'Управления категориями';
$_lang["manage_categories"] = 'Управления категориями';
...
$_lang["charset_message"] = 'Выберите кодировку страниц сайта. Помните, что EVO тестировался не на всех кодировках. Для большинства языков подходит кодировка UTF-8.';
...
$_lang["configcheck_cache_msg"] = 'EVO не в состоянии записывать данные в папку кэширования. Система будет работать нормально, но кэширования происходить не будет. Для решения проблемы разрешите запись в папку <b>/assets/cache<b>.';
$_lang["configcheck_configinc"] = 'Файл конфигурации все еще доступен для записи';
$_lang["configcheck_configinc_msg"] = 'Злоумышленники потенциально могут нанести вред вашему сайту. <strong>Серьёзно.</strong> Пожалуйста, установите права доступа к файлу конфигурации (/[+MGR_DIR+]/includes/config.inc.php) в режим \'Только для чтения\'';
...
$_lang["configcheck_filemanager_path_msg"] = 'Это может произойти, например, после перемещения вашего сайта в другой каталог или на другой сервер. Пожалуйста, проверьте и обновите настройки вашей системы EvolutionCMS';
...
$_lang["configcheck_installer_msg"] = 'Папка /install содержит инсталляционные файлы системы EVO. Злоумышленники могут воспользоваться этими файлами для взлома/повреждения сайта, так что лучше удалить папку с сервера.';
...
$_lang["configcheck_php_gdzip_msg"] = 'Для нормальной работы EVO необходимо, чтобы были разрешены GD и Zip расширения для PHP. EVO будет работать и без этих расширений, но вы не сможете использовать все возможности встроенного файл-менеджера, редактора изображений или код CAPTCHA для авторизации.';
$_lang["configcheck_rb_base_dir"] = 'Указан неверный <a href="index.php?a=17&tab=6">путь для файл-браузера</a>';
$_lang["configcheck_rb_base_dir_msg"] = 'Это может произойти, например, после перемещения вашего сайта в другой каталог или на другой сервер. Пожалуйста, проверьте и обновите настройки вашей системы EvolutionCMS';
...
$_lang["confirm_name_change"] = 'Изменение имени пользователя может повлиять на работу некоторых дополнений системы EVO. \n\nВы уверены, что хотите изменить имя пользователя?';
...
$_lang["credits"] = 'EVO использует';
$_lang["credits_shouts_msg"] = '<p>EVO поддерживается на сайте <a href="http://evo.im/" target="_blank">evo.im</a>.</p>';
...
$_lang["duplicate_alias_message"] = 'Выберите \'Да\', чтобы разрешить повторение псевдонимов.<br /><b>Примечание:</b> этот параметр должна использоваться вместе с включенной функцией \'Использовать вложенные URL\'.';
...
$_lang["export_site_message"] = '<p>Эта функция позволяет экспортировать сайт в HTML файлы целиком. Имейте в виду, что статический HTML-сайт имеет очень ограниченные возможности по сравнению с EVO-сайтом:</p><ul><li>не будет записываться статистика посещений;</li><li>интерактивные сниппеты работать не будут;</li><li>веб-ссылки экспортированы не будут;</li> <li>процесс экспорта может не удастся, если ресурсы содержат сниппеты с перенаправлением;</li><li>возможна неправильная работа дизайна шаблона вашего сайта. Во избежание этого экспортированные файлы должны находиться в корневой папке (там же, где и файл index.php системы EVO).</li></ul><p /><p>Пожалуйста, заполните форму и нажмите \'Начать экспорт\'. Файлы будут записаны в папку /assets/export, используя, где возможно, псевдонимы в качестве имен. При экспорте сайта рекомендуется в конфигурации EVO включить функцию \'Использовать псевдонимы в URL\'. Время экспорта зависит от размеров вашего сайта.</p><p><b>Существующие файлы с совпадающими именами будут заменены новыми.</b></p>';
...
$_lang["file_folder_chmod_error"] = 'Не удалось изменить права, необходимо установить нужные права вне EVO.';
...
$_lang["functionnotimpl_message"] = 'Эта функция еще не используется данной версией EVO.';
...
$_lang["guid"] = 'GUID';
$_lang["help"] = 'Помощь';
$_lang["help_msg"] = '<p>Вы можете получить бесплатную помощь сообщества EVO <a href="http://modx.im" target="_blank">на форумах EVO</a>. Смотрите также <a href="http://docs.evolution-cms.com" target="_blank">\'Документация и уроки по EVO\'</a>, где подробно описан каждый аспект системы.</p>';
...
$_lang["images_management"] = 'Управление изображениями';
...
$_lang["modx_news"] = 'Новости EVO';
$_lang["modx_news_tab"] = 'Новости EVO';
$_lang["modx_news_title"] = 'Новости EVO';
$_lang["modx_security_notices"] = 'Уведомления безопасности EVO';
$_lang["modx_version"] = 'Версия EVO';
$_lang["monday"] = 'Понедельник';
$_lang["move"] = 'Переместить';
$_lang["move_resource"] = 'Переместить';
$_lang["move_resource_message"] = 'Вы можете переместить ресурс и все его дочерние ресурсы, выбрав новый \'родительский\' ресурс. Если вы выберете в качестве родительского ресурс, не являющийся папкой, EVO автоматически сделает его папкой. Выберите новый \'родительский ресурс\' в дереве сайта слева.';
...
$_lang["password_gen_gen"] = 'Позволить EVO сгенерировать пароль.';
...
$_lang["resource_opt_folder_help"] = 'Отметьте, чтобы ресурс выполнял также роль папки (родителя) для других ресурсов. Не стоит особо заострять внимание на этом параметре – EVO автоматически установит для ресурса режим папки, если внутри него начнут создаваться ресурсы.';
...
$_lang["resource_type_message"] = 'Веб-ссылка на ресурс в интернете, включая другие ресурсы EVO, внешние веб-страницы, изображения или другие файлы в интернете. Для ресурса должен быть задан тип содержимого text/html, а в местонахождении содержимого - отображаемое.';
...
$_lang["role_file_management"] = 'Управление файлами';
...
$_lang["role_management_msg"] = '<p><b>Роль</b> - это набор прав совершать определённые действия. Роли назначаются пользователям. Типичные роли:</p> <ul> <li><b>Администраторы сайта</b> - управляют пользователями и общими настройками;</li> <li><b>Разработчики</b> - пишут код и, соответственно, имеют набор прав на создание / редактирование / удаление <i>модулей</i>, <i>плагинов</i>, <i>сниппетов</i>, <i>чанков</i>, <i>параметров (TV)</i>;</li> <li><b>Дизайнеры</b> - отвечают за внешний вид и вёрстку страниц сайта, имеют набор прав на создание / редактирование / удаление <i>шаблонов</i> и <i>чанков</i>;</li> <li><b>Редакторы</b> - отвечают за содержание страниц сайта, создают, редактируют и удаляют ресурсы;</li> <li><b>Корректоры</b> - читают и корректируют ресурсы, но не имеют прав на их создание и удаление;</li> <li><b>Главный редактор</b> - принимает решение о публикации новых ресурсов, управляет расписанием публикации.</li> </ul><br /><p>Выберите роль для редактирования или создайте новую роль.</p>';
...
$_lang["rss_url_news_message"] = 'Введите адрес (URL) RSS-ленты новостей EVO.';
$_lang["rss_url_news_title"] = 'Лента RSS новостей';
$_lang["rss_url_security_default"] = 'http://feeds.feedburner.com/evocms-security-news';
$_lang["rss_url_security_message"] = 'Введите адрес (URL) RSS-ленты безопасности EVO.';
...
$_lang["web_user_management_msg"] = '<b>Пользователи</b> - это зарегистрированные посетители сайта (не менеджеры). <br /><br />Выберите веб-пользователя, настройки которого вы хотите редактировать, или создайте нового веб-пользователя.';
...
$_lang["which_editor_message"] = 'Выберите HTML-редактор. Вы также можете загрузить и установить редакторы из списка доступных на сайте EVO.';
...
$_lang["setting_resource_tree_node_name_desc_add"] = 'Внимание: Начиная с версии EVO 1.1 Вы можете изменить отображаемое имя ресурса через опцию "Сортировать дерево". Этот параметр используется, если отображаемое имя в дереве ресурсов устанавливается на & &quot;По-умолчанию&quot;.';
...
$_lang["enable_cache_title"] = 'Способ кеширования';
...
$_lang["settings_friendlyurls_alert"] = 'Для использования дружественных URL, необходимо сменить имя файла ht.access в папке, в которую установлен EVO, на .htaccess.';
$_lang["settings_friendlyurls_alert2"] = 'При установке EVO в подпапку необходимо внести изменения в файл .htaccess.';
...
$_lang["minifyphp_incache_message"] = 'Сжатие PHP кода(снипетов и плагинов) и сохранение в фаил кеша, реф:<a href="https://github.com/modxcms/evolution/issues/938" target="_blank">#938</a> ';
...
$_lang["cm_categorize_x"] = "Классифицировать <span class=\"highlight\">%s</span>";
$_lang["cm_unknown_error"] = "Что-то пошло не так.";
$_lang["cm_x_assigned_to_category_y"] = "<span class=\"highlight\">%s(%s)</span> присвоено категории <span class=\"highlight\">%s(%s)</span>";
$_lang["cm_no_categorization"] = "Классификация не производилась.";
$_lang["cm_no_changes"] = "Нечего менять, поэтому изменений не было.";
$_lang["cm_x_changes_made"] = "<span class=\"highlight\">%s</span> изменений сделано";
$_lang["cm_enter_name_for_category"] = "Пожалуйста введите имя для новой категории";
$_lang["cm_category_x_exists"] = "Категория <span class=\"highlight\">%s</span> уже существует.";
$_lang["cm_category_x_saved_at_position_y"] = "Новая категория <span class=\"highlight\">%s</span> сохранена на позиции <span class=\"highlight\">%s</span>.";
$_lang["cm_category_x_moved_to_position_y"] = "Категория <span class=\"highlight\">%s</span> перемещена к позиции <span class=\"highlight\">%s</span>";
$_lang["cm_category_x_deleted"] = "Категория <span class=\"highlight\">%s</span> удалена";
$_lang["cm_category_x_renamed_to_y"] = "Категория <span class=\"highlight\">%s</span> переименована в <span class=\"highlight\">%s</span>";
$_lang["cm_translation_for_x_empty"] = "Перевод для <span class=\"highlight\">%s</span> пуст";
$_lang["cm_translation_for_x_to_y_success"] = "Перевод для <span class=\"highlight\">%s</span> к <span class=\"highlight\">%s</span> успешно сохранен";
