...
$_lang["export_site_message"] = '<p>Эта функция позволяет экспортировать сайт в HTML файлы целиком. Имейте в виду, что статический HTML-сайт имеет очень ограниченные возможности по сравнению с сайтом на Evolution CMS:</p><ul><li>не будет записываться статистика посещений;</li><li>интерактивные сниппеты работать не будут;</li><li>веб-ссылки экспортированы не будут;</li> <li>процесс экспорта может не удастся, если ресурсы содержат сниппеты с перенаправлением;</li><li>возможна неправильная работа дизайна шаблона вашего сайта. Во избежание этого экспортированные файлы должны находиться в корневой папке (там же, где и файл index.php).</li></ul><p /><p>Пожалуйста, заполните форму и нажмите \'Начать экспорт\'. Файлы будут записаны в папку /assets/export, используя, где возможно, псевдонимы в качестве имен. При экспорте сайта рекомендуется в конфигурации Evolution CMS включить функцию \'Использовать псевдонимы в URL\'. Время экспорта зависит от размеров вашего сайта.</p><p><b>Существующие файлы с совпадающими именами будут заменены новыми.</b></p>';
