...
$_lang["duplicate_alias_message"] = 'Выберите \'Да\', чтобы разрешить повторение псевдонимов. <b>ПРИМЕЧАНИЕ:</b> этот параметр должен использоваться вместе с включенной функцией \'Использовать вложенные URL\'.';
