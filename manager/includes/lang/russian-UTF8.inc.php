...
$_lang["template_selectable"] = 'Шаблон доступен для выбора, при создании или редактировании документа';
...
$_lang["sort_menuindex"] = 'Сортировать элементы';
$_lang['sort_updating'] = 'Обновляем ...';
$_lang['sort_updated'] = 'обновленно!';
$_lang['sort_nochildren'] = 'Документ не содержит дочерних документов';
$_lang["sort_elements_msg"] = 'Перетащите, чтобы изменить порядок элементов в списке.';
...
$_lang["use_breadcrumbs"] = 'Показывать навигацию';
