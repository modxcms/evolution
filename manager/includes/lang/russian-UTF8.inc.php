...
$_lang["document_parent_help"] = 'Щелкните мышью на значок папки вверху, чтобы включить (выключить) режим выбора родительского документа, затем выберите его в дереве документов слева.';
...
$_lang["errorpage_message"] = 'Введите ID документа, который вы хотите использовать как страницу ошибки (404 - документ не найден). <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему документу, и что этот документ опубликован';
