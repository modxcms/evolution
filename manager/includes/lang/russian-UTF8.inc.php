...
$_lang["login_captcha_message"] = 'Введите код подтверждения. Если у вас возникли трудности с прочтением кода, нажмите на него, чтобы сгенерировать новый вариант.';
...
$_lang["resource_opt_trackvisit_help"] = 'Скрывает показ дочерних ресурсов в дереве документов';
...
$_lang["track_visitors_title"] = 'Скрывать дочерние ресурсы';
