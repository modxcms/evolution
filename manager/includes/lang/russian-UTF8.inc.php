...
$_lang["setting_resource_tree_node_name_desc_add"] = 'Примечание: Начиная с версии MODX Evoluton 1.1 Вы можете изменить отображаемое имя ресурса через опцию \'Сортировать дерево\'. Этот параметр используется, если отображаемое имя в дереве ресурсов устанавливается на \'По-умолчанию\'.';
