...
$_lang["purge_plugin"] = 'Чистка устаревших плагинов';
...
$_lang["search_criteria_top_msg"] = 'Заголовок, Расширенный заголовок, Псевдоним';
...
$_lang["udperms_title"] = 'Использовать права доступа:';$_lang["use_breadcrumbs_message"] = 'Показывать навигацию, при создании или редактировании ресурса';
...
$_lang["enable_filter_message"] = 'Фильтры позволяют управлять выходными данными, преобразовывая их прямо в теге внутри шаблона. Аналог PHx. <a href="https://github.com/modxcms/evolution/issues/623" target="ext_help">Больше информации</a>'; // todo: Поменять ссылку на документацию 
...
$_lang["lock_interval_msg"] = "При редактировании элементов и ресурсов, они блокируются для других пользователей, периодически посылая Lock-запросы к серверу. Этот параметр управляет задержкой между каждым запросом (в секундах).";
$_lang["lock_release_delay"] = "Lock-Release Delay";
$_lang["lock_release_delay_msg"] = "Этот параметр управляет задержкой между последним запросом к элементу и снятием блокировки (в секундах).";
$_lang["lock_element_unknown_error"] = "Неизвестная ошибка при отправке запроса блокировки ( [+type+], ID  [+id+]). Этот [+element_type+], не блокируется больше от редактирования другими пользователями! Прежде чем пытаться редактировать дальше, убедитесь, что никакой другой пользователь не редактирует его.";
