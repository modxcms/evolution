...
$_lang["weblink_message"] = 'Веб-ссылка должна указывать на объект в Интернете. Это может быть как документ внутри системы MODx, так и страница на другом сайте, либо файл или изображение в Интернете.';
...
$_lang["rb_webuser_message"] = 'Хотите ли вы, чтобы web-пользователи использовали браузер файлов? <b>Предупреждение:</b> Позволяя web-пользователям использовать браузер файлов, вы делаете доступ для всех файлов, которые доступны менеджерам. Используйте эту настройку только для проверенных web-пользователей.';
...
$_lang["manager_direction_title"] = 'Направление текста системы управления:';
$_lang["manager_direction_message"] = 'Выберите направление текста в системе управления сайтом, слева направо(ltr) или справа налево(rtl).';
...
$_lang["no"] = 'Нет';
$_lang["none"] = 'Нет';
$_lang["configcheck_configinc_msg"] = 'Злоумышленники потенциально могут нанести вред Вашему сайту. <strong>Серьёзно.</strong> Пожалуйста, установите права доступа к файлу конфигурации (/assets/config.inc.php) в режим "Только для чтения"';
...
$_lang["role_empty_trash"] = 'Полное очищение корзины';
...
$_lang["view_child_documents_in_container"] = "Просмотр дочерних документов";
$_lang["xhtml_urls_title"] = 'Поддержка XHTML урлов';
$_lang["xhtml_urls_message"] = 'Заменять или нет амперсанд (&amp;) сгенерированый MODx в урлах на правильное &amp;<!-- -->amp; html-представление';
$_lang["tree_show_protected"] = 'Показывать защищенные документы в дереве';
$_lang["tree_show_protected_message"] = 'Когда установлена "No", Защищенные документы (и все их дочерние документы) не показываются в дереве документов. "No" - это устаревшая настройка для MODx.';
$_lang["mail_check_timeperiod_title"] = 'Период для проверки почты:';
$_lang["mail_check_timeperiod_message"] = 'Введите число в секундах, указывающее, как часто проверять новые почтовые сообщения.';
$_lang['role_export_static'] = 'Экспортирование в статичный HTML';
$_lang['role_import_static'] = 'Импортирование из HTML';
