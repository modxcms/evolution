...
$_lang["credits_shouts_msg"] = '<p>MODX поддерживается на сайте <a href="http://modx.com/" target="_blank">modx.com</a>.</p>';
...
$_lang["setting_resource_tree_node_name_desc_add"] = 'Внимание: Начиная с версии MODX 1.1 Вы можете изменить отображаемое имя ресурса через опцию "Сортировать дерево". Этот параметр используется, если отображаемое имя в дереве ресурсов устанавливается на & &quot;По-умолчанию&quot;.';
...
$_lang['help_translating_title'] = "Помочь с переводом MODX Evolution";
