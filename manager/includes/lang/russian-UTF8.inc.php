...
$_lang["access_permissions_document_groups"] = 'Группы ресурсов';
$_lang["access_permissions_documents_in_group"] = '<b>ресурсов в группе:</b> ';
$_lang["access_permissions_documents_tab"] = 'Здесь вы можете увидеть все группы ресурсов. Также, здесь вы можете создать, переименовать, удалить группу, просмотреть ресурсы в группе. Для добавления или удаления ресурса из группы редактируйте ресурс непосредственно.';
...
$_lang["access_permissions_no_documents_in_group"] = 'Нет ресурсов.';
...
$_lang["add_document"] = 'Новый ресурс';
...
$_lang["confirm_delete_document"] = 'Вы уверены, что хотите удалить этот ресурс? \nВсе дочерние ресурсы будут также удалены.';
...
$_lang["confirm_duplicate_document"] = 'Вы уверены, что хотите сделать копию этого ресурса? \nВсе дочерние ресурсы будут также скопированы.';
...
$_lang["create_document_here"] = 'Дочерний ресурс';
...
$_lang["doc_data_title"] = 'Просмотр данных ресурса (страницы)';
$_lang["document"] = 'Ресурс';
$_lang["document_alias"] = 'Псевдоним';
$_lang["document_alias_help"] = "Здесь вы можете выбрать псевдоним для ресурса. Псевдоним позволяет обращаться к ресурсу по адресу:\n\nhttp://example.com/псевдоним\n\nВнимание: функция будет работать только при включенных 'дружественных URL'."; 
$_lang["document_content"] = 'Содержимое ресурса';
$_lang["document_description"] = 'Описание';
$_lang["document_description_help"] = 'Здесь вы можете ввести описание ресурса.';
$_lang["document_long_title_help"] = 'Здесь вы можете ввести расширенный заголовок вашего ресурса, что может быть полезно для поисковых систем.';
$_lang["document_metatag_help"] = 'Выберите META-теги и ключевые слова, которые вы хотите присвоить этому ресурсу. Для выбора нескольких ключевых слов или МЕТА-тегов нажимайте на них мышью, удерживая Ctrl.';
$_lang["document_opt_contentdispo"] = 'Местонахождение содержимого';
$_lang["document_opt_contentdispo_help"] = 'Этот параметр определяет, как браузер должен обработать ресурс. Для того, чтобы ресурс стал доступным для скачивания, а не отображался в окне браузера, выберите \'Прикрепленное\'.';
$_lang["document_opt_emptycache"] = 'Очистить кэш?';
$_lang["document_opt_emptycache_help"] = 'Отметьте для того, чтобы очистить кэш после сохранения изменений этого ресурса. В этом случае посетители увидят свежую версию ресурса.';
$_lang["document_opt_folder"] = 'Контейнер (содержит дочерние ресурсы)';
$_lang["document_opt_folder_help"] = 'Отметьте, чтобы ресурс выполнял также роль папки (родителя) для других ресурсов. Не стоит особо заострять внимание на этом параметре – MODx автоматически установит для ресурса режим папки, если внутри него начнут создаваться ресурсы.';
$_lang["document_opt_menu_index"] = 'Позиция в меню';
$_lang["document_opt_menu_index_help"] = 'Позиция (индекс) в меню - это порядковый номер ресурса в меню. Эту величину можно также использовать в разработке сниппетов.';
$_lang["document_opt_menu_title"] = 'Пункт меню';
$_lang["document_opt_menu_title_help"] = 'Пункт меню - это параметр, который можно использовать для отображения краткого заголовка ресурса в меню.';
$_lang["document_opt_published"] = 'Публиковать';
$_lang["document_opt_published_help"] = 'Отметьте, чтобы опубликовать ресурс сразу после сохранения.';
$_lang["document_opt_richtext"] = 'Использовать HTML-редактор';
$_lang["document_opt_richtext_help"] = 'Отметьте, чтобы для редактирования ресурса использовался HTML-редактор. Если ресурс содержит JavaScript или формы - снимите галочку, чтобы редактировать его в режиме HTML-кода (чтобы HTML-редактор не вносил никаких изменений в код).';
$_lang["document_opt_show_menu"] = 'Показывать в меню';
$_lang["document_opt_show_menu_help"] = 'Включите этот параметр для отображения ресурса в каком-либо меню сайта. Имейте в виду, некоторые сниппеты могут игнорировать этот параметр.';
$_lang["document_opt_trackvisit_help"] = 'Регистрировать каждое посещение';
$_lang["document_overview"] = 'Обзор ресурса';
$_lang["document_parent"] = 'Папка';
$_lang["document_parent_help"] = 'Щелкните мышью на значке контейнера вверху, чтобы включить (выключить) режим выбора родительского ресурса, затем выберите его в дереве сайта слева.';
...
$_lang["document_setting"] = 'Настройки ресурса';
$_lang["document_summary"] = 'Аннотация (введение)';
$_lang["document_summary_help"] = 'Введите краткое описание ресурса';
$_lang["document_title"] = 'Заголовок';
$_lang["document_title_help"] = 'Введите имя/заголовок ресурса. Нежелательно использовать при этом обратный слэш (\\)';
$_lang["document_to_be_moved"] = 'Перемещаемый ресурс';
$_lang["document_weblink_help"] = 'Введите адрес (URI) объекта в сети, на который должна указывать вэб-ссылка.';
$_lang["documents_in_container"] = 'ресурс(ов) в этом контейнере';
$_lang["documents_in_container_no"] = 'Текущий контейнер не содержит дочерних ресурсов.';
...
$_lang["edit_document_title"] = 'Создать / редактировать ресурс';
...
$_lang["import_files_found"] = '<b>Найдено %s ресурсов для импорта...</b><p />';
...
$_lang["import_parent_document"] = 'Родительский ресурс:';
...
$_lang["move_document_message"] = 'Вы можете переместить ресурс и все его дочерние ресурсы, выбрав новый \'родительский\' ресурс. Если вы выберете в качестве родительского ресурс, не являющийся папкой, MODx автоматически сделает его папкой. Выберите новый \'родительский ресурс\' в дереве сайта слева.';
$_lang["move_document_new_parent"] = 'Выберите новый \'родительский\' ресурс в дереве сайта слева.';
...
$_lang["untitled_document"] = 'Новый ресурс';
...
$_lang["view"] = 'Просмотр';
$_lang["view_child_documents_in_container"] = 'Просмотр дочерних ресурсов';
...
$_lang["weblink_message"] = 'Веб-ссылка должна указывать на объект в Интернете. Это может быть как ресурс внутри системы MODx, так и страница на другом сайте, либо файл или изображение в Интернете.';
