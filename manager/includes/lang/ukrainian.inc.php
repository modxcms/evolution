...
$_lang["export_site_maxtime_message"] = 'Вкажіть максимальну кількість секунд, протягом яких буде виконуватися процес експорту сайту (нехтуючи налаштуваннями PHP). Введіть 0 для необмеженого часу. Майте на увазі, що 0 або дуже велика кількість часу, заТакнние для процесу експорту, можуть привести до неадекватної роботі сервера, тому такі значення задавати не рекомендується.';
$_lang["export_site_message"] = '<p>Ця функція дозволяє експортувати сайт в HTML файли цілком. Майте на увазі, що статичний HTML-сайт має дуже обмежені можливості в порівнянні з EVO-сайтом:</p><ul><li>не буде записуватися статистика відвідувань;</li><li>інтерактивні сніпети працювати не будуть;</li><li>веб-посилання експортувати не будуть;</li> <li>процес експорту може не вдасться, якщо ресурси містять сніппети з перенаправленням;</li><li>система може виконувати функції дизайну шаблону вашого сайту. Щоб уникнути цього експортовані файли повинні знаходитися в кореневій папці (там же, де і файл index.php системи EVO).</li></ul><p /><p>Будь ласка, заповніть форму і натисніть \'Почати експорт\'. Файли будуть записані в папку /assets/export, використовуючи, де можливо, псевдоніми як імена. При експорті сайту рекомендується в конфігурації EVO включити функцію \'Використовувати псевдоніми в URL\'. Час експорту залежить від розмірів вашого сайту. </P> <p> <b> Існуючі файли з однаковими іменами будуть замінені новими.</b></p>';
$_lang["export_site_numberdocs"] = '<p><b>Найдено %s ресурсів для експорту...</b></p>';
...
$_lang["export_site_suffix"] = 'Суффікс файлів:';
...
$_lang["import_site_failed_no_retrieve_file"] = 'Неможливо отримати файл: ';
$_lang["import_site_html"] = 'Імпортувати сайт з HTML';
$_lang["import_site_importing_document"] = 'Імпортується файл <b>%s</b>';
$_lang["import_site_maxtime"] = 'Максимальний час імпорту:';
$_lang["import_site_maxtime_message"] = 'Тут ви можете вказати, кілька секунд може зайняти процес імпорту (перевизначення установок PHP). Введіть 0, щоб задати необмежений час. Майте на увазі, що 0 або дуже великий проміжок часу, задані для процесу імпорту, можуть привести до неадекватної роботі сервера, тому такі значення задавати не рекомендується.';
$_lang["import_site_message"] = 'Використовуючи цю функцію, ви можете імпортувати сайт з HTML в базу Такна. Врахуйте, що всі HTML-файли потрібно скопіювати в папку \'assets/import\'. <br /><br />Заповніть форму, Оберіть батьківський ресурс в дереві сайту і натисніть \'почати імпорт\' для початку процесу. Файли будуть скопійовані в вказане місце, використовуючи, де можливо, імена файлів як псевдоніми і заголовки сторінок як назви ресурсів. <br /><br />';
...
$_lang["messages_no_messages"] = 'Поштова скринька порожній.';
...
$_lang["messages_select_group"] = 'Оберіть группу';
$_lang["messages_select_user"] = 'Оберіть пользователя';
$_lang["messages_send"] = 'Відправити';
$_lang["messages_send_to"] = 'Кому';
$_lang["messages_sent"] = 'Відправлено';
...
$_lang["password_msg"] = 'Для користувача <b>%s</b> заданий новий пароль - <b>%s</b><br>';
...
$_lang["import_site.static.php2"] = 'Скинути дерево ресурсів і форматувати все ідентифікатори ресурсів.';
...
$_lang["a83_ignore_ids_title"] = 'ID, що треба ігнорувати (через запятую)';
...
$_lang["export_site.static.php7"] = 'Файл не може бути збережений в [+rb_base_url+]';
