 ...
 * Encoding:       UTF-8
 * Author:         The MODx Project Persian/Farsi Translation By Mohsen.H.Z 
 * Date:           20 Dec 2006
 * Version:        0.1
 * MODx version:   0.9.5
*/
// NOTE: Now alpha-sorted
$_lang["about_msg"] = 'مدایکس یک <a href="http://modxcms.com/what-is-modx.html" target="_blank">سیستم مدیریت محتوای ساختار یافته و پیشرفته  توسط پی اچ پی میباشد</a> که  تحت لیسانس <a href="../assets/docs/license.txt">جی ان یو جی پی ال</a> منتشر شده است';
$_lang["about_title"] = 'درباره مدایکس';
$_lang["access_permissions"] = 'سطوح دسترسی';
$_lang["access_permissions_add_document_group"] = 'ایجاد یک گروه جدید برای پرونده ها';
...
$_lang["access_permissions_documents_tab"] = 'در اینجا شما میتوانید مشاهده کنید که چه گروه های پرونده ای تهیه شده است. همچنین شما قادر خواهید بود گروه های جدیدی را تعریف و ایجاد کنید, نام گروه ها را تغییر دهید, گروه ها را حذف کنید و ببنید که چه پرونده ای در چه چه گروهی قرار دارد (نشانگر موس را روی ردیف یا شناسه ی پرونده برانید تا اسم آنرا مشاهده کنید). برای افزودن پرونده به گروه یا حذف پرونده از یک گروه, پوشه ی پرونده را ویرایش کنید.';
$_lang["access_permissions_document_groups"] = 'گروههای پرونده';
$_lang["access_permissions_introtext"] = 'در اینجا شما میتوانید گروه های کاربری و گروه های پرونده ها را که برای اعمال در سطوح دسترسی کاربرد دارند را مدیریت کنید. برای افزودن کاربر به یک گروه کاربری , کاربر مورد نظر را ویرایش کرده و گروه هایی را که این کاربر بایستی در آنها عضو باشد را انتخاب کنید. برای افزودن پرونده ای به یک گروه کاربری, پرونده را ویرایش کرده و گروه هایی را که به متعلق به آنهاست را انتخاب کنید.';
$_lang["access_permissions_links"] = 'لینک گروه های پرونده ها / کاربران';
...
$_lang["access_permissions_users_tab"] = 'در اینجا شما میتوانید مشاهده کنید که چه گروه های کاربری تعریف شده اند. همچنین شما میتوانید گروه های جدیدی ایجاد نمایید, تغییر نام دهید, گروه ها را حذف کنید و ببینید که کدام کاربران عضو گروه های مختلف دیگر هستند. برای افزودن کاربر جدید به یک گروه یا حذف یک کاربر از یک گروه, خود کاربر را مستقیما ویرایش کنید. مدیران کل (کاربرانی که با نقش اول یا 1 تعریف شده اند) همیشه به کلیه ی پرونده ها دسترسی خواهند داشت, به همین دلیل نیازی نیست که آنها به گروه خاصی اضافه شوند.';
$_lang["access_permissions_user_group"] = 'گروه کاربری:';
$_lang["access_permissions_user_groups"] = 'گروه های کاربرات';
$_lang["access_permissions_user_group_access"] = 'گروه های پرونده ای که این گروه کاربری اجازه دسترسی به آنها را دارد:';
...
$_lang["access_permission_parent_denied"] = 'شما اجازه یا دسترسی ایجاد پرونده ای جدید در این مکان را ندارید!';
...
$_lang["add_document"] = 'پرونده ی جدید';
...
$_lang["all_doc_groups"] = 'همه ی گروه های پرونده -عمومی';
...
$_lang["charset_message"] = 'لطفا مشخص بفرمایید تا تمایل دارید از کدام کاراکتر انکد برای بخش مدیریت استفاده شود. لطفا توجه داشته باشید که سیستم فعلی با  همه ی آنها آزمایش نشده و تنها برخی از این کاراکتر انکد آزمایش موفقیت آمیز داشته. برای اکثر زبانها, ترجیحا میتوان کاراکتر ست یوتی اف 8 را انتخاب کرد.';
$_lang["charset_title"] = 'کارکاکترست متون';
$_lang["chunk"] = 'چانک';
$_lang["chunk_code"] = 'کد چانک (اچ تی ام ال)';
...
$_lang["configcheck_configinc_msg"] = 'انسانهای بی وجدان ممکن است از طریق این مسئله به وبگاه یا فایلهای مشترک با آن آسیب برسانند. <strong>حتما</strong> فایل کانفیگ خود را (/manager/includes/config.inc.php) تنها قابل بازخوانی کنید و از این حالت با قابلیت نگارش خارج کنید.';
...
$_lang["configcheck_register_globals"] = 'رجیستر_گلوبال در تنظیمات فایل اصلی پی اچ پی سرور میزبان روشن می باشد';
...
$_lang["confirm_delete_document"] = 'آیا از حذف این پرونده اطمینان دارید؟ \n کلیه ی پرونده های زیر بخش این پرونده نیز حذف خواهند شد.';
...
$_lang["confirm_duplicate_document"] = 'آیا از مشابه سازی این پرونده اطمینان دارید؟ همه ی گزینه هایی که در بر دارد نیز مشابه سازی خواهد شد.';
...
$_lang["create_document_here"] = 'ایجاد پرونده در اینجا';
...
$_lang["credits_dTree"] = 'مدایکس از اسکریپت درختی فوق العاده ی ارائه شده در دستروی دراپ استفاده میکند!';
$_lang["credits_everaldo"] = 'مدایکس از تعدادی از نمادها یا آیکونهای سری کریستال اورالدو استفاده میکند. نمادهای زیبایی است.';
$_lang["credits_mysql"] = 'مدایکس از قدرت مای اس کیو ال بهره گرفته است';
$_lang["credits_php"] = 'مدایکس از قدرت پی اچ پی بهره گرفته است';
$_lang["credits_shouts_msg"] = '
<ul>
<li><b>ریموند آیروینگ و رایان تراش</b> - بنیانگذاران پروژه</li>
<li><b>جیسون کوارد, ویکتور بریلون, آدام کراونوبل, جف ویتفیلد, رمون سیرر</b> - طراحی و مهندسی هسته ی مرکزی</li>
<li><b>محسن مهربان</b> - ترجمه و پشتیبانی فارسی</li>
</ul>';
$_lang["credits_shouts_title"] = '<b>با تشکر ویژه از :</b>';
$_lang["credits_webfx"] = 'مدایکس تعدادی از جاوا اسکریپتهای فوق العاده ای که در وب اف ایکس ارائه شده را استفاده کرده است';
...
$_lang["delete"] = 'حذف';
$_lang["delete_document"] = 'حذف پرونده';
...
$_lang["document"] = 'پرونده';
$_lang["document_alias"] = 'آلایس پرونده';
$_lang["document_alias_help"] = 'در اینجا شما میتوانید یک آلایس برای این پرونده انتخاب کنید. این حالت شما را قادر به دسترسی به پرونده از طریق:\n\nhttp://yourserver/alias می کند\n\nاین حالت فقط در صورتیکه شما از آدرسهای دوستانه استفاده کرده باشید فعال می شود.';
$_lang["document_content"] = 'محتوای پرونده';
$_lang["document_description"] = 'توضیحات';
$_lang["document_description_help"] = 'شما میتوانید توضیحاتی را به دلخواه در مورد پرونده در اینجا وارد کنید.';
$_lang["document_long_title_help"] = 'در اینجا شما میتوانید عنوانی بلندتر را برای پرونده ی خود وارد کنید. این کمک کار موتورهای جستجو خواهد بود, و میتواند با توضیحاتی بیشتر برای شما بهتر یادآوری و یا تعریف شود.';
$_lang["document_metatag_help"] = 'کلمات کلیدی و مشخصات کاربردی که تمایل دارید به این پرونده اختصاص یابد را وارد کنید. کلید کنترل صفحه کلید خود را پایین نگه داشته تا بتوانید همزمان چنیدین مشخصه ی کاربردی و کلمات کلیدی را انتخاب کنید.';
$_lang["document_opt_contentdispo"] = 'ساختار محتوا';
$_lang["document_opt_contentdispo_help"] = 'ساختار محتوایی را برای مشخص کردن نحوه ی پردازش مرورگر وب با محتوای مورد نظر خود مشخص کنید. برای فایلهای قابل دانلود میتوانید ساختار محتوایی را روی فایلهای پیوستی یا ضمیمه تنظیم کنید';
$_lang["document_opt_emptycache"] = 'ذخیره یا کش خالی شود؟';
$_lang["document_opt_emptycache_help"] = 'انتخاب این کزینه و فعالسازی آن سیستم را پس از ذخیره ی پرونده قادر به پاسکازی ذخیره یا کش میکند. در این صورت بازدید کنندگان وبگاه شما محتوای قدیمی این پرونده را مجددا مشاهده نخواهند کرد.';
$_lang["document_opt_folder"] = 'حاوی یا محفظه؟';
$_lang["document_opt_folder_help"] = 'این گزینه را انتخاب کنید تا این قابلیت را به این پرونده بدهید که بعنوان حاوی یا محفظه برای سایر پرونده ها عمل کند. این  \'حاوی یا محفظه\' شبیه یک پوشه است, با این تفاوت که میتواند شامل محتوا هم باشد.';
$_lang["document_opt_menu_index"] = 'محتوای فهرست یا منو';
$_lang["document_opt_menu_index_help"] = 'اجزای داخلی فهرست گزینه ای است که شما متوانید از آن به منظور ترتیب دادن به پرونده ها در اسنیپت منو یا فهرست خود استفاده کنید. همچنین میتوانید کاربردهای دیگری از آن در اسنیپت خود داشته باشید.';
$_lang["document_opt_menu_title"] = 'عنوان در فهرست';
$_lang["document_opt_menu_title_help"] = 'عنوان در فهرست قابلیتی است که به شما امکان استفاده از عنوان مختصر برای پرونده در داخل اسنیپتهای فهرست و یا ماژولها میدهد';
$_lang["document_opt_published"] = 'انتشار یابد؟';
$_lang["document_opt_published_help"] = 'این گزینه را انتخاب کنید تا پس از حفظ پرونده همزمان منتشر شود.';
$_lang["document_opt_richtext"] = 'ویرایشگر متن؟';
$_lang["document_opt_richtext_help"] = 'این گزینه را انتخاب کنید تا از ویرایشگر برای ویرایش متون پرونده ها استفاده شود. اگر پرونده های شما حاوی جاوا اسکریپت و فرم ها می باشد, این گزینه را غیر فعال کنید تا در محیط اچ تی ام ال ویرایش کنید و بدین ترتیب ویرایشگر اختلالی در محتوای اصلی شما ایجاد نمی کند.';
$_lang["document_opt_show_menu"] = 'نمایش در فهرست';
$_lang["document_opt_show_menu_help"] = 'این گزینه را انتخاب کنید تا پرونده در داخل فهرست وب نمایش داده شود. لطفا به خاطر داشته باشید تا برخی از ابزار تهیه ی فهرست یا به این گزینه ترتیب اثر نمی دهند.';
$_lang["document_opt_trackvisit_help"] = 'دفعات بازدید هر یک از بازدیدکنندگان ثبت شود';
$_lang["document_parent"] = 'سرگروه پرونده';
$_lang["document_parent_help"] = 'برای انتخاب یا مشخص کردن سرگروه این پرونده روی نماد یا آیکون بالا کلیک کنید سپس از طریق درختی روی پرونده کلیک کنید تا سرگروه جدید آنرا تعیین کنید';
$_lang["document_setting"] = 'تنظیمات پرونده';
$_lang["document_summary"] = 'خلاصه یا مقدمه ی کوتاه مطلب';
$_lang["document_summary_help"] = 'خلاصه ای مختصر از پرونده را در اینجا ذکر کنید.';
$_lang["document_title"] = 'عنوان';
$_lang["document_title_help"] = 'اسم / عنوان پرونده را اینجا وارد کنید. لطفا از بک اسلش در انتخاب نامها استفاده نکنید!';
$_lang["document_to_be_moved"] = 'پرونده ی مورد نظر برای انتقال';
$_lang["document_weblink_help"] = 'آدرس شیء مورد نظر خود را که تمایل دارید این وب لینک به آن اشاره کند را در اینجا وارد کنید.';
...
$_lang["duplicate_document"] = 'پرونده ی مشابه';
$_lang["edit"] = 'ویرایش';
$_lang["editedon"] = 'ویرایش تاریخ';
$_lang["editing_file"] = 'ویرایش فایل: ';
$_lang["editor_css_path_message"] = 'مسیری که فایل سی اس اس شما در آن قرار دارد و تمایل به استفاده در ویرایشگر دارید را وارد کنید. بهترین راه وارد کردن مسیر فایل سی اس اس از محل روت است, بعنوان مثال: /assets/site/style.css. اگر تمایلی به استفاده از فایل سی اس اس در ویرایشگر ندارید, این قسمت را خالی بگذارید.';
$_lang["editor_css_path_title"] = 'مسیر فایل سی اس اس:';
$_lang["edit_document"] = 'ویرایش پرونده';
$_lang["edit_document_title"] = 'ایجاد / ویرایش پرونده';
...
$_lang["eventlog_msg"] = 'ثبت آمار فعالیت سیستم ببرای ثبت اطلاعات بکار میرود. پیغامهای اخطار و خطا که توسط سیستم نمایش داده شده را ثبت میکند. ستون  \'منبع یا عامل \' بخس را که که خطلا در آن ثبت شده را نمایش میدهد';
...
$_lang["export_site"] = 'تخلیه و دریافت خروجی بصورت اچ تی ام ال';
...
$_lang["export_site_failed"] = '<span style="color:#990000">عملیات خروجی ناموق بود</span>';
$_lang["export_site_html"] = 'تخلیه و دریافت خروجی سایت به اچ تی ام ال';
$_lang["export_site_maxtime"] = 'نهایت زمان برای تخلیه و دریافت خروجی';
$_lang["export_site_maxtime_message"] = 'در اینجا شما میتوانید تعداد ثانیه ها یی را که سیستم میتواند برای تهیه ی خروجی و تخلیه وبگاه مصرف کند را مشخص کنید (فارغ از تنظیمات پی اچ پی). صفر 0 را برای انتخاب بازه ی زمانی نامحدود وارد کنید. توجه کنید که , انتخاب صفر 0 یا اعداد بیسار بزرگ پیشنهاد نمی شود چرا که ممکن است سرور یا میزبان شما را به قدری مشغول کند که وبگاه را به حالت تعلیق درآورد.';
$_lang["export_site_message"] = '<p>با استفاده از این قابلیت شما قادر خواهید بود کلیه ی مطالب و محتوای وبگاه خود را بصورت اچ تی ام ال خروجی بگیرید. لطفا توجه داشته باشید, به هر ترتیب, اگر شما این کار را انجام دهید بسیاری از قابلیتهایی که توسط سیستم روی پرونده ها اعمال شده است را از دست خواهید داد:</p><ul><li>Page reads on the exported files will not be recorded.</li><li>اسنیپتهای فعال پس از دریافت خروجی قابلیتی از خود نخواهند داشت</li><li>تنها از پرونده های معمولی خروجی تهیه خواهد شد, از وب لینک ها خروجی گرفته نخواهد شد.</li><li>عملیات تهیه ی خروجی امکان دارد بوسیله ی کدهای اسنیپتی که در فایلها موجود است و آنها را به محلی دیگر هدایت میکند مخدوش شود.</li><li>به نحوه نگارش پرونده های شما بستگی دارد, فایلهای سی اس اس و تصاویر, طراحی وبگاه شما امکان دارد به درستی تهیه نشود. برای رفع این مسئله, شما میتوانید حفظ و ذخیره کنید و یا انتقال دهید فایلهایی را که از آنها خروجی تهیه کرده اید به همان دایره یا محلی که صفحه ی اصلی شما در آنجا قرار دارد.</li></ul><p>لطفا فرم زیر را تکمیل کنید و روی گزینه ی \'تهیه ی خروجی\' کلیک کنید تا عملیات تهیه ی خروجی آغاز شود. فایلهای خروجی تهیه شده در مکانی که شما تعیین کرده اید حفظ و ذخیره خواهد شد, با استفاده از, حالتیکه امکان داشته باشد, آلایاس پرونده ها به عنوان نام فایلها تعیین خواهد شد. در هنگامیکه از وبگاه خود خروجی تهیه میکنید, بهتر است این قابلیت در تنظیمات سیستم با عنوان \'آلایاس دوستانه\' در حالت \'بلی\' تنظیم و ست شده باشد. بنا به حجم وبگاه شما, مدت زمان تهیه ی خروجی از آن به طول می انجامد.</p><p><em>فایلهای جدید بر روی فایلهای قبلی همنام بازمگاری خواهد شد در صورتیکه نام آنها بصورت مخصوص تعبیه شده باشد!</em></p>';
$_lang["export_site_numberdocs"] = '<p><b>تعداد %s پرونده برای تخلیه و تهیه خروجی یافت شد...</b></p>';
$_lang["export_site_prefix"] = 'پیشفرض فایل :';
$_lang["export_site_start"] = 'عملیات تهیه ی خروجی را آغاز شود.';
$_lang["export_site_success"] = '<span style="color:#009900">عملیات تهیه ی خروجی  و تخلیه موفق آمیز بود</span>';
$_lang["export_site_suffix"] = 'پسوند فایل:';
$_lang["export_site_target_unwritable"] = 'پوشه ی مقصد قابلیت نگارش را ندارد. لطفا از قابلیت نگارش پوشه ی مقصد اطمینان حاصل کرده, و مجددا امتحان کنید.';
$_lang["export_site_time"] = 'عملیات تهیه ی خروجی به اتمام رسید. کل زمان تهیه ی خروجی %s ثانیه برای تکمیل عملیات بوده است.';
...
$_lang["files_title"] = 'جستجو یا نمایشگر فایل';
...
$_lang["file_folder_chmod_error"] = 'قادر به تغییر دسترسی نیست, شما بایستی سطوح دسترسی را خارج از سیستم مدایکس تعریف کنید.';
...
$_lang["friday"] = 'جمعه';
$_lang["friendlyurlsprefix_message"] = 'در اینجا شما میتوانید تعیین کنید که چه پیشفرضی برای آدرسهای دوستانه مورد استفاده قرار گیرد. بعنوان مثال, تنظیم پیفرض  \'صفحه\' آدرس صفحات را از این نوع /index.php?id=2 به نوع بهتر و دوستانه ی قابل تشخیص موتورهای جستجو همچون /page2.html تبدیل میکند (با فرض اینکه پسوند صفحات روی اچ تی ام ال تنظیم شده باشد). به این نحو شما میتوانید تعیین کنید که کاربران شما و مخصوصا موتورهای جستجو چگونه لینک ها و آدرسهای شما را بشناسند و به خاطر بسپارند.';
...
$_lang["htmlsnippet_msg"] = 'در اینجا شما میتوانید چانکها را ایجاد / ویرایش نمایید. به خاطر داشته باشید, چانکها فقط محتوای \'خالص\' کدهای اچ تی ام ال هستند, به همین ترتیب هیچ کد پی اچ پی قابل پردازش نخواهد بود.';
...
$_lang["import_files_found"] = '<b>تعداد %s پرونده برای وارد کردن یافت شد...</b><p/>';
...
$_lang["import_parent_document"] = 'پرونده ی سرگروه: ';
$_lang["import_site"] = 'وارد کردن اچ تی ام ال';
$_lang["import_site_failed"] = '<span style="color:#990000">ناموفق!</span>';
$_lang["import_site_html"] = 'وارد کردن صفحات اچ تی ام ال به وبگاه';
$_lang["import_site_importing_document"] = 'در حال وارد کردن فایل <b>%s</b> ';
$_lang["import_site_maxtime"] = 'نهایت زمان برای آپلود: ';
$_lang["import_site_maxtime_message"] = 'در اینجا متوانید تعیین کنید که چه میزان ثانیه  سیستم مدیریت محتوای شما میتواند صرف وارد کردن اچ تی ام ال به داخل وبگاه کند (overriding PHP settings). عدد 0 را برای زمان نامحدود انتخاب کنید. توجه داشته باشید, تنظیم عدد به 0 یا اعدا بسیار بزرگ امکان آسیب رسانی به سرور شما را دارد و پیشنهاد نمی شود.';
$_lang["import_site_message"] = 'با استفاده از این قابلیت شما میتوانید کلیه ی صفحات اچ تی ام ال وبگاه یا سایت را بطور کامل وارد کنید. به خاطر داشته باشید که شما بایستی فایلهای اچ تی ام ال خود را و یا پوشه ی حاوی آنرا به داخل assets/import کپی کنید.<p />لطفا فرم را تکمیل کرده و بر روی \'اجرای عملیات وارد سازی\' کلیک کنید تا وارد کردن انجام شود. فایلهای وارد شده در محلی که شما مشخص کرده اید حفظ و ضبط خواهد شد, در صورت امکان, از نام فایل بعنوان آلایس پرونده و از عنوان صفحه بعنوان عنوان پرونده استفاده خواهد شد';
$_lang["import_site_skip"] = '<span style="color:#990000">توقف عملیات</span>';
$_lang["import_site_start"] = 'شروع واردات';
$_lang["import_site_success"] = '<span style="color:#009900">موفقیت آمیز بود</span>';
$_lang["import_site_time"] = 'وارد سازی تمام شد. کل عملیات مدت %s ثانیه برای تکمیل به طول انجامید.';
$_lang["inbox"] = 'صندوق';
$_lang["info"] = 'مشخصات';
$_lang["information"] = 'اطلاعات';
$_lang["inline"] = 'این لاین یا داخل صفحه';
$_lang["insert"] = 'وارد شود';
$_lang["insert_snippet"] = 'اسنیپت به داخل پرونده وارد شود';
...
$_lang["list_mode"] = 'فعال یا غیر فعال کردن حالت فهرستی - برای فهرست شدن کلیه ی ثبت ها در grid استفاده می شود.';
...
$_lang["logo_slogan"] = 'مدیریت محتوای مدایکس - \nبا حداقل امکان بسازید بلکه برتر از آن';
...
$_lang["manage_plugins"] = 'پلاگین ها';
$_lang["manage_snippets"] = 'اسنیپت ها';
$_lang["manage_templates"] = 'قالبها یا پوسته ها';
$_lang["messages"] = 'چاپار برقی';
$_lang["messages_all"] = 'همه ی کاربران';
$_lang["messages_compose"] = 'نگارش پیغام جدید';
$_lang["messages_forward"] = 'ارسال به دیگری';
$_lang["messages_from"] = 'از طرف ';
$_lang["messages_group"] = 'به گروه';
$_lang["messages_inbox"] = 'صندوق';
$_lang["messages_message"] = 'نگارش و ارسال ';
$_lang["messages_not_allowed_to_read"] = 'شما اجازه ی خواندن این پیغام را ندارید';
$_lang["messages_no_messages"] = 'پیغامی در صندوق نامه ی شما نیست';
$_lang["messages_private"] = 'خصوصی';
$_lang["messages_read_message"] = 'خواندن پیغام';
$_lang["messages_reply"] = 'پاسخ';
$_lang["messages_select_group"] = 'انتخاب گروه ';
$_lang["messages_select_user"] = 'انتخاب کاربر ';
$_lang["messages_send"] = 'ارسال';
$_lang["messages_send_to"] = 'ارسال به ';
$_lang["messages_sent"] = 'ارسال شده در';
$_lang["messages_subject"] = 'عنوان ';
$_lang["messages_system_user"] = '[سیستم]';
$_lang["messages_title"] = 'سیستم پیغام رسان یا چاپار برقی';
$_lang["messages_user"] = 'به کاربر';
$_lang["metatags"] = 'کلمات شاخص';
$_lang["metatags_and_keywords"] = 'کلمات شاخص و کاربردی';
...
$_lang["metatag_notice"] = 'در صورت تمایل برای اطلاعات بیشتر میتوانید به مرجع <a href="http://www.html-reference.com/META.htm" target="_blank">راهنمای اچ تی ام ال</a> مراجعه کنید. این لیست کاملی از شاخصای فراهم شده محسوب نمی شود.';
...
$_lang["mgrlog_query_msg"] = 'لطفا موردی را برای مرور اطلاعات ثبت شده انتخاب کنید. شما میتوانید طبق تاریخ آنها را انتخاب کنید, اما توجه کنید که تاریخی که وارد میکنید طبق بازه ی زمانی است - برای انتخاب همه ی اطلاعات ثبت شده برای تاریخ 01-01-2004, اینگونه تنظیم کنید که \'از تاریخ\' به 01-01-2004 و \'تا تاریخ\' به 02-01-2004.<br /><br />
پیغامها و نحوه عملکرد اغلب به یک نحو خواهد بود. اگر شما بدنبال پیغام مشخصی هستید, بهترین کار این است که عملکرد را روی \'هر / همه\' تنظیم کنید.';
...
$_lang["module_code"] = 'کد پی اچ پی ماژول';
...
$_lang["module_group_access_msg"] = 'گروه های کاربری که مجاز به اجرای این ماژول در بخش مدیریت محتوا هستند را انتخاب کنید.';
...
$_lang["modx_version"] = "ورژن مدایکس شما";
$_lang["monday"] = 'دوشنبه';
$_lang["move"] = 'انتقال';
$_lang["move_document"] = 'انتقال پرونده';
$_lang["move_document_message"] = 'انتقال پرونده و کلیه ی زیر گروه های آن را میتوانید از طریق انتخاب یک سرگروه جدید انجام دهید. اگر شما پرونده ای را انتخاب کنید که هنوز به عنوان محفظه شناخته نمی شو, تبدیل به محفظه خواهد شد. لطفا از طریق درختی روی سرگروه جدید کلیک کنید.';
$_lang["move_document_new_parent"] = 'لطفا سرگروه جدیدی را از درختی پرونده انتخاب کنید.';
$_lang["move_document_title"] = 'انتقال پرونده';
$_lang["name"] = 'نام';
$_lang["new_category"] = 'بخش جدید';
$_lang["new_file_permissions_message"] = 'زمانیکه فایل جدیدی را در بخش مدیریت فایل آپلود میکیند, مدیریت فایل تلاش خواهد کرد اختیارات و سطوح دسترسی به فایل را بر اساس تنظیمات تغییر دهد. این حالت در برخی از سرورهای میزبان فعال نمی شود, همچون آی اس اس, که شما شخصا بایستی اختیارات و سطوح دسترسی فایل ها را تنظیم کنید.';
$_lang["new_file_permissions_title"] = 'اجازه ی دسترسی به فایل جدید :';
$_lang["new_folder_permissions_message"] = 'زمانیکه پوشه ی جدیدی را در بخش مدیریت فایل آپلود میکیند, مدیریت فایل تلاش خواهد کرد اختیارات و سطوح دسترسی به پوشه را بر اساس تنظیمات تغییر دهد. این حالت در برخی از سرورهای میزبان فعال نمی شود, همچون آی اس اس, که شما شخصا بایستی اختیارات و سطوح دسترسی پوشه ها را تنظیم کنید.';
...
$_lang["page_data_contentType_help"] = 'نوع محتوا را برای این پرونده مشخص کنید. اگر از نوع محتوای پرونده خود هنوز مطمئن نیستید آنرا روی تکست/اچ تی ام ال تنظیم کنید';
...
$_lang["page_data_searchable_help"] = 'انتخاب این گزینه پرونده را قابل جستجو می کند. همچنین شما میتوانید از این گزینه برای اهداف دیگری در اسنیپت ها استفاده کنید.';
...
$_lang["password_gen_gen"] = 'انتخاب اتفاقی کلمه ی عبور توسط مدایکس ';
...
$_lang["password_msg"] = 'کلمهی عبور جدید برای <b>%s</b> این است: <b>%s</b>.';
$_lang["php_version_check"] = 'مدایکس تنها بر روی نسخه ی پی اچ پی 4.3.0 و بالاتر اجرا می شود لطفا نسخه ی پی اچ پی خود را ارتقاء دهید';
$_lang["plugin"] = 'پلاگین';
$_lang["plugin_code"] = 'کدهای پلاگین یا پی اچ پی';
...
$_lang["plugin_locked_message"] = 'این پلاگین قفل شده است';
$_lang["plugin_management_msg"] = 'دراینجا میتوانید نوع پلاگین مورد نظر خود را برای اعمال تغییرات در آن انتخاب کنید';
$_lang["plugin_msg"] = 'در اینجا شما میتوانید پلاگینها را ایجاد / ویرایش کنید. پلاگینها در واقع کدهای خام و خالص پی اچ پی هستند که از فراخوانی دستوری مربوط به آن وظیفه ای مشخص در سیستم اعمال میشود';
...
$_lang["resolve_hostnames_message"] = 'آیا شما علاقه ای به تسطیح هاست نیم های بازدیدکنندگان حاضر در وبگاه از سوی مدایکس ؟دارید<br />آیا میخواهید مدایکس تلاشی برای تسطیح هاست نیم های بازدید کنندگان زمانیکه آنها از وبگاه شما بازدید میکنند کند؟ تسطیح هاست نیم ها ممکن است باعث ایجاد بار اضافی روی سرور میزبان شود, اما به هر ترتیب بازدیدکنندگان از این موضوع آگاه نمی شوند.';
$_lang["resolve_hostnames_title"] = 'تصطیح هاست نیم ها';
$_lang["resource"] = 'منبع';
$_lang["resources"] = 'منابع';
$_lang["resource_categories"] = 'نمایش مخلوط';
$_lang["resource_management"] = 'مدیریت منابع';
$_lang["resource_name"] = 'نام منبع';
$_lang["resource_selector_msg"] = 'منابع را از فهرست زیر انتخاب و روی \'وارد کردن\' کلیک کنید.';
$_lang["resource_selector_title"] = 'انتخابگر منبع';
...
$_lang["role_delete_plugin"] = 'حذف پلاگین ها';
...
$_lang["scroll_dn"] = 'هدایت صفحه به پایین';
$_lang["scroll_up"] = 'هدایت صفحه به بالا';
$_lang["search"] = 'جستجو';
...
$_lang["settings_snippets"] = 'اسنیپتها';
...
$_lang["snippets_availabe"] = 'اسنیپت شما برای وارد شدن و استفاده در صفحه آماده شده';
$_lang["snippet_code"] = 'کدخام پی اچ پی اسنیپت';
...
$_lang["snippet_msg"] = 'در اینجا شما میتوانید اسنیپت ها را ایجاد / ویرایش کنید. به خاطر داشته باشید که اسنیپت ها کد های خام پی اچ پی هستند و اگر شما تمایل دارید که خروجی یا نتیجه ی اسنیپت در بخش خاصی از پوسته یا قالب ویگاه شما به نمایش درآید شما بایستی مقدار آنرا در پوسته یا قالب وارد کنید';
...
$_lang["template_code"] = 'کدهای اچ تی ام ال قالب';
$_lang["template_desc"] = 'توضیحات';
$_lang["template_edit_tab"] = 'ویرایش پوسته یا قالب';
$_lang["template_locked_message"] = 'این پوسته یا قالب قفل شده است';
...
$_lang["tmplvar_change_template_msg"] = 'تغییر دادن این قالب یا پوسته باعث میشود صفحه مجددا متغیرهای قالب را بازخوانی کند, و تغییرا ذخیره نشده از دست خواهد رفت.\n\n آیا از تغییر این پوسته یا قالب اطمینان دارید؟';
...
$_lang["udperms_message"] = 'بخش سطوح دسترسی این امکان را به شما میدهد تا تعیین کنید کاربران شما قادر به ویرایش کدامیک از صفحات هستند. شما بایستی کاربران را در گروه های کاربری دسته بندی کنید, پرونده ها را به گروه پرونده ها, و نهایتا بایستی مشخص کنید کدام گروه کاربری دسترسی به کدام گروه پرونده ها را دارد. وقتی که برای اولین بار این گزینه را فعال کنید, فقط مدیران کل مجاز به ویرایش هر پرونده ای خواهند بود.';
...
$_lang["undelete_document"] = 'بازگردانی پرونده از حذفی ها';
$_lang["unpublish_date"] = 'تاریخ تعلیق انتشار';
$_lang["unpublish_document"] = 'تعلیق انتشار پرونده';
$_lang["unpublish_events"] = 'معلق کردن فعالیت ها';
$_lang["untitled_document"] = 'پرونده بدون عنوان';
...
$_lang["user_edit_self_msg"] = 'برای بروز رسانی کامل اطلاعات شما بایستی یک بار از سیستم خارج و مجددا به سیستم بازگردید</b><br>همچنین, میتوانید انتخاب کنید که یک کلمه ی عبور جدید برایتان ارسال شود, کلمه ی عبور جدید شما از طریق پست الکترونیک برای شما ارسال خواهد شد';
...
$_lang["use_alias_path_message"] = 'تنظیم کردن این حالت به  \'بله\' مسیر کامل به پرونده را نمایش میدهد. اگر پرونده همراه آدرس باشد.به عنوان مثال,اگر پرونده در داخل آدرس به این عنوان خوانده شود \'child\' واقع شده باشد در داخلپرونده ی حاوی آن با این آدرس خوانده میشود \'parent\', بنابراین آدرس کامل به پرونده به این صورت نمایش داده خواهد شد \'/parent/child.html\'.<br /><b>تذکر: وقتی که این حالت را \'فعال\' (آدرس دهی را روشن نمایید), آیتمهای مرجع (مثل عکس یا تصویر یا فایلهای سی اس اس و جاوا اسکریپتها و غیره) با اشتفاده از مکان معلوم و مشخص : بعنوان مثال \'/assets/images\' به جای استفاده از \'assets/images\'. با استفاده از این حالت درواقع شما مرورگر یا بازدیدکننده را ببه محل اصلی آن ارجاع میدهید</b>';
$_lang["use_alias_path_title"] = 'آدرس مکانی قابل فهم:';
$_lang["use_editor_message"] = 'آیا شما تمایلی برای فراهم کردن امکان ویرایشگر متون دارید؟,اگر شما راحتی بیشتری برای استفاده از کدهای اچ تی ام ال دارید میتوانید ویرایشگر متون را از طریق همین تنظیمات خاموش کنید توجه داشته باشید که این حالت برای کلیه ی پرونده ها و کلیه ی کاربران لحاظ خواهد شد.';
$_lang["use_editor_title"] = 'استفاده از ویرایشگر:';
$_lang["value"] = 'Value';
$_lang["version_codename"] = "مشخصه و کد ورژن";
$_lang["view"] = 'View';
$_lang["view_document"] = 'نمایش پرونده';
$_lang["view_log"] = 'مرور آمار ثبتی';
$_lang["view_logging"] = 'کاربری مدیر';
$_lang["view_sysinfo"] = 'اطلاعات سیستم';
$_lang["warning"] = 'هشدار!';
$_lang["warning_not_saved"] = 'تغییراتی که انجام گرفته همچنان ذخیره نشده است.شما میتوانید همچنان در همین صفحه بمانید بمنظور ذخیره ی تغییرات (\'بی خیال\'), و یا میتوانید این صفحه را ترک کنید, و کلیه ی تغییرات انجام شده اعمال نشود (\'قبول\')';
$_lang["weblink"] = 'وب لینک';
$_lang["weblink_message"] = 'وب لینک ارجاع دهننده ای است به هر نوع شیء موجود در وب و اینترنت. این شیء میتواند یک پرونده داخل وبگاه شما و یا یک صفحه در وبگاهی دیگر و یا حتی یک عکس یا هر نوع فایلی در اینترنت باشد';
...
$_lang["web_access_permissions_user_group"] = 'گروه های کاربری وب :';
$_lang["web_access_permissions_user_groups"] = 'گروههای کاربری وب';
$_lang["web_access_permissions_user_group_access"] = 'مجموعه پرونده هایی که این گروه کاربری به آن دسترسی  دارند :';
...
$_lang["welcome_title"] = 'به سیستم مدیریت محتوای وبگاه مدایکس خود خوش آمدید';
$_lang["which_editor_message"] = 'در اینجا شما میتوانید "ویرایشگر متن "مورد نظر خود را برای استفاده خود انتخاب کنید. همچنین شما میتوانید ویرایشگر متون مختلفی را در بخش دانلود مدایکس تهیه و نصب کنید';
