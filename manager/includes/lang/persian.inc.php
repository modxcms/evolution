...
$_lang["credits_dTree"] = 'مادایکس از اسکریپت درختی فوق العاده ی ارائه شده در دستروی دراپ استفاده میکند!';
$_lang["credits_everaldo"] = 'مادایکس از تعدادی از نمادها یا آیکونهای سری کریستال اورالدو استفاده میکند. نمادهای زیبایی است.';
$_lang["credits_mysql"] = 'مادایکس از قدرت مای اس کیو ال بهره گرفته است';
$_lang["credits_php"] = 'مادایکس از قدرت PHP بهره گرفته است';
$_lang["credits_shouts_msg"] = '
<ul>
<li><b>Raymond Irving, Ryan Thrash</b> - بنیانگذاران پروژه</li>
<li><b>Jason Coward, Victor Brilon, Adam Crownoble, Jeff Whitfield, Remon Sijrier</b> - طراحی و مهندسی هسته ی مرکزی</li><li><b>Mohsen(MotSmart)</b> - Persian Support, پشتیبانی فارسی</li>
</ul>';
$_lang["credits_shouts_title"] = '<b>با تشکر ویژه از :</b>';
$_lang["credits_webfx"] = 'مادایکس تعدادی از جاوا اسکریپتهای فوق العاده ای که در وب اف ایکس ارائه شده را استفاده کرده است';
...
$_lang["document_opt_richtext_help"] = 'این گزینه را انتخاب کنید تا از ویرایشگر برای ویرایش متون پرونده ها استفاده شود. اگر پرونده های شما حاوی جاوا اسکریپت و فرم ها می باشد, این گزینه را غیر فعال کنید تا در محیط HTML ویرایش کنید و بدین ترتیب ویرایشگر اختلالی در محتوای اصلی شما ایجاد نمی کند.';
...
$_lang["document_overview"] = 'بازخوانی پرونده';
...
$_lang["documents_in_container"] = "پرونده های موجود در این پرونده ی حاوی";
$_lang["documents_in_container_no"] = "این پرونده ی حاوی, هیچ زیر پرونده ای ندارد.";
...
$_lang["login_cancelled_install_in_progress"] = '<span style="font-weight: bold; color: red;">نصب/ارتقاء این وبگاه در حال انجام است. <br />لطفا چند دقیقه دیگر مراجعه کنید!</span><br />';
$_lang["login_cancelled_site_was_updated"] = '<span style="font-weight: bold; color: red;">نصب/ارتقاء وبگاه انجام شد, لطفا دوباره وارد شوید!</span><br />';
...
$_lang["metatag_notice"] = 'در صورت تمایل برای اطلاعات بیشتر میتوانید به مرجع <a href="http://www.html-reference.com/META.htm" target="_blank">راهنمای HTML</a> مراجعه کنید. این لیست کاملی از شاخصای فراهم شده محسوب نمی شود.';
...
$_lang["move_document_message"] = 'انتقال پرونده و کلیه ی زیر گروههای آن را میتوانید از طریق انتخاب یک سرگروه جدید انجام دهید. اگر شما پرونده ای را انتخاب کنید که هنوز به عنوان محفظه شناخته نمی شو, تبدیل به محفظه خواهد شد. لطفا از طریق درختی روی سرگروه جدید کلیک کنید.';
...
$_lang["php_version_check"] = 'مادایکس تنها بر روی نسخه ی PHP 4.3.0 و بالاتر اجرا می شود لطفا نسخه ی PHP خود را ارتقاء دهید';
$_lang["plugin"] = 'پلاگین';
...
$_lang["preview_document"] = 'نمایش پرونده';
...
$_lang["resolve_hostnames_message"] = 'آیا شما علاقه ای به تسطیح هاست نیم های بازدیدکنندگان حاضر در وبگاه از سوی مادایکس ؟دارید<br />آیا میخواهید مادایکس تلاشی برای تسطیح هاست نیم های بازدید کنندگان زمانیکه آنها از وبگاه شما بازدید میکنند کند؟ تسطیح هاست نیم ها ممکن است باعث ایجاد بار اضافی روی سرور میزبان شود, اما به هر ترتیب بازدیدکنندگان از این موضوع آگاه نمی شوند.';
...
$_lang["view"] = 'View';
$_lang["view_child_documents_in_container"] = "مرور پرونده ی زیر دست";
