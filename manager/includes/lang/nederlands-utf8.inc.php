...
$_lang["actioncomplete"] = '<b>De bewerking is succesvol uitgevoerd!</b><br /> - Een moment geduld a.u.b. '.CMS_NAME.' is bezig met opschonen.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' kan niet naar de cache Map schrijven. '.CMS_NAME.' blijft normaal functioneren, maar er zal geen caching plaatsvinden. Om dit probleem op te lossen dient u de /_cache/ Map schrijfrechten te geven.';
...
$_lang["configcheck_installer_msg"] = 'De \'/install\'-Map bevat de installer voor '.CMS_NAME.'. Probeert u eens in te denken wat een vervelend persoon zou kunnen doen als hij de installer zou vinden! We raden u aan om de \'install\'-Map van uw server te verwijderen, om zo uw website veilig te houden.';
...
$_lang["export_site_maxtime_message"] = 'Specificeer hoeveel seconden '.CMS_NAME.' mag spenderen aan het exporteren van de website, onafhankelijk van de PHP instelling. Geef 0 in voor een onbeperkt aantal seconden. Let op dat 0 of een erg hoog nummer rare dingen kan veroorzaken op uw webserver en dat dit daarom niet aanbevolen is.';
$_lang["export_site_message"] = '<p>Gebruik dit om de volledige website te exporteren naar HTML bestanden. Daardoor verliest u dan wel een heel aantal voordelen van '.CMS_NAME.':</p><ul><li>Bezoekersstatistieken worden NIET meer bijgehouden.</li><li>Interactieve Snippets werken niet meer.</li><li>Enkel gewone Pagina\'s worden ge&euml;xporteerd, gelinkte Pagina\'s niet.</li><li>Het exporteren kan mislukken indien uw Pagina\'s Snippets bevatten die \'redirection headers\' sturen.</li><li>Afhankelijk van hoe uw Pagina\'s, style sheets en Afbeeldingen werden gemaakt, kan de layout van uw website wijzigen. Om dit op te lossen kunt u de ge&euml;xporteerde bestanden verhuizen naar de Map waar de basis '.CMS_NAME.' index.php staat.</li></ul><p>Vul het formulier in en klik op \'Start export\'. De bestanden zullen bewaard worden op de plaats die u opgeeft. Waar mogelijk zal het bestand als naam de alias van de Pagina krijgen. Daarom is het beter om in de '.CMS_NAME.' configuratie de optie \'zoekmachine vriendelijke URL\'s\' aan te zetten. De export kan een tijdje duren, afhankelijk van de grootte van uw website.</p><p><em>Bestaande bestanden met dezelfde naam worden overschreven!</em></p>';
...
$_lang["file_folder_chmod_error"] = 'Wijzigen toegangsrechten mislukt. U dient de toegangsrechten buiten '.CMS_NAME.' om aan te passen.';
...
$_lang["filemanager_path_message"] = 'IIS kan het pad naar de '.CMS_NAME.' installatie dikwijls niet vinden. Dit pad wordt gebruikt door het bestandsbeheer om te bepalen wat u te zien krijgt. Indien u problemen ondervindt met het bestandsbeheer, controleer dan of dit pad juist staat.';
$_lang["filemanager_path_title"] = 'Pad naar de '.CMS_NAME.' installatie:';
...
$_lang["language_message"] = 'U kunt hier de taal voor het '.CMS_NAME.' Content Management Systeem selecteren.';
...
$_lang["loading_page"] = 'Een moment geduld a.u.b., '.CMS_NAME.' is de Pagina aan het laden...';
...
$_lang["login_message"] = 'Om '.CMS_NAME.' te gebruiken dient u zich eerst aan te melden. Let op: hierbij wordt onderscheid gemaakt tussen hoofd- en kleine letters!';
$_lang["logo_slogan"] = CMS_NAME.' Content Management Systeem - \nCre&#235;er en doe meer met minder';
...
$_lang["modx_news"] = CMS_NAME.' nieuws waarschuwingen';
$_lang["modx_news_tab"] = CMS_NAME.' nieuws';
$_lang["modx_news_title"] = CMS_NAME.' nieuws';
$_lang["modx_security_notices"] = CMS_NAME.' beveiligingswaarschuwingen';
$_lang["modx_version"] = CMS_NAME.' versie';
...
$_lang["password_gen_gen"] = 'Laat '.CMS_NAME.' het wachtwoord genereren.';
...
$_lang["php_version_check"] = CMS_NAME.' is geschikt voor PHP versie 4.0.3 en hoger. U dient uw PHP distributie te upgraden!';
...
$_lang["rb_base_dir_message"] = 'Het fysieke pad naar de Map met bestanden. Normaal gesproken wordt dit automatisch gegenereerd. Helaas komt het bij het gebruik van IIS voor dat '.CMS_NAME.' niet in staat is om het pad automatisch te genereren. In dat geval kan hier het pad naar de Map worden opgegeven (dit is het pad dat u ziet in Windows Verkenner). <b>NB:</b> Voor een juiste werking van het bestandsbeheer moet de hier opgegeven Map de volgende submappen bevatten: images, files, flash en media.';
$_lang["rb_base_dir_title"] = 'Pad naar de bestanden:';
$_lang["rb_base_url_message"] = 'Het virtuele pad naar de bestanden. Normaal gesproken wordt dit automatisch gegenereerd. Helaas komt het bij het gebruik van IIS voor dat '.CMS_NAME.' niet in staat is om het pad automatisch te genereren. In dat geval kan hier het pad naar de Map worden opgegeven (dit is het pad dat u ziet in uw web browser)';
...
$_lang["resource_opt_emptycache_help"] = 'Laat dit aangevinkt zodat '.CMS_NAME.' de cache leegmaakt na het opslaan van de Pagina. Dit zorgt ervoor dat uw bezoekers geen oude versie van de Pagina te zien krijgen.';
$_lang["resource_opt_folder"] = 'Map?';
$_lang["resource_opt_folder_help"] = 'U kunt deze optie aanvinken om deze Pagina als een Map voor andere Pagina\'s te gebruiken. U hoeft hier niet te veel aandacht aan te besteden, aangezien '.CMS_NAME.' Mapinstellingen over het algemeen automatisch verzorgt.';
...
$_lang["rss_url_news_message"] = 'Geef hier de URL voor de '.CMS_NAME.' Nieuws Feed.';
$_lang["rss_url_news_title"] = 'RSS Nieuws Feed:';
$_lang["rss_url_security_default"] = 'http://feeds.feedburner.com/modxsecurity';
$_lang["rss_url_security_message"] = 'Geef hier de URL voor de '.CMS_NAME.' Beveiligings Feed.';
...
$_lang["settings_strip_image_paths_message"] = 'Als dit op \'Nee\' is gezet zal '.CMS_NAME.' de locaties van Afbeeldingen / Bestanden / Flash e.d. uit de bestandsbeheer browser omzetten naar absolute paden. Relatieve URL\'s zijn handig als u uw '.CMS_NAME.' installatie wilt verhuizen van bijvoorbeeld een test naar productie website. Als u geen idee heeft wat dit betekend laat u deze optie het beste op \'Ja\' staan.';
...
$_lang["webpwdreminder_message"] = 'Hier kunt u de boodschap instellen die naar uw Gebruikers verstuurd wordt als zij een nieuw wachtwoord aanvragen per e-mail. '.CMS_NAME.' zal een e-mail sturen met het nieuwe wachtwoord en activerings informatie.<br /><br /><b>NB:</b> De volgende codes worden door '.CMS_NAME.' vervangen als het bericht verstuurd wordt: <br /><br /> [+sname+] - Naam van uw website, <br />[+saddr+] - E-mail adres van uw website, <br />[+surl+] - Adres van de website, <br />[+uid+] - Aanmeld naam of id, <br />[+pwd+] - Wachtwoord, <br />[+ufn+] - Volledige naam. <br /><br /><b>Laat de [+uid+] en [+pwd+] codes in de e-mail staan, omdat de Gebruikersnaam en het wachtwoord anders niet in de e-mail komen te staan en uw Gebruikers daardoor hun aanmeldgevens niet ontvangen!</b>';
$_lang["webpwdreminder_title"] = 'Herinnerings e-mail:<br />(Webgebruiker)';
$_lang["websignupemail_message"] = 'Hier kunt u de boodschap instellen die naar uw Gebruikers verstuurd wordt wanneer u voor hen een webaccount heeft aangemaakt en '.CMS_NAME.' een e-mail laat sturen met hun Gebruikersnaam en wachtwoord. <br /><br /><b>NB:</b> De volgende codes worden door '.CMS_NAME.' vervangen als het bericht verstuurd wordt: <br /><br /> [+sname+] - Naam van uw website, <br />[+saddr+] - E-mail adres van uw website, <br />[+surl+] - Adres van de website, <br />[+uid+] - Aanmeld naam of id, <br />[+pwd+] - Wachtwoord, <br />[+ufn+] - Volledige naam. <br /><br /><b>Laat de [+uid+] en [+pwd+] codes in de e-mail staan, omdat de Gebruikersnaam en het wachtwoord anders niet in de e-mail komen te staan en uw Gebruikers daardoor hun aanmeldgegevens niet ontvangen!</b>';
...
$_lang["welcome_title"] = 'Welkom bij uw '.CMS_NAME.' Content Management Systeem';
$_lang["which_editor_message"] = 'Hier kiest u welke teksteditor u wenst te gebruiken. TinyMCE en FCKeditor werken goed maar zijn nog niet uitgebreid getest met '.CMS_NAME.'. Xihna (gabaseerd op HTMLArea) is minder geschikt voor strikte, op CCS gebaseerde ontwerpen, maar heeft meer functies.';
$_lang["which_editor_title"] = 'Kies uw teksteditor:';
$_lang["working"] = 'Wordt verwerkt...';
$_lang["wrap_lines"] = 'Regels afbreken';
$_lang["xhtml_urls_message"] = 'Vervangt ampersand (&amp;) tekens in urls die zijn gegenereerd door '.CMS_NAME.' met de validerende &amp;<!-- -->amp; html entiteit';
