...
$_lang["access_permissions_add_document_group"] = 'Maak een nieuwe Paginagroep';
...
$_lang["access_permissions_document_groups"] = 'Paginagroepen';
$_lang["access_permissions_documents_in_group"] = '<b>Pagina\'s in deze groep:</b> ';
$_lang["access_permissions_documents_tab"] = 'Bekijk hier de Paginagroepen. U kunt ook nieuwe groepen maken, bestaande bewerken of verwijderen of nagaan welke Pagina deel uitmaakt van een groep. Door met de muis over de ID van de Pagina te bewegen, ziet u de naam ervan. Door de Pagina te bewerken kunt u de groepsrechten wijzigen.';
...
$_lang["add_document"] = 'Nieuwe Pagina';
...
$_lang["confirm_delete_document"] = 'Weet u zeker dat u deze Pagina wilt verwijderen?\nDan worden tevens alle Subpagina\'s verwijderd.';
...
$_lang["create_document_here"] = 'Nieuwe Pagina';
...
$_lang["delete_document"] = 'Verwijder Pagina';
...
$_lang["document_alias"] = 'Pagina alias';
$_lang["document_alias_help"] = 'Hier kunt u voor deze Pagina een alias invoeren. Dit zal de Pagina toegangelijk maken als u gebruik maakt van http://uwsite.nl/alias. Dit werkt alleen als u gebruik maakt van zoekmachine vriendelijke URL\'s.';
$_lang["document_content"] = 'Paginainhoud';
$_lang["document_description"] = 'Beschrijving';
$_lang["document_description_help"] = 'Geef een eventuele beschrijving op van deze Pagina.';
$_lang["document_long_title_help"] = 'Geef een langere titel op van deze Pagina. Dit kan handig zijn voor zoekmachines en is misschien ook een betere beschrijving van uw Pagina.';
$_lang["document_metatag_help"] = 'Selecteer de \'META tags\' of keywords die u aan de Pagina wilt toekennen. Met de CTRL-toets (cmd in Mac OS) kunnen meerdere META tags worden geselecteerd';
$_lang["document_opt_contentdispo"] = 'Content-Disposition';
$_lang["document_opt_contentdispo_help"] = 'Gebruik \'Content-Disposition\' om aan te geven hoe de Pagina wordt behandeld door de webbrowser. Gebruik \'Bijlage\' voor separate bestanden.';
$_lang["document_opt_emptycache"] = 'Cache leegmaken?';
$_lang["document_opt_emptycache_help"] = 'Laat dit aangevinkt zodat MODx de cache leegmaakt na het opslaan van de Pagina. Dit zorgt ervoor dat uw bezoekers geen oude versie van de Pagina te zien krijgen.';
$_lang["document_opt_folder"] = 'Map?';
$_lang["document_opt_folder_help"] = 'U kunt deze optie aanvinken om deze Pagina als een Map voor andere Pagina\'s te gebruiken. U hoeft hier niet te veel aandacht aan te besteden, aangezien MODx Mapinstellingen over het algemeen automatisch verzorgt.';
$_lang["document_opt_menu_index"] = 'Menu index';
$_lang["document_opt_menu_index_help"] = 'De menu-index is een veld waarmee u het sorteren van Pagina\'s kunt be&iuml;nvloeden, voornamelijk in menu\'s en opsommingen. U kunt het ook voor andere doeleinden gebruiken in uw Snippets.';
$_lang["document_opt_menu_title"] = 'Menu titel';
$_lang["document_opt_menu_title_help"] = 'De menu titel is een optioneel veld dat gebruikt wordt om een korte titel te tonen in menu Snippet(s) of Modules.';
$_lang["document_opt_published"] = 'Gepubliceerd?';
$_lang["document_opt_published_help"] = 'Vink deze optie aan zodat uw Pagina automatisch gepubliceerd wordt na het opslaan.';
...
$_lang["document_opt_show_menu_help"] = 'Gebruikt door een aantal Plug-ins/Modules om deze Pagina niet te tonen in een menu.';
$_lang["document_opt_trackvisit_help"] = 'Sla elke bezoeker op deze Pagina op in het logboek.';
$_lang["document_overview"] = 'Pagina overzicht';
$_lang["document_parent"] = 'Hoofdpagina';
$_lang["document_parent_help"] = 'Selecteer een Pagina in de Website boomstructuur om het als Hoofdpagina van deze Pagina in te stellen.';
$_lang["document_permissions_error"] = 'Koppel deze Pagina aan tenminste 1 Paginagroep waar u toegang tot heeft.';
$_lang["document_setting"] = 'Pagina instellingen';
$_lang["document_summary"] = 'Samenvatting (introductietekst)';
$_lang["document_summary_help"] = 'Typ een korte beschrijving van de Pagina.';
$_lang["document_title"] = 'Titel';
$_lang["document_title_help"] = 'U kunt hier de titel van de Pagina opgeven. Vermijdt het gebruik van backslashes in de naam!';
$_lang["document_to_be_moved"] = 'De te verplaatsen Pagina';
$_lang["document_weblink_help"] = 'Typ hier het adres van het object waarnaar u wilt verwijzen met deze Weblink.';
$_lang["documents_in_container"] = 'Pagina\'s in deze Map';
$_lang["documents_in_container_no"] = 'Deze Map bevat geen Subpagina\'s.';
...
$_lang["duplicate_document"] = 'Dupliceer Pagina';
...
$_lang["edit"] = 'Bewerk';
$_lang["edit_document"] = 'Bewerk Pagina';
$_lang["edit_document_title"] = 'Maak/wijzig Pagina';
...
$_lang["import_files_found"] = '<b>%s Pagina\'s gevonden om te importeren...</b><p />';
...
$_lang["import_parent_document"] = 'Hoofdpagina:';
...
$_lang["move_document"] = 'Verplaats Pagina';
$_lang["move_document_message"] = 'Verplaats een Pagina inclusief Subpagina\'s door een nieuw Hoofdpagina in de Website boomstructuur te selecteren. Als de geselecteerde Pagina geen Map is, wordt er een Map van gemaakt. Selecteer een nieuw Hoofdpagina in de Website boomstructuur.';
$_lang["move_document_new_parent"] = 'Selecteer een nieuwe Hoofdpagina in de Website boomstructuur.';
$_lang["move_document_title"] = 'Pagina verplaatsen';
$_lang["name"] = 'Naam';
...
$_lang["preview_document"] = 'Pagina voorbeeld';
...
$_lang["resource_management"] = 'Elementen beheren';
$_lang["resource_name"] = 'Element naam';
$_lang["resource_selector_msg"] = 'Selecteer de Element(en) uit onderstaande lijst en klik op de knop \'Toevoegen\'.';
$_lang["resource_selector_title"] = 'Selecteer een Element';
$_lang["resources"] = 'Elementen';
$_lang["role"] = 'Rol';
...
$_lang["undelete_document"] = 'Herstel Pagina';
$_lang["unpublish_date"] = 'Niet-publiceren datum';
$_lang["unpublish_document"] = 'Publicatie Pagina ongedaan maken';
$_lang["unpublish_events"] = 'Niet-publiceren gebeurtenissen';
$_lang["untitled_document"] = 'Naamloze Pagina';
...
$_lang["view"] = 'Bekijken';
$_lang["view_child_documents_in_container"] = 'Bekijk Subpagina\'s in Map';
