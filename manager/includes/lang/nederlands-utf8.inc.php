...
$_lang["session_timeout_msg"] = "MODX zal de server eens per minuut pingen voor een update. Als de laatste ping deze instelling overschrijdt, wordt de bijbehorende sessie ongeldig beschouwd en alle gerelateerde blokkeringen automatisch verwijderd. Stel waarde in minuten (> 2 min, standaard 15 min).";
