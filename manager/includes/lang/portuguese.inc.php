 ...
 * Encoding:			Western-European (ISO) - iso-8859-1
...
$_lang["access_permission_parent_denied"] = 'Não tem permissão para criar um documento aqui!';
$_lang["account_email"] = 'E-mail da conta';
...
$_lang["add_template"] = 'Adicionar Modelo (template)';
$_lang["add_tv"] = 'Adicionar variável de Modelo (template) (TV)';
...
$_lang["confirm_delete_template"] = 'De certeza que deseja apagar este Modelo (template)?';
...
$_lang["confirm_remove_locks"] = 'Por vezes os utilizadores fecham os seus navegadores enquanto criam ou editam alguns documentos, Modelos (templates), Snippets ou parsers, possivelmente deixando items bloqueados. Pressionando OK, remove TODOS os bloqueios.\n\nDeseja continuar?';
...
$_lang["defaulttemplate_message"] = 'Seleccione o Modelo (template) padrão que deseja utilizar em novos documentos. Pode seleccionar um Modelo diferente no editor de documentos. Esta opção apenas selecciona o Modelo a utilizar por defeito.';
$_lang["defaulttemplate_title"] = 'Modelo (template) Padrão';
$_lang["delete"] = 'Apagar';
...
$_lang["deselect_metatags"] = 'Limpar eqtiquetas (tags) META';
...
$_lang["files_dirwritable"] = 'Directório com permissão de escrita?';
...
$_lang["lock_template"] = 'Bloquear Modelo (template) contra edição';
...
$_lang["manage_templates"] = 'Modelos (Templates)';
...
$_lang["new_template"] = 'Nove Modelo (template)';
...
$_lang["page_data_template"] = 'Usa Modelo (template)';
$_lang["page_data_template_help"] = 'Aqui pode seleccionar qual o Modelo (template) que o documento utiliza.';
...
$_lang["role_create_template"] = 'Criar novos Modelos (templates) para o site';
...
$_lang["role_delete_template"] = 'Apagar Modelos (templates)';
...
$_lang["role_edit_template"] = 'Editar Modelos (templates)';
...
$_lang["role_save_template"] = 'Guardar Modelos (templates)';
...
$_lang["role_template_management"] = 'Gestão de Modelos (templates)';
...
$_lang["snippet_msg"] = 'Aqui pode adicionar ou editar Snippets. Atenção que os Snippets são código PHP \'em bruto\': se espera que o resultado de um Snippet seja mostrado a uma certo ponto num Modelo (template), é necessário que um valor seja devolvido a partir do Snippet.';
...
$_lang["table_hoverinfo"] = 'Passe o cursor do rato sobre o nome da tabela para ver uma curta descrição da função da tabela (nem todas as tabelas tê <i>comentários activos</i>).';
$_lang["table_prefix"] = 'Prefixo da Tabela';
$_lang["tag"] = 'Etiqueta (Tag)';
$_lang["template"] = 'Modelo (template)';
$_lang["template_assignedtv_tab"] = 'Variáveis de Template atribuídas';
$_lang["template_code"] = 'Código HTML do Modelo (template)';
$_lang["template_desc"] = 'Descrição';
$_lang["template_edit_tab"] = 'Editar Modelo (template)';
...
$_lang["template_msg"] = 'Criar e editar Modelos (templates). Modelos novos ou modificados não serão visíveis nas páginas em cache até que esta seja esvaziada, no entanto pode usar a função de pré-visualização na página para ver o Modelo em acção.';
$_lang["template_name"] = 'Nome do Modelo (template)';
$_lang["template_no_tv"] = 'Ainda não foi atribuída nenhuma Variável de Template a este Modelo.';
$_lang["template_reset_all"] = 'Aplicar o Modelo (template) padrão a todas as páginas';
$_lang["template_reset_specific"] = 'Aplicar apenas às páginas que usam o Modelo %s';
$_lang["template_title"] = 'Criar/editar Modelo (template)';
...
$_lang["tmplvars_msg"] = 'Adicionar ou editar Variáveis de Template. Estas deverão ser atribuídas aos Modelos (templates) para que sejam acessíveis pelos Snippets e Documentos.';
...
$_lang["tmplvar_tmpl_access"] = 'Acesso a Modelos (templates)';
$_lang["tmplvar_tmpl_access_msg"] = 'Seleccione que Modelos (templates) têm permissão para aceder e/ou processar esta variável';
$_lang["to"] = 'para';
...
$_lang["total"] = 'total';
$_lang["track_visitors_message"] = 'Esta opção não tem nenhum efeito a menos que exista um recurso de seguimento de visitantes (tracking) ou de estatísticas instalado e que suporte esta opçã. Fazer um relatório de visitas permite analisar estatísticas sobre a utilização do site.';
