...
$_lang["configcheck_configinc_msg"] = 'Gente mal intencionada poderá eventualmente afectar seriamente o site e tudo o que lhe estiver associado. <strong>A sério.</strong> Por favor desligue as permissões de escrita no ficheiro de configuração (/assets/config.inc.php)!';
