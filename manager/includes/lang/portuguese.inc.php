<?php
/**
 * Filename:       includes/lang/portuguese.inc.php
...
$_lang["actioncomplete"] = '<b>Acção concluída!</b><br /> - Por favor aguarde enquanto o '.CMS_NAME.' refresca a página.';
...
$_lang["configcheck_cache_msg"] = 'O sistema '.CMS_NAME.' não pode escrever o directório de cache. O sistema '.CMS_NAME.' continuará a funcionar como esperado, mas a cache não estará activa. Para resolver isto, active a permissão de escrita no directório da cache (/_cache/).';
...
$_lang["filemanager_path_message"] = 'Frequentemente, o IIS não interpreta correctamente a opção document_root utilizada pelo Gestor de Ficheiros para determinar o que o utilizador pode ver. Se tiver problemas ao usar o Gestor de Ficheiros, certifique-se de que este caminho aponta para a raiz da instalação do sistema '.CMS_NAME.'.';
...
$_lang["language_message"] = 'Seleccione em que idioma deseja utilizar o Gestor de Conteúdos '.CMS_NAME.'.';
...
$_lang["php_version_check"] = 'O '.CMS_NAME.' é compatível com PHP versão 4.0.3 ou superior. Por favor actualize a sua instalação de PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["resource_opt_emptycache_help"] = 'Deixando este campo marcado o '.CMS_NAME.' irá apagar a cache sempre que gravar este documento. Isto é importante para que os seus visitantes não vejam versões desactualizadas do documento.';
$_lang["resource_opt_folder"] = 'É Pasta?';
$_lang["resource_opt_folder_help"] = 'Seleccione aqui para usar o documento como pasta para outros documentos. Não precisa de se preocupar muito com isto, pois o '.CMS_NAME.' geralmente encarrega-se das configurações da pasta automaticamente.';
...
$_lang["tree_show_protected_message"] = 'Quando marcado como "Não", as Páginas Protegidas (e todos os documentos seus descendentes) não aparecem na árvore de documentos. "Não" é a opção por defeito do '.CMS_NAME.' para compatibilidade com versões antigas.';
