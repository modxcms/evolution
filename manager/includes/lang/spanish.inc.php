...
$_lang["actioncomplete"] = '<b>¡La acción fue completada satisfactoriamente!</b><br /> - Por favor, espera mientras '.CMS_NAME.' hace limpieza.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' no puede escribir en el directorio cache. '.CMS_NAME.' continuará funcionando como es esperado, pero no realizará ningún cache. Para solucionar esto, haz el directorio /_cache/ escribible.';
...
$_lang["configcheck_installer_msg"] = 'El directorio install/ contiene el instalador de '.CMS_NAME.'. Sólo imagina lo que puede pasar si una persona maligna encuentra esta carpeta y ¡ejecuta el instalador!  Probablemente no llegue muy lejos, porque deberá ingresar cierta información de usuario para la base de datos, pero es mejor borrar esta carpeta de tu servidor.';
...
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' es administrado y mantenido en <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMX.com</a>.</p>';
...
$_lang["file_folder_chmod_error"] = 'No es posible cambiar los permisos, necesitarás cambiar los permisos fuera de '.CMS_NAME.'.';
...
$_lang["friendly_alias_message"] = 'Si estás utilizando URLs amigables, y el documento tiene un alias, el alias siempre tiene preferencia sobre la URL amigable.  Configurando esta opción a \'si\', el prefijo y sufijo de URL amigable también será aplicado al alias.  Por ejemplo, si tu documento con ID 1 tiene un alias de `introducción`, y has configurado un prefijo de `` y un sufijo de `.html`, configurando esta opción a `si` generará `introduccion.html`.  Si no hay un alias, '.CMS_NAME.' generará `1.html` como enlace.';
$_lang["friendly_alias_title"] = 'Utilizar alias amigables:';
$_lang["friendlyurls_message"] = 'Esto te permite usar URLs amigables para los buscadores con '.CMS_NAME.'.  Favor de notar, que esto sólo funciona en instalaciones '.CMS_NAME.' corriendo sobre Apache, y que deberás escribir un archivo .htaccess para que esto funcione.  Ve el archivo .htaccess incluido en la distribución para más información.';
...
$_lang["language_message"] = 'Seleccione el idioma para el Administrador de Contenido de '.CMS_NAME.'.';
...
$_lang["loading_page"] = 'Por favor espera mientras '.CMS_NAME.' carga la página...';
...
$_lang["logo_slogan"] = 'Administrador de Contenido '.CMS_NAME.' - \nCrea y haz más con menos';
$_lang["logout"] = 'Salir';
...
$_lang["modx_news"] ='Noticias de '.CMS_NAME;
$_lang["modx_news_tab"] ='Noticias de '.CMS_NAME;
$_lang["modx_news_title"] ='Noticias de '.CMS_NAME;
$_lang["modx_security_notices"] ='Notas de Seguridad de '.CMS_NAME;
$_lang["modx_version"] = "Versión de '.CMS_NAME.'";
$_lang["monday"] = 'Lunes';
$_lang["move"] = 'Mover';
...
$_lang["password_gen_gen"] = 'Deja que '.CMS_NAME.' genere una contraseña.';
...
$_lang["php_version_check"] = CMS_NAME.' es compatible con PHP Versión 4.0.3 y superior.  Por favor ¡actualiza tu instalación de PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["resource_opt_emptycache_help"] = 'Dejando marcado este campo hará que '.CMS_NAME.' vacíe el cache después de que guardes el documento. De esta forma tus visitantes no verán una versión vieja del documento.';
...
$_lang["rss_url_news_message"] = 'Ingresa el URL del Feed de Noticias de '.CMS_NAME.'.';
$_lang["rss_url_news_title"] = 'Feed RSS de Noticias';
$_lang["rss_url_security_default"] = 'http://feeds.feedburner.com/modxsecurity';
$_lang["rss_url_security_message"] = 'Ingresa el URL para el Feed de Seguridad '.CMS_NAME.'.';
...
$_lang["settings_strip_image_paths_message"] = 'Si esto está configurado \'No\', '.CMS_NAME.' escribirá las fuentes del navegador de archivos (imágenes, archivos, flash, etc.) como URLs absolutas.  Las URLs relativas son de ayuda si deseas mover tu instalación de '.CMS_NAME.', p.ej. de un servidor de trabajo a uno de producción.  Si no tienes idea de qué significa esto, será mejor lo dejes seleccionado en \'Si\'.';
...
$_lang["tree_show_protected_message"] = 'Si configurado a "No", las Páginas Protegidas (y todos sus documentos hijos) no aparecen en el árbol de documentos. "No" es la configuración anterior de '.CMS_NAME.'.';
...
$_lang["welcome_title"] = 'Bienvenido a tu Administrador de Contenido '.CMS_NAME;
$_lang["which_editor_message"] = 'Selecciona el editor de texto formateado.  Puedes descargar e instalar editores de texto formateado adicionales desde la página de descargas de '.CMS_NAME.'.';
$_lang["which_editor_title"] = 'Editor a usar:';
$_lang["working"] = 'Trabajando...';
$_lang["wrap_lines"] = 'Encapsular líneas (wrap)';
$_lang["xhtml_urls_message"] = 'Reemplaza los signos & (&amp;) en los URLs generados por '.CMS_NAME.' con el htmlentity &amp<!-- -->amp; que es XHTML válido.';
