...
$_lang["actioncomplete"] = '<b>¡La acción fue completada satisfactoriamente!</b><br /> - Por favor, espera mientras MODx hace limpieza.';
...
$_lang["charset_message"] = 'Por favor, selecciona qué codificación de caracteres deseas utilizar en el Admin.  Por favor nota que MODx ha sido probado con un buen número de estas codificación, pero no con todas ellas. Para la mayoría de los idiomas, la configuración prefijada a UTF-8 es la preferible.';
...
$_lang["configcheck_cache_msg"] = 'MODx no puede escribir en el directorio cache. MODx continuará funcionando como es esperado, pero no realizará ningún cache. Para solucionar esto, haz el directorio /_cache/ escribible.';
$_lang["configcheck_configinc"] = 'El archivo de configuración todavía es escribible';
$_lang["configcheck_configinc_msg"] = 'Personas muy malintencionadas podrían potencialmente probocar algunos problemas en tu sitio y todo lo asociado con él. <strong>En serio.</strong> Por favor ¡Haz tu archivo de configuración  (/manager/includes/config.inc.php) de sólo lectura!';
...
$_lang["configcheck_installer_msg"] = 'El directorio install/ contiene el instalador de MODx. Sólo imagina lo que puede pasar si una persona maligna encuentra esta carpeta y ¡ejecuta el instalador!  Probablemente no llegue muy lejos, porque deberá ingresar cierta información de usuario para la base de datos, pero es mejor borrar esta carpeta de tu servidor.';
...
$_lang["confirm_delete_document"] = '¿Estás segura de que quieres borrar este documento?\nCualquier documento hijo también será borrado.';
...
$_lang["confirm_duplicate_document"] = '¿Estás segura de que quieres duplicar este documento? Cualquier artículo que contenga también será duplicado.';
...
$_lang["credits_dTree"] = '¡MODx utiliza el excelente programa dTree de DestroyDrop.com!';
$_lang["credits_everaldo"] = 'MODx usa algunos de los iconos del conjunto  Crystal de Everaldo. ¡Iconos estupendos!';
$_lang["credits_mysql"] = '¡MODx opera con MySQL!';
$_lang["credits_php"] = '¡MODx opera con PHP!';
...
$_lang["database_tables"] = 'Conjunto de Caracteres de Compaginación de la BD';
...
$_lang["document_alias_help"] = 'Configura el alias del URL para hacer el documento accesible como http://ejemplo.com/alias.  Esto sólo funciona si los URLs amigables están habilitados en la configuración del sitio.';
$_lang["document_content"] = 'Contenido del documento';
$_lang["document_description"] = 'Descripción';
$_lang["document_description_help"] = 'Puedes escribir una descripción opcional del documento.';
$_lang["document_long_title_help"] = 'Escribe un título más largo para tu documento.  Esto es bueno para los buscadores, y puede ser más descriptivo para tu documento.';
$_lang["document_metatag_help"] = 'Selecciona las etiquetas META o palabras clave que desea asignar a este documento. Mantén presionada la tecla CTRL para seleccionar múltiples palabras clave o etiquetas META.';
$_lang["document_opt_contentdispo"] = 'Disposición del contenido';
$_lang["document_opt_contentdispo_help"] = 'Usa el campo de disposición del contenido para especificar cómo debe ser manejado este documento por el navegador. Para descarga de archivos selecciona la opción de Adjunto.';
$_lang["document_opt_emptycache"] = '¿Vaciar Cache?';
$_lang["document_opt_emptycache_help"] = 'Dejando marcado este campo hará que MODx vacíe el cache después de que guardes el documento. De esta forma tus visitantes no verán una versión vieja del documento.';
$_lang["document_opt_folder"] = '¿Contenedor?';
$_lang["document_opt_folder_help"] = 'Selecciona esto para hacer que el documento también actúe como un contenedor de otros documentos. Un \'contenedor\' es como una carpeta, sólo que también puede tener contenido.';
$_lang["document_opt_menu_index"] = 'Indice del menú';
$_lang["document_opt_menu_index_help"] = 'El Indice del menú es un campo que puedes usar para ordenar los documentos en tus snippet(s) de menú. También puedes usarlo para cualquier otro propósito en tus snippets.';
$_lang["document_opt_menu_title"] = 'Título del menú';
$_lang["document_opt_menu_title_help"] = 'El Título del menú es un campo que puedes usar para mostrar un título corto para el documento dentro de tus snippet(s) de menú o módulos.';
$_lang["document_opt_published"] = '¿Publicado?';
$_lang["document_opt_published_help"] = 'Selecciona este campo para publicar el documento inmediatamente después de guardarlo.';
$_lang["document_opt_richtext"] = '¿Texto Formateado?';
$_lang["document_opt_richtext_help"] = 'Deja este campo seleccionado para utilizar el editor de texto formateado para editar documentos. Si tus documentos contienen JavaScript y formas, deselecciona esto para editarlos en modo HTML y así el editor no deshace tus documentos.';
$_lang["document_opt_show_menu"] = 'Mostrar en menú';
$_lang["document_opt_show_menu_help"] = 'Selecciona esta opción para mostrar el documento dentro de un menú web. Por favor nota que algunos constructores de menús pueden elegir ignorar esta opción.';
$_lang["document_opt_trackvisit_help"] = 'Registrar cada visita del visitante a esta página';
$_lang["document_overview"] = 'Vista general del documento';
$_lang["document_parent"] = 'Padre del documento';
$_lang["document_parent_help"] = 'Haz clic en el icono de arriba para habilitar (o deshabilitar) seleccionar el padre de este documento. Luego, haz clic en un documento del árbol para seleccionar su nuevo padre.';
...
$_lang["document_title_help"] = 'Escribe aquí el nombre/título del documento. ¡Trata de evitar el uso de barras diagonales en el nombre!';
$_lang["document_to_be_moved"] = 'Documento a mover';
$_lang["document_weblink_help"] = 'Escribe la dirección del objeto que deseas referenciar con este enlace web aquí.';
...
$_lang["file_folder_chmod_error"] = 'No es posible cambiar los permisos, necesitarás cambiar los permisos fuera de MODx.';
...
$_lang["files_title"] = 'Navegador de archivos';
...
$_lang["guid"] = 'GUID';
$_lang["help"] = 'Ayuda';
$_lang["help_msg"] = '<p>Puede obtener soporte gratuito de la comunidad <a href="http://modxcms.com/forums" target="_blank">visitando los foros de MODx</a>.  También hay un cumulo creciente de <a href="http://modxcms.com/documentation" target="_blank">Documentación y Guías MODx</a> que tocan virtualmente todos los aspectos de MODx.</p><p>Estamos planeando ofrecer servicios de soporte comercial para MODx. Por favor, <a href="mailto:modx@vertexworks.com?subject=MODx Commercial Support Inquiry">envíenos un mensaje si está interesado</a>.';
...
$_lang["insert_snippet"] = 'Insertar snippet en el documento';
...
$_lang["loading_page"] = 'Por favor espera mientras MODx carga la página...';
...
$_lang["login_cancelled_install_in_progress"] = '<span style="font-weight: bold; color: red;">Este sitio está en el proceso de instalación/actualización. <br />¡Favor de volver a intentarlo en un par de minutos!.</span><br />';
$_lang["login_cancelled_site_was_updated"] = '<span style="font-weight: bold; color: red;">Se acaba de ejecutar una instalación/actualización de este sitio. Favor de volver a entrar.</span><br />';
...
$_lang["manager_direction_title"] = 'Dirección del texto del Admin:';
...
$_lang["move_document_message"] = 'Puedes mover el documento y todos sus hijos seleccionando un nuevo padre en el árbol.  Si seleccionas un documento que no es un contenedor, será combiado a uno.  Por favor, haz clic en el nuevo padre en el árbol.';
$_lang["move_document_new_parent"] = 'Por favor selecciona un nuevo padre en el árbol de documentos.';
...
$_lang["password_gen_gen"] = 'Deja que MODx genere una contraseña.';
...
$_lang["php_version_check"] = 'MODx es compatible con PHP Versión 4.0.3 y superior.  Por favor ¡actualiza tu instalación de PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["resolve_hostnames_message"] = '¿Quieres que MODx intente traducir los nombres de hospedaje de tus visitantes cuando visiten tu sitio? Traducir los nombres de hospedaje puede crear una carga extra en el servidor, aunque  tus visitantes no lo notarán de ninguna manera.';
...
$_lang["resource_selector_msg"] = 'Selecciona el o los Elemento(s) de la lista aquí abajo y haz clic en el botón \'Insertar\'.';
...
$_lang["settings_strip_image_paths_message"] = 'Si esto está configurado \'No\', MODx escribirá las fuentes del navegador de archivos (imágenes, archivos, flash, etc.) como URLs absolutas.  Las URLs relativas son de ayuda si deseas mover tu instalación de MODx, p.ej. de un servidor de trabajo a uno de producción.  Si no tienes idea de qué significa esto, será mejor lo dejes seleccionado en \'Si\'.';
...
$_lang["snippets_availabe"] = 'Snippets disponibles para incluir en tu página';
...
$_lang["tree_show_protected_message"] = 'Si configurado a "No", las Páginas Protegidas (y todos sus documentos hijos) no aparecen en el árbol de documentos. "No" es la configuración anterior de MODx.';
...
$_lang["user_edit_self_msg"] = 'Necesitas cerrar la sesión e iniciarla nuevamente después de actualizar completamente tu información.</b><br>También, si eliges generar una contraseña nueva para tí, te será enviada en un email.';
...
$_lang["value"] = 'Valor';
$_lang["version_codename"] = "Nombre del código de la Versión";
$_lang["view"] = 'Ver';
...
$_lang["weblink_message"] = 'Un enlace web es una referencia a un objeto en Internet. Este puede ser un documento dentro de MODx, una página en otro sitio o una imagen u otro archivo en la Internet.';
...
$_lang["which_editor_message"] = 'Selecciona el editor de texto formateado.  Puedes descargar e instalar editores de texto formateado adicionales desde la página de descargas de MODx.';
$_lang["which_editor_title"] = 'Editor a usar:';
$_lang["working"] = 'Trabajando...';
$_lang["wrap_lines"] = 'Encapsular líneas (wrap)';
$_lang["xhtml_urls_message"] = 'Reemplaza los signos & (&amp;) en los URLs generados por MODx con el htmlentity &amp<!-- -->amp; que es XHTML válido.';
