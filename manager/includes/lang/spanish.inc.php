...
$_lang["access_permissions_add_document_group"] = 'Crear a new document group';
...
$_lang["access_permissions_document_groups"] = 'Grupo de documentos';
...
$_lang["actioncomplete"] = '<b>!La acción fue realizada correctamente!</b><br /> - Por favor espera mientras MODx limpia.';
...
$_lang["bk_manager"] = 'Administrador de respaldos';
...
$_lang["change_password"] = 'Cambiar clave';
...
$_lang["charset_message"] = 'Please select which character encoding you wish to use in the manager. Please note that MODx has been tested with a number of these encodings, but not all of them. For most languages, the default setting of ISO-8859-1 suffices.';
...
$_lang["confirm_delete_keywords"] = '¿Estas seguro que quieres borrar estas palabras clave?';
$_lang["confirm_delete_module"] = '¿Estas seguro que quieres borrar este modulo?';
$_lang["confirm_delete_plugin"] = '¿Estas seguro que quieres borrar este plugin?';
...
$_lang["create_folder_here"] = 'Crear un folder aquí';
...
$_lang["custom_contenttype_message"] = 'Here you can add custom content types to be used in your documents. To add a new entr, enter the content type in the textbox then click the \'Add\' button.';
...
$_lang["defaulttemplate_title"] = 'Plantilla por defecto';
$_lang["delete"] = 'Borrar';
...
$_lang["document_opt_emptycache"] = '¿Borrar cache?';
...
$_lang["document_opt_menu_title"] = 'Titulo del menú';
...
$_lang["document_setting"] = 'Parametros del documento';
$_lang["document_summary"] = 'Sumario (introtext)';
$_lang["document_summary_help"] = 'Type a brief summary of the document';
$_lang["document_title"] = 'Titulo';
...
$_lang["editor_css_path_message"] = 'Enter the path to your CSS file that you wish to use within the editor. The best way to enter the path is to enter the path from the root of your server, for example: /assets/site/style.css. If you do not wish to load a stylesheet into the editor, leave this field blank.';
...
$_lang["edit_settings"] = 'Configurar el sistema';
$_lang["email"] = 'Email';
...
$_lang["empty_folder"] = 'Este folder esta vacio';
...
$_lang["eventlog_msg"] = 'The event log is used to display information, warning and error messages generated by the content manager. The \'source\' column shows the section of the content manager where the message occured.';
...
$_lang["export_site"] = 'Exportar sito';
...
$_lang["functionnotimpl"] = '!Disculpa!';
$_lang["functionnotimpl_message"] = 'Esta función todavía no a sido implementada has not been implemented yet.';
$_lang["group_access_permissions"] = 'User group access';
$_lang["guid"] = 'GUID';
$_lang["help"] = 'Ayuda';
$_lang["help_msg"] = 'If you need help using MODx, your best bet is to visit the <a href=\'http://www.vertexworks.com/forums\' target=\'_blank\'>MODx Forums</a>. Also, the tutorials which contains some documentation about using MODx or how to set it up, the answer you\'re looking for might be there. If not, post your question in the forums, and We\'ll answer as soon as we can.';
$_lang["help_title"] = 'Ayuda';
$_lang["hide_tree"] = 'Hide tree';
$_lang["home"] = 'Inicio';
$_lang["htmlsnippet_desc"] = 'Descripciónn';
$_lang["htmlsnippet_management_msg"] = 'Here you can select which chunk you wish to edit.';
$_lang["htmlsnippet_msg"] = 'Aquí puede añadir o editar chunks. Recuerda, los chunks son codigo HTML, así que cualquier codigo php no se procesara.';
...
$_lang["import_site"] = 'Importar sito';
...
$_lang["language_message"] = 'Seleccionar el idioma.';
...
$_lang["loading_doc_tree"] = 'Llamando menú del documento...';
...
$_lang["login_message"] = 'Por favor pon tu datos para entrar a el area de administración. El usuario y clave son case-sensitive, ponlos con cuidado!';
$_lang["logout"] = 'Logout';
$_lang["logo_slogan"] = 'Create and do more with less - 
MODx Content Manager';
$_lang["long_title"] = 'Titulo largo';
$_lang["manager"] = 'Manager';
$_lang["manager_permissions"] = 'Administrador de permisos';
$_lang["manager_theme"] = 'Manager Theme:';
$_lang["manager_theme_message"] = 'Seleccionar el tema para el administrador de contenido.';
$_lang["manage_depends"] = 'Manage Dependencies';
$_lang["manage_files"] = 'Manejar archivos';
$_lang["manage_htmlsnippets"] = 'Chunks';
$_lang["manage_metatags"] = 'Manage META tags and Keywords';
$_lang["manage_modules"] = 'Administración de modulos';
$_lang["manage_plugins"] = 'Plugins';
$_lang["manage_snippets"] = 'Snippets';
$_lang["manage_templates"] = 'Plantillas';
$_lang["messages"] = 'Mensajes';
$_lang["messages_all"] = 'A todo mundo';
...
$_lang["messages_message"] = 'Mesaje';
$_lang["messages_not_allowed_to_read"] = '!No tienes permiso para leer este mensaje!';
$_lang["messages_no_messages"] = 'Ningun mensaje en el Inbox.';
$_lang["messages_private"] = 'Privado';
$_lang["messages_read_message"] = 'Leer mensaje';
$_lang["messages_reply"] = 'Responder';
$_lang["messages_select_group"] = 'Seleccionar grupo';
$_lang["messages_select_user"] = 'Seleccionar usuario';
$_lang["messages_send"] = 'Mandar';
$_lang["messages_send_to"] = 'Mandar a';
$_lang["messages_sent"] = 'Mandar a';
$_lang["messages_subject"] = 'Tema';
$_lang["messages_system_user"] = '[System]';
$_lang["messages_title"] = 'Mensaje';
$_lang["messages_user"] = 'Un usuario';
$_lang["metatags"] = 'META tags';
$_lang["metatags_and_keywords"] = 'META tags and Palabras clave';
...
$_lang["meta_keywords"] = 'META Palabras clave';
...
$_lang["module_disabled"] = 'Modulo desavilitado';
...
$_lang["module_management"] = 'Administración de modulos';
...
$_lang["module_msg"] = 'En esta sección puedes añador o editar los modulos. Un modulo es una colleción de recursos (ejemplo. plugins, snippets, etc).';
...
$_lang["module_title"] = 'Crear/ editar Modulo';
...
$_lang["move_document_title"] = 'Movee document';
$_lang["name"] = 'Name';
$_lang["new_category"] = 'New Category';
$_lang["new_htmlsnippet"] = 'Nuevo chunk';
$_lang["new_keyword"] = 'Añadir nueva palabra clave:';
...
$_lang["nomessages_title"] = 'Numero de mensajes:';
$_lang["none"] = 'None';
$_lang["noresults_message"] = 'Enter the number of results to show in the datagrid when viewing listings and search results.';
$_lang["noresults_title"] = 'Numero de resultados:';
$_lang["notset"] = 'No asignado';
...
$_lang["no_keywords_found"] = 'Actualmente no existen palabras clave.';
...
$_lang["page_data_cacheable"] = 'Poner en cache';
...
$_lang["page_data_editor"] = 'Editar usando editor rich text';
$_lang["page_data_folder"] = 'El documento es un folder';
$_lang["page_data_general"] = 'General';
$_lang["page_data_markup"] = 'Markup/ structure';
$_lang["page_data_mgr_access"] = 'Manager access';
$_lang["page_data_notcached"] = 'Este documento todavía no a sido puesto en el cache.';
$_lang["page_data_publishdate"] = 'Inicio de publicación';
...
$_lang["page_data_searchable"] = 'Para buscar';
...
$_lang["page_data_template"] = 'Plantilla usada';
$_lang["page_data_template_help"] = 'Here you can select which template the document uses.';
$_lang["page_data_title"] = 'Información de la pagina';
$_lang["page_data_unpublishdate"] = 'Fin de publicación';
...
$_lang["page_data_unpublished"] = 'Sin publicar';
...
$_lang["resource_management"] = 'Administración de recursos';
...
$_lang["role_credits"] = 'Ver creditos';
...
$_lang["role_edit_settings"] = 'Cambiar parametros del sitio';
$_lang["role_edit_snippet"] = 'Edit snippets';
$_lang["role_edit_template"] = 'Edit site templates';
$_lang["role_edit_user"] = 'Editar usuario';
$_lang["role_edit_web_user"] = 'Editar usuario web';
...
$_lang["role_help"] = 'Ver pagina de ayuda';
...
$_lang["role_new_module"] = 'Crear nuevo modulo';
...
$_lang["role_run_module"] = 'Correr modulo';
$_lang["role_save_doc"] = 'Salvar documentos';
$_lang["role_save_module"] = 'Salvar modulo';
$_lang["role_save_password"] = 'Salvar clave';
...
$_lang["role_save_user"] = 'Salvar usuarios';
$_lang["role_save_web_user"] = 'Salvar usuarios web';
$_lang["role_snippet_management"] = 'Snippet management';
$_lang["role_template_management"] = 'Template management';
$_lang["role_title"] = 'Crear/ editar role';
...
$_lang["saturday"] = 'Sabado';
$_lang["save"] = 'Salvar';
$_lang["save_all_changes"] = 'Salvar todos los cambios';
...
$_lang["search_criteria_content"] = 'Buscar por content';
...
$_lang["search_criteria_longtitle"] = 'Buscar por titulo largo';
$_lang["search_criteria_longtitle_msg"] = 'Find all documents with the entered text in their long title.';
$_lang["search_criteria_title"] = 'Buscar por titulo';
$_lang["search_criteria_title_msg"] = 'Find all documents with the entered text in their title.';
$_lang["search_empty"] = 'Tu búsqueda no tuvo ningun resultado. Por favor amplia el criterio de búsqueda e intena de nuevo.';
...
$_lang["settings_misc"] = 'Parametros extras';
$_lang["settings_page_settings"] = 'Parametros de la pagina';
$_lang["settings_photo"] = 'Fotografía';
$_lang["settings_properties"] = 'Propiedades';
$_lang["settings_site"] = 'Parametros del sitio';
...
$_lang["settings_title"] = 'Configuración del sistema';
$_lang["settings_ui"] = 'Parametros de Interfaz y editor';
$_lang["settings_users"] = 'Parametros de usuario';
...
$_lang["site"] = 'Sitio';
$_lang["sitename_message"] = 'Aquí pon el nombre de tu sitio.';
...
$_lang["site_schedule"] = 'Horario del sitio';
...
$_lang["snippet_management_msg"] = 'En esta sección puedes escoger que snippet quieres editar.';
...
$_lang["template_management_msg"] = 'En esta sección puedes escoger que plantilla quieres editar.';
...
$_lang["tmplvars_binding_msg"] = 'This field supports datasource bindings using the @ commands';
...
$_lang["track_visitors_title"] = 'Log de visitas';
...
$_lang["unauthorizedpage_title"] = 'Pagina no autorizada:';
...
$_lang["user_email"] = 'Correo electronico';
...
$_lang["user_management_title"] = 'Administrar usuarios';
...
$_lang["weblink_message"] = 'Un weblink es una referencia a un objeto en internet. This could be a document within MODx, a page on another site or an image or other file on the internet.<p>';
...
$_lang["web_access_permissions"] = 'Permiso de acceso web';
...
$_lang["web_user_management_msg"] = 'Aqui puedes editar usuarios web. Los usuarios web son los que solo pueden logearse en el sitio sin entrar a el administrador';
$_lang["web_user_management_title"] = 'Manejar usuarios web';
$_lang["web_user_title"] = 'Crear/ editar usuario web';
$_lang["wednesday"] = 'Miercoles';
$_lang["welcome_messages"] = 'Tu Inbox contiene <b>%d</b> mensaje(s), de los cuales <b>%s</b> no han sido leidos.';
$_lang["welcome_title"] = 'Benvenido a MODx administrador de contenido';
$_lang["which_editor_message"] = 'Here you can select which rich text editor you wish to use. You can download abd install additional RichText editors from the MODx download page.';
$_lang["which_editor_title"] = 'Editor to use:';
$_lang["working"] = 'Procesando...';
...
$_lang["you_got_mail"] = 'Tienes un correo';
?>
