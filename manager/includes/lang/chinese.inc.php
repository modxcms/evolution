...
$_lang["configcheck_configinc_msg"] = '可能会有不怀好意的人通过它破坏网站. <strong>真的.</strong> 请将您的 config文件(/[+MGR_DIR+]/includes/config.inc.php) 设置为只读!';
...
$_lang["guid"] = '唯一标识符';
$_lang["help"] = '关于';
$_lang["help_msg"] = '<p>您可以在这里寻求支持：<a href="http://modx.com" target="_blank">访问镆铘网站</a>或者<a href="http://www.changkong.org" target="_blank">访问镆铘汉化者的网站</a>.如果您有兴趣， <a href="mailto:rerbin@gmail.com?subject=镆铘中文支持">可以写信给我们</a>.';
$_lang["help_title"] = '关于';
...
$_lang["php_version_check"] = '镆铘兼容PHP 5.0.0 和更高的版本，请升级PHP版本！';
$_lang["plugin"] = '插件';
...
$_lang["which_editor_message"] = '您可以在这里选择您要使用哪一个编辑器。您可以在<a href="http://modx.com" target="_blank">镆铘网站</a>下载文本编辑器。';
