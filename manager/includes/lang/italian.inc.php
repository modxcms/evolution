...
$_lang["access_permissions_link_to_group"] = 'al Gruppo Documenti';
$_lang["access_permissions_links"] = 'Collegamenti gruppi utente/documento';
$_lang["access_permissions_links_tab"] = 'Qui potete specificare a quali gruppi utente &egrave; permesso l\'accesso ai gruppi documento (ad es.: possono modificare o creare documenti figlio). Per collegare un gruppo documento a un gruppo utente, selezionatelo dalla lista a tendina, e cliccate su \'Aggiungi gruppo\'. Per rimuovere il collegamento ad un certo gruppo premete \'Rimuovi ->\'. Il collegamento sar&agrave; immediatamente eliminato.';
...
$_lang["allow_mgr_access_message"] = 'Selezionate questa opzione per abilitare o disabilitare ad accedere alla interfaccia di ammnistrazione. <b>NOTA: Se questa opzione &egrave; attiva, gli utenti verranno ridiretti alla Interfaccia di amministrazione o alla pagina di inizio del sito.</b>';
...
$_lang["already_deleted"] = '&egrave; stato gi&agrave; eliminato.';
$_lang["attachment"] = 'Allegato';
$_lang["automatic_alias_message"] = 'Selezionate \'Si\' affinch&egrave; il sistema, al momento del salvataggio, generi automaticamente un alias basato sul titolo del documento.';
...
$_lang["blocked_minutes_message"] = 'Qui potete inserire per quanti minuti un utente sar&agrave; bloccato dopo aver oltrepassato il limite concesso di login errati. Solo la cifra, senza punti o virgole.';
...
$_lang["configcheck_cache_msg"] = 'MODx non pu&ograve; scrivere nella cartella cache. MODx continuer&agrave; a funzionare come previsto, ma non avverr&agrave; nessuna operazione di caching. Per risolvere, rendete la cartella /_cache/ scrivibile.';
$_lang["configcheck_configinc"] = 'Il file di configurazione (/manager/includes/config.inc.php) &egrave; ancora scrivibile';
$_lang["configcheck_configinc_msg"] = 'Malintenzionati potrebbero combinare guai sul vostro sito e tutto ci&ograve; che &egrave; collegato ad esso. <strong>Sul serio.</strong> Per favore impostate il file di configurazione (/manager/includes/config.inc.php) in sola lettura!';
...
$_lang["configcheck_errorpage_unpublished"] = 'La pagina di Errore del vostro sito non &egrave; stata pubblicata oppure &egrave; insesistente.';
$_lang["configcheck_errorpage_unpublished_msg"] = 'Ci&ograve; significa che la pagina di Errore &egrave; inaccessibile da parte del pubblico. Pubblicate la pagina o fate in modo che sia assegnata ad un documento esistente nella struttura ramificata del vostro sio nel menu Strumenti e Configurazione.';
...
$_lang["configcheck_notok"] = 'Uno o pi&ugrave; dettagli di configurazione non riportano un controllo OK: ';
...
$_lang["configcheck_unauthorizedpage_unavailable"] = 'La pagina Non Autorizzato del vostro sito non &egrave; stata pubblicata o &egrave; insesistente';
...
$_lang["confirm_delete_file"] = 'Siete sicuri di voler eliminare il file?\n\nQuesto potrebbe impedire al sito di funzionare regolarmente! Eliminatelo solo se avete la certezza che ci&ograve; che state facendo non pregiudica nulla.';
...
$_lang["confirm_remove_locks"] = 'Gli utenti a volte chiudono il browser mentre stanno modificando documenti, template, snippet o parser, lasciando con ogni probabilita\' tali oggetti in stato di blocco. Premendo OK potete rimuovere TUTTI i blocchi attualmente presenti.\n\nProcedere?';
...
$_lang["database_overhead"] = '<b style=\'color:#990033\'>Note:</b> L\'Overhead &egrave; spazio inutilizzato riservato da MySQL. Per liberare questo spazio, cliccate sulla cifra overhead della tabella.';
...
$_lang["defaultcache_message"] = 'Selezionate \'si\' se volete che tutti i nuovi documenti siano salvati in cache di default.';
...
$_lang["defaultpublish_message"] = 'Selezionate \'si\' se volete che tutti i nuovi documenti siano pubblicati di default.';
$_lang["defaultpublish_title"] = 'Pubblicato di default';
$_lang["defaultsearch_message"] = 'Selezionate \'si\' se volete che tutti i nuovi documenti siano ricercabili di default.';
$_lang["defaultsearch_title"] = 'Ricercabile di default';
$_lang["defaulttemplate_message"] = 'Selezionate il template di default che desiderate usare per i nuovi documenti. Potete sempre selezionarne uno diverso nell\'editor di documenti, questa impostazione semplicemente ne preseleziona uno per voi.';
...
$_lang["document_alias_help"] = 'Qui potete inserire un alias per il documento. Questo render&agrave; il documento accessibile usando:\n\nhttp://vostroserver/alias\n\nFunziona solo se state usando le URL semplici.';
...
$_lang["document_long_title_help"] = 'Qui potete inserire un titolo esteso per il documento. Questo &egrave; utile per i motori di ricerca e potrebbe essere maggiormente descrittivo per il documento.';
$_lang["document_metatag_help"] = 'Selezionate i META tag e le parole chiave che volete assegnare al documento. Tenete premuto il tasto control per selezionare pi&ugrave; tag o parole.';
$_lang["document_opt_contentdispo"] = 'Pubblicazione del contenuto';
$_lang["document_opt_contentdispo_help"] = 'Utilizzate il campo pubblicazione contenuto per impostare come il browser avr&agrave; accesso al contenuto del documento. Per file da scaricare selezionare come opzione Allegato.';
$_lang["document_opt_emptycache"] = 'Svuota cache?';
$_lang["document_opt_emptycache_help"] = 'Lasciando questo campo selezionato permetterete a MODx di svuotare la cache dopo che avrete salvato il documento. Cos&igrave; i visitatori non vedranno pi&ugrave; la vecchia versione del documento.';
...
$_lang["document_opt_menu_index_help"] = 'Indice menu &egrave; un campo che potete usare per ordinare i documenti nel menu snippet. Potete anche usare il campo per altri scopi nei tuoi snippet.';
$_lang["document_opt_menu_title"] = 'Titolo nel menu';
$_lang["document_opt_menu_title_help"] = 'Il titolo nel menu &egrave; un campo che potete usare per visualizzare un titolo abbreviato per il documento all\'interno di menu snippet o moduli.';
...
$_lang["document_opt_richtext_help"] = 'Lasciate selezionata questa casella se volete usare l\'editor rich text per modificare i documenti. Se i documenti contengono JavaScripts e moduli, deselezionatela e modificateli in modalit&agrave; HTML evitando cos&igrave; che l\'editor ne comprometta il contenuto.';
...
$_lang["duplicate_alias_found"] = 'Il documento \'%s\' utilizza gi&agrave; l\'alias \'%s\'. Inserire un altro alias.';
$_lang["duplicate_alias_message"] = 'Qui potete impostare \'si\' per permettere gli alias duplicati. <b>NOTA: Questa opzione deve essere usata con l\'opzione \'Percorso URL semplici\' attiva per evitare problemi di riferimenti ai documenti.</b>';
...
$_lang["enable_sharedparams_msg"] = '<b>NOTE:</b> L\'id globalmente unico (GUID) sar&agrave; usato per identificare unicamente questo modulo e i suoi parametri condivisi. Il GUID &egrave; anche utilizzato per formare un collegamento tra il modulo ed i plugin o snippet che accedono ai suoi parametri condivisi. ';
$_lang["error"] = 'Errore';
$_lang["errorpage_message"] = 'Inserite l\'ID del documento da mostrare agli utenti che hanno richiesto un documento che in realt&agrave; potrebbe non esistere. <b>NOTA: assicuratevi che l\'ID inserito appartenga a un documento esistente e che sia stato pubblicato!</b>';
...
$_lang["export_site_target_unwritable"] = 'La cartella target non &egrave; scrivibile. Per favore assicuratevi che la cartella sia scrivibile, quindi riprovate.';
$_lang["export_site_time"] = 'Esportazione terminata. L\'operazione &egrave; stata completata in %s secondi.';
$_lang["failed_login_message"] = 'Qui potete inserire il numero delle volte che &egrave; concesso sbagliare l\'autenticazione prima che l\'account venga bloccato.';
...
$_lang["friendlyurlsprefix_message"] = 'Qui potete specificare il prefisso da usare con le URL semplici. Ad esempio, un prefisso impostato su \'pagina\' trasformer&agrave; l\'URL /index.php?id=2 nell\'URL semplice /pagina2.html (assumendo che il suffisso sia impostato su .html). In questo modo potete specificare cosa gli utenti (e i motori di ricerca) vedranno come collegamenti nel sito.';
$_lang["friendlyurlsprefix_title"] = 'Prefisso per le URL semplici:';
$_lang["friendlyurlsuffix_message"] = 'Qui potete specificare il suffisso delle URL semplici. Specificando \'.html\' sar&agrave; aggiunto .html a tutti le URL semplici.';
...
$_lang["htmlsnippet_msg"] = 'Qui potete aggiungere/ modificare i chunk. Ricorda, i chunk sono codice HTML \'raw\' (grezzo), quindi qualsiasi codice PHP non verr&agrave; processato.';
$_lang["htmlsnippet_name"] = 'Nome chunk';
$_lang["htmlsnippet_title"] = 'Crea/ modifica chunk';
$_lang["icon"] = 'Icona';
$_lang["id"] = 'ID';
$_lang["illegal_parent_child"] = 'Assegnazione parentela:\n\nIl documento &egrave; un sottodocumento del documento selezionato.';
$_lang["illegal_parent_self"] = 'Assegnazione parentela:\n\nIl documento selezionato non pu&ograve; essere assegnato a se stesso.';
...
$_lang["import_site_maxtime_message"] = 'Qui potete specificare il numero di secondi che il sistema di gestione dei contenuti impiega per importare il sito (ignorando le impostazioni PHP). Inserite  0 per un tempo illimitato. Attenzione, un\'impostazione 0 o molto alta pu&ograve; causare un timeout del server, quindi non &egrave; raccomandato.';
...
$_lang["mgrlog_query_msg"] = 'Per vedere i log, fate una selezione. Potete selezionare un intervallo di date, ma ricordate che le date che immettete non sono entrambe incluse. Ad esempio per selezionare tutti i dati di log del giorno 1 gennaio 2007, impostate \'Data iniziale\' su 01-01-2007 e \'Data finale\' su 02-01-2007.<br /><br />
Messaggio ed azione sono in genere coincidenti. Se state cercando un messaggio specifico, &egrave; meglio impostare l\'azione su \'Qualunque/tutti\'.';
...
$_lang["module_edit_click_title"] = 'Cliccate qui per editare il modulo';
...
$_lang["module_msg"] = 'qui potete creare o modificare i Moduli. Un Modulo &egrave; un insieme di risorse che interagiscono (es. plugin, snippet, ecc).';
...
$_lang["move_document_message"] = 'Potete spostare un documento e tutti i suoi sottodocumenti selezionando un nuovo genitore nella struttura ramificata. Se selezionate un documento che non &egrave; una cartella, esso sar&agrave; trasformato in cartella. Per favore, cliccate sul nuovo documento genitore nella struttura ramificata dei documenti.';
...
$_lang["page_data_folder"] = 'Il documento &egrave; una cartella';
...
$_lang["page_data_notcached"] = 'Questo documento non &egrave; stato (ancora) inserito nella cache.';
$_lang["page_data_publishdate"] = 'Data di pubblicazione';
$_lang["page_data_publishdate_help"] = 'Se impostate una data di pubblicazione, il documento sar&agrave; pubblicato alla data prescelta. Cliccate sull\'icona del calendario per selezionare una data di pubblicazione o sull\'icona a fianco per rimuoverla. Con questo sistema, il documento non verr&agrave; mai pubblicato automaticamente.';
...
$_lang["page_data_unpublishdate_help"] = 'Se impostate una data di ritiro, il documento sar&agrave; ritirato alla data prescelta. Cliccate sull\'icona del calendario per selezionare una data di ritiro o sull\'icona a fianco per rimuoverla. Con questo sistema, il documento non verr&agrave; mai ritirato automaticamente.';
...
$_lang["resolve_hostnames_message"] = 'Volete che MODx provi a risolvere i nomi host dei visitatori quando visitano il sito? La risoluzione dei nomi host pu&ograve; generare un carico supplementare per il server anche se i visitatori non lo noteranno in alcun modo.';
...
$_lang["role_empty_trash"] = 'Elimina in modo permanente i documenti cancellati';
...
$_lang["rss_url_news_message"] = 'Inserire l\'URL per il News Feed Modx.';
$_lang["rss_url_news_title"] = 'RSS News Feed';
$_lang["rss_url_security_message"] = 'Inserire l\' URL per il Security Feed Modx.';
...
$_lang["search_results_returned_msg"] = 'I criteri di ricerca hanno restituito <b>%s</b> documenti. Se i risultati sono molti, provate con una ricerca pi&ugrave; specifica. Le due colonne pi&ugrave; a sinistra permettono di trovare il documento nella struttura ramificata o di visualizzarlo. Le due colonne pi&ugrave; a destra mostrano, rispettivamente, se un documento &egrave; stato eliminato e qual\'&egrave; il suo stato di pubblicazione.<p />';
...
$_lang["settings_after_install"] = 'Dato che questa &egrave; una nuova installazione, vi si richiede di controllare queste impostazioni e di cambiare quelle che desiderate. Dopo aver controllato le impostazioni, premete \'Salva\' per aggiornarne il database delle impostazioni.<br /><br />';
...
$_lang["sitestatus_message"] = 'Seleziona \'Online\' per pubblicare il sito sul web. Se selezioni \'Offline\', i visitatori vedranno il messaggio \'Sito non disponibile\' e non potranno consultarlo.';
...
$_lang["siteunavailable_page_message"] = 'Inserite l\'ID che volete mostrare quando il sito &egrave; offline. <b>NOTA: assicuratevi che l\'ID appartenga ad un documento esistente, e che sia stato pubblicato!</b>';
...
$_lang["tmplvar_change_template_msg"] = 'Cambiando questo template, verr&agrave; ricaricata la Variabile di Template. Tutte le modifiche non salvate verranno perse.\n\n Siete sicuri di voler modificare il template?';
...
$_lang["tree_show_protected_message"] = 'Se impostato "No", Le pagine protette (e tutte le pagine figlie) non appariranno nell\'albero dei documenti. "No" &egrave; l\'impostazione di default di MODx.';
...
$_lang["unauthorizedpage_message"] = 'Digitate l\'Id del documento che volete mostrare agli utenti che hanno richiesto un documento protetto o non autorizzato. <b>NOTE: assicuratevi che il documento indicato esista, sia pubblicato e accessibile all\'utente!</b>';
...
$_lang["user_zip"] = 'CAP';
$_lang["use_alias_path_message"] = 'Impostando questa opzione su \'si\' verr&agrave; mostrato il percorso completo al documento, se il documento ha un alias. Ad esempio, se un documento con un alias \'figlio\' si trova nella cartella con alias \'genitore\', il percorso dell\'alias sar&agrave; \'/genitore/figlio.html\'.<br /><b>NOTA: Impostando questa opzione su \'si\' (attivando il percorso alias), dovete far riferimento a file (come immagini, css, javascript, etc) usando il percorso assoluto:  ad esempio, \'/assets/images\' anzich&egrave; \'assets/images\'. In questo modo impedirete al browser (o web server) di collegare il percorso relativo al percorso dell\'alias.</b>';
$_lang["use_alias_path_title"] = 'Usa i percorsi semplici dell\'alias:';
$_lang["use_editor_message"] = 'Volete abilitare l\'editor rich text? Se reputate pi&ugrave; confortevole scrivere in HTML, con questa impostazione potete disabilitarlo. Da notare che le impostazioni si applicano a tutti i documenti e a tutti gli utenti!';
$_lang["use_editor_title"] = 'Abilita editor:';
$_lang["validate_referer_title"] = 'Validare HTTP_REFERER headers?';
$_lang["validate_referer_message"] = 'Validare gli headers HTTP_REFERER per ridurre il rischio che gli editors di contenuti possano essere vittime di un attacco CSRF (Cross Site Request Forgery). Alcune configurazioni possono non essere in grado di gestire questa opzione se il server non invia gli headers HTTP_REFERER.';
$_lang["value"] = 'Valore';
...
$_lang["weblink_message"] = 'Un link web &egrave; un collegamento ad un oggetto su Internet. Questo oggetto pu&ograve; essere un documento interno a MODx, una pagina su un altro sito o un\'immagine od altro file su internet.';
