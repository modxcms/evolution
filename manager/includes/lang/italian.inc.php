...
$_lang["about_msg"] = 'MODX &egrave; un <a href="http://modx.com/" target="_blank">framework PHP e un sistema di gestione dei contenuti (CMS)</a> su licenza <a href="../assets/docs/license.txt">GNU GPL</a>.';
...
$_lang["configcheck_configinc"] = 'Il file di configurazione (/[+MGR_DIR+]/includes/config.inc.php) &egrave; ancora scrivibile';
$_lang["configcheck_configinc_msg"] = 'Malintenzionati potrebbero combinare guai sul vostro sito e tutto ci&ograve; che &egrave; collegato ad esso. <strong>Sul serio.</strong> Impostate il file di configurazione (/[+MGR_DIR+]/includes/config.inc.php) in sola lettura!';
...
$_lang["credits_shouts_msg"] = '<p>MODX &egrave; gestito e mantenuto su <a href="http://modx.com/" target="_blank">modx.com</a>.</p>';
...
$_lang["guid"] = 'GUID';
$_lang["help"] = 'Aiuto';
$_lang["help_msg"] = '<p>Se avete bisogno di aiuto nell\'utilizzo di MODX, vi consigliamo di visitare i <a href=\'http://forums.modx.com\' target=\'_blank\'>Forum MODX</a>. Inoltre, il sito MODX contiene tutta la <a href=\"http://modx.com/documentation\" target=\"_blank\">documentazione</a> riguardo l\'uso di MODX o su come configurarlo, la risposta che state cercando potrebbe essere qui.</p><p>Prevediamo anche di offrire servizi di supporto di tipo commerciale per MODX. Se siete interessati, <a href=\"mailto:modx@vertexworks.com?subject=MODX Commercial Support Inquiry\">inviateci un messaggio email</a>.';
...
$_lang["thumbWidth"] = 'Larghezza massima miniatura';
$_lang["thumbHeight"] = 'Altezza massima miniatura';
$_lang["thumbsDir"] = 'Posizione della cartella miniatura';
$_lang["jpegQuality"] = 'Compressione JPEG';
$_lang["denyZipDownload"] = 'Disabilita il download degli archivi zip';
$_lang["denyExtensionRename"] = 'Disabilita la ridenominazione delle estensioni dei file';
$_lang["maxImageWidth_message"] = 'Se la risoluzione dell\'immagine caricata supera questa impostazione verr&agrave; automaticamente ridimensionata. Impostare 0 per disabilitare.';
$_lang["maxImageHeight_message"] = 'Se la risoluzione dell\'immagine caricata supera questa impostazione verr&agrave; automaticamente ridimensionata. Impostare 0 per disabilitare.';
$_lang["thumbWidth_message"] = 'Larghezza massima miniatura.';
$_lang["thumbHeight_message"] = 'Altezza massima miniatura.';
$_lang["thumbsDir_message"] = 'Il nome della cartella delle anteprime.';
$_lang["jpegQuality_message"] = 'Qualit&agrave; della compressione JPEG delle miniature ridimensionate';
$_lang["showHiddenFiles"] = 'Mostra i file nascosti nel browser';
...
$_lang["php_version_check"] = 'MODX &egrave; compatibile con PHP versione 5.0.0 o superiore. Si prega di aggiornare l\'installazione di PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["bkmgr_snapshot_ok"] = 'L\'istantanea &egrave; stata salvata normalmente.';
...
$_lang["bkmgr_snapshot_title"] = 'Salvataggio e recupero istantanea';
$_lang["bkmgr_snapshot_msg"] = '<p>I Contenuti del database vengono salvati e ripristinati su un server.<br />Destinazione di salvataggio : [+snapshot_path+] ($modx->config[\'snapshot_path\'])</p>';
$_lang["bkmgr_snapshot_submit"] = 'Aggiungi istantanea';
