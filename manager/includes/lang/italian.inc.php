...
$_lang["about_msg"] = CMS_NAME.' &egrave; un <a href="http://'.CMS_DOMAIN.'" target="_blank">framework PHP e un sistema di gestione dei contenuti (CMS)</a> su licenza <a href="../assets/docs/license.txt">GNU GPL</a>.';
$_lang["about_title"] = 'Cos\'&egrave; '.CMS_NAME;
...
$_lang["actioncomplete"] = '<b>Azione completata con successo!</b><br />Vi preghiamo di attendere che '.CMS_NAME.' ripulisca.';
...
$_lang["charset_message"] = 'Selezionate la codifica caratteri che intendete usare nel manager. Da notare che '.CMS_NAME.' &egrave; stato testato con numerose codifiche, ma non con tutte. Per la maggior parte delle lingue, la codifica ISO-8859-1 impostata di default &egrave; sufficiente.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' non pu&ograve; scrivere nella cartella cache. '.CMS_NAME.' continuer&agrave; a funzionare come previsto, ma non avverr&agrave; alcuna operazione di caching. Per risolvere, rendete la cartella /_cache/ scrivibile.';
...
$_lang["configcheck_php_gdzip_msg"] = CMS_NAME.' richiede le estensioni PHP GD e Zip. '.CMS_NAME.' funziona anche senza, ma non potrete utilizzare File Manager, Image Editor e Captcha.';
...
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' &egrave; gestito e mantenuto su <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMS.com</a>.</p>';
...
$_lang["file_folder_chmod_error"] = 'Impossibile modificare i permessi: dovete effettuare la modifica dei permessi con un programma esterno a '.CMS_NAME.'.';
...
$_lang["filemanager_path_message"] = 'IIS spesso non riesce a determinare correttamente la cartella principale usata dal File Manager per determinare ci&ograve; che potete vedere. Se avete problemi nell\'uso del File Manager, assicuratevi che il percorso punti alla root dell\'installazione di '.CMS_NAME.'.';
...
$_lang["language_message"] = 'Selezionate la lingua per il sistema di gestione dei contenuti '.CMS_NAME.'.';
...
$_lang["loading_page"] = 'Vi preghiamo di attendere che '.CMS_NAME.' carichi la pagina...';
...
$_lang["logo_slogan"] = 'Sistema di gestione dei contenuti '.CMS_NAME.' - \nCreate e fate di pi&ugrave; con meno';
$_lang["logout"] = 'Uscita';
...
$_lang["modx_version"] = "Versione '.CMS_NAME.'";
...
$_lang["password_gen_gen"] = 'Lascia che '.CMS_NAME.' generi una password.';
...
$_lang["php_version_check"] = CMS_NAME.' &egrave; compatibile con PHP versione 4.0.3 o superiore. Si prega di aggiornare l\'installazione di PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["rb_base_dir_message"] = 'Inserite il percorso fisico alla directory delle Risorse. Questa impostazione &egrave; generata automaticamente. Se state usando IIS, tuttavia, '.CMS_NAME.' potrebbe non riuscire ad impostare il percorso corretto, inducendo il browser delle Risorse a mostrare un errore. In quel caso, qui potete correggere il percorso alla cartella delle immagini  (il percorso che vedete in Windows Explorer). <b>NOTA:</b> La directory delle Risorse deve contenere le sottocartelle images, files, flash e media affinch&egrave; funzioni correttamente con il Browser di Risorse.';
$_lang["rb_base_dir_title"] = 'Percorso delle Risorse:';
$_lang["rb_base_url_message"] = 'Inserite il percorso virtuale alla directory delle Risorse. Questa impostazione &egrave; generata automaticamente. Se state usando IIS, tuttavia, '.CMS_NAME.' potrebbe non riuscire ad impostare il percorso corretto, inducendo il browser delle Risorse a mostrare un errore. In quel caso, qui potete correggere il percorso alla cartella delle immagini  (l\'URL che vedete in Internet Explorer).';
