...
$_lang["access_permissions_docs_collision"] = 'A causa di un conflitto fra il Web User Groups e Manager User Groups del vostro Ruolo, questa Risorsa sarà pubblica. Contattare un amministratore di sistema per maggiori chiarimenti.';
...
$_lang["configcheck_cache_msg"] = 'MODX non può scrivere nella cartella cache. MODX continuerà a funzionare come previsto, ma non avverrà alcuna operazione di caching. Per risolvere, rendete la cartella /_cache/ scrivibile.';
$_lang["configcheck_configinc"] = 'Il file di configurazione (/[+MGR_DIR+]/includes/config.inc.php) è ancora scrivibile';
$_lang["configcheck_configinc_msg"] = 'Malintenzionati potrebbero combinare guai sul vostro sito e tutto ciò che è collegato ad esso. <strong>Sul serio.</strong> Impostate il file di configurazione (/[+MGR_DIR+]/includes/config.inc.php) in sola lettura!';
...
$_lang["pwd_hash_algo_title"] = '<b>Algoritmo di hash:</b>';
$_lang["pwd_hash_algo_message"] = 'Password algoritmo di hash.';

$_lang["enable_bindings_title"] = '<b>Abilita comandi @Bindings:</b>';
