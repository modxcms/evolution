...
$_lang["access_permissions_links_tab"] = 'Qui potete specificare a quali Gruppi di Utenti &egrave; permesso l\'accesso ai Gruppi di Risorse (ad es.: possono modificare o creare Risorse). Per collegare un Gruppo di Risorse a un Gruppo di Utenti, selezionatelo dalla lista a tendina, e cliccate su \'Aggiungi gruppo\'. Per rimuovere il collegamento ad un certo gruppo premete \'Rimuovi ->\'. Il collegamento sar&agrave; immediatamente eliminato.';
...
$_lang["chunk_multiple_id"] = 'Errore: Diversi Chunks condividono lo stesso ID.';
...
$_lang["configcheck_validate_referer_msg"] = "L'opzione di <strong>Validazione degli headers HTTP_REFERER?</strong> non &egrave; attivata. Raccomandiamo di attivarla. <a href=\"index.php?a=17\">Vai alle Opzioni di Configurazione</a><br /><a href=\"javascript:hideHeaderVerificationWarning();\"><em>Non chiedermelo pi&ugrave;.</em></a>";
