...
$_lang["configcheck_cache_msg"] = CMS_NAME.' не може да пише в кеш-директорията. '.CMS_NAME.' ще работи нормално, но няма да се извършва кеширане. За да разрешите проблема, позволете записа в директория /_cache/ .';
...
$_lang["configcheck_installer_msg"] = 'Директорията install/ съдържа инсталационните файлове на '.CMS_NAME.'. Някой може да злоупотреби с информацията вътре в нея, ето защо е препоръчително папката да бъде изтрита от сървъра.';
$_lang["configcheck_lang_difference"] = 'Грешен брой записи в езиковия файл';
$_lang["configcheck_lang_difference_msg"] = 'Текущо избрания езиков файл има различен брой записи от езиковия файл по подразбиране. Това не е проблем, тъй като '.CMS_NAME.' ще работи нормално, но означава, че езиковия файл трябва бъде обновен.';
...
$_lang["credits"] = 'Екипът на '.CMS_NAME;
...
$_lang["file_folder_chmod_error"] = 'Неуспешна промяна на правата за достъп, трябва да ги смените извън '.CMS_NAME.'.';
...
$_lang["filemanager_path_message"] = 'IIS много често не интерпретира правилно настройките на document_root , който се използва от файловия мениджър за определяне какво да виждате. В случай, че имате проблеми при използването на файловия мениджър, уверете се, че пътя сочи към root на '.CMS_NAME.' инсталацията.';
...
$_lang["friday"] = 'Петък';
$_lang["friendly_alias_message"] = 'В случай, че използвате приятелски URL адреси, и документът има псевдоним, псевдонимът винаги има предимство пред приятелския URL адрес. Посредством yстановяване на тази опция в \'Да\', префикса и суфикса на приятелския  URL адрес ще бъдат приложени и към псевдонима. Например, ако документът с ID 1 има псевдоним  `introduction`, и сте настроили префикс `` и суфикс `.html`, установяването на тази опция в `Да` ще генерира `introduction.html`. Ако няма никакъв псевдоним, '.CMS_NAME.' ще генерира `1.html` като връзка.';
$_lang["friendly_alias_title"] = 'Използване на приятелски псевдоними:';
$_lang["friendlyurls_message"] = 'Дадената опция позволява да разрешите използването на приятелски URL адреси на сайта. Запомнете, че дадената възможност е достъпна само тогава, когато '.CMS_NAME.' е инсталиран на сървър Apache, освен това ще е необходимо да промените файла .htaccess. За подробна информация разгледайте файла  .htaccess от дистрибутивния пакет на '.CMS_NAME.'.';
...
$_lang["guid"] = 'GUID';
$_lang["help"] = 'Помощ';
$_lang["help_msg"] = '<p>Можете да получите безплатна помощ на <a href="http://clippercms.com/forums" target="_blank">адреса на Форума на '.CMS_NAME.'</a>. Също така можете да посетите и <a href="http://clippercms.com/documentation" target="_blank">'.CMS_NAME.' Документация и Ръководства</a> , където са засегнати почти всички аспекти на '.CMS_NAME.'.</p><p>Екипът планира да предложи и платена помощ като услуга също. Моля да се информирате за платената помощ на адрес <a href="mailto:modx@vertexworks.com?subject='.CMS_NAME.' Commercial Support Inquiry"></a>.';
...
$_lang["language_message"] = 'Изберете език за '.CMS_NAME.' Мениджъра.';
...
$_lang["loading_page"] = 'Моля изчакайте, докато '.CMS_NAME.' зареди страницата...';
...
$_lang["modx_version"] = 'Версия на '.CMS_NAME;
...
$_lang["password_gen_gen"] = 'Нека '.CMS_NAME.' да генерира парола.';
...
$_lang["php_version_check"] = CMS_NAME.' е съвместим с PHP версия 4.0.3 и по-високи. Ъпгрейдвайте PHP инсталацията си!';
$_lang["plugin"] = 'Плъгин';
...
$_lang["resource_opt_emptycache_help"] = 'Оставяйки това поле маркирано, ще накара '.CMS_NAME.' да изчисти кеша след съхраняване на документа. По този начин потребителите няма да видят някоя стара версия на документа.';
...
$_lang["rss_url_news_message"] = 'Въвеждане на URL адрес за '.CMS_NAME.' Новините.';
$_lang["rss_url_news_title"] = 'RSS на Новините';
$_lang["rss_url_security_message"] = 'Въвеждане на URL адрес за '.CMS_NAME.' Сигурността.';
...
$_lang["settings_strip_image_paths_message"] = 'Ако това е указано \'Не\', '.CMS_NAME.'  ще запише ресурсите на файловия браузер (изображения, файлове, флаш, и др.) като абсолютни URL адреси. Относителните URL адреси са много полезни, когато решите да местите инсталацията на '.CMS_NAME.', т.е. от тестови в продуктивен сайт. Ако нямате никаква идея какво означава това, най-добре е да оставите тази настройка на \'Да\'.';
...
$_lang["tree_show_protected_message"] = 'Когато е "Не", защитените страници (и техните дъщерни документи) не се показват в дървото с документите. "Не" е настройката за '.CMS_NAME.'.';
...
$_lang["welcome_title"] = 'ДОБРЕ ДОШЪЛ в Мениджъра на '.CMS_NAME;
$_lang["which_editor_message"] = 'Тук можете да изберете кой редкатор ще използвате. Можете също така да даунлоуднете и инсталирате допълнителен редактор от секцията за даунлоуд на '.CMS_NAME.'.';
$_lang["which_editor_title"] = 'Редактор, който ще използваш:';
$_lang["working"] = 'Зарежда се...';
$_lang["wrap_lines"] = 'Пренасяне на нов ред';
$_lang["xhtml_urls_message"] = 'Заменя символа ampersand (&amp;) в URL адресите, генерирани от '.CMS_NAME.' с валидното &amp;<!-- -->amp; htmlentity';
