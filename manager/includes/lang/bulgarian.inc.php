...
$_lang["configcheck_configinc_msg"] = 'Моля, направете config файла (/assets/config.inc.php) достъпен само за четене, за да не се създават предпоставки за потенциално увреждане на Вашия сайт и всичко, свързано с него!';
