...
$_lang["access_permissions_docs_collision"] = 'Det här dokumentet kommer att vara publikt på grund av att webbanvändargrupperna och hanterarens användargrupper är i konflikt för din roll. Kontakta en av webbplatsens administratörer för att få ytterligare hjälp.';
...
$_lang["access_permissions_documents_tab"] = 'Här kan du se vilka dokumentgrupper som har blivit konfigurerade. Du kan också skapa nya eller byta namn på grupper samt se vilka dokument som tillhör de olika grupperna (håll musen över dokumentets ID för att se dess namn). För att lägga till eller ta bort ett dokument från en grupp - redigera dokumentet direkt.';
...
$_lang["access_permissions_user_message"] = 'Här kan du välja vilka användargrupper denna användare ska tillhöra:';
...
$_lang["category_msg"] = 'Här kan du visa och redigera alla element grupperade i kategorier.';
...
$_lang["charset_message"] = 'Välj den teckenkodning du vill använda i sidhanteraren. Notera att MODx har testats med ett antal av dessa kodningar, men inte alla. För de flesta språk är standardalternativet UTF-8 att föredra.';
...
$_lang["configcheck_cache_msg"] = 'MODx kan inte skriva till cache-katalogen. MODx kommer fortfarande att fungera som förväntat, men inga dokument kommer att cachas. För att rätta till det här, gör /_cache/-katalogen skrivbar.';
...
$_lang["configcheck_unauthorizedpage_unpublished_msg"] = 'Detta betyder att din otillåten-sida är oåtkomlig för allmänheten. Publicera sidan eller kontrollera under Verktyg &gt; Konfiguration att den angivna sidan är ett existerande dokument i webbplatsens dokumentträd.';
...
$_lang["custom_contenttype_message"] = 'Här kan du lägga till egna innehållstyper som kan användas i dina dokument. Skriv in innehållstypen i det övre fältet och klicka på "Lägg till" för att lägga till en ny. Markera den innehållstyp som du vill ta bort i det nedre fältet och klicka på "Ta bort".';
...
$_lang["defaulttemplate_message"] = 'Välj den standarmall du vill använda för nya dokument. Du kan fortfarande välja en annan mall när du redigerar dokumentet. Denna inställning är bara den förvalda.';
...
$_lang["document_alias_help"] = 'Ange ett URL-alias för att göra dokumentet tillgängligt som http://dinserver/alias. Detta fungerar endast om vänliga adresser är aktiverade i webbplatsens konfiguration.';
...
$_lang["document_long_title_help"] = 'Ange en längre titel för ditt dokument. Detta är bra för sökmotorer, och beskriver kanske ditt dokument bättre.';
...
$_lang["document_opt_folder_help"] = 'Markera här om dokumentet ska fungera som en behållare för andra dokument. En "behållare" är som en mapp, men den kan också ha ett eget innehåll.';
$_lang["document_opt_menu_index"] = 'Menyindex';
$_lang["document_opt_menu_index_help"] = 'Menyindex är ett fält du kan använda för att sortera dokument i den snippet som bygger menyn. Du kan också använda det för andra ändamål i dina snippets.';
...
$_lang["document_opt_show_menu_help"] = 'Välj den här inställningen för att visa dokumentet i en webbmeny. Notera att vissa menybyggarsnippets kan välja att strunta i den här inställningen.';
...
$_lang["document_parent_help"] = 'Klicka på ovanstående ikon för att sätta på (eller stänga av) föräldraval för detta dokument. Klicka sedan på ett dokument i dokumentträdet för att ange det som ny förälder.';
$_lang["document_permissions_error"] = 'Tilldela detta dokument till minst en dokumentgrupp som du kan komma åt.';
...
$_lang["emailsender_message"] = 'Här kan du ange den e-postadress som används för att skicka användarnamn och lösenord till en användare.';
$_lang["emailsender_title"] = 'E-postadress';
$_lang["emailsubject_message"] = 'Här kan du ange ämnet för e-posten som skickas vid registrering.';
...
$_lang["export_site_maxtime_message"] = 'Här kan du ange hur många sekunder MODx har på sig för att exportera webbplatsen (åsidosätter PHPs inställningar). Skriv 0 för obegränsad tid. Notera att om 0 eller ett väldigt högt nummer anges, kan det få din server att göra konstiga saker och rekommenderas därför inte.';
...
$_lang["export_site_numberdocs"] = '<p><b>Hittade %s dokument att exportera...</b></p>';
...
$_lang["filemanager_path_message"] = 'IIS fyller oftast inte i inställningarna för document_root ordentligt, vilket används av filhanteraren för att bestämma vad du får se. Om du har problem med filhanteraren, se till så att denna sökväg pekar till roten på din MODx-installation.';
...
$_lang["friday"] = 'Fredag';
$_lang["friendly_alias_message"] = 'Om du använder vänliga adresser och dokumentet har ett alias, kommer aliaset alltid att prioriteras före den vänliga adressen. Genom att sätta detta alternativ till "Ja", kommer den vänliga adressens prefix och suffix att läggas till aliaset.<br />Exempel: om ditt dokument med ID 1 har aliaset "introduktion", prefixet är satt till "", suffixet till ".html" och du sätter denna inställning till "Ja", så kommer "introduktion.html" att visas. Om det inte finns något alias, kommer MODx att generera länken "1.html".';
...
$_lang["link_attributes_help"] = 'Ange frivilliga attribut för en länk till denna sida, t.ex. "target=" eller "rel=".';
...
$_lang["login_cancelled_install_in_progress"] = 'Installation/uppdatering av den här webbplatsen pågår.<br />Försök igen om ett par minuter!<br />';
$_lang["login_cancelled_site_was_updated"] = 'Installationen/uppdateringen av den här webbplatsen är klar. Nu kan du logga in igen!<br />';
...
$_lang["login_homepage_message"] = 'Ange ID till det dokument du vill skicka användaren till efter den har loggat in.<br /><b>OBS: Se till att det ID du anger tillhör ett existerande dokument, att det har blivit publicerat och kan kommas åt av användaren!</b>';
...
$_lang["page_data_notcached"] = 'Dokumentet har inte blivit cachat än.';
...
$_lang["page_data_template_help"] = 'Välj mall för detta dokument.';
...
$_lang["role_edit_doc_metatags"] = 'Redigera dokuments META-taggar och nyckelord';
...
$_lang["role_empty_trash"] = 'Permanent radera borttagna dokument';
...
$_lang["search_results_returned_msg"] = 'Din sökning returnerade <b>%s</b> dokument. Försök att göra en mer specifik sökning om du får många träffar. De två kolumnerna längst till vänster låter dig hitta dokumentet i trädet eller visa dokumentet. De två kolumnerna till höger visar om dokumentet har tagits bort och vilken publiceringsstatus det har.<p />';
...
$_lang["tmplvars_msg"] = 'Lägga till och redigera mallvariabeln här. Den måste tilldelas till en eller flera mallar för att den ska kunna kommas åt från snippets och dokument.';
...
$_lang["total"] = 'totalt';
$_lang["track_visitors_message"] = 'Den här inställningen har ingen effekt om du inte har en besöksräknare eller ett statistiktillägg installerat som stödjer den här inställningen. Genom att logga besök kan du få fram statistik på hur din webbplats används.';
...
$_lang["use_alias_path_message"] = 'Om detta val sätts till "Ja", kommer hela sökvägen till dokumentet att visas om dokumentet har ett alias. Till exempel, om ett dokument med aliaset "barn" befinner sig i en behållare med aliaset "foralder", kommer hela sökvägen att visas som "/foralder/barn.html".<br /><b>Notera: När detta val sätts till "Ja" (aliassökvägar aktiveras), måste du referera objekt (som bilder, css, javascript etc) med en absolut sökväg. Exempel: "/assets/images" istället för "assets/images". Genom att göra så förhindrar du att webbläsaren (eller webbservern) lägger till den relativa sökvägen till aliassökvägen.</b>';
...
$_lang["weblink_message"] = 'En webblänk är en referens till ett objekt på Internet. Detta kan vara ett dokument i MODx, en sida på en annan webbserver, en bild, eller en annan typ av fil på Internet.';
