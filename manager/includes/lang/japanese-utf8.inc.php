...
$_lang["access_permissions_resources_tab"] = 'リソースグループの設定を一覧することができます。グループの作成・リネーム・削除もここで操作します。 また、リソースがどのグループに属しているかを閲覧することもできます(リソース名を表示するには、idの上にマウスポインタを乗せてください)。 リソースをグループに追加したり、グループから削除するには、リソースを直接編集してください。';
...
$_lang["captcha_message"] = '機械的に読み取ることのできないコードを画像で表示し、ユーザーの入力を求めます。これによりセキュリティを強化することができます。';
...
$_lang["sitestatus_message"] = 'このサイトをウェブ上に公開するには「公開」を選択してください。「メンテナンスモード」を選択した場合、訪問者には「メンテナンス中ページ」または「メンテナンス中メッセージ」が表示されます。';
