...
$_lang["import_site_maxtime_message"] = 'EVOがサイトのインポート処理に使用できる最大秒数を指定します。（<a href="http://www.google.com/search?q=php+set_time_limit&hl=ja&lr=lang_ja" target="_blank">PHPの指定処理秒数</a>を上書きします）「0」を指定すると処理時間を制限しませんが、想定外の処理時間を要することもあるためご注意ください。';
...
$_lang["settings_email_templates"] = 'メールアドレスとテンプレート';
...
$_lang["import_site.static.php1"] = 'リソースツリーをリセットする';
$_lang["import_site.static.php2"] = 'リソースツリー上のリソースを全削除してからインポートします。リソースIDも初期化されます。';
$_lang["import_site.static.php3"] = 'インポート対象';
$_lang["import_site.static.php4"] = 'body要素のみ';
$_lang["import_site.static.php5"] = 'htmlファイルまるごと';

$_lang["a83_ignore_ids_title"] = '無視するリソースID (コンマ区切り)';
$_lang["export_site.static.php1"] = 'エクスポート対象';
$_lang["export_site.static.php2"] = '更新されたページのみ';
$_lang["export_site.static.php3"] = '全てのページ';
