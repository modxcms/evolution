...
$_lang["configcheck_default_msg"] = 'よく分からない警告が見つかりました。これは変です。';
...
$_lang["configcheck_errorpage_unpublished_msg"] = 'これはあなたが設定したエラーページが誰でも見れるようにはなっていないことを意味します。エラーページは全ての人(Public)に公開するようにしてください。';
...
$_lang["configcheck_unauthorizedpage_unpublished_msg"] = '設定した権限外告知のページが誰でも見れるようにはなっていない事を意味します。権限外告知ページは全ての人「Public」に公開するようにしてください。';
...
$_lang["htmlsnippet_msg"] = 'チャンクを追加・編集することができます。チャンクは「生の」HTMLコードです。PHPコードは動作しないことに注意してください。';
...
$_lang["plugin_msg"] = 'プラグインの追加や編集をする事ができます。プラグインは選択したシステムイベントの発生時に実行されるPHPのコード群です。';
...
$_lang["tmplvars_management_msg"] = 'ドキュメントに使用する追加の変数フィールドを管理できます。';
...
$_lang["wednesday"] = '水曜';
$_lang["welcome_messages"] = '受信箱に <b>%d</b> 件のメッセージが入っています。<b>%s</b> 件が未読です。';
