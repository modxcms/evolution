...
$_lang["access_permissions_documents_tab"] = 'リソースグループの設定を一覧することができます。グループの作成・リネーム・削除もここで操作します。 また、ドキュメントがどのグループに属しているかを閲覧することもできます(リソース名を表示するには、idの上にマウスポインタを乗せてください)。 リソースをグループに追加したり、グループから削除するには、リソースを直接編集してください。';
...
$_lang["document_opt_folder_help"] = 'このリソースをコンテナとして明示的に扱いたい場合にチェックしてください。通常はサブドキュメントの有無により自動的に判定されます';
