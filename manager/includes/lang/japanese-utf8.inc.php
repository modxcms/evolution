...
$_lang["access_permissions_docs_message"] = 'このリソースを所属させたい<a href="index.php?a=40">リソースグループ</a>を選択してください。アクセスを制限する必要がなければ「全リソースグループ」にチェックを入れておきます。';
...
$_lang["duplicate_name_found_general"] = '%sにはすでに\'%s\'という名前が存在します。ユニークな名前を入力してください。';
$_lang["duplicate_name_found_module"] = 'モジュールにはすでに\'%s\'という名前が存在します。重複しない名前を入力してください。';
$_lang["edit"] = '編集';
