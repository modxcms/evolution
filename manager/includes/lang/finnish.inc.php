...
$_lang["access_permissions_add_document_group"] = 'Uusi sivuryhmä';
...
$_lang["access_permissions_document_groups"] = 'Sivuryhmät';
$_lang["access_permissions_documents_in_group"] = '<strong>Sivut ryhmässä:</strong> ';
$_lang["access_permissions_documents_tab"] = 'Muokkaa sivuryhmiä. Lisää yksittäinen sivu ryhmään tai poista yksittäinen sivu ryhmästä muokkaamalla suoraan kyseistä sivua.';
...
$_lang["access_permissions_no_documents_in_group"] = 'Ei yhtään.';
...
$_lang["click_to_context"] = 'Napsauta päästäksesi lauseyhteysvalikon';
...
$_lang["confirm_delete_document"] = 'Haluatko varmasti poistaa?\nKaikki sivun (kansion) alasivut poistetaan myös.';
...
$_lang["confirm_duplicate_document"] = 'Haluatko varmasti tehdä kopion?';
...
$_lang["create_document_here"] = 'Uusi sivu tähän';
...
$_lang["credits_dTree"] = 'MODx käyttää DestroyDrop.com:n dTree -skriptiä.';
$_lang["credits_everaldo"] = 'MODx käyttää Everaldo\'s Crystal kuvakekokoelmaa.';
$_lang["credits_mysql"] = 'MODx käyttää MySQL:ää.';
$_lang["credits_php"] = 'MODx käyttää PHP:tä.';
$_lang["credits_shouts_msg"] = '<p>MODx:n kehittäjät ja ylläpitäjät: <a href="http://modxcms.com/about/" target="_blank">MODxCMS.com</a>.</p>';
$_lang["credits_shouts_title"] = '<strong>Kiitokset:</strong>';
$_lang["credits_webfx"] = 'MODx käyttää monia Webfx:n JavaSkriptejä.';
...
$_lang["document_alias_help"] = 'Määrittelee sivun internet-selaimen osoitekentässä näkyvän osoitteen viimeisen osan, esim. http://www.kotisivu.fi/sivun-alias. HUOM! Sivun alias luodaan automaattisesti sivun otsikon perusteella, jos jätät aliaksen tyhjäksi.';
$_lang["document_content"] = 'Sivun sisältö';
$_lang["document_description"] = 'Kuvaus';
$_lang["document_description_help"] = 'Vapaaehtoinen sivun kuvaus.';
$_lang["document_long_title_help"] = 'Sivun sisältöä paremmin kuvaava pitkä otsikko on hyödyllinen hakukoneille.';
$_lang["document_metatag_help"] = 'Valitse sivun metatiedot ja avainsanat. Voit valita useita metatietoja ja avainsanoja pitämällä CTRL-näppäintä pohjassa.';
$_lang["document_opt_contentdispo"] = 'Sisällön esitystapa';
$_lang["document_opt_contentdispo_help"] = 'Sisällön luonne määrittelee, miten selain käsittelee sivua. Esim. tiedoston latauksia varten valitse Liite -valinta.';
$_lang["document_opt_emptycache"] = 'Tyhjennä välimuisti?';
$_lang["document_opt_emptycache_help"] = 'Määrittelee tyhjennetäänkö välimuisti sivun tallennuksen yhteydessä. Jos välimuistia ei tyhjennetä, muuttunut sisältö ei välttämättä näy vierailijoille.';
$_lang["document_opt_folder"] = 'Kansio?';
$_lang["document_opt_folder_help"] = 'Määrittele sivu kansioksi. Tästä ei normaalisti tarvitse huolehtia ollenkaan, koska sivu muuttuu automaattisesti kansioksi, jos sen alle lisätään toinen sivu.';
$_lang["document_opt_menu_index"] = ' Järjestysnumero valikossa';
$_lang["document_opt_menu_index_help"] = 'Sivujen keskinäinen järjestys valikoissa, esim. järjestys sivuston navigaatiovalikossa.';
$_lang["document_opt_menu_title"] = 'Otsikko valikossa';
$_lang["document_opt_menu_title_help"] = 'Sivun valikoissa näkyvä sivun otsikko. Jos valikon otsikko on tyhjä, valikoissa käytetään otsikkona sivun otsikkoa ';
$_lang["document_opt_published"] = 'Julkaistu?';
$_lang["document_opt_published_help"] = 'Julkaistaanko sivu heti tallennuksen jälkeen?';
$_lang["document_opt_richtext"] = 'Sisältöeditori?';
$_lang["document_opt_richtext_help"] = 'Määrittelee käytetäänko tekstinkäsittelyohjelmaa muistuttavaa sisältöeditoria (rich text editor) sivun siällön muokkaamiseen. Jos sivu sisältää JavaScriptiä tai lomakkeita, sisältöeditorin käyttäminen voi sotkea sisältöä.';
$_lang["document_opt_show_menu"] = ' Näytä valikossa';
$_lang["document_opt_show_menu_help"] = 'Näytetäänkö sivu valikoissa, esim. sivuston naviaatiovalikossa?';
$_lang["document_opt_trackvisit_help"] = 'Kirjaa kävijöiden vierailut sivulla.';
$_lang["document_overview"] = 'Yhteenveto';
$_lang["document_parent"] = 'Sivun paikka';
$_lang["document_parent_help"] = 'Napsauta ensin yllä olevaa kansiokuvaketta ja sitten sivukartasta sitä sivua, jonka alle tämä sivu sijoitetaan.';
$_lang["document_permissions_error"] = 'Sijoita tämä sivu vähintään yhteen sivuryhmään, johon myös itselläsi on käyttöoikeudet.';
$_lang["document_setting"] = 'Sivun asetukset';
$_lang["document_summary"] = 'Yhteenveto';
$_lang["document_summary_help"] = 'Sivun yhteenveto.';
$_lang["document_title"] = 'Otsikko';
$_lang["document_title_help"] = 'Sivun otsikko. Vältä kenoviivoja "" otsikon nimessä.';
$_lang["document_to_be_moved"] = 'Siirrettävä sivu';
$_lang["document_weblink_help"] = 'Hyperlinkin osoite, esim. www-sivun osoite. Voit myös valita hyperlinkiksi jonkin sivun napsauttamalla kansio-kuvaketta ja napsauttamalla tämän jälkeen sivukartasta haluamaasi sivua.';
$_lang["documents_in_container"] = 'Alasivut';
$_lang["documents_in_container_no"] = 'Sivulla ei ole yhtään alasivua.';
...
$_lang["duplicate_document"] = 'Tee kopio';
...
$_lang["edit"] = 'Muokkaa';
$_lang["edit_document"] = 'Muokkaa';
$_lang["edit_document_title"] = 'Muokkaa';
...
$_lang["export_site_failed"] = '<span style=\'color:#990000\'>Epäonnistui!</span>';
...
$_lang["export_site_suffix"] = 'Tiedoston jälkiliite:';
$_lang["export_site_target_unwritable"] = 'Kohdehakemistoon ei voi kirjoittaa. Varmista, että kansioon voidaan kirjoittaa ja yritä uudelleen.';
...
$_lang["files_upload_inhibited_msg"] = '<strong>Siirto-oikeuksia rajoitettu</strong>. Varmista tiedoston siirtojen tuki ja tarkista kansion kirjoitusoikeudet.<br />';
...
$_lang["files_uploading"] = 'Siirtää <strong>%s</strong> kohteeseen <strong>%s/</strong><br />';
...
$_lang["friendly_alias_message"] = 'Jos käytät selkokielisiä osoitteita, alias on aina etusijalla. Selkokielisten osoitteiden etu- ja takaliitteitä käytetään myös aliaksessa. Esim. sivun ID on 1 ja alias on \'esittely\'. Lisäksi etuliitteeksi on asetettu `` ja takaliitteeksi \'.html\'. Tällöin asetuksen ollessa \'kyllä\' luodaan aliaksen perusteella osoite \'esittely.html\'. Jos asetus on \'ei\', luodaan sivun ID:n perusteella osoite \'1.html\'.';
...
$_lang["import_parent_document"] = 'Pääryhmän sivu:';
$_lang["import_site"] = 'Tuo sivusto';
$_lang["import_site_failed"] = '<span style=\'color:#990000\'>Epäonnistui!</span>';
$_lang["import_site_html"] = 'Tuo sivusto';
$_lang["import_site_importing_document"] = 'Tuo tiedostoa <strong>%s</strong> ';
$_lang["import_site_maxtime"] = 'Suurin tuontiaika:';
$_lang["import_site_maxtime_message"] = 'Määrittele sivuston tuontiin enintään käytettävä aika (syrjäyttää PHP:n asetukset). Arvo 0 tarkoittaa rajoittamatonta aikaa, jonka käyttäminen voi kuitenkin saada aikaan outoja asioita palvelimella. Siksi arvon nolla tai muun erittäin suuren arvon käyttö ei ole suositeltavaa.';
$_lang["import_site_message"] = 'Toiminnon avulla voi tuoda kokonaisen HTML-sivuston tietokantaan. Ennen sivuston tuonnin aloittamista, kopioi tuotavat HTML-tiedostot ja/tai kansiot assets/import/ -kansioon.<p /> Tuodut tiedostot pyritään tallentamaan käyttäen tiedostojen nimiä sivujen aliaksina ja sivun otsikkoa otsikkona.';
...
$_lang["insert"] = 'Selaa';
$_lang["insert_snippet"] = 'Liitä PHP-palanen sivuun';
...
$_lang["link_attributes_help"] = 'Linkin ominaisuudet, esim. target= tai rel=.';
...
$_lang["login_message"] = 'Kirjaudu ylläpitoon. Isoilla ja pienillä kirjaimilla on merkitystä, joten kirjoita käyttänimi ja salasana huolella.';
...
$_lang["manager_direction_message"] = 'Valitse tekstin lukusuunta ylläpidossa, vasemmalta oikealle (ltr) tai oikealta vasemmalle (rtl).';
$_lang["manager_direction_title"] = 'Tekstin lukusuunta:';
...
$_lang["messages_forward"] = 'Lähetä edelleen';
$_lang["messages_from"] = 'Lähettäjä';
$_lang["messages_group"] = 'Ryhmä';
$_lang["messages_inbox"] = 'Viestit';
$_lang["messages_message"] = 'Viesti';
$_lang["messages_no_messages"] = 'Ei viestejä.';
$_lang["messages_not_allowed_to_read"] = 'Sinulla ei ole lupaa lukea tätä viestiä!';
$_lang["messages_private"] = 'Yksityiset';
$_lang["messages_read_message"] = 'Lue viesti';
$_lang["messages_reply"] = 'Vastaa';
$_lang["messages_select_group"] = 'Valitse ryhmä';
$_lang["messages_select_user"] = 'Valitse käyttäjä';
$_lang["messages_send"] = 'Lähetä';
$_lang["messages_send_to"] = 'Lähetetty';
$_lang["messages_sent"] = 'Päiväys';
$_lang["messages_subject"] = 'Aihe';
$_lang["messages_system_user"] = '[Järjestelmä]';
...
$_lang["mgrlog_dateto"] = 'Loppumispäivä';
...
$_lang["mgrlog_query_msg"] = 'Jäljitä tehtyjä toimintoja lokitiedostosta. HUOM! Jos haluat hakea toimintoja yhdeltä päivältä, on loppumispäiväksi annettava haettavaa päivää seuraava päivä.';
...
$_lang["move"] = 'Siirrä';
$_lang["move_document"] = 'Siirrä';
$_lang["move_document_message"] = 'Siirrä sivu ja sivun kaikki alasivut uuteen paikkaan napsauttamlla haluttua kohtaa sivukartasta. Siirrettävät sivun sijoitetaan valitun sivun alle.';
$_lang["move_document_new_parent"] = 'Valitse sivukartasta uusi paikka.';
$_lang["move_document_title"] = 'Siirrä';
$_lang["name"] = 'Nimi';
...
$_lang["online"] = 'Kirjautuneet käyttäjät';
...
$_lang["page_data_unpublishdate"] = 'Piilotuspäiväys';
$_lang["page_data_unpublishdate_help"] = 'Julkaisun piilotuspäiväys määrittelee, koska sivu piilotetaan eli otetaan pois julkaisusta. Valitse piilotuspäiväys napsauttamalla kalenteri-kuvaketta. Poista piilotuspäiväys napsauttamalla kalenterikielto-kuvaketta. Jätä piilotuspäiväys tyhjäksi, jos haluat, että sivua ei piiloteta automaattisesti.';
...
$_lang["password_gen_length"] = 'Salasanan täytyy olla vähintään 6 merkkiä pitkä. Salasana ei saa sisältää skandeja (ääkkösiä) eikä erikoismerkkejä (+, -, ? jne.).';
...
$_lang["plugin_locked_message"] = 'Tämä liitännäinen on lukittu.';
...
$_lang["preview_document"] = 'Esikatsele';
$_lang["preview_msg"] = 'Esikatselunäkymä viimeksi tallennetuista muutoksista. Napsauta <a href=\'javascript://\' onclick="saveRefreshPreview();"><img src=\'media/images/icons/save.gif\' align=\'absmiddle\' height=\'12\'>tästä tallentaaksesi ja päivittääksesi</a> tämän hetkiset muutokset';
$_lang["private"] = 'Yksityinen';
$_lang["public"] = 'Julkinen';
$_lang["publish_date"] = 'Julkaisupäiväys';
$_lang["publish_document"] = 'Julkaise';
...
$_lang["resolve_hostnames_message"] = 'Haluatko MODx:n yrittävän selvittää kävijöiden isäntänimet? Isäntänimien selventäminen voi aiheuttaa palvelimelle jonkin verran lisäkuormaa, joskaan vieraasi eivät tätä huomaa millään tavoin.';
$_lang["resolve_hostnames_title"] = 'Selvitä isäntänimet';
$_lang["resource"] = 'Elementti';
$_lang["resource_categories"] = 'Yhdistetty näkymä';
$_lang["resource_management"] = 'Elementit';
$_lang["resource_name"] = 'Elementin nimi';
$_lang["resource_selector_msg"] = 'Valitse elementit alapuolella olevasta listasta ja paina \'Tuo\' painiketta.';
$_lang["resource_selector_title"] = 'Elementinvalitsin';
$_lang["resources"] = 'Elementit';
$_lang["role"] = 'Rooli';
...
$_lang["settings_after_install"] = 'Koska tämä on uusi asennus, tulee tarkistaa nämä asetukset ja muuttaa niitä tarpeesi mukaan. Kun olet tarkistanut asetukset, paina \'Tallenna\' päivittääksesi muutokset tietokantaan.<br /><br />';
...
$_lang["settings_snippets"] = 'PHP-palaset';
...
$_lang["siteunavailable_message"] = 'Viesti näytetään, kun sivusto on poissa käytöstä. <strong>HUOMAA:</strong> Viesti näytetään vain jos sivusto poissa käytössä -sivua ei ole asetettu.';
$_lang["siteunavailable_page_message"] = 'Syötä sivusto poissa käytössä -sivuna käytettävän sivun ID. Sivu näytetään, jos sivuston tila on poissa käytöstä. <strong>HUOMAA:</strong> Varmista, että ID on olemassa ja, että kyseinen sivu on julkaistu!';
$_lang["siteunavailable_page_title"] = 'Sivusto poissa käytössä -sivu:';
...
$_lang["snippets_available"] = 'Lisättävissä olevat PHP-palaset';
...
$_lang["template_locked_message"] = 'Tämä sivupohja on lukittu.';
...
$_lang["undelete_document"] = 'Palauta';
$_lang["unpublish_date"] = 'Piilotuspäiväys';
$_lang["unpublish_document"] = 'Piilota';
$_lang["unpublish_events"] = 'Piilotettavien sivujen aikataulu';
$_lang["untitled_document"] = 'Nimetön sivu';
...
$_lang["view"] = 'Näytä';
$_lang["view_child_documents_in_container"] = 'Näytä alasivut';
$_lang["view_document"] = 'Näytä';
...
$_lang["weblink_message"] = 'Hyperlinkki esim. voi olla linkki sivuston sivuun, jokin ulkopuolinen verkkosivu, tai muu tiedosto jollakin aivan toisella sivustolla.<p>';
