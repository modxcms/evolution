...
$_lang["configcheck_cache_msg"] = CMS_NAME.' לא יכול לכתוב לתיקיית זיכרון  המטמון .  '.CMS_NAME.'  ימשיך לתפקד כמצופה, אך לא ניתן יהיה להשתמש בזיכרון מטמון.  כדי לפתור את זה, יש לתת לתיקיית / _cache /   הרשאות כתיבה.';
$_lang["configcheck_configinc"] = 'קובץ ההגדרות עדיין ניתן לכתיבה';
$_lang["configcheck_configinc_msg"] = 'אנא הפוך את קובץ התצורה (/manager/includes/config.inc.php) לקריאה בלבד!';
...
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' is managed and maintained at <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMS.com</a>.<br /> תרגום לעברית '.CMS_NAME.' ישראל<a href="http://www.modx.co.il" target="_blank">'.CMS_NAME.'.co.il</a>.</p>';
...
$_lang["export_site_maxtime"] = 'זמן ייצוא מקסימאלי:';
$_lang["export_site_maxtime_message"] = 'Here you can specify the number of seconds '.CMS_NAME.' can take to export the site (overriding PHP settings). Enter 0 for unlimited time. Please note, setting 0 or a really high number can do weird things to your server and is not recommended.';
$_lang["export_site_message"] = '<p>Using this function you can export the entire site to HTML files. Please note, however, that you will lose a lot of the '.CMS_NAME.' functionality should you do so:</p><ul><li>Page reads on the exported files will not be recorded.</li><li>Interactive snippets will NOT work in exported files</li><li>Only regular documents will be exported, Weblinks will not be exported.</li><li>The export process may fail if your documents contain snippets which send redirection headers.</li><li>Depending on how you\'ve written your documents, style sheets and images, the design of your site may be broken. To fix this, you can save/move your exported files to the same directory where the main '.CMS_NAME.' index.php file is located.</li></ul><p>Please fill out the form and press \'Export\' to start the export process. The files created will be saved in the location you specify, using, where possible, the document\'s aliases as filenames. While exporting your site, it\'s best to have the '.CMS_NAME.' configuration item \'Friendly aliases\' set to \'yes\'. Depending on the size of your site, the export may take a while.</p><p><em>Any existing files will be overwritten by the new files if their names are identical!</em></p>';
$_lang["export_site_numberdocs"] = '<p><b>Found %s documents to export...</b></p>';
$_lang["export_site_prefix"] = 'File prefix:';
$_lang["export_site_start"] = 'התחל בייצוא';
$_lang["export_site_success"] = 'Success!';
$_lang["export_site_suffix"] = 'קידומת קובץ:';
...
$_lang["file_folder_chmod_error"] = 'Unable to change permissions, you will need to change permissions outside of '.CMS_NAME.'.';
...
$_lang["friendlyurls_message"] = 'This allows you to use search engine friendly URLs with '.CMS_NAME.'. Please note, this only works for '.CMS_NAME.' installations running on Apache, and you\'ll need to write a .htaccess file for this to work. See the .htaccess file included in the distribution for more info.';
...
$_lang["import_site"] = 'HTML יבוא מ';
$_lang["import_site_failed"] = 'Failed!';
$_lang["import_site_html"] = 'HTML יבוא אתר מ';
...
$_lang["language_message"] = 'Select the language for the '.CMS_NAME.' Content Manager.';
...
$_lang["messages"] = 'הודעות';
$_lang["messages_all"] = 'כולם';
$_lang["messages_compose"] = 'צור הודעה חדשה';
$_lang["messages_forward"] = 'העבר';
$_lang["messages_from"] = 'מ';
$_lang["messages_group"] = 'קבוצה';
$_lang["messages_inbox"] = 'תיבת דואר נכנס';
$_lang["messages_message"] = 'הודעה';
$_lang["messages_no_messages"] = 'אין הודעות בתיבת הדואר הנכנס.';
$_lang["messages_not_allowed_to_read"] = 'אינך מורשה לקרוא הודעה זו!';
$_lang["messages_private"] = 'פרטי';
$_lang["messages_read_message"] = 'קרא הודעות';
$_lang["messages_reply"] = 'השב';
$_lang["messages_select_group"] = 'בחר קבוצה';
$_lang["messages_select_user"] = 'בחר משתמש';
$_lang["messages_send"] = 'שלח';
$_lang["messages_send_to"] = 'שלח אל';
$_lang["messages_sent"] = 'נשלח ב';
$_lang["messages_subject"] = 'נושא';
$_lang["messages_system_user"] = '[מערכת]';
$_lang["messages_title"] = 'הודעות';
$_lang["messages_user"] = 'משתמש';
...
$_lang["modx_news"] = CMS_NAME.' התראות';
$_lang["modx_news_tab"] = CMS_NAME.' חדשות';
$_lang["modx_news_title"] = CMS_NAME.' חדשות';
$_lang["modx_security_notices"] = CMS_NAME.' התראות אבטחה';
$_lang["modx_version"] = 'גרסת '.CMS_NAME;
$_lang["monday"] = 'שני';
$_lang["move"] = 'הזז';
...
$_lang["password_gen_gen"] = 'Let '.CMS_NAME.' generate a password.';
...
$_lang["php_version_check"] = CMS_NAME.' is compatible with PHP version 4.0.3 and higher. Please upgrade your PHP installation!';
$_lang["plugin"] = 'התקן';
...
$_lang["resource_opt_emptycache_help"] = 'Leaving this field checked will make '.CMS_NAME.' empty the cache after you save the document. This way your visitors will not see an older version of the document.';
...
$_lang["rss_url_news_message"] = 'Enter the URL for the '.CMS_NAME.' News Feed.';
$_lang["rss_url_news_title"] = 'RSS News Feed';
$_lang["rss_url_security_message"] = 'Enter the URL for the '.CMS_NAME.' Security Feed.';
...
$_lang["settings_strip_image_paths_message"] = 'If this is set to \'No\', '.CMS_NAME.'  will write file browser src\'s (images, files, flash, etc.) as absolute URLs. Relative URLs are helpful should you wish to move your '.CMS_NAME.' install, e.g., from a staging site to a production site. If you have no idea what this means, it\'s best just to leave it set to \'Yes\'.';
...
$_lang["tree_show_protected_message"] = 'When set to "No", Protected Pages (and all their child-documents) do not appear in the document tree menu. "No" is the legacy setting for '.CMS_NAME.'.';
...
$_lang["value"] = 'ערך';
$_lang["version_codename"] = 'קוד גרסה';
$_lang["view"] = 'הצג';
...
$_lang["welcome_title"] = '  '.CMS_NAME.' ברוכים הבאים למערכת ניהול התוכן';
$_lang["which_editor_message"] = 'Select the rich text editor (RTE). You can download and install additional RTEs from the '.CMS_NAME.' download page.';
$_lang["which_editor_title"] = 'עורך בשימוש:';
$_lang["working"] = 'בעבודה...';
$_lang["wrap_lines"] = 'שבירת שורות';
$_lang["xhtml_urls_message"] = 'Replaces ampersand (&amp;) characters in urls that are generated by '.CMS_NAME.' with the validating &amp;<!-- -->amp; htmlentity';
