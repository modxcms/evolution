...
$_lang["access_permissions_add_document_group"] = 'Créer un nouveau groupe de documents';
...
$_lang["confirm_duplicate_document"] = 'Voulez-vous vraiment dupliquer ce document?\nLes éléments qu\'il contient seront également dupliqués.';
...
$_lang["credits_everaldo"] = 'MODx utilise plusieurs icônes du jeu d\'icônes Crystal d\'Everaldo. Superbes icônes!';
...
$_lang["credits_shouts_title"] = '<b>Remerciements également à:</b>';
$_lang["credits_webfx"] = 'MODx utilise un certain nombre de JavaScript de Webfx. Superbe travail!';
...
$_lang["delete_document"] = 'Supprimer le document';
...
$_lang["document_alias_help"] = 'Définissez un alias pour que le document soit accessible à l\'adresse : http://exemple.com/alias. Cette fonctionnalité n\'est effective que si vous avez activé les URLs simples dans la configuration de votre site.';
$_lang["document_content"] = 'Contenu du document';
$_lang["document_description"] = 'Description';
$_lang["document_description_help"] = 'Vous pouvez saisir ici une description du document (facultatif).';
$_lang["document_long_title_help"] = 'Vous pouvez saisir ici un titre plus complet pour votre document. Un tel titre peut être utile pour les moteurs de recherche, et offrira une meilleure description de votre document.';
$_lang["document_metatag_help"] = 'Sélectionnez les balises META et les mots-clés que vous souhaitez associer à ce document. Vous pouvez sélectionner plusieurs mots-clés ou balises en gardant la touche CTRL enfoncée';
$_lang["document_opt_contentdispo"] = 'Affichage du contenu';
$_lang["document_opt_contentdispo_help"] = 'Utilisez le champ Affichage du contenu pour définir la façon dont le document doit être traité par le navigateur web. Pour les fichiers à télécharger, sélectionnez l\'option Annexe.';
$_lang["document_opt_emptycache"] = 'Supprimer du cache?';
$_lang["document_opt_emptycache_help"] = 'Cochez cette case si vous souhaitez que MODx supprime automatiquement le document du cache après son enregistrement. Ainsi, vos visiteurs auront accès à la dernière version du document et non pas à la version en cache.';
$_lang["document_opt_folder"] = 'Répertoire?';
$_lang["document_opt_folder_help"] = 'Cochez cette case pour définir ce document comme répertoire d\'autres documents. Un \'répertoire\' est similaire à un dossier, à la différence qu\il peut également avoir du contenu (comme un document).';
$_lang["document_opt_menu_index"] = 'Index de menu';
$_lang["document_opt_menu_index_help"] = 'L\'index de menu est un champ que vous pouvez utiliser pour trier les documents, notamment dans vos snippets de menu. Vous pouvez également l\'utiliser dans vos snippets pour une toute autre utilisation.';
$_lang["document_opt_menu_title"] = 'Titre de menu';
$_lang["document_opt_menu_title_help"] = 'Le titre de menu est un champ (optionnel) que vous pouvez utiliser pour afficher un bref intitulé du document dans vos snippets de menu ou modules.';
$_lang["document_opt_published"] = 'Publié?';
$_lang["document_opt_published_help"] = 'Cochez cette case pour publier ce document immédiatement après son enregistrement.';
$_lang["document_opt_richtext"] = 'Éditeur WYSIWYG?';
$_lang["document_opt_richtext_help"] = 'Cochez cette case si vous souhaitez utiliser l\'éditeur WISIWYG pour modifier ce document. Si le document contient du JavaScript ou des formulaires, décochez la case pour modifier le document en mode HTML, afin que l\'éditeur WYSIWYG ne le détériore pas.';
...
$_lang["document_parent_help"] = 'Cliquez sur l\'icône dossier ci-dessus pour activer (ou désactiver) la sélection d\'un parent. Cliquez ensuite sur un document dans l\'arbre pour le choisir comme parent.';
$_lang["document_permissions_error"] = 'Assignez ce document à au moins un groupe de documents auquel vous avez accès.';
$_lang["document_setting"] = 'Propriétés du document';
$_lang["document_summary"] = 'Résumé';
$_lang["document_summary_help"] = 'Rédigez un bref résumé du document';
$_lang["document_title"] = 'Titre';
$_lang["document_title_help"] = 'Entrez ici le nom du document. Évitez d\'utiliser des antislashs (\) dans ce champ!';
$_lang["document_to_be_moved"] = 'Document à déplacer';
$_lang["document_weblink_help"] = 'Entrez ici l\'adresse (URL) de l\'objet que vous souhaitez référencer.';
$_lang["documents_in_container"] = 'documents dans ce répertoire';
$_lang["documents_in_container_no"] = 'Ce répertoire n\'a aucun document enfant.';
...
$_lang["edit"] = 'Modifier';
$_lang["edit_document"] = 'Modifier le document';
...
$_lang["files_title"] = 'Sélecteur de fichiers';
...
$_lang["insert_snippet"] = 'Insérer un snippet dans le document';
...
$_lang["login_cancelled_site_was_updated"] = '<span style="font-weight: bold; color: red;">MODx a été ré-installé. Veuillez vous connecter à nouveau!</span><br />';
...
$_lang["monday"] = 'Lundi';
$_lang["move"] = 'Déplacer';
$_lang["move_document"] = 'Déplacer le document';
...
$_lang["move_document_new_parent"] = 'Veuillez choisir un nouveau parent dans l\'arbre de documents.';
...
$_lang["resource"] = 'Élément';
$_lang["resource_categories"] = 'Tous les éléments';
$_lang["resource_management"] = 'Gestion des éléments';
$_lang["resource_name"] = 'Nom de l\'élément';
$_lang["resource_selector_msg"] = 'Sélectionne le/les élément(s) dans la liste ci-dessous et cliquez sur le bouton \'Insérer\'.';
$_lang["resource_selector_title"] = 'Sélecteur d\'éléments';
$_lang["resources"] = 'Élements';
$_lang["role"] = 'Rôle';
...
$_lang["snippets_available"] = 'Snippets disponibles pour cette page';
...
$_lang["total"] = 'total';
$_lang["track_visitors_message"] = 'Cette case à cocher permets d\'activer ou non un hook pour les plugins de suivi de statistiques. Ceci peut être utilisé pour contrôler si les visites des pages doivent être comptabilisées.';
...
$_lang["undelete_document"] = 'Rétablir le document';
$_lang["unpublish_date"] = 'Date de dépublication';
$_lang["unpublish_document"] = 'Dépublier le document';
...
$_lang["uploadable_files_message"] = 'Entrez une liste de types de fichiers pouvant être déposés dans le répertoire \'assets/files/\' via le gestionnaire de fichiers. Veuillez entrer les extensions correspondant aux types de fichiers, séparées par des virgules.';
$_lang["uploadable_files_title"] = 'Types de fichier autorisés:';
$_lang["uploadable_flash_message"] = 'Entrez une liste de types de fichiers pouvant être déposés dans \'assets/flash/\' via le gestionnaire de fichiers. Veuillez entrer les extensions pour les fichiers Flash (swf, flv...), séparées par des virgules.';
$_lang["uploadable_flash_title"] = 'Types Flash autorisés:';
$_lang["uploadable_images_message"] = 'Entrez une liste de types de fichier pouvant être déposés dans \'assets/images/\' via le gestionnaire de fichiers. Veuillez entrer les extensions pour les fichiers Image (jpg, jpeg, png...), séparées par des virgules.';
$_lang["uploadable_images_title"] = 'Types d\'image autorisés:';
$_lang["uploadable_media_message"] = 'Entrez une liste de types de fichier pouvant être déposés dans \'assets/media/\' via le gestionnaire de fichiers. Veuillez entrer les extensions pour les fichiers multimédia (mov, avi...), séparées par des virgules.';
...
$_lang["view_document"] = 'Afficher le document';
