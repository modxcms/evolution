...
$_lang["configcheck_cache_msg"] = CMS_NAME.' ne peut pas écrire dans le répertoire cache. '.CMS_NAME.' continuera à fonctionner normalement, mais le cache ne fonctionnera pas. Pour corriger ce problème, veuillez donnez les droits en écriture au répertoire /_cache/.';
...
$_lang["configcheck_php_gdzip_msg"] = CMS_NAME.' a besoin de l\'extension GD et Zip autorisée pour PHP. Même si '.CMS_NAME.' sait travailler sans, vous ne tirerez pas pleinement profit du gestionnaire de fichiers, de l\'éditeur d\'images ou de Captcha pour les logins.';
...
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' est développé et maintenu par <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMS.com</a>.</p>';
...
$_lang["import_site_maxtime_message"] = 'Indiquez ici la durée maximale (en secondes) dont '.CMS_NAME.' va disposer pour importer le site (ceci remplace la configuration PHP). Entrez 0 pour une durée illimitée. Veuillez noter qu\'entrer 0 ou un nombre très élevé n\'est pas recommandé et peut entraîner des dysfonctionnements sur votre serveur.';
...
$_lang["language_message"] = 'Sélectionnez la langue du Gestionnaire de Contenu '.CMS_NAME.'.';
...
$_lang["logo_slogan"] = 'Faire plus avec moins - Gestionnaire de Contenu '.CMS_NAME;
$_lang["logout"] = 'Déconnexion';
$_lang["long_title"] = 'Titre long';
$_lang["mail_check_timeperiod_message"] = 'À quel intervalle '.CMS_NAME.' doit-il vérifier l\'arrivée de nouveaux messages, en secondes.';
...
$_lang["modx_news"] = 'Annonces d\'actualité de '.CMS_NAME;
$_lang["modx_news_tab"] = 'Actualités '.CMS_NAME;
$_lang["modx_news_title"] = 'Actualités de '.CMS_NAME;
$_lang["modx_security_notices"] = 'Bulletins de sécurité '.CMS_NAME;
$_lang["modx_version"] = 'Version de '.CMS_NAME;
$_lang["monday"] = 'Lundi';
$_lang["move"] = 'Déplacer';
...
$_lang["password_gen_gen"] = 'Laisser '.CMS_NAME.' générer un mot de passe.';
...
$_lang["php_version_check"] = CMS_NAME.' est compatible avec PHP version 4.0.3 ou ultérieure. Veuillez mettre à jour votre installation de PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["plugin_msg"] = 'Créer/modifier des Plugins. Les Plugins sont des extraits de code PHP brut exécutés par '.CMS_NAME.' lorsque les Événements Système choisis sont détectés.';
...
$_lang["resource_opt_emptycache_help"] = 'Cochez cette case si vous souhaitez que '.CMS_NAME.' supprime automatiquement la Ressource du cache après son enregistrement. Ainsi, vos visiteurs auront accès à la dernière version de la Ressource et non pas à la version en cache.';
...
$_lang["resource_type_message"] = 'Les Liens Web sont des références à des objets sur Internet. Ce peut être une Ressource dans '.CMS_NAME.', une page sur un autre site, une image ou tout autre fichier accessible sur Internet. Les Liens Web doivent avoir l\'option Type de contenu réglée sur «text/html» et l\'Affichage du contenu défini comme «Élément en ligne»';
...
$_lang["rss_url_news_message"] = 'Entrez l\'URL du flux pour les actualités '.CMS_NAME.'.';
$_lang["rss_url_news_title"] = 'Flux RSS des actualités';
$_lang["rss_url_security_default"] = 'http://feeds.feedburner.com/modxsecurity';
$_lang["rss_url_security_message"] = 'Entrez l\'URL du flux pour les bulletins de sécurité '.CMS_NAME.'.';
...
$_lang["settings_strip_image_paths_message"] = 'L\'activation de cette option permet à '.CMS_NAME.' de changer les liens vers les images et les fichiers en chemin relatifs au lieu de chemins absolus. C\'est très pratique si vous souhaitez déplacer votre installation de '.CMS_NAME.' (par exemple d\'un site en développement à un site en production). Si vous ne savez pas de quoi il s\'agit, il est préférable de ne pas l\'activer.';
...
$_lang["tree_show_protected_message"] = 'Lorsque cette option est sur «Non», les Ressources protégées (et toutes leurs Ressources enfants) ne seront pas visibles dans l\'Arbre du Site. «Non» est le réglage par défaut pour '.CMS_NAME.'.';
...
$_lang["welcome_title"] = 'Bienvenue dans votre Gestionnaire de Contenu '.CMS_NAME;
$_lang["which_editor_message"] = 'Choisissez l\'éditeur WYSIWYG que vous souhaitez utiliser. D\'autres éditeurs WYSIWYG à installer sont disponibles sur la page de téléchargement de '.CMS_NAME.'.';
