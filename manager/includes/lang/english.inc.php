...
$_lang["lock_element_unknown_error"] = "Unknown error occured while sending lock-request (Type %d, Id %d). Element/Resource is not locked against editing by other users anymore!";