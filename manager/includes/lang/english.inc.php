...
$_lang["actioncomplete"] = '<b>Action was completed successfully!</b><br /> - Please wait while '.CMS_NAME.' cleans up.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' cannot write to the cache directory. '.CMS_NAME.' will still function as expected, but no caching will take place. To solve this, make the /_cache/ directory writable.';
...
$_lang["configcheck_installer_msg"] = 'The /install directory contains the installer for '.CMS_NAME.'. Just imagine what might happen if an evil person finds this folder and runs the installer! They\'d probably not get too far, because they need to enter some user information for the database, but it is still best to remove this folder from your server.';
...
$_lang["configcheck_php_gdzip_msg"] = CMS_NAME.' needs the GD and Zip extension enabled for PHP. While '.CMS_NAME.' will work without them, you will not be able to take full advantage of the built-in File Manager, Image Editor or Captcha for logins.';
...
$_lang['configcheck_error_handling_silent_msg'] = 'The configuration setting <strong>Should PHP error messages be shown on the screen</strong> is set so that errors are displayed on the screen. This is recommended for development, but not for live sites.';
...
$_lang["filemanager_path_message"] = 'IIS often does not populate the document_root setting properly, which is used by the file manager to determine what you can see. If you are having problems using the file manager, make sure this path points to the root of your '.CMS_NAME.' installation.';
...
$_lang["loading_page"] = 'Please wait while '.CMS_NAME.' loads the page...';
...
$_lang["modx_news_tab"] = CMS_NAME.' News';
$_lang["modx_news_title"] = CMS_NAME.' News';
$_lang["modx_security_notices"] = CMS_NAME.' Security Notices';
...
$_lang["php_version_check"] = 'ClipperCMS is compatible with PHP version 5 and higher. This server is using version %s%. Please upgrade your PHP installation!';
$_lang["plugin"] = 'Plugin';
...
$_lang["resource_opt_emptycache_help"] = 'Leaving this field checked will make '.CMS_NAME.' empty the cache after you save the Resource. This way your visitors will not see an older version of the Resource.';
...
$_lang["resource_type_message"] = 'Weblinks reference Resources on the Internet including another '.CMS_NAME.' Resource, an external page, or an image or other file on the Internet. Weblinks should have a text/html Internet Media Type and Inline Content-Disposition.';
...
$_lang["tree_show_protected_message"] = 'When set to "No", Protected Resources (and all their child-Resources) do not appear in the Site Tree menu. "No" is the legacy setting for '.CMS_NAME.'.';
...
$_lang["welcome_title"] = 'Welcome to your '.CMS_NAME.' Content Manager';
...
$_lang['error_handling_silent_label'] = 'Should PHP/SQL error messages be shown on the screen.';
$_lang['error_handling_silent_0'] = 'Shown on screen';
$_lang['error_handling_silent_1'] = 'Not displayed. Execution halts with a blank screen.';
