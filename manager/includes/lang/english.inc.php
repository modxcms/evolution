...
$modx_lang_attribute = 'en'; // Manager HTML and XML Language Attribute
$modx_encoding = 'UTF-8';
...
$_lang["friday"] = 'Friday';
$_lang["friendly_alias_message"] = 'With Friendly URLs enabled, a Resource alias will be used when present instead of the Resource ID. E.g., if a Resource with ID 1 has an alias of "introduction", no prefix set (empty) and a suffix of ".html", enabling this option would generate an alias of  "introduction.html". If there is no alias, MODx generates "1.html".';
...
$_lang["use_alias_path_message"] = 'Enabling this option generates a virtual path to the Resource. E.g., if a Resource "child.html" is located in a Container Resource "parent", then the full alias path URL will be "/parent/child.html".';
