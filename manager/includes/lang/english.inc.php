...
$_lang["search_criteria_top_msg"] = 'Pagetitle, Longtitle, alias';
...
$_lang["search_criteria_url_msg"] = 'Find Resource by exact URL or ID.';
...
$_lang["lock_element_unknown_error"] = "Unknown error occured while sending lock-request (Type %d, Id %d). This %s is possibly not locked anymore against editing by other users! Before trying to save, be sure no other user is editing it.";
$_lang["unlock_element_id_warning"] = "Are you sure you want to unlock %s (ID %d)";
...
$_lang["lock_element_editing"] = "You are editing this %s since\n%s";
$_lang["lock_element_locked_by"] = "This %s is locked by user %s since\n%s";