...
$_lang["which_editor_message"] = "Here you can select which rich text editor you wish to use. Note that both TinyMCE and FCKeditor work very well, but have not yet been tested extensively with MODx.  HTMLArea is less suited for stricter, CSS-based designs, but has more features and is a more mature editor.";
