...
$_lang["total"] = 'total';
$_lang["track_visitors_message"] = 'This checkbox provides a hook for analytics plug-ins. It can be used to control whether or not visits to the page are logged.';
$_lang["track_visitors_title"] = 'Enable Stats Traking';
