...
$_lang['document_summary'] ='Summary';
$_lang['document_summary_help'] ='Type a brief summary of the document';
$_lang['close'] = "Close";
$_lang['import_site'] = "Import site from HTML";
...
$_lang['tmplvars_display'] = "Display Type";
$_lang['tmplvars_display_prop'] = "Display Properties";
...
$_lang["empty_plugins_folder"] = "No Plugins found";
...
$_lang["new_user"] = "Create a new user";
$_lang["new_web_user"] = "Create a new Web user";
...
$_lang["edit_settings"] = "System configuration";
$_lang["view_sysinfo"] = "View system info";
...
$_lang["siteunavailable_message"] = "Message to show when the site is offline or if an error occurs.";
...
$_lang['personal_prefs_message'] = "Currently there are no preferences which can be changes on a per-user basis. This section will contain options for overriding stuff like language settings, eventually. Please edit the System configuration to change settings.";
...
$_lang['credits_phpBB'] = "The MODx forums are powered by phpBB!"; // obsolete
...
$_lang['parser_not_writable'] = "The parser you wish to edit is not writable. Please make the file writable (using FTP or your hosts' control panel) before continuing."; //obsolete
...
$_lang['to_plugin_message'] = "Do you wish to enable extended table operations in the document editor?"; // changed 06 RC2
$_lang['im_plugin_title'] = "Image Manager:";
$_lang['im_plugin_message'] = "Do you wish to enable the image manager in the document editor? This will allow your users to upload and edit images on the server."; // changed 06 RC2
$_lang['cm_plugin_title'] = "Context Menu:";
$_lang['cm_plugin_message'] = "Do you wish to enable the Context Menu in the document editor?"; // changed 06 RC2
...
$_lang['layout_settings_1'] = "Basic Layout <br /><span class='comment'>Navigation above the document tree.</span>";
$_lang['layout_settings_2'] = "IE Top Menu Layout <br /><span class='comment'>Navigation at the top of the screen. Currently only works in IE.</span>";
$_lang['layout_settings_3'] = "Advance Layout <br /><span class='comment'>Navigation to the left of the document tree.</span>";
...
$_lang['visitor_stats_online'] = "Visitors now browsing";
...
$_lang['no_online_users'] = "There are no visitors currently browinsg your site.";
...
$_lang['use_strict_editor_message'] = "[Xihna only] - Setting this to Yes will remove some of Xihna's functions that tend to produce non XHTML compliant output.";
...
$_lang['export_site'] = "Export site to HTML";
...
$_lang["which_editor_message"] = "Here you can select which rich text editor you wish to use. Note that both TinyMCE and FCKeditor work very well, but have not yet been tested extensively with MODx.  Xihna (a fork of HTMLArea) is less suited for stricter, CSS-based designs, but has more features and is a more mature editor.";
$_lang["fck_toolbar_title"] = "Toolbar to use:";
$_lang["fck_toolbar_message"] = "[FCKeditor only] - Here you can select which toolbar set to use with FCKeditor.  Choose Basic for limited options and Default for all the available options.";
$_lang["tiny_theme_title"] = "Theme to use:";
$_lang["tiny_theme_message"] = "[TinyMCE only] - Here you can select which theme to use with TinyMCE.  Choose simple for limited options, default for typical options, and advanced for all the available options.";
$_lang["tiny_css_path_title"] = "Path to CSS file:";
$_lang["tiny_css_path_message"] = "[TinyMCE only] - Enter the path to your CSS file that you wish to use within the TinyMCE editor. The best way to enter the path is to enter the path from the root of your server, for example: /assets/site/style.css. If you do not wish to load a stylesheet into the editor, leave this field blank.";
$_lang["tiny_css_selectors_title"] = "CSS selectors:";
$_lang["tiny_css_selectors_message"] = "[TinyMCE only] - Here you can enter a list of selectors that should be available in the editor. Enter them as follows:<br />'displayName=selectorName;displayName2=selectorName2'<br />For instance, say you have <b>.mono</b> and <b>.smallText</b> selectors in your CSS file, you could add them here as:<br />'Monospaced text=mono;Small text=smallText'<br />Note that the last entry should not have a semi-colon after it.";
