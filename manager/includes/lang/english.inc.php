...
$_lang["access_permissions_add_document_group"] = 'Create a new Resource Group';
...
$_lang["access_permissions_docs_message"] = 'Here you can select which Resource Groups this Resource belongs to';
$_lang["access_permissions_document_groups"] = 'Resource Groups';
$_lang["access_permissions_documents_in_group"] = '<b>Resources in group:</b> ';
$_lang["access_permissions_documents_tab"] = 'Here you can see which Resource Groups have been set up. You can also create new groups, rename groups, delete groups and see which Resources are in the different groups (hover over the id of the Resource to see it\'s name). To add a Resource to a group or remove a Resource from a group, edit the Resource directly.';
$_lang["access_permissions_group_link"] = 'Create a new group link';
$_lang["access_permissions_introtext"] = 'Here you can manage the user groups and Resource Groups used for access permissions. To add a user to a user group, edit the user and select the groups (s)he should be a member of. To add a Resource to a user group, edit the Resource and select the groups it should belong to.';
...
$_lang["access_permissions_links_tab"] = 'Here you specify which user groups are given access (i.e. can edit or create children) to the Resource Groups. To link a Resource Group to a user group, select the appropriate groups from the drop down menus, and click on \'Submit\'. To remove the link for a certain group, press \'Remove\'. This will immediately remove the link.';
...
$_lang["add_document"] = 'New Resource';
...
$_lang["automatic_alias_message"] = 'Select \'yes\' to have the system automatically generate an alias based on the Resource\'s page title when saving.';
...
$_lang["category_msg"] = 'Here you can view and edit all Elements grouped by category.';
...
$_lang["charset_message"] = 'Please select which character encoding you wish to use in the manager. Please note that MODx has been tested with a number of these encodings, but not all of them. For most languages, the default setting of UTF-8 is preferable.';
...
$_lang["confirm_delete_document"] = 'Are you sure you want to delete this Resource?\nAny children Resources will also be deleted.';
...
$_lang["confirm_duplicate_document"] = 'Are you sure you want to duplicate this Resource? Any item(s) it contains will also be duplicated.';
...
$_lang["create_document_here"] = 'Create Resource here';
...
$_lang["custom_contenttype_message"] = 'Here you can add custom content types to be used in your Resources. To add a new entry, enter the content type in the text box then click the \'Add\' button.';
...
$_lang["delete"] = 'Delete';
$_lang["delete_document"] = 'Delete Resource';
...
$_lang["document_alias"] = 'Resource\'s alias';
$_lang["document_alias_help"] = 'Set the URL alias to make the Resource accessible as http://example.com/alias. This only works friendly URLs are enabled in the site configuration.';
...
$_lang["document_long_title_help"] = 'Enter an optional longer title for your Resource. This can be used for automatic Resource header tags for search engines, and might be more descriptive for your Resource.';
$_lang["document_metatag_help"] = 'Select the META tags or keywords you wish to assign to this Resource. Hold down the CTRL key to select multiple keywords or meta tags.';
$_lang["document_opt_contentdispo"] = 'Content Disposition';
$_lang["document_opt_contentdispo_help"] = 'Use the content disposition field to specify how this Resource will be handled by the web browser. For file downloads select the Attachment option.';
$_lang["document_opt_emptycache"] = 'Empty cache?';
$_lang["document_opt_emptycache_help"] = 'Leaving this field checked will make MODx empty the cache after you save the Resource. This way your visitors will not see an older version of the Resource.';
$_lang["document_opt_folder"] = 'Container?';
$_lang["document_opt_folder_help"] = 'Check this to make the Resource also act as a Container for other Resources. A \'Container\' is like a folder, only it can also have content.';
...
$_lang["document_opt_published_help"] = 'Check this field to have the Resource published immediately after saving it.';
$_lang["document_opt_richtext"] = 'Rich text?';
$_lang["document_opt_richtext_help"] = 'Leave this checked to use the rich text editor for editing Resources. If your Resources contain JavaScript and forms, uncheck this to edit in HTML mode to prevent the editor from incorrectly changing your Resources.';
$_lang["document_opt_show_menu"] = 'Show in menu';
$_lang["document_opt_show_menu_help"] = 'Select this option to show Resource inside a web menu. Please note that some Menu Builders might choose to ignore this option.';
$_lang["document_opt_trackvisit_help"] = 'Log each visitor\'s visit to this page';
$_lang["document_overview"] = 'Resource overview';
$_lang["document_parent"] = 'Resource parent';
$_lang["document_parent_help"] = 'Click on the icon above to enable (or disable) selecting this Resource\'s parent. Next, click a Resource in the Site Tree to set its new parent.';
$_lang["document_permissions_error"] = 'Assign this Resource to at least one Resource Group to which you have access.';
$_lang["document_setting"] = 'Resource setting';
$_lang["document_summary"] = 'Summary (introtext)';
$_lang["document_summary_help"] = 'Type a brief summary of the Resource';
$_lang["document_title"] = 'Title';
$_lang["document_title_help"] = 'Enter the name/title of the Resource. Avoid using backslashes in the name.';
$_lang["document_to_be_moved"] = 'Resource to be moved';
$_lang["document_weblink_help"] = 'Type the address of the object you wish to reference with this weblink here.';
$_lang["documents_in_container"] = 'Resources in this Container';
$_lang["documents_in_container_no"] = 'This Container does not have child-Resources.';
$_lang["duplicate"] = 'Duplicate';
$_lang["duplicate_alias_found"] = 'Resource \'%s\' is already using the alias \'%s\'. Please enter a unique alias.';
$_lang["duplicate_alias_message"] = 'Select \'yes\' to allow duplicate aliases to be saved. <b>NOTE: This option should be used with \'Friendly alias path\' option set to \'Yes\' in order to avoid problems when referencing a Resource.</b>';
...
$_lang["edit_document_title"] = 'Edit Resource';
...
$_lang["errorpage_message"] = 'Enter the ID of the Resource you want to send users to if they request a Resource which doesn\'t actually exist. <b>NOTE: make sure this ID you enter belongs to an existing Resource, and that it has been published!</b>';
...
$_lang["export_site_failed_no_open_filename"] = 'Cannot open file ($filename).';
...
$_lang["filemanager_path_message"] = 'IIS often does not populate the document_root setting properly, which is used by the file manager to determine what you can see. If you\'re having problems using the file manager, make sure this path points to the root of your MODx installation.';
...
$_lang["import_parent_document"] = 'Parent Resource:';
...
$_lang["import_site_message"] = '<p>Import an entire HTML site into your site database. Please note that you will need to copy your html files and/or folders into the /assets/import directory.</p><p>Please fill out the form and press \'Import\' to start the import process. The files imported will be saved into the selected location, using the files name as the Resource\'s aliases where possible, and the Resource title tag as the pagetitle.';
...
$_lang["monday"] = 'Monday';
$_lang["move"] = 'Move';
$_lang["move_document"] = 'Move Resource';
$_lang["move_document_message"] = 'Move a Resource and all its children by selecting a new parent in the Site Tree. If you select a Resource that is not already a Container, it will be changed into one. Please click on the new parent in the Site Tree.';
$_lang["move_document_new_parent"] = 'Please select a new parent in the Site Tree.';
$_lang["move_document_title"] = 'Move Resource';
$_lang["name"] = 'Name';
...
$_lang["preview_document"] = 'Preview Resource';
...
$_lang["publish_document"] = 'Publish Resource';
...
$_lang["resource"] = 'Element';
$_lang["resource_categories"] = 'Combined View';
$_lang["resource_management"] = 'Manage Elements';
$_lang["resource_name"] = 'Element name';
$_lang["resource_selector_msg"] = 'Select the Elements(s) from the list below and click the \'Insert\' button.';
$_lang["resource_selector_title"] = 'Element Selector';
$_lang["resources"] = 'Elements';
$_lang["role"] = 'Role';
...
$_lang["total"] = 'total';
$_lang["track_visitors_message"] = 'This checkbox provides a hook for analytics Plugins. It can be used to control whether or not visits to the page are logged.';
...
$_lang["tv"] = 'TV';
$_lang["type"] = 'Type';
$_lang["udperms_allowroot_message"] = 'Do you want to allow your users to create new Resources in the root of the site? ';
$_lang["udperms_allowroot_title"] = 'Allow root:';
$_lang["udperms_message"] = 'Access permissions allow you to specify which pages your users are allowed to edit. You\'ll need to assign your users to user groups, your Resources to Resource Groups, and then you\'ll need to specify which user groups are allowed to access which Resource Groups. When you first turn this on, only administrators will be allowed to edit any Resources.';
...
$_lang["unauthorizedpage_message"] = 'Enter the ID of the Resource you want to send users to if they have requested a secured or unauthorized Resource. <b>NOTE: make sure the ID you enter belongs to an existing Resource, and that it has been published and is publicly accessible!</b>';
...
$_lang["undelete_document"] = 'Undelete Resource';
$_lang["unpublish_date"] = 'Unpublish Date';
$_lang["unpublish_document"] = 'Un-publish Resource';
$_lang["unpublish_events"] = 'Un-publish Events';
$_lang["untitled_document"] = 'Untitled Resource';
...
$_lang["use_alias_path_message"] = 'Setting this option to \'yes\' will display the full path to the Resource if the Resource has an alias. For example, if a Resource with an alias called \'child\' is located inside a Container Resource with an alias called \'parent\', then the full alias path to the Resource will be displayed as \'/parent/child.html\'.<br /><b>NOTE: When setting this option to \'Yes\' (turning on alias paths), reference items (such as images, CSS, javascript, etc.) using the absolute path: e.g., \'/assets/images\' as oppose to \'assets/images\'. By doing so you will prevent the browser (or web server) from appending the relative path to the alias path.</b>';
$_lang["use_alias_path_title"] = 'Use friendly alias path:';
$_lang["use_editor_message"] = 'Do you want to enable the rich text editor? If you\'re more comfortable writing HTML, then you can turn the editor off using this setting. Note that this setting applies to all Resources and all users!';
