...
$_lang["which_editor_message"] = "Here you can select which rich text editor you wish to use. Note that TinyMCE works very well, but has not yet been tested extensively with MODx. Also, it does not offer all the features that HTMLArea offers, but is better suited for people who wish to use a lot of CSS in their document's markup. ImageManager, TableOperations and other HTMLArea settings will not affect TinyMCE, likewise, the TinyMCE CSS settings will have no effect on HTMLArea.";
