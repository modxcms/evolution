...
$_lang["access_permissions_link_to_group"] = 'to Document Group';
...
$_lang["module_msg"] = 'Here you can add/edit Modules. A Module is a collection of Elements (e.g. plugins, snippets, etc).';
$_lang["module_name"] = 'Module name';
$_lang["module_resource_msg"] = 'Here you can add or remove Elements that this module depends on. To add a new Element click on the one of the add buttons below.';
$_lang["module_resource_title"] = 'Module Dependencies';
$_lang["module_title"] = 'Create/edit Module';
$_lang["module_viewdepend_msg"] = 'Here you can view the assigned Elements that the module depends on. Click on the \'Manager Dependencies\' button to modify the dependencies';
...
$_lang["uploadable_files_message"] = 'Here you can enter a list of files that can be uploaded into \'assets/files/\' using the File Browser. Please enter the extensions for the filetypes, seperated by commas.';
$_lang["uploadable_files_title"] = 'Uploadable File Types:';
$_lang["uploadable_flash_message"] = 'Here you can enter a list of files that can be uploaded into \'assets/flash/\' using the File Browser. Please enter the extensions for the flash types, separated by commas.';
$_lang["uploadable_flash_title"] = 'Uploadable Flash Types:';
$_lang["uploadable_images_message"] = 'Here you can enter a list of files that can be uploaded into \'assets/images/\' using the File Browser. Please enter the extensions for the image types, separated by commas.';
$_lang["uploadable_images_title"] = 'Uploadable Image Types:';
$_lang["uploadable_media_message"] = 'Here you can enter a list of files that can be uploaded into \'assets/media/\' using the File Browser. Please enter the extensions for the media types, separated by commas.';
