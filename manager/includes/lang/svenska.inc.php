 ...
 * Encoding:       ISO-8859-1
 * Author:         Johnny Chadda & Pontus Ågren
 * Date:           17-Dec-2005
 * Version:        0.9.1
 * MODx version:   0.9.1
*/
...
$_lang['my_preferences'] = "Inställningar";
...
$_lang['edit_parser'] = "Redigera tolkar";
$_lang['site_parser'] = "Webbplatstolk";
$_lang['action_parser'] = "Händelsetolk";
...
$_lang['edit_snippet'] = "Redigera kodsnutt";
$_lang['document_tree'] = "Dokumentträd";
...
$_lang['restore_tree'] = "Återställ träd (standardbredd)";
$_lang['help'] = "Hjälp";
$_lang['credits'] = "Erkännanden";
$_lang['about'] = "Om MODx";
$_lang['rebuild'] = "Återskapa";
$_lang['menu'] = "Meny";
$_lang['tree'] = "Träd";
$_lang['manager'] = "Hanterare";
$_lang['test_page'] = "Testsida";
$_lang['logout'] = "Logga ut";
$_lang['nojava'] = "Java verkar vara avstängt. Klicka <a href='index.php?a=1&f=9&javaDis=1'>här</a> för att ladda en meny utan java.";
$_lang['confirm_empty_trash'] = "Detta kommer att permanent radera ALLA borttagna dokument!\\n\\nFortsätt?"; // changed 06 RC2
...
$_lang['published_document'] = "Detta är ett publicerat dokument.";
$_lang['unpublished_document'] = "Detta är ett avpublicerat dokument.";
$_lang['deleted_document'] = "Detta är ett borttaget dokument.";
$_lang['published_folder'] = "Detta är en publicerad mapp.";
$_lang['unpublished_folder'] = "Detta är en avpublicerad mapp.";
$_lang['deleted_folder'] = "Detta är en borttagen mapp.";
$_lang['published_weblink'] = "Detta är en publicerad webblänk.";
$_lang['unpublished_weblink'] = "Detta är en avpublicerad webblänk.";
$_lang['deleted_weblink'] = "Detta är en borttagen webblänk.";
$_lang['published_weblink_folder'] = "Detta är en publicerad webblänkmapp.";
$_lang['unpublished_weblink_folder'] = "Detta är en avpublicerad webblänkmapp.";
$_lang['deleted_weblink_folder'] = "Detta är en borttagen webblänkmapp.";
$_lang['recycle_bin'] = "Papperskorg"; // obsolete
$_lang['empty_recycle_bin'] = "Radera borttagna dokument"; // changed 06 rc 2
$_lang['deleted_in_tree'] = "Visa borttagna i trädet"; // obsolete
$_lang['deleted_in_recycle_bin'] = "Visa borttagna i papperskorgen"; // obsolete
$_lang['recycle_bin_empty'] = "Papperskorgen är tom."; // obsolete
$_lang['loading_doc_tree'] = "Laddar dokumentträd...";
$_lang['loading_menu'] = "Laddar meny...";
$_lang['loading_menu_tree'] = "Laddar dokumentträd och meny...";
...
$_lang['clicktopin'] = "Klicka för att fästa denna sektion.";
$_lang['clicktounpin'] = "Klicka för att lossa denna sektion.";
$_lang['clickonsection'] = "Klicka här för att visa eller dölja denna sektion.";
$_lang['edit'] = "Redigera";
$_lang['save'] = "Spara";
$_lang['delete'] = "Ta bort";
$_lang['cancel'] = "Avbryt";
$_lang['find_in_tree'] = "Hitta i trädet"; // obsolete per 06 RC2
...
$_lang['advanced'] = "Avancerad";
$_lang['regular'] = "Vanlig";
...
$_lang['friendlyurlsprefix_message'] = "Här specificerar du prefixet som ska användas för vänliga adresser. Om exempelvis prefixet 'sida' sätts, kommer adressen /index.php?id=2 att konverteras till /sida2.html (om suffixet är satt till .html). På detta sätt kan du specificera vad dina användare (och sökmotorerna) ser för länkar på din sida."; // updated 0.6 - removed htaccess warning
$_lang['friendlyurlsuffix_title'] = "Suffix för vänliga adresser";
$_lang['friendlyurlsuffix_message'] = "Här anger du suffix för vänliga adresser. Specificerar du '.html' kommer .html att läggas till på alla dina vänliga adresser."; // updated 0.6 - removed htaccess warning
$_lang['udperms_title'] = "Använd åtkomsträttigheter";
$_lang['udperms_message'] = "Åtkomsträttigheter tillåter dig att specificera vilka sidor dina användare har behörighet att redigera. Du måste tilldela användargrupper till dina användare, gruppera dokumenten i dokumentgrupper och till sist specificera vilka användargrupper som har behörighet att komma åt vilka dokumentgrupper. När du först slår på detta, kommer endast administratörer att kunna redigera dokument."; // updated 0.6
$_lang['menutype_title'] = "Menytyp";
$_lang['menutype_message'] = "Välj om du vill använda den avancerade javamenyn eller den vanliga textmenyn. (För närvarande kan du ej ändra detta, då jag fortfarande behöver skriva om textmenyn.)";
...
$_lang['graphtype_title'] = "Graftyp";
$_lang['graphtype_message'] = "Väljer du 'Avancerad' så får du kantutjämnade grafer i dina rapporter, men även en högre processoranvändning. Graferna kommer dock att se mycket bättre ut.";
$_lang['showgraphs_title'] = "Visa grafer";
$_lang['showgraphs_message'] = "Vill du visa värdena i grafer och tabeller, när rapporten för besöksstatistik genereras?";
$_lang['showtestpage_title'] = "Tillåt testsida";
$_lang['showtestpage_message'] = "Du kan använda testsidan för att förhandsgranska kodsnuttar som du bygger. Om du inte använder testsidan, kanske du vill ta bort den från menyn genom att välja 'Nej'.";
$_lang['enabledebug_title'] = "Använd felsökning";
$_lang['enabledebug_message'] = "Väljer du 'Ja', kommer MODx visa felsökningsinformation om olika funktioner. Vanligtvis behöver du ej det här, men om du försöker utreda en bugg kan det vara användbart att slå på detta.";
...
$_lang['document_opt'] = "Publicering, cachning och utseende";
...
$_lang['edit_parser_title'] = "Redigera tolk";
$_lang['edit_parser_warning'] = "<b style='color:#821517'>Modifiering av denna fil kan allvarligt förstöra din webbplats!</b><br />Du redigerar nu en fysisk PHP-fil. Var noga med att göra en säkerhetskopia (i Anteckningar eller liknande) innan ändringar sparas!";
...
$_lang['role_edit_parser'] = "Redigera tolkar";
$_lang['role_save_parser'] = "Spara tolkar";
...
$_lang['refresh_cache'] = "Cache: Hittade <b>%s</b> filer i cachekatalogen, och tog bort <b>%d</b> cachefiler. <p>Nya cachefiler kommer automatiskt att skapas när sidorna hämtas"; // changed in 0.6
...
$_lang['credits_htmlarea'] = "HTMLArea skapades av mishoo. För närvarande är det den enda editorn som fungerar i flera olika webbläsare, och den är dessutom fri också!"; // obsolete
$_lang['credits_adodb'] = "John Lim skrev detta underbara abstraktionslager för databaser. MODx använder bara MySQL-delarna, men det är fint ändå!"; // obsolete
$_lang['credits_php'] = "MODx använder PHP!"; // obsolete
$_lang['credits_mysql'] = "MODx använder MySQL!"; // obsolete
$_lang['credits_webfx'] = "MODx använder ett antal javascript från Webfx. Fina grejer!"; // obsolete
$_lang['credits_dTree'] = "MODx använder det utmärkta dTree-scriptet från DestroyDrop.com!"; // obsolete
$_lang['credits_shouts_title'] = "<b>Stort tack till:</b>"; // obsolete
...
$_lang['messages_category'] = "Kategori";
...
$_lang['files_file_upload'] = "Ladda upp fil";
...
$_lang['parser_not_writable'] = "Tolken du vill redigera är inte skrivbar. Gör filen skrivbar (genom FTP eller din internetleverantörs kontrollpanel) innan du fortsätter."; //obsolete
...
$_lang['settings_server'] = "Serverinställningar"; // deprecated
$_lang['settings_site'] = "Webbplatsen";
$_lang['settings_furls'] = "Vänliga adresser";
$_lang['settings_users'] = "Användare"; //changed 0.6 - shortened
$_lang['settings_ui'] = "Gränssnitt & editor"; //changed 0.6 - added editor
$_lang['settings_reports'] = "Rapportinställningar"; // deprecated
$_lang['settings_editor'] = "Editorinställningar"; // deprecated
...
$_lang['layout_settings_title'] = "Layoutinställningar"; // deprecated
$_lang['layout_title'] = "Layout för hanterare";
$_lang['layout_message'] = "Använd denna inställning för att välja layout för MODx sidhanterare";
$_lang['layout_settings_1'] = "Standardlayout<br /><span class='comment'>Navigation i ett fast fält ovanför dokumentträdet</span>";
$_lang['layout_settings_2'] = "Toppmenylayout (endast IE)<br /><span class='comment'>Navigationslist överst på skärmen, som för närvarande endast fungerar i IE.</span>";
...
$_lang['snippet_locked_message'] = "Denna kodsnutt är låst.";
...
$_lang['visitor_stats_online'] = "Nuvarande besökare";
...
$_lang['no_stats_message'] = "Denna sektion visar vanligtvis besöksstatistik för din webbplats, men i konfigurationen för MODx har du satt 'Logga besök' till 'Nej', så det lagras för närvarande ingen information.";
$_lang['welcome_visitor_stats'] = "Denna tabell visar besöksstatistik för din webbplats. För mer detaljerad information, gå till sidan 'Besöksstatistik'.<br /><br />";
$_lang['page_impressions'] = "Sidavtryck";
$_lang['visitors'] = "Unika besökare";
$_lang['visits'] = "Besök";
$_lang['all_time'] = "Alltid";
$_lang['this_month'] = "Denna månad";
$_lang['today'] = "Idag";
$_lang['document_visitor_stats'] = "<br /><br />Denna tabell visar besöksstatistik för detta dokument:<br />";
...
$_lang['stats_title'] = "Besöksstatistik för '%s' från %s till %s";
$_lang['stats_monthly_breakup'] = "Statistik per månad";
$_lang['stats_daily_breakup'] = "Statistik per dag";
$_lang['stats_hourly_breakup'] = "Statistik per timme";
$_lang['top_howmany_title'] = "Hur många i toppen";
$_lang['top_howmany_message'] = "När rapporter visas, hur långa ska 'Topp ...' listorna vara?";
$_lang['stats_top_pages'] = "Topp %s dokument";
$_lang['document'] = "Dokument";
$_lang['rank'] = "Rank";
$_lang['stats_top_referrers'] = "Topp %s hänvisande sidor";
$_lang['referrer'] = "Hänvisad av";
$_lang['stats_top_ua'] = "Topp %s webbläsare";
$_lang['ua'] = "Webbläsare";
$_lang['stats_top_os'] = "Topp %s operativsystem";
$_lang['os'] = "Operativsystem";
$_lang['visitors_used_this'] = "Besökare använder detta";
$_lang['visitors_came_from_here'] = "Besökare kom härifrån";
$_lang['no_results'] = "Inga resultat hittade";
$_lang['no_online_users'] = "Det finns för närvarande inga besökare på webbplatsen.";
$_lang['stats_top_hosts'] = "Topp %s värddatorer";
$_lang['hostname'] = "Värddatornamn";
$_lang['unknown_referer'] = "Okänd/Direkt/Bokmärke";
$_lang['internal_referer'] = "Interna hänvisningar";
$_lang['stats_top_entrypages'] = "Topp %s ingångsdokument";
$_lang['visits_started_here'] = "Besök startade här";
$_lang['no_logging_found'] = "MODx kunde inte hitta några loggdata i databasen. Detta betyder att loggningen är avstängd, eller så har din sida ännu ej haft några besökare.";
$_lang['visitor_online'] = "Nuvarande besökare på webbplatsen";
$_lang['visitor_online_message'] = "Här kan du se vilka besökare som varit aktiva på webbplatsen de senaste 20 minuterna (sedan %s).";
$_lang['access_permission_denied'] = "Du har inte behörighet för detta dokument."; // changed 0.6 RC2
...
$_lang['edit_htmlsnippet'] = "Redigera kodstycke";
...
$_lang['htmlsnippet_locked_message'] = "Detta kodstycke är låst";
...
$_lang['access_permissions_users_message'] = "Här kan du välja vilka användargrupper denna anvädare ska tillhöra:";
...
$_lang['openurl_message'] = "Vilken adress vill du öppna?";
$_lang['openurl'] = "Öppna en extern webbplats";
...
$_lang['modules_already_installed'] = "Installerade moduler";
$_lang['modules_install_new'] = "Installera ny modul";
$_lang['module_install_info'] = "Komponenter installerade av denna modul";
$_lang['type'] = "Typ";
$_lang['alias'] = "Alias";
$_lang['deleted'] = "Borttaget";
...
$_lang['sort_dir'] = "Sorteringsordning:";

/***************************************************************************/
// new to modx tech preview
/***************************************************************************/

$_lang['my_account'] = "Mitt&nbsp;konto";
...
$_lang['back'] = "Tillbaka";
$_lang['back_title'] = "Ladda föregående sida";
$_lang['forward'] = "Framåt";
$_lang['reload'] = "Ladda om";
$_lang['reload_title'] = "Laddar om sidan";
...
$_lang['edit_tmplvars'] = "Redigera mallvariabler";
...
$_lang['tmplvars_locked_message'] = "Denna variabel är låst.";
...
$_lang['settings_keywords'] = "Nyckelord";
...
$_lang['edit_plugin'] = "Redigera insticksprogram";
...
$_lang['layout_settings_3'] = "Tre kolumner<br /><span class='comment'>Navigation till vänster om dokumentträdet.</span>";
...
$_lang['edit_module'] = "Redigera modul";
...
$_lang['module_depend_msg'] = "Använd knapparna till höger för att lägga till eller ta bort resurser som den här modulen är beroende av.";
...
$_lang['metatag_message'] = "Här kan du hantera webbplatsens META-taggar och nyckelord.";
$_lang['tag'] = "Tagg";
...
$_lang['layout_settings_4'] = "Ihopfällbar toppmeny<br /><span class='comment'>Ihopfällbar navigeringsmeny ovanför dokumentträdet och huvudfönstret.</span>";
...
$_lang['months'] = array("Jan", "Feb", "Mar", "Apr", "Maj", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec");
$_lang['days'] = array("Sön", "Mån", "Tis", "Ons", "Tor", "Fre", "Lör");
...
$_lang['logout_message'] = "Du är för närvarande inloggad i innehållshanteraren. Om du vill avsluta din session klickar du på 'Logga ut'. <p />Klicka på 'Hem' för att komma till hanterarens startsida.";
$_lang['layout_settings_5'] = "Snapin toppmeny<br /><span class='comment'>Öppnar en navigeringsmeny ovanför dokumentträdet och huvudfönstret.</span>";
...
$_lang['switch_to_rte'] = "Ändra till richtext";
...
$_lang['QE_hide_links'] = 'Dölj länkar';
