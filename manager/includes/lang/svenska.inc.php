 ...
 * Date:           2009-07-29
 * Version:        1.0
 * MODx version:   Evolution 1.0 rev 5552
*/
...
$_lang["access_permissions_add_document_group"] = 'Skapa en ny resursgrupp';
...
$_lang["automatic_alias_message"] = 'Välj "Ja" för att låta systemet automatiskt skapa ett alias baserat på resursens titel när den sparas.';
...
$_lang["confirm_delete_document"] = 'Är du säker på att du vill ta bort denna resurs?\nEventuella underresurser kommer också att tas bort.';
...
$_lang["confirm_duplicate_document"] = 'Är du säker på att du vill duplicera denna resurs?\nEventuella underresurser som den innehåller kommer också att dupliceras.';
...
$_lang["create_document_here"] = 'Skapa resurs här';
...
$_lang["delete_document"] = 'Ta bort resurs';
...
$_lang["document"] = 'Resurs';
$_lang["document_alias"] = 'Resursens&nbsp;alias';
$_lang["document_alias_help"] = 'Ange ett URL-alias för att göra resursen tillgänglig som http://dinserver/alias. Detta fungerar endast om vänliga adresser är aktiverade i webbplatsens konfiguration.';
$_lang["document_content"] = 'Resursinnehåll';
$_lang["document_description"] = 'Beskrivning';
$_lang["document_description_help"] = 'Ange en valfri beskrivning av denna resurs.';
$_lang["document_long_title_help"] = 'Ange en valfri längre titel för din resurs. Denna kan användas för automatiska header-taggar för sökmotorer, och beskriver kanske din resurs bättre.';
$_lang["document_metatag_help"] = 'Välj de META-taggar och nyckelord som du vill knyta till den här resursen. Håll ner Ctrl för att välja flera nyckelord eller META-taggar.';
$_lang["document_opt_contentdispo"] = 'Innehållsdisposition';
$_lang["document_opt_contentdispo_help"] = 'Använd innehållsdispositionsfältet för att specificera hur den här resursen ska hanteras av webbläsaren. För filnedladdningar väljer du inställningen "Bifogad fil".';
$_lang["document_opt_emptycache"] = 'Töm cachen';
$_lang["document_opt_emptycache_help"] = 'Lämnar du detta fält markerat, kommer MODx att tömma sin cache när du sparar resursen. Det gör att dina besökare inte kommer att se en gammal version av resursen.';
$_lang["document_opt_folder"] = 'Behållare?';
$_lang["document_opt_folder_help"] = 'Markera här om resursen ska fungera som en behållare för andra resurser. En "behållare" är som en mapp, men den kan också ha ett eget innehåll.';
$_lang["document_opt_menu_index"] = 'Menyindex';
$_lang["document_opt_menu_index_help"] = 'Menyindex är ett fält som kan användas för att kontrollera sorteringen av resurser. Speciellt i snippets som bygger menyer. Du kan också använda det för andra ändamål i dina snippets.';
$_lang["document_opt_menu_title"] = 'Menytitel';
$_lang["document_opt_menu_title_help"] = 'Menytitel är ett valfritt fält som används för att visa en kort titel i menysnippets eller moduler.';
$_lang["document_opt_published"] = 'Publicerad';
$_lang["document_opt_published_help"] = 'Markera detta fält om resursen ska publiceras direkt när den sparas.';
$_lang["document_opt_richtext"] = 'Richtext';
$_lang["document_opt_richtext_help"] = 'Lämna denna ikryssad för att använda en richtext-editor vid resursredigering. Om dina resurser innehåller javascript eller formulär - avmarkera denna för att redigera i HTML-läge, så editorn inte stökar till i dina resurser.';
$_lang["document_opt_show_menu"] = 'Visa i meny';
$_lang["document_opt_show_menu_help"] = 'Välj den här inställningen för att visa resursen i en webbmeny. Notera att vissa menybyggarsnippets kan välja att strunta i den här inställningen.';
$_lang["document_opt_trackvisit_help"] = 'Logga varje besökares besök på den här sidan';
$_lang["document_overview"] = 'Resursöversikt';
$_lang["document_parent"] = 'Resursförälder';
$_lang["document_parent_help"] = 'Klicka på ikonen för att aktivera val av förälder för denna resurs. Klicka sedan på en resurs i webbplatsträdet för att ange den som ny förälder.';
$_lang["document_permissions_error"] = 'Tilldela denna resurs till minst en resursgrupp som du kan komma åt.';
$_lang["document_setting"] = 'Resursinställningar';
$_lang["document_summary"] = 'Sammanfattning';
$_lang["document_summary_help"] = 'Skriv en kort sammanfattning av resursen';
$_lang["document_title"] = 'Titel';
$_lang["document_title_help"] = 'Skriv namnet/titeln på resursen här. Undvik omvända snedstreck i namnet.';
$_lang["document_to_be_moved"] = 'Resursen som ska flyttas';
$_lang["document_weblink_help"] = 'Ange adressen till objektet du vill referera till med denna webblänk.';
$_lang["documents_in_container"] = 'resurser i den här behållaren';
$_lang["documents_in_container_no"] = 'Den här behållaren har inga underresurser.';
$_lang["duplicate"] = 'Duplicera';
$_lang["duplicate_alias_found"] = 'Resursen "%s" använder redan aliaset "%s". Ange ett unikt alias.';
$_lang["duplicate_alias_message"] = 'Välj "Ja" för att tillåta att aliasdubletter sparas.<br /><b>Notera: Den här inställningen bör användas med "Vänliga aliassökvägar" satt till "Ja" för att undvika problem med refereringen av resurser.</b>';
$_lang["duplicate_alias_title"] = 'Tillåt aliasdubletter';
$_lang["duplicate_document"] = 'Duplicera resurs';
...
$_lang["edit"] = 'Redigera';
$_lang["edit_document"] = 'Redigera resurs';
$_lang["edit_document_title"] = 'Redigera resurs';
...
$_lang["export_site_success_skip_dir"] = 'Hoppa över denna katalog.';
$_lang["export_site_success_skip_doc"] = 'Hoppa över detta dokument.';
...
$_lang["export_site_time"] = 'Exporten är klar. Den tog %s sekunder att göra.';
...
$_lang["friday"] = 'Fredag';
$_lang["friendly_alias_message"] = 'Om vänliga adresser aktiveras kommer resursens alias att användas istället för resursens ID. Det betyder att en resurs med ID 1 som har aliaset "introduktion", inget prefix (tomt) och suffixet satt till ".html" vid en aktivering av vänliga adresser kommer att få adressen "introduktion.html". Om det inte finns något alias, kommer MODx att generera adressen "1.html".';
...
$_lang["friendlyurlsprefix_message"] = 'Om prefixet "sida" anges, kommer adressen /index.php?id=2 att omvandlas till aliaset "sida2.html" (om suffixet är satt till .html).';
$_lang["friendlyurlsprefix_title"] = 'Prefix för vänliga adresser';
$_lang["friendlyurlsuffix_message"] = 'Vilket suffix som helst, även ett tomt, kommer att fungera. Om du anger ".aspx" kommer .aspx att läggas till i slutet av alla alias.';
...
$_lang["import_parent_document"] = 'Föräldraresurs';
$_lang["import_site"] = 'Importera HTML';
$_lang["import_site_failed"] = 'Misslyckades!';
$_lang["import_site_failed_db_error"] = 'Ett databasfel inträffade när dokumentet skulle klonas: ';
$_lang["import_site_failed_no_open_dir"] = 'Kunde inte öppna katalog: ';
$_lang["import_site_failed_no_retrieve_file"] = 'Kunde inte hämta fil: ';
...
$_lang["import_site_maxtime_message"] = 'Ange hur många sekunder som innehållshanteraren får ta i anspråk när den importerar webbplatsen (åsidosätter PHPs inställningar). Skriv 0 för obegränsad tid. Notera att om 0 eller ett väldigt stort nummer anges, kan det få din server att göra konstiga saker och rekommenderas därför inte.';
$_lang["import_site_message"] = '<p>Importera en hel HTML-webbplats till din webbplats databas. Notera att du måste kopiera dina html-filer och kataloger till katalogen assets/import.</p><p>Fyll i formuläret och klicka på "Starta import" för att starta importprocessen. Filerna som importeras kommer att sparas till den valda platsen, och där det är möjligt kommer filnamnet att användas som resursens alias, och title-elementet som resursens titel.';
$_lang["import_site_skip"] = 'Överhoppad!';
$_lang["import_site_start"] = 'Starta import';
$_lang["import_site_success"] = 'Klart!';
$_lang["import_site_time"] = 'Importen är klar. Den tog %s sekunder att göra.';
$_lang["inbox"] = 'Inkorg';
...
$_lang["monday"] = 'Måndag';
$_lang["move"] = 'Flytta';
$_lang["move_document"] = 'Flytta resurs';
$_lang["move_document_message"] = 'Flytta en resurs och alla dess underresurser genom att välja en ny förälder i webbplatsträdet. Om du väljer en resurs som inte redan är en behållare, kommer den att ändras till en. Klicka på den nya föräldern i trädet.';
$_lang["move_document_new_parent"] = 'Välj en ny förälder i webbplatsträdet.';
$_lang["move_document_title"] = 'Flytta resurs';
$_lang["name"] = 'Namn';
...
$_lang["publish_document"] = 'Publicera resurs';
...
$_lang["resource_management"] = 'Hantera element';
$_lang["resource_name"] = 'Elementnamn';
$_lang["resource_selector_msg"] = 'Välj element i nedanstående lista och klicka på "Lägg till".';
$_lang["resource_selector_title"] = 'Elementväljare';
$_lang["resources"] = 'Element';
$_lang["role"] = 'Roll';
...
$_lang["total"] = 'totalt';
$_lang["track_visitors_message"] = 'Denna inställning erbjuder en krok för analysplugins. Den kan användas för att kontrollera om besök på webbplatsen loggas eller inte.';
...
$_lang["undelete_document"] = 'Återställ resurs';
$_lang["unpublish_date"] = 'Avpubliceringsdatum';
$_lang["unpublish_document"] = 'Avpublicera resurs';
$_lang["unpublish_events"] = 'Avpublicera händelser';
$_lang["untitled_document"] = 'Namnlös resurs';
...
$_lang["use_alias_path_message"] = 'Med denna inställning aktiverad kommer en virtuell sökväg till resursen att genereras. Om exempelvis resursen "barn.html" befinner sig i behållaren "foralder", kommer hela sökvägen att bli "/foralder/barn.html".';
...
$_lang["view"] = 'Visa';
$_lang["view_child_documents_in_container"] = 'Underresurser';
...
$_lang["weblink_message"] = 'En webblänk är en referens till ett objekt på Internet. Detta kan vara en resurs i MODx, en sida på en annan webbserver, en bild, eller en annan typ av fil på Internet.';
