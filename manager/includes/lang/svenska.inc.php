...
$_lang["about_msg"] = CMS_NAME.' är ett <a href="http://'.CMS_DOMAIN.'" target="_blank">PHP applikationsramverk och system för innehållshantering</a> och är licensierat under <a href="../assets/docs/license.txt">GNU GPL</a>.';
...
$_lang["actioncomplete"] = '<b>Åtgärden har utförts!</b><br /> - Vänta medan '.CMS_NAME.' rensar upp.';
...
$_lang["configcheck_cache_msg"] = CMS_NAME.' kan inte skriva till cache-katalogen. '.CMS_NAME.' kommer fortfarande att fungera som förväntat, men inga resurser kommer att cachas. För att rätta till det här, gör /_cache/-katalogen skrivbar.';
...
$_lang["configcheck_installer_msg"] = 'Katalogen /install innehåller installationsprogrammet för '.CMS_NAME.'. Tänk vad som kan hända om en elaka människor hittar katalogen och kör installationen! De kommer förhoppningsvis inte så långt, eftersom databasen kräver inloggningsuppgifter, men det är ändå bäst att ta bort katalogen från servern.';
...
$_lang["configcheck_php_gdzip_msg"] = CMS_NAME.' behöver tilläggen GD och Zip aktiverade för PHP. Även om '.CMS_NAME.' kommer att fungera utan dom, så kommer du inte att kunna utnyttja alla möjligheterna i den inbyggda filhanteraren, bildredigeraren eller captcha för inloggningar.';
...
$_lang["credits_shouts_msg"] = '<p>'.CMS_NAME.' förvaltas och underhålls på <a href="http://'.CMS_DOMAIN.'/about/" target="_blank">'.CMS_NAME.'CMS.com</a>.</p>';
...
$_lang["export_site_maxtime_message"] = 'Ange hur många sekunder '.CMS_NAME.' har på sig för att exportera webbplatsen (åsidosätter PHPs inställningar). Skriv 0 för obegränsad tid. Notera att om 0 eller ett väldigt högt nummer anges, kan det få din server att göra konstiga saker och rekommenderas därför inte.';
$_lang["export_site_message"] = '<p>Använd denna funktion för att exportera hela webbplatsen till statiska HTML-filer. Kom ihåg att du förlorar stora delar av funktionaliteten i '.CMS_NAME.' om du gör det:</p><ul><li>Sidläsningar på exporterade filer kommer inte att lagras.</li><li>Interaktiva snippets kommer inte att fungera i exporterade filer</li><li>Endast vanliga resurser kommer att exporteras. Webblänkar blir alltså inte exporterade.</li><li>Exportprocessen kan misslyckas om dina resurser innehåller snippets som skickar omdirigeringsanvisningar.</li><li>Beroende på hur du skrivit dina resurser, kan bilder och stilmallar få fel sökvägar. Fixa det här genom att spara eller flytta dina exporterade filer till samma katalog som index.php för '.CMS_NAME.' befinner sig i.</li></ul><p>Fyll i formuläret och tryck på "Starta export" för att starta exportprocessen. Filerna som skapas kommer att sparas i katalogen assets/export, och när det är möjligt, används resursens URL-alias som filnamn. När du ska exporterar din webbplats är det bäst att ha '.CMS_NAME.'  konfigurationsinställning "Vänliga URL-alias" satt till "Ja". Beroende på storleken på din webbplats, kan exporten ta en del tid.</p><p><em>Redan existerande filer kommer att skrivas över om de har samma namn som en exporterad fil!</em></p>';
...
$_lang["file_folder_chmod_error"] = 'Kunde inte ändra behörigheterna. Du måste själv ändra behörigheterna utanför '.CMS_NAME.'.';
...
$_lang["filemanager_path_message"] = 'IIS fyller oftast inte i inställningarna för document_root ordentligt, vilket används av filhanteraren för att bestämma vad du kan se. Om du har problem med filhanteraren, se till så att denna sökväg pekar till roten på din '.CMS_NAME.'-installation.';
...
$_lang["friday"] = 'Fredag';
$_lang["friendly_alias_message"] = 'Om vänliga URL:er aktiveras kommer resursens URL-alias att användas istället för resursens ID. Det betyder att en resurs med ID 1 som har URL-aliaset "introduktion", inget prefix (tomt) och suffixet satt till ".html" vid en aktivering av vänliga URL:er kommer att få adressen "introduktion.html". Om det inte finns något URL-alias, kommer '.CMS_NAME.' att generera adressen "1.html".';
...
$_lang["import_site_failed_db_error"] = 'Ett databasfel inträffade när resursen skulle klonas: ';
...
$_lang["language_message"] = 'Välj vilket språket du vill använda i '.CMS_NAME.' innehållshanterare.';
...
$_lang["loading_page"] = 'Vänta medan '.CMS_NAME.' laddar sidan...';
...
$_lang["modx_news"] = CMS_NAME.' Nyhetsnotiser';
$_lang["modx_news_tab"] = CMS_NAME.' Nyheter';
$_lang["modx_news_title"] = CMS_NAME.' Nyheter';
$_lang["modx_security_notices"] = CMS_NAME.' Säkerhetsnotiser';
$_lang["modx_version"] = CMS_NAME.'-version';
$_lang["monday"] = 'Måndag';
$_lang["move"] = 'Flytta';
...
$_lang["password_gen_gen"] = 'Låt '.CMS_NAME.' generera ett lösenord';
...
$_lang["php_version_check"] = CMS_NAME.' är kompatibelt med PHP version 4.0.3 eller högre. Du behöver uppgradera din installation av PHP!';
$_lang["plugin"] = 'Plugin';
...
$_lang["rb_base_dir_message"] = 'Ange den fysiska sökvägen till filhanterarens katalog. Den här inställningen görs vanligen automatiskt, men om du använder IIS är det möjligt att '.CMS_NAME.' inte kan räkna ut sökvägen själv, vilket orsakar ett felmeddelande i filhanteraren. I så fall kan du skriva in sökvägen till bildkatalogen här (sökvägen som den visas i Utforskaren).<br /><b>OBS: Filhanterarens katalog måste innehålla underkatalogerna images, files, flash och media för att filhanteraren ska fungera korrekt.</b>';
$_lang["rb_base_dir_title"] = 'Sökväg till filer';
$_lang["rb_base_url_message"] = 'Ange den virtuella sökvägen till filhanterarens katalog. Den här inställningen görs vanligen automatiskt, men om du använder IIS är det möjligt att '.CMS_NAME.' inte kan räkna ut adressen på egen hand, vilket orsakar ett felmeddelande i filhanteraren. I så fall kan du skriva in adressen till bildkatalogen här (adressen som du skulle skriva den i Internet Explorer).';
...
$_lang["resource_opt_emptycache_help"] = 'Lämnar du detta fält markerat, kommer '.CMS_NAME.' att tömma sin cache när du sparar resursen. Det gör att dina besökare inte kommer att se en gammal version av resursen.';
...
$_lang["resource_type_message"] = 'Webblänkar refererar till resurser på internet, inklusive en annan '.CMS_NAME.'-resurs, en extern sida, en bild eller en annan fil på internet. Webblänkar ska ha internetmediatypen "text/html" och innehållsdispositionen "inline".';
...
$_lang["rss_url_news_message"] = 'Ange URL:en för '.CMS_NAME.' nyhetsflöde.';
$_lang["rss_url_news_title"] = 'RSS nyhetsflöde';
$_lang["rss_url_security_default"] = 'http://feeds.feedburner.com/modxsecurity';
$_lang["rss_url_security_message"] = 'Ange URL:en för '.CMS_NAME.' säkerhetsflöde.';
...
$_lang["tree_show_protected_message"] = 'När den här inställningen är satt till "Nej" visas inte skyddade resurser (och deras underresurser) i webbplatsträdet. "Nej" är den traditionella inställningen för '.CMS_NAME.'.';
...
$_lang["welcome_title"] = 'Välkommen till webbpubliceringsverktyget '.CMS_NAME;
$_lang["which_editor_message"] = 'Välj vilken richtext-editor du vill använda. Du kan ladda ner och installera fler richtext-editorer från '.CMS_NAME.' nedladdningssida.';
$_lang["which_editor_title"] = 'Editor att använda';
$_lang["working"] = 'Arbetar...';
$_lang["wrap_lines"] = 'Radbryt';
$_lang["xhtml_urls_message"] = 'Ersätter et-tecken (&amp;) i URLer som genereras av '.CMS_NAME.' med den validerande &amp;<!-- -->amp; html-entiteten.';
