...
$_lang["configcheck_configinc_msg"] = 'Elaka människor kan orsaka stora skador på din webbplats och allt som hör till den. <strong>På riktigt.</strong> Se till att konfigurationsfilen (/assets/config.inc.php) blir skrivskyddad!';
...
$_lang["rb_webuser_message"] = 'Vill du tillåta att en webbanvändare kan använda resursläsaren? <b>Varning:</b> Genom att tillåta webbanvändare att använda resursläsaren så exponerar man även filer som är tillgängliga för användare av hanteraren. Använda bara den här inställningen för betrodda webbanvändare.';
...
$_lang["role_empty_trash"] = 'Permanent radera borttagna document';
