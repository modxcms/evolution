...
$_lang["access_permissions_docs_collision"] = 'Omdat de webgebruikersgroepen en gebruikersgroepen conflicteren voor uw rol, zal dit document onbeveiligd zijn. Neem contact op met uw website beheerder voor meer hulp.';
$_lang["access_permissions_docs_message"] = 'Geef aan tot welke documentgroepen dit document behoort';
...
$_lang["access_permissions_documents_tab"] = 'Bekijk hier welke documentgroepen er bestaan. U kunt ook nieuwe groepen maken, bestaande bewerken of verwijderen of nagaan welk document deel uitmaakt van een groep (door met de muis over de ID van het document te gaan, ziet u de naam ervan). Door het document te bewerken kunt u het aan een groep toewijzen of het uit een groep verwijderen.';
$_lang["access_permissions_group_link"] = 'Maak een nieuwe groep koppeling';
$_lang["access_permissions_introtext"] = 'Dit is de beheermodule van gebruikers- en documentgroepen die worden gebruikt in het toegangsbeheer. Om een gebruiker toe te voegen aan een groep, volstaat het deze te bewerken en de groepen te kiezen waartoe deze moet behoren. Om een document toe te wijzen aan een gebruikersgroep, kiest u tijdens het bewerken van het document voor de groepen waartoe het document moet behoren.';
...
$_lang["activity_message"] = 'Deze lijst toont de laatst bewerkte/gemaakte documenten:';
...
$_lang["allow_mgr_access_message"] = 'Deze optie geeft de gebruiker toegang tot het Content Management Systeem. <b>NB: \'Nee\' betekent dat de gebruiker wordt doorverwezen naar het \'Content Management Systeem Login Startpagina\' of de eerste pagina van de website.</b>';
...
$_lang["charset_message"] = 'Kies hier welke karakterset codering u voor de codering in het Content Management Systeem wilt gebruiken. Houdt er rekening mee dat MODx met verschillende coderingen getest is, maar niet met allemaal! Als de tekenset van de karakterset codering die u heeft geselecteerd problemen veroorzaakt, dan raden we u aan UTF-8 te gebruiken. Deze ondersteunt alle tekens.';
...
$_lang["configcheck_configinc_msg"] = 'Slechtwillende mensen zouden mogelijk schade aan uw website kunnen veroorzaken met alle gevolgen van dien. <strong>Echt waar.</strong> Zet a.u.b. uw configuratiebestand (/manager/includes/config.inc.php) op alleen-lezen!';
...
$_lang["document_alias"] = 'Document alias';
$_lang["document_alias_help"] = 'Hier kunt u voor dit document een alias invoeren. Dit zal het document toegangelijk maken als u gebruik maakt van http://uwsite.nl/alias. Dit werkt alleen als u gebruik maakt van zoekmachine vriendelijke URL\'s.';
...
$_lang["document_long_title_help"] = 'Geef eventueel een langere titel op van dit document. Dit kan handig zijn voor zoekmachines en is misschien ook een betere beschrijving van uw document.';
$_lang["document_metatag_help"] = 'Selecteer de \'META tags\' of keywords die u aan het document wilt toekennen. Met de CTRL-toets (cmd in Mac OS) kunnen meerdere META tags worden geselecteerd';
...
$_lang["document_opt_folder_help"] = 'U kunt deze optie aanvinken om dit document als een map voor andere documenten te gebruiken. U hoeft hier niet te veel aandacht aan te besteden, aangezien MODx mapinstellingen over het algemeen automatisch verzorgt.';
$_lang["document_opt_menu_index"] = 'Menu index';
$_lang["document_opt_menu_index_help"] = 'De menu-index is een veld waarmee u de sortering van documenten kunt be&iuml;nvloeden, voornamelijk in menu\'s en opsommingen. U kunt het ook voor andere doeleinden gebruiken in uw snippets.';
...
$_lang["document_opt_trackvisit_help"] = 'Sla elke bezoeker op deze pagina op in het logboek';
$_lang["document_overview"] = 'Document overzicht';
$_lang["document_parent"] = 'Hoofddocument';
$_lang["document_parent_help"] = 'Selecteer een document in de boomstructuur om het als hoofddocument van dit document in te stellen.';
$_lang["document_permissions_error"] = 'Koppel dit document aan tenminste 1 documentgroep waar u toegang tot heeft.';
$_lang["document_setting"] = 'Document instellingen';
$_lang["document_summary"] = 'Samenvatting (introductietekst)';
$_lang["document_summary_help"] = 'Typ een korte beschrijving van het document';
$_lang["document_title"] = 'Titel';
$_lang["document_title_help"] = 'U kunt hier de titel van het document opgeven. Probeer het gebruik van backslashes in de naam te vermijden!';
...
$_lang["documents_in_container"] = 'documenten in deze map';
$_lang["documents_in_container_no"] = 'Deze map bevat geen subdocumenten.';
...
$_lang["duplicate_alias_message"] = 'Kies \'Ja\' om dubbele aliassen toe te staan wanneer een document wordt opgeslagen. <b>NB: Deze optie kan niet worden gebruikt in combinatie met \'Zoekmachine vriendelijke URL\'s\'.</b>';
...
$_lang["empty_recycle_bin_empty"] = 'Er zijn geen verwijderde documenten om permanent te verwijderen.';
...
$_lang["errorpage_message"] = 'Vul hier de ID van het document in waar u gebruikers naar wilt verwijzen als ze een niet-bestaand document willen bekijken. <br /><b>NB: Let op dat dit de ID van een bestaand document is en het tevens gepubliceerd is!</b>';
$_lang["errorpage_title"] = 'Error pagina:';
...
$_lang["export_site_target_unwritable"] = 'De map waarnaar u wilt exporteren is niet toegankelijk. Verzeker uzelf ervan dat in deze map geschreven kan worden, en probeer het daarna opnieuw.';
...
$_lang["file_not_saved"] = 'Het bestand kan niet worden bewaard. Verzeker uzelf ervan dat u kunt schrijven in de map!';
...
$_lang["files_upload_inhibited_msg"] = '<b>Upload optie niet toegelaten</b> - controleer of uploaden ondersteund wordt en of de map voor PHP schrijfbaar is.<br />';
...
$_lang["friendly_alias_message"] = 'Indien u zoekmachine vriendelijke URL\'s gebruikt en het document heeft een alias, dan zal deze alias gebruikt worden in plaats van de zoekmachine vriendelijke URL. Door deze optie aan te zetten wordt het voor- en achtervoegsel ook toegepast op de alias. Bijvoorbeeld, een document met ID 1 en als alias \'introductie\', zal met voorvoegsel \'\' en achtervoegsel \'.html\' vertaald worden naar \'introdcutie.html\'. Indien het document geen alias geeft zal MODx de link vertalen naar \'1.html\'.';
$_lang["friendly_alias_title"] = 'Gebruik zoekmachine vriendelijke URL\'s:';
$_lang["friendlyurls_message"] = 'Deze optie stelt u in staat om met MODx zoekmachine vriendelijke URL\'s te gebruiken. LET OP: deze optie werkt alleen als u MODx op een Apache webserver draait, daarnaast dient u voor een correcte werking ook een .htaccess bestand aan te maken. Zie voor meer informatie het bij de distributie toegevoegde .htaccess bestand.';
$_lang["friendlyurls_title"] = 'Zoekmachine vriendelijke URL\'s:';
$_lang["friendlyurlsprefix_message"] = 'Specificeer de zoekmachine vriendelijke URL\'s voorvoegsel om te be&iuml;nvloeden hoe zoekmachines en bezoekers toegang hebben tot uw website. Bijvoorbeeld, het voorvoegsel \'pagina\' zorgt ervoor dat de normale URL /index.php?id=2 de gebruiksvriendelijke URL /pagina2.html wordt (Ervan uitgaande dat het achtervoegsel op .html staat ingesteld!).';
$_lang["friendlyurlsprefix_title"] = 'Voorvoegsel zoekmachine vriendelijke URL\'s:';
$_lang["friendlyurlsuffix_message"] = 'Specificeer de zoekmachine vriendelijke URL\'s achtervoegsel. Als bijvoorbeeld \'.html\' ingevoerd wordt, wordt het achtervoegsel .html aan alle zoekmachine vriendelijke URL\'s toegevoegd.';
...
$_lang["loading_doc_tree"] = 'Boomstructuur wordt geladen...';
...
$_lang["login_homepage_message"] = 'Voer de ID in van het document waarnaar gebruikers worden verwezen als ze aangemeld zijn. <b>NB: Zorg ervoor dat de ID dat u invoert een bestaand, gepubliceerd en voor deze gebruiker toegangkelijk document is!</b>';
...
$_lang["manager_direction_message"] = 'Kies de richting waarin de tekst wordt geschreven in het Content Management Systeem, van links naar rechts of van rechts naar links.';
$_lang["manager_direction_title"] = 'Content Management Systeem tekst richting:';
$_lang["manager_lang_attribute_message"] = 'Kies de taalcode die het beste past bij de Content Management Systeem taal. De taalcode zorgt ervoor dat de browser de content het beste kan weergeven. Gebruik \'en\' voor Engels, \'nl\' voor Nederlands, etc.';
...
$_lang["metatag_intro"] = 'Op deze pagina kunt u \'META tags\' toevoegen, verwijderen en bewerken. De \'META tags\' kunt u aan documenten toevoegen op de <u>META keywords</u> tab bij het bewerken van een document. Vul een naam en een waarde in voor een nieuwe tag en klik op de \'Tag toevoegen\' knop om een nieuwe \'tag\' toe te voegen. Klik op de naam van een \'tag\' om deze te bewerken.';
...
$_lang["mgr_login_start_message"] = 'Geef de ID van het document dat wordt getoond nadat een gebruiker is ingelogd. <b>NB: Let erop dat de ID bestaat, dat het document gepubliceerd is en dat het document toegankelijk is voor de gebruiker!</b>';
...
$_lang["move_document_message"] = 'Verplaats een document inclusief subdocumenten door een nieuw hoofddocument in de boomstructuur te selecteren. Als het geselecteerde document geen map is, wordt er een map van gemaakt. Selecteer een nieuw hoofddocument in de boomstructuur.';
$_lang["move_document_new_parent"] = 'Selecteer een nieuw hoofddocument in de boomstructuur.';
...
$_lang["plugin_management_msg"] = 'Hier kunt u plugins toevoegen of bewerken.';
...
$_lang["plugin_priority"] = 'Wijzig de uitvoer-volgorde van plugins op basis van gebeurtenissen (events).';
...
$_lang["refresh_unpublished"] = '<b>%s</b> documenten zijn niet gepubliceerd.';
...
$_lang["role_empty_trash"] = 'Verwijderde documenten permanent verwijderen';
...
$_lang["search_criteria_id_msg"] = 'Voer de ID van het document in om het document snel te vinden.';
...
$_lang["search_results_returned_msg"] = 'Uw zoekcriteria hebben <b>%s</b> documenten opgeleverd. Als het teveel resultaten heeft opgeleverd, probeer dan een specifiekere zoekopdracht. Met de twee linker kolommen kunt u het bestand in de boomstructuur vinden of het document bekijken. De twee meest rechtse kolommen geven aan of een document verwijderd is en wat de publicatiestatus is.<p />';
...
$_lang["settings_strip_image_paths_message"] = 'Als dit op \'Nee\' is gezet zal MODx de locaties van plaatjes / bestanden / flash e.d. uit de bestandsbeheer browser omzetten naar absolute paden. Relatieve URL\'s zijn handig als u uw MODx installatie wilt verhuizen van bijvoorbeeld een test naar productie website. Als u geen idee heeft wat dit betekend laat u deze optie het beste op \'Ja\' staan.';
...
$_lang["sitestart_message"] = 'Vul hier de ID van het document in dat u als startpagina wilt gebruiken. <br /><b>NB: Let op dat dit de ID van een bestaand document is en het tevens gepubliceerd is!</b>';
...
$_lang["siteunavailable_page_message"] = 'Geef de ID van het document dat wordt weergegeven wanneer de website niet beschikbaar (offline) is. <b>NB: Let erop dat de ID bestaat en dat het document gepubliceerd is!</b>';
...
$_lang["tmplvar_access_msg"] = 'Selecteer de documentgroepen die de inhoud van deze variabele mogen aanpassen';
...
$_lang["tmplvar_inuse"] = 'De volgende documenten gebruiken deze template variabele. Om door te gaan met het verwijderen van de template variabele klik op de knop Verwijderen, anders klik op Annuleren.';
$_lang["tmplvar_tmpl_access"] = 'Template toegang';
$_lang["tmplvar_tmpl_access_msg"] = 'Selecteer de templates die deze variabele mogen gebruiken';
...
$_lang["tmplvars_management_msg"] = 'Hier kunt u de extra template variabele velden voor uw documenten beheren.';
...
$_lang["tmplvars_name"] = 'Variabele naam';
...
$_lang["tree_show_protected_message"] = 'Als dit op "Nee" staat, worden beschermde pagina\'s en al hun afstammelingen niet getoond in de boomstructuur. "Nee" is de legacy (erfenis) instelling van MODx.';
...
$_lang["udperms_message"] = 'Met behulp van toegangsrechten kunt u bepalen welke pagina\'s door welke gebruikers gewijzigd mogen worden. Hiervoor moet u de gebruikers indelen in gebruikersgroepen, en de documenten in documentgroepen. Daarna kunt u bepalen welke gebruikersgroepen toegang krijgen tot welke documentgroepen. Wanneer u deze optie voor het eerst aanzet, is het alleen voor beheerders mogelijk om documenten te wijzigen.';
...
$_lang["unauthorizedpage_message"] = 'Voer de ID in van het document waarnaar gebruikers worden verwezen als ze een beveiligde pagina opvragen. <br /><b>NB: Zorg ervoor dat de ID dat u invoert een bestaand en publiek toegangkelijk document is!</b>';
