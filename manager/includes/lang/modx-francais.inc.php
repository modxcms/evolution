 ...
 * Code:        Western Europa aka ISO-Latin-1
 * Author:      Nicolas Martignoni and Lorenzo
**/
...
$_lang["siteunavailable_message"] = "Ce message est affiché lorsque le site est «&nbsp;Hors ligne&nbsp;» ou si une erreur se produit.";
...
$_lang['document_parent_help'] = "Cliquez sur un document dans l'arbre pour le choisir comme parent de ce document.";
...
$_lang['about_msg'] = "ModX a été développé à partir d'Etomite, qui a été écrit par Alex. Il est placé sous licence <a href=\"../assets/docs/license.txt\">GPL</a>."; //changed 06 RC2
...
$_lang['credits_shouts_title'] = "<b>Remerciements à :</b>"; // obsolete
$_lang['credits_shouts_msg'] = "
<ul><li><b>Jorg Diederen</b> - Traduction hollandaise</li>
<li><b>Anders Monrad</b> - Traduction danoise</li>
<li><b>Evaldas Stulgaitis</b> - Traduction lituanienne</li>
<li><b>Luis Lacerda</b> - Traduction portugaise</li>
<li><b>Johnny Chadda</b> - Traduction suédoise</li>
<li><b>Tobias Nix</b> - Traduction allemande</li>
<li><b>Espen O. Pedersen</b> - Traduction norvégienne</li>
<li><b>stevew</b> - code pour la récriture des «IMG src» en chemins relatifs</li>
<li><b>Ron & Ivo</b> - Testeurs</li><li><b>Nicolas Martignoni et Lorenzo</b> - Traduction française</li>
<li><b>Snuffkin</b> - Recherche de bogues, modérateur et administrateur du forum, miroir pour téléchargement, contrôle et assurance de qualité, vétilles, bonnes idées</li>
<li>Tous ceux qui ont envoyés des feedbacks sur ModX, ou suggéré de nouvelles fonctionnalités, ou qui ont donné de l'argent pour me remercier de mon dur travail. Remerciements à tous !</li></ul>"; // changed (this changes almost every release)  // obsolete
...
$_lang['layout_settings_2'] = "Disposition simple <br /><span class='comment'>Navigation au dessus de l'arbre des documents.</span>";
$_lang['layout_settings_1'] = "Disposition top (IE) <br /><span class='comment'>Navigation au haut de l'écran. Ne fonctionne actuellement qu'avec Internet Explorer.</span>";
...
$_lang['friendly_alias_title'] = "Alias simples";
...
$_lang['export_site'] = "Exportation en HTML";
...
$_lang["which_editor_message"] = "Vous pouvez choisir ici l'éditeur WYSIWYG que vous souhaitez utiliser. L'éditeur TinyMCE fonctionne très bien, mais n'a pas encore été testé intensivement avec ModX. En outre, il n'offre pas toutes les fonctionnalités offertes par HTMLArea, mais il est mieux approprié aux personnes désirant utiliser beaucoup de CSS dans leurs documents. ImageManager, TableOperations et d'autres réglages de HTMLArea n'affecteront pas TinyMCE. De même, les réglages propres à TinyMCE CSS n'auront aucun effet sur HTMLArea.";
...
$_lang['close'] = "Fermer";
$_lang['import_site'] = "Importer un site en HTML";
...
$_lang["confirm_duplicate_document"] = "Voulez-vous vraiment dupliquer ce document/dossier&nbsp;?\\nLes sous-dossiers et pages incluses seront aussi dupliquées.\\n\\n Attention&nbsp;! Les données externes (mots clés, variables de modèles, etc.) ne seront pas dupliquées.";
...
$_lang['tmplvars_display'] = "Type d'affichage";
$_lang['tmplvars_display_prop'] = "Propriétés d'affichage";
...
$_lang["new_web_user"] = "Créer un utilisateur web";
...
$_lang['layout_settings_3'] = "Disposition avancée <br /><span class='comment'>Navigation à gauche de l'arbre.</span>";
