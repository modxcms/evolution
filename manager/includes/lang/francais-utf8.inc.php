...
$_lang["access_permissions_add_document_group"] = 'Créer un nouveau Groupe de Ressources';
...
$_lang["activity_message"] = 'Cette liste contient les Ressources que vous avez modifié ou créé récemment:';
...
$_lang["add_document"] = 'Nouvelle Ressource';
...
$_lang["confirm_delete_document"] = 'Voulez-vous vraiment supprimer cette Ressource?\nToutes les Ressources enfants seront également supprimées.';
...
$_lang["confirm_duplicate_document"] = 'Voulez-vous vraiment dupliquer cette Ressource?\nLes éléments qu\'elle contient seront également dupliqués.';
...
$_lang["create_document_here"] = 'Créer une Ressource ici';
...
$_lang["delete_document"] = 'Supprimer la Ressource';
...
$_lang["document_alias"] = 'Alias de la Ressource';
$_lang["document_alias_help"] = 'Définissez un alias pour que la Ressource soit accessible à l\'adresse : http://exemple.com/alias. Cette fonctionnalité n\'est effective que si vous avez activé les URLs simples dans la configuration de votre site.';
$_lang["document_content"] = 'Contenu de la Ressource';
$_lang["document_description"] = 'Description';
$_lang["document_description_help"] = 'Vous pouvez saisir ici une description de la Ressource (facultatif).';
$_lang["document_long_title_help"] = 'Vous pouvez saisir ici un titre plus complet pour votre Ressource. Un tel titre peut être utile pour les moteurs de recherche, et offrira une meilleure description de votre Ressource.';
$_lang["document_metatag_help"] = 'Sélectionnez les balises META et les mots-clés que vous souhaitez associer à cette Ressource. Vous pouvez sélectionner plusieurs mots-clés ou balises en gardant la touche CTRL enfoncée';
$_lang["document_opt_contentdispo"] = 'Affichage du contenu';
$_lang["document_opt_contentdispo_help"] = 'Utilisez le champ Affichage du contenu pour définir la manière dont la Ressource doit être traitée par le navigateur web. Pour les fichiers à télécharger, sélectionnez l\'option Annexe.';
$_lang["document_opt_emptycache"] = 'Supprimer du cache?';
$_lang["document_opt_emptycache_help"] = 'Cochez cette case si vous souhaitez que MODx supprime automatiquement la Ressource du cache après son enregistrement. Ainsi, vos visiteurs auront accès à la dernière version de la Ressource et non pas à la version en cache.';
$_lang["document_opt_folder"] = 'Conteneur?';
$_lang["document_opt_folder_help"] = 'Cochez cette case pour définir cette Ressource comme Conteneur d\'autres Ressources. Un «Conteneur» est similaire à un dossier, à la différence qu\'il peut également avoir du contenu.';
$_lang["document_opt_menu_index"] = 'Index de menu';
$_lang["document_opt_menu_index_help"] = 'L\'index de menu est un champ que vous pouvez utiliser pour trier les Ressources, notamment dans vos Snippets de menu. Vous pouvez également l\'utiliser dans vos Snippets pour une toute autre utilisation.';
$_lang["document_opt_menu_title"] = 'Titre de menu';
$_lang["document_opt_menu_title_help"] = 'Le titre de menu est un champ (optionnel) que vous pouvez utiliser pour afficher un bref intitulé dans vos Snippets de menu ou Modules.';
$_lang["document_opt_published"] = 'Publié?';
$_lang["document_opt_published_help"] = 'Cochez cette case pour publier cette Ressource immédiatement après son enregistrement.';
$_lang["document_opt_richtext"] = 'Éditeur WYSIWYG?';
$_lang["document_opt_richtext_help"] = 'Cochez cette case si vous souhaitez utiliser l\'éditeur WISIWYG pour modifier cette Ressource. Si la Ressource contient du JavaScript ou des formulaires, décochez la case pour modifier la Ressource en mode HTML, afin que l\'éditeur WYSIWYG ne la détériore pas.';
$_lang["document_opt_show_menu"] = 'Afficher dans le menu';
$_lang["document_opt_show_menu_help"] = 'Choisissez cette option pour afficher la Ressource dans un menu web. Certains scripts de construction de menus peuvent ignorer cette option.';
$_lang["document_opt_trackvisit_help"] = 'Enregistrer les visites de chaque internaute sur cette Ressource';
$_lang["document_overview"] = 'Résumé de la Ressource';
$_lang["document_parent"] = 'Ressource parente';
$_lang["document_parent_help"] = 'Cliquez sur l\'icône ci-dessus pour activer (ou désactiver) la sélection d\'une Ressource parente. Cliquez ensuite sur une Ressource dans l\'Arbre du Site pour la choisir comme parente.';
$_lang["document_permissions_error"] = 'Assignez cette Ressource à au moins un Groupe de Ressources auquel vous avez accès.';
$_lang["document_setting"] = 'Propriétés de la Ressource';
$_lang["document_summary"] = 'Résumé';
$_lang["document_summary_help"] = 'Rédigez un bref résumé de la Ressource';
$_lang["document_title"] = 'Titre';
$_lang["document_title_help"] = 'Entrez ici le nom/titre de la Ressource. Évitez d\'entrer des antislashs (\) dans ce champ.';
$_lang["document_to_be_moved"] = 'Ressource à déplacer';
$_lang["document_weblink_help"] = 'Entrez ici l\'adresse (URL) de l\'objet que vous souhaitez référencer à ce Lien Web.';
$_lang["documents_in_container"] = 'Ressources dans ce Conteneur';
$_lang["documents_in_container_no"] = 'Ce Conteneur n\'a aucune Ressources enfant.';
...
$_lang["duplicate_document"] = 'Dupliquer une Ressource';
...
$_lang["edit"] = 'Modifier';
$_lang["edit_document"] = 'Modifier la Ressource';
$_lang["edit_document_title"] = 'Créer/modifier une Ressource';
...
$_lang["export_site_failed_no_write"] = 'Impossible d\'écrire le fichier.';
...
$_lang["export_site_message"] = '<p>Cette fonction vous permet d\'exporter la totalité du site au format HTML. Ce faisant, vous perdrez ainsi beaucoup de fonctionnalités de MODx:</p><ul><li>Les visites sur les fichiers exportés ne seront pas comptabilisées.</li><li>Les Snippets interactifs ne fonctionneront pas dans les fichiers exportés.</li><li>Seules les Ressources seront exportées, alors que les Liens Web ne le seront pas.</li><li>Le processus d\'exportation peut échouer si vos Ressources contiennent des Snippets qui renvoient des en-têtes de redirection.</li><li>Suivant la façon dont vous avez écrit vos Ressources, feuilles de styles et images, la mise en page de votre site pourrait être chamboulée. Pour éviter ceci, vous pouvez enregistrer ou déplacer vos fichiers exportés dans le répertoire où se situe le fichier principal de MODx index.php.</li></ul><p>Veuillez remplir le formulaire et cliquer sur «Commencer l\'exportation» pour débuter le processus. Les fichiers créés seront enregistrés dans le répertoire /assets/export, en utilisant comme noms de fichiers, dans la mesure du possible, les alias des Ressources. Lors de l\'exportation de votre site, il est préférable d\'activer les «Alias simples» dans la configuration de MODx. Selon la taille de votre site, l\'exportation peut prendre un bon moment.</p><p><em>Tous les fichiers existants seront écrasés par les nouveaux fichiers si leurs noms sont identiques!</em></p>';
$_lang["export_site_numberdocs"] = '<p><b>%s Ressources trouvées pour exportation...</b></p>';
...
$_lang["export_site_success_skip_dir"] = 'Passer ce répertoire.';
...
$_lang["import_parent_document"] = 'Ressource parente:';
$_lang["import_site"] = 'Import HTML';
$_lang["import_site_failed"] = 'Échec!';
$_lang["import_site_failed_db_error"] = 'Une erreur de la base de données s\'est produite pendant la duplication du document: ';
$_lang["import_site_failed_no_open_dir"] = 'Impossible d\'ouvrir le répertoire: ';
$_lang["import_site_failed_no_retrieve_file"] = 'Impossible de récupérer le fichier: ';
...
$_lang["monday"] = 'Lundi';
$_lang["move"] = 'Déplacer';
$_lang["move_document"] = 'Déplacer la Ressource';
$_lang["move_document_message"] = 'Vous pouvez déplacer une Ressource et tous ses enfants en choisissant un nouveau parent dans l\'Arbre du Site. Si cette Ressource n\'est pas un Conteneur, elle le deviendra ensuite. Veuillez cliquer sur le nouveau parent dans l\'Arbre du Site.';
$_lang["move_document_new_parent"] = 'Veuillez choisir un nouveau parent dans l\'Arbre du Site.';
$_lang["move_document_title"] = 'Déplacer la Ressource';
$_lang["name"] = 'Nom';
...
$_lang["preview_document"] = 'Prévisualiser';
...
$_lang["publish_document"] = 'Publier la Ressource';
...
$_lang["resource_selector_msg"] = 'Sélectionnez le/les Élément(s) dans la liste ci-dessous et cliquez sur le bouton «Insérer».';
$_lang["resource_selector_title"] = 'Sélecteur d\'Éléments';
$_lang["resources"] = 'Éléments';
$_lang["role"] = 'Rôle';
...
$_lang["template_msg"] = 'Créer/modifier des Modèles. Les Modèles créés ou modifiés ne seront pas actualisés dans les pages en cache de votre site jusqu\'à ce que le cache soit vidé. Cependant, vous pouvez utiliser la fonction de prévisualisation d\'une page pour voire le nouveau Modèle en action.';
...
$_lang["undelete_document"] = 'Rétablir la Ressource';
$_lang["unpublish_date"] = 'Date de dépublication';
$_lang["unpublish_document"] = 'Dépublier la Ressource';
$_lang["unpublish_events"] = 'Dépublication(s)';
$_lang["untitled_document"] = 'Ressource sans titre';
...
$_lang["uploadable_images_message"] = 'Entrez une liste des types de fichier pouvant être déposés dans \'assets/images/\' via l\'Explorateur de Fichiers. Veuillez entrer les extensions pour les fichiers image, séparées par des virgules.';
$_lang["uploadable_images_title"] = 'Types d\'image autorisés:';
$_lang["uploadable_media_message"] = 'Entrez une liste des types de fichier pouvant être déposés dans \'assets/media/\' via l\'Explorateur de Fichiers. Veuillez entrer les extensions pour les fichiers multimédia, séparées par des virgules.';
...
$_lang["view"] = 'Afficher';
$_lang["view_child_documents_in_container"] = 'Afficher les enfants';
...
$_lang["weblink_message"] = 'Un Lien Web est une référence à un objet sur Internet. Ce peut être une Ressource dans MODx, une page sur un autre site, une image ou tout autre fichier accessible sur Internet.';
