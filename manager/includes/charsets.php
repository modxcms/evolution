...
<option value="iso-8859-6" <?php echo $modx_charset=="iso-8859-6" ? "selected='selected'" : "" ; ?> >Arabic (ISO) - iso-8859-6</option>
...
<option value="iso-8859-4" <?php echo $modx_charset=="iso-8859-4" ? "selected='selected'" : "" ; ?> >Baltic (ISO) - iso-8859-4</option>
...
<option value="iso-8859-2" <?php echo $modx_charset=="iso-8859-2" ? "selected='selected'" : "" ; ?> >Central European (ISO) - iso-8859-2</option>
...
<option value="iso-8859-5" <?php echo $modx_charset=="iso-8859-5" ? "selected='selected'" : "" ; ?> >Cyrillic (ISO) - iso-8859-5</option>
...
<option value="iso-8859-7" <?php echo $modx_charset=="iso-8859-7" ? "selected='selected'" : "" ; ?> >Greek (ISO) - iso-8859-7</option>
...
<option value="iso-8859-8-i" <?php echo $modx_charset=="iso-8859-8-i" ? "selected='selected'" : "" ; ?> >Hebrew (ISO-Logical) - iso-8859-8-i</option>
<option value="iso-8859-8" <?php echo $modx_charset=="iso-8859-8" ? "selected='selected'" : "" ; ?> >Hebrew (ISO-Visual) - iso-8859-8</option>
...
<option value="iso-8859-3" <?php echo $modx_charset=="iso-8859-3" ? "selected='selected'" : "" ; ?> >Latin 3 (ISO) - iso-8859-3</option>
<option value="iso-8859-15" <?php echo $modx_charset=="iso-8859-15" ? "selected='selected'" : "" ; ?> >Latin 9 (ISO) - iso-8859-15</option>
...
<option value="iso-8859-9" <?php echo $modx_charset=="iso-8859-9" ? "selected='selected'" : "" ; ?> >Turkish (ISO) - iso-8859-9</option>
