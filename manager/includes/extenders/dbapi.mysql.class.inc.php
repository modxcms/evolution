...
class DBAPI {
   ...
   function insert($fields, $intotable, $fromfields = "*", $fromtable = "", $where = "", $limit = "") {
   	return __insert('INSERT', $fields, $intotable, $fromfields = "*", $fromtable = "", $where = "", $limit = "");
   }
   ...
   function insert_ignore($fields, $intotable, $fromfields = "*", $fromtable = "", $where = "", $limit = "") {
   	return __insert('INSERT IGNORE', $fields, $intotable, $fromfields = "*", $fromtable = "", $where = "", $limit = "");
   }   
   ...
   function replace($fields, $intotable, $fromfields = "*", $fromtable = "", $where = "", $limit = "") {
   	return __insert('REPLACE', $fields, $intotable, $fromfields = "*", $fromtable = "", $where = "", $limit = "");
   }   
