...
function getAction($lastaction, $itemid='') {
			switch($lastaction) {
				...
				case "94" : return "Duplicate Document $id"; break;
				case "95" : return "Importing documents from HTML"; break;
				case "96" : return "Duplicate Template $id"; break;
				case "97" : return "Duplicate Chunk (HTML Snippet) $id"; break;
				case "98" : return "Duplicate Snippet $id"; break;
				case "99" : return "Manage Web Users"; break;
				case "100" : return "Previewing document $itemid"; break;	
				case "101" : return "Create new plugin $id"; break;	
				case "102" : return "Edit plugin $id"; break;	
				...
				case "304" : return "Duplicate Template Variable $id"; break;
