				...
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<?php if($modx->hasPermission('new_document')) { ?>
							<td><a href="javascript:;" class="treeButton" id="Button3a" onClick="top.main.document.location.href='index.php?a=4';" title="<?php echo $_lang['add_resource']; ?>"><?php echo $_style['add_doc_tree']; ?></a></td>
						...
						<?php if($modx->hasPermission('edit_document')) { ?>
							<td><a href="javascript:;" id="Button11" class="treeButton" onClick="top.main.document.location.href='index.php?a=56&id=0';" title="<?php echo $_lang['sort_menuindex']; ?>"><?php echo $_style['sort_menuindex']; ?></a></td>
						<?php } ?>
						<?php if($use_browser && $modx->hasPermission('assets_images')) { ?>
							<td><a href="javascript:;" id="Button13" class="treeButton" title="<?php echo $_lang["images_management"] . "\n" . $_lang['em_button_shift'] ?>"><?php echo $_style['images_management']; ?></a></td>
						<?php } ?>
						<?php if($use_browser && $modx->hasPermission('assets_files')) { ?>
							<td><a href="javascript:;" id="Button14" class="treeButton" title="<?php echo $_lang["files_management"] . "\n" . $_lang['em_button_shift'] ?>"><?php echo $_style['files_management']; ?></a></td>
						<?php } ?>
						<?php if($modx->hasPermission('edit_template') || $modx->hasPermission('edit_snippet') || $modx->hasPermission('edit_chunk') || $modx->hasPermission('edit_plugin')) { ?>
							<td><a href="javascript:;" id="Button12" class="treeButton" title="<?php echo $_lang["element_management"] . "\n" . $_lang['em_button_shift'] ?>"><?php echo $_style['element_management']; ?></a></td>
						<?php } ?>
				...
				<tr>
					<td style="padding-left: 10px;padding-top: 1px;">
						<ul class="actionButtons" style="margin:10px 0;">
							<li><a href="javascript:;" class="treeButton" id="button7" style="text-align:right" onClick="updateTree();showSorter();" title="<?php echo $_lang['sort_tree']; ?>"><?php echo $_lang['sort_tree']; ?></a></li>
						</ul>
					</td>
				</tr>
			</table>
