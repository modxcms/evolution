...
?>
    ...
    function dopopup(x,y) {
        ...
        context.style.left= x<?php echo $textdir ? '-190' : '';?>+"px"; //offset menu to the left if rtl is selected
...
<body onclick="hideMenu(1);" class="treeframebody<?php echo $textdir ? ' rtl':''?>">
