...
<script type="text/javascript" language="JavaScript1.5" src="media/script/cb2.js"></script>		
<style>
TD {
...
function openURL(url) {
	url = prompt("<?php echo $_lang['openurl_message'];?>", "http://wiki.etomite.org/");
	if (url!="" && url!=null) {
...
siteMenu.add( tmp = new MenuItem( "<?php echo $_lang['export_site']; ?>", "index.php?a=83", "media/images/icons/save.gif") );
	tmp.target="main";
<?php echo $_SESSION['permissions']['edit_document']!=1 ? "\ttmp.disabled=true;" : "" ; ?> 
...
usersMenu.add( tmp = new MenuItem( "<?php echo $_lang['user_management_title']; ?>", "index.php?a=75", "media/images/icons/new4-098.gif") );
	tmp.target="main";
<?php echo $_SESSION['permissions']['new_user']!=1 && $_SESSION['permissions']['edit_user']!=1 ? "\ttmp.disabled=true;" : "" ; ?> 

usersMenu.add( tmp = new MenuItem( "<?php echo $_lang['web_user_management_title']; ?>", "index.php?a=99", "media/images/icons/new4-098.gif") );
	tmp.target="main";
<?php echo $_SESSION['permissions']['new_user']!=1 && $_SESSION['permissions']['edit_user']!=1 ? "\ttmp.disabled=true;" : "" ; ?> 
...
usersMenu.add( tmp = new MenuItem( "<?php echo $_lang['web_access_permissions']; ?>", "index.php?a=91", null) );
	tmp.target="main";
<?php echo $_SESSION['permissions']['access_permissions']!=1 ? "\ttmp.disabled=true;" : "" ; ?> 
...
administrationMenu.add( tmp = new MenuItem( "<?php echo $_lang['bk_manager']; ?>", "index.php?a=93", "media/images/icons/bkmanager.gif") );
	tmp.target="main";
<?php echo $_SESSION['permissions']['bk_manager']!=1 ? "\ttmp.disabled=true;" : "" ; ?> 
