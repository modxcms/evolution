...
<?php 	if($modx->hasPermission('new_user')==1||$modx->hasPermission('edit_user')==1) { ?>
	...
	<a href="index.php?a=86" target="main"><img src='media/images/misc/menu_dot.gif' alt="dot!" /><?php echo $_lang["role_manageme
	nt_title"]; ?></a>
...
<?php if($modx->hasPermission('new_template')==1 || $modx->hasPermission('edit_template')==1 || $modx->hasPermission('new_snippet')==1 || $modx->hasPermission('edit_snippet')==1) { ?>
	<td valign="top">
	<a href="index.php?a=106" target="main"><img src='media/images/misc/arrow.gif' alt="Arrow!" /><?php echo $_lang["module_management"]; ?></a>
