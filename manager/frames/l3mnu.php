...
<div id="container" >
<form name="menuForm">
<div style="height:15px;width:100%" ><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td align="center" class="buttonoc"><a style="height:15px;" href="javascript:parent.resizeFrame('0,20,17,*')"><b>Open/Close Menu</b></a></td></tr></table></div>
<div>
...
<?php 	if($modx->hasPermission('new_role')||$modx->hasPermission('edit_user')) { ?>					
				<a href="index.php?a=86" target="main"><img src='media/images/misc/menu_dot.gif' alt="dot!"/><?php echo $_lang["role_management_title"]; ?></a>
<?php 	} ?>
<?php if($modx->hasPermission('access_permissions')) { ?>
	<a href="index.php?a=40" target="main"><img src='media/images/misc/menu_dot.gif' alt="dot!"/><?php echo $_lang["manager_permissions"]; ?></a>
<?php 	} ?>
<?php if($modx->hasPermission('web_access_permissions')) { ?>
	<a href="index.php?a=91" target="main"><img src='media/images/misc/menu_dot.gif' alt="dot!"/><?php echo $_lang["web_permissions"]; ?></a>
<?php 	} ?>
	</td>
 <?php } ?>
...
<?php 	if($modx->hasPermission('new_module') || $modx->hasPermission('edit_module') || $modx->hasPermission('exec_module')) { ?>
	<td valign="top">					
				<a href="index.php?a=106" target="main"><img src='media/images/misc/menu_dot.gif' alt="dot!" /><?php echo $_lang["module_management"]; ?></a>
<?php 	} ?>
<?php 	if($hasAccess) { ?>					
...
<?php 	if($modx->hasPermission('view_eventlog')) { ?>		
				<a href="index.php?a=114" target="main"><img src='media/images/misc/menu_dot.gif' alt="dot!"/><?php echo $_lang["eventlog_viewer"]; ?></a>
<?php 	} ?>
