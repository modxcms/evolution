...
?>
	...
	<frameset rows="0,24,*" frameborder="no" border="0">
		...
		<frameset cols="280,*" border="<?php echo !($browser=='ie') ? 6 : 0 ;?>" frameborder="yes" FRAMESPACING="<?php echo !($browser=='ie') ? 1 : 6 ;?>" bordercolor="#94b451" resize>
			<frameset rows="200,*" name="menuFrame" border="<?php echo ($browser=='mz' || $browser=='fb') ? 6 : 0 ;?>" frameborder="1" FRAMESPACING="<?php echo ($browser=='mz' || $browser=='fb') ? 1 : 6 ;?>" bordercolor="#FFFFFF">
				<frame src="index.php?a=1&f=l1mnu" name="mainMenu" scrolling="no" FRAMEBORDER="no" BORDER="0" BORDERCOLOR="#FFFFFF">
...
?>
	...
	<frameset rows="0,24,*" frameborder="no" border="0">
		<frame src="index.php?a=1&f=scripter" name="scripter" scrolling="no" noresize>
		<frame src="index.php?a=1&f=topbar" name="topFrame">
		<frameset cols="370,*" border="<?php echo ($browser=='mz' || $browser=='fb') ? 6 : 0 ;?>" frameborder="1" FRAMESPACING="<?php echo ($browser=='mz' || $browser=='fb') ? 1 : 6 ;?>" bordercolor="#FFFFFF">
			<frameset cols="170,*" name="menuFrame" border="<?php echo ($browser=='mz' || $browser=='fb') ? 6 : 0 ;?>" frameborder="1" FRAMESPACING="<?php echo ($browser=='mz' || $browser=='fb') ? 1 : 6 ;?>" bordercolor="#FFFFFF">
				<frame src="index.php?a=1&f=l2mnu" name="mainMenu" scrolling="no" FRAMEBORDER="no" BORDER="0" BORDERCOLOR="#FFFFFF">
				<frame src="index.php?a=1&f=3" name="menu" FRAMEBORDER="no" BORDER="0" bordercolor="#FFFFFF" scrolling="AUTO">
			</frameset>
			<frame src="index.php?a=2" name="main" scrolling="auto" FRAMEBORDER="no" BORDER="0" BORDERCOLOR="#FFFFFF">
		</frameset>
...
?>
	...
	<frameset rows="0,21,24,*" frameborder="no" border="0">
		...
		<frame src="index.php?a=1&f=topbar" name="topFrame">
		<frameset cols="250,*" border="<?php echo ($browser=='mz' || $browser=='fb') ? 6 : 0 ;?>" frameborder="1" framespacing="<?php echo ($browser=='mz' || $browser=='fb') ? 1 : 6 ;?>" bordercolor="#FFFFFF">
			<frame src="index.php?a=1&f=3" name="menu" FRAMEBORDER="no" BORDER="0" bordercolor="#FFFFFF" scrolling="auto">
			<frame src="index.php?a=2" name="main" scrolling="auto" FRAMEBORDER="no" BORDER="0" BORDERCOLOR="#FFFFFF">
		</frameset>
	</frameset>
