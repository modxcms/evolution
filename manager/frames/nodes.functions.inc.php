...
function makeHTML($indent,$parent,$expandAll,$theme) {
    ...
    while($row = $modx->db->getRow($result))
    {
        ...
        if (!$isfolder)
        {
            ...
            $tpl = '<div id="node[+id+]" p="[+parent+]" style="white-space: nowrap;">[+spacer+][+pad+]<img id="p[+id+]" align="absmiddle" title="[%click_to_context%]" style="cursor: pointer" src="[+icon+]" onclick="showPopup([+id+],\'[+nodetitle_esc+]\',event);return false;" oncontextmenu="this.onclick(event);return false;" onmouseover="setCNS(this, 1)" onmouseout="setCNS(this, 0)" onmousedown="itemToChange=[+id+]; selectedObjectName=\'[+nodetitle_esc+]\'; selectedObjectDeleted=[+deleted+]; selectedObjectUrl=\'[+url+]\'" />&nbsp;<span p="[+parent+]" onclick="treeAction([+id+],\'[+nodetitle_esc+]\'); setSelected(this);" onmouseover="setHoverClass(this,1);" onmouseout="setHoverClass(this, 0);" class="treeNode" onmousedown="itemToChange=[+id+]; selectedObjectName=\'[+nodetitle_esc+]\'; selectedObjectDeleted=[+deleted+]; selectedObjectUrl=\'[+url+]\';" oncontextmenu="document.getElementById(\'p[+id+]\').onclick(event);return false;" title="[+alt+]">[+nodetitle+][+weblink+]</span> [+pageIdDisplay+]</div>';
            $ph = array('parent'=>$parent,'id'=>$id,'nodetitle_esc'=>$nodetitle_esc,'deleted'=>$deleted,'url'=>$url,'alt'=>$alt,'nodetitle'=>$nodetitleDisplay,'weblink'=>$weblinkDisplay,'spacer'=>$spacer,'pad'=>$pad,'icon'=>$icon,'pageIdDisplay'=>$pageIdDisplay);
        ...
        else
        {
            ...
            if ($expandAll ==1 || ($expandAll == 2 && in_array($id, $opened)))
            {
                ...
                $tpl = '<div id="node[+id+]" p="[+parent+]" style="white-space: nowrap;">[+spacer+]<img id="s[+id+]" align="absmiddle" style="margin-left:-1px;cursor: pointer" src="[&tree_minusnode&]" onclick="toggleNode(this,[+indent+],[+id+],[+expandAll+],[+pmode+]); return false;" oncontextmenu="this.onclick(event); return false;" />&nbsp;<img id="f[+id+]" align="absmiddle" title="[%click_to_context%]" style="cursor: pointer;margin-top:-2px;margin-left:-3px;" src="[+src+]" onclick="showPopup([+id+],\'[+nodetitle_esc+]\',event);return false;" oncontextmenu="this.onclick(event);return false;" onmouseover="setCNS(this, 1)" onmouseout="setCNS(this, 0)" onmousedown="itemToChange=[+id+]; selectedObjectName=\'[+nodetitle_esc+]\'; selectedObjectDeleted=[+deleted+]; selectedObjectUrl=\'[+url+]\';" />&nbsp;<span onclick="treeAction([+id+],\'[+nodetitle_esc+]\'); setSelected(this);" onmouseover="setHoverClass(this, 1);" onmouseout="setHoverClass(this, 0);" class="treeNode" onmousedown="itemToChange=[+id+]; selectedObjectName=\'[+nodetitle_esc+]\'; selectedObjectDeleted=[+deleted+]; selectedObjectUrl=\'[+url+]\';" oncontextmenu="document.getElementById(\'f[+id+]\').onclick(event);return false;" title="[+alt+]">[+nodetitle+][+weblink+]</span> [+pageIdDisplay+]<div style="display:block">';
                $ph = array('parent'=>$parent,'id'=>$id,'nodetitle_esc'=>$nodetitle_esc,'deleted'=>$deleted,'url'=>$url,'alt'=>$alt,'nodetitle'=>$nodetitleDisplay,'weblink'=>$weblinkDisplay,'spacer'=>$spacer,'pad'=>$pad,'pageIdDisplay'=>$pageIdDisplay,'indent'=>$indent+1,'expandAll'=>$expandAll,'pmode'=>$pmode,'src'=>$src);
                $node = $modx->parseText($tpl,$ph);
                $node = $modx->parseText($node,$_lang, '[%','%]');
            ...
            else
            {
                ...
                $tpl = '<div id="node[+id+]" p="[+parent+]" style="white-space: nowrap;">[+spacer+]<img id="s[+id+]" align="absmiddle" style="margin-left:-1px;cursor: pointer" src="[&tree_plusnode&]" onclick="toggleNode(this,[+indent+],[+id+],[+expandAll+],[+pmode+]); return false;" oncontextmenu="this.onclick(event); return false;" />&nbsp;<img id="f[+id+]" title="[%click_to_context%]" align="absmiddle" style="cursor: pointer;margin-top:-2px;margin-left:-3px;" src="[+src+]" onclick="showPopup([+id+],\'[+nodetitle_esc+]\',event);return false;" oncontextmenu="this.onclick(event);return false;" onmouseover="setCNS(this, 1)" onmouseout="setCNS(this, 0)" onmousedown="itemToChange=[+id+]; selectedObjectName=\'[+nodetitle_esc+]\'; selectedObjectDeleted=[+deleted+]; selectedObjectUrl=\'[+url+]\';" />&nbsp;<span onclick="treeAction([+id+], \'[+nodetitle_esc+]\'); setSelected(this);" onmouseover="setHoverClass(this, 1);" onmouseout="setHoverClass(this, 0);" class="treeNode" onmousedown="itemToChange=[+id+]; selectedObjectName=\'[+nodetitle_esc+]\'; selectedObjectDeleted=[+deleted+]; selectedObjectUrl=\'[+url+]\';" oncontextmenu="document.getElementById(\'f[+id+]\').onclick(event);return false;" title="[+alt+]">[+nodetitle+][+weblink+]</span> [+pageIdDisplay+]<div style="display:none"></div></div>';
                $ph = array('parent'=>$parent,'id'=>$id,'nodetitle_esc'=>$nodetitle_esc,'deleted'=>$deleted,'url'=>$url,'alt'=>$alt,'nodetitle'=>$nodetitleDisplay,'weblink'=>$weblinkDisplay,'spacer'=>$spacer,'pad'=>$pad,'pageIdDisplay'=>$pageIdDisplay,'indent'=>$indent+1,'expandAll'=>$expandAll,'pmode'=>$pmode,'src'=>$src);
                $node = $modx->parseText($tpl,$ph);
                $node = $modx->parseText($node,$_lang, '[%','%]');
                $node = $modx->parseText($node,$_style,'[&','&]');
