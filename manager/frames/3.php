...
<script type="text/javascript">
	...
	function dopopup(x,y) {
		...
		//oPopup.document.getElementById('nameHolder').innerHTML = selectedObjectName;
		context.style.display = 'block';
		
		// adjust context menu height
		oPopup.document.body.style.height='auto';
		h=oPopup.document.body.offsetHeight;
...
<div id='contextMenu' style="position: absolute; right: 20px; top: 20px; z-index:10000; width: 170px; display: none; background-color:yellow">
