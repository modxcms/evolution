...
function Marquee(id,html,mspeed,mpause,transfx) {
	...
	elm.marqueespeed = !isNaN(mspeed) ? parseInt(mspeed) :2;	// Specify the marquee's marquee speed (larger is faster 1-20)
	...
	elm.actualheight='';
	elm._transfx = !isNaN(transfx) ? parseInt(transfx):1; // 1 - vert, 2- horz
