...
if(isset($resources->items['site_templates'])) { ?>
	<div class="tab-page" id="tabTemplates">
		...
		<ul class="actionButtons">
			...
			<li><a href="index.php?a=19"><i class="<?php echo $_style["actions_new"] ?>"></i><span><?php echo $_lang['new_template']; ?></span></a></li>
			<li><a href="javascript:;" id="template-help"><i class="<?php echo $_style["actions_help"] ?>"></i><span><?php echo $_lang['help']; ?></span></a></li>
