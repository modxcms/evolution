...
if(isset($resources->items['site_snippets'])) { ?>
	<div class="tab-page" id="tabSnippets">
		...
		<ul class="actionButtons">
			...
			<li><a href="index.php?a=23"><i class="<?php echo $_style["actions_new"] ?>"></i><span><?php echo $_lang['new_snippet']; ?></span></a></li>
			<li><a href="javascript:;" id="snippets-help"><i class="<?php echo $_style["actions_help"] ?>"></i><span><?php echo $_lang['help']; ?></span></a></li>
