	...
	<form action="index.php?a=36" method="post" name="userform" enctype="multipart/form-data">
		...
		<div class="tab-page">
			<div class="row form-check">
				<div class="col-sm-2"><?php echo $_lang['role_name']; ?>:</div>
				<div class="col-sm-10"><input class="form-control" name="name" type="text" maxlength="50" value="<?php echo $roledata['name'] ?>" /></div>
			</div>
			<div class="row form-group">
				<div class="col-sm-2"><?php echo $_lang['resource_description']; ?>:</div>
				<div class="col-sm-10"><input name="description" type="text" maxlength="255" value="<?php echo $roledata['description'] ?>" size="60" /></div>
			</div>
