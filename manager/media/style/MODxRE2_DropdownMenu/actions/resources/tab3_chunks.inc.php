...
if(isset($resources->items['site_htmlsnippets'])) { ?>
	<div class="tab-page" id="tabChunks">
		...
		<ul class="actionButtons">
			...
			<li><a href="index.php?a=77"><i class="<?php echo $_style["actions_new"] ?>"></i><span><?php echo $_lang['new_htmlsnippet']; ?></span></a></li>
			<li><a href="javascript:;" id="chunks-help"><i class="<?php echo $_style["actions_help"] ?>"></i><span><?php echo $_lang['help']; ?></span></a></li>
