	...
	function showParameters(ctrl) {
		...
		try {
			...
			Object.keys(currentParams).forEach(function(key) {
				...
				sd = defaultVal != undefined ? '<ul class="actionButtons" style="float:right;margin-top:12px;"><li><a title="<?php echo $_lang["set_default"]; ?>" href="javascript:;" class="btnSetDefault" onclick="setDefaultParam(\'' + key + '\',1);return false;"><i class="fa fa-refresh"></i></a></li></ul>' : '';
		...
		<div class="tab-pane" id="modulePane">
			...
			<div class="tab-page" id="tabModule">
				...
				<table border="0" cellspacing="0" cellpadding="1">
					...
					<tr>
						...
						<td><input name="description" type="text" maxlength="255" value="<?php echo $content['description'] ?>" class="inputBox" onchange="documentDirty=true;"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="newcategory" type="text" maxlength="45" value="" class="inputBox" onchange="documentDirty=true;"></td>
					</tr>
					<tr>
						<th><?php echo $_lang['icon'] ?> <span class="comment">(32x32)</span></th>
						<td><input onchange="documentDirty=true;" type="text" maxlength="255" style="width: 235px;" name="icon" value="<?php echo $content['icon'] ?>" /> <input type="button" value="<?php echo $_lang['insert'] ?>" onclick="BrowseServer();" /></td>
					</tr>
					<tr>
						<th><input name="enable_resource" title="<?php echo $_lang['enable_resource'] ?>" type="checkbox"<?php echo $content['enable_resource'] == 1 ? ' checked="checked"' : '' ?> class="inputBox" onclick="documentDirty=true;" /> <span style="cursor:pointer" onclick="document.mutate.enable_resource.click();" title="<?php echo $_lang['enable_resource'] ?>"><?php echo $_lang["element"] ?></span></th>
						<td><input name="resourcefile" type="text" maxlength="255" value="<?php echo $content['resourcefile'] ?>" class="inputBox" onchange="documentDirty=true;" /></td>
					</tr>
					<tr>
						<th colspan="2"><input name="disabled" type="checkbox" <?php echo $content['disabled'] == 1 ? 'checked="checked"' : '' ?> value="on" class="inputBox" />
							<span style="cursor:pointer" onclick="document.mutate.disabled.click();"><?php echo $content['disabled'] == 1 ? '<span class="warning">' . $_lang['module_disabled'] . '</span>' : $_lang['module_disabled'] ?></span></th>
					</tr>
					<tr>
						<th colspan="2"><input name="locked" type="checkbox"<?php echo $content['locked'] == 1 ? ' checked="checked"' : '' ?> class="inputBox" />
							<span style="cursor:pointer" onclick="document.mutate.locked.click();"><?php echo $_lang['lock_module'] ?></span><br /><span class="comment"><?php echo $_lang['lock_module_msg'] ?></span></th>
					</tr>
					<tr>
						<th colspan="2"><label style="display:block;"><input name="parse_docblock" type="checkbox" <?php echo $modx->manager->action == 107 ? 'checked="checked"' : ''; ?> value="1" class="inputBox"> <?php echo $_lang['parse_docblock']; ?></label> <span class="comment"><?php echo $_lang['parse_docblock_msg']; ?></span></th>
					</tr>
				</table>
			...
			<div class="tab-page" id="tabParams">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<th><?php echo $_lang['guid'] ?></th>
						<td align="left" valign="top"><input name="guid" type="text" maxlength="32" value="<?php echo $modx->manager->action == 107 ? createGUID() : $content['guid'] ?>" class="inputBox" onchange="documentDirty=true;" /></td>
					</tr>
					<tr>
					<tr>
						<th><input name="enable_sharedparams" type="checkbox"<?php echo $content['enable_sharedparams'] == 1 ? ' checked="checked"' : '' ?> class="inputBox" onclick="documentDirty=true;" /> <span style="cursor:pointer" onclick="document.mutate.enable_sharedparams.click();"><?php echo $_lang['enable_sharedparams'] ?></span></th>
						<td><span class="comment"><?php echo $_lang['enable_sharedparams_msg'] ?></span></td>
					</tr>
					<tr>
