<?php
/**
 * Filename:       media/style/MODx RTL/style.php
 * Function:       Manager style variables for images and icons.
 * Encoding:       UTF-8
 * Author:         Jeff Whitfield | RTL by MotSmart | www.modxcms.ir
 * Date:           2006/05/30 | 1.1.2008
 * Version:        1.0
 * MODx version:   0.9.6
*/
$style_path = "media/style/MODxRTL/";
...
// Miscellaneous
$_style["ajax_loader"] = "<p>".$_lang['loading_page']."</p><p><img src=\"".$style_path."images/icons/exclamation.png\" alt=\"Please wait\"></p>";
