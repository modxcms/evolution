...
browser.thumbsURL = browser.assetsURL + "/<?php echo text::jsValue($this->getConfig('thumbsDir')) ?>";
browser.clientResize = <?php echo json_encode($this->getConfig('clientResize')) ?>;
