...
$lang = array(
    ...
    "Missing a temporary folder." => "一時フォルダが見付かりません。",
    ...
    "Cannot rename the folder." => "ディレクトリを名前を変更できません",
    ...
    "Cannot access or create thumbnails folder." => "サムネイルフォルダにアクセス、又はサムネイルフォルダを作成できません。",
    "Cannot access or write to upload folder." => "アップロードフォルダにアクセス、又は書き込みできません。",
    ...
    "File name shouldn't begins with '.'" => "ファイル名は、'.'で開始しないで下さい。",
    ...
    "Cannot delete the folder." => "ディレクトリを削除できません",
    ...
    "A file or folder with that name already exists." => "その名前のファイル、又はフォルダは既に存在します。",
    ...
    "Inexistant or inaccessible folder." => "存在しない、又はアクセスできないフォルダです。",
    ...
    "Clipboard" => "クリップボード",
    "Checking for new version..." => "新しいバージョンを確認しています...",
    "Unable to connect!" => "接続できませんでした！",
    "Download version {version} now!" => "新しいバージョン（{version}）を今すぐダウンロード！",
    "KCFinder is up to date!" => "KCFinderは更新されました！",
    "Licenses:" => "ライセンス",
    "Attention" => "注意",
    "Question" => "確認",
    "Yes" => "はい",
