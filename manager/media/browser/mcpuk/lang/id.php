...
$lang = array(
    ...
    "The uploaded file exceeds {size} bytes." => "File yang anda unggah melebihi {ukuran} bytes.",
    ...
    "Cannot create {dir} folder." => "Gagal membuat {direktori} folder",
    ...
    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" => "{jumlah} file-file di Clipboard tidak bisa di baca. Apakah anda mau menyalin sisa-nya?",
    "The files in the Clipboard are not movable." => "File-file yang di clipboard tidak memungkinkan untuk di pindah.",
    "{count} files in the Clipboard are not movable. Do you want to move the rest?" => "{jumlah} file-file yang di Clipboard tidak bisa di pindah. Apakan anda mau memindahkan sisa-nya?",
    "The files in the Clipboard are not removable." => "File file yang di Clipboard tidak memungkinkan untuk di hapus.",
    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" => "{jumlah} file-file di Clipboard tidak memungkinkan untuk di hapus. Apakah anda mau menghapus sisa-nya?",
    "The selected files are not removable." => "File-file yang anda pilih tidak memungkinkan untuk di hapus.",
    "{count} selected files are not removable. Do you want to delete the rest?" => "{jumlah] file-file yang terpilih tidak memungkinkan untuk di hapus. Apakah anda mau menghapus sisa-nya?",
    "Are you sure you want to delete all selected files?" => "Yakin anda akan menghapus semua file-file yang di pilih?",
    "Failed to delete {count} files/folders." => "Gagal menghapus {jumlah} file/folder.",
    ...
    "Copy {count} files" => "Salin {jumlah} file-file",
    "Move {count} files" => "Pindah {jumlah} file-file",
    ...
    "Download version {version} now!" => "Unduh versi {versi} sekarang!",
