...
HTMLArea.Config = function () {
	...
	this.pageStyle = "body { font-family: verdana,sans-serif; font-size: 12px; background: white; width:100%;} td {font-family: verdana,sans-serif; font-size: 12px; } ";
...
HTMLArea.prototype.generate = function () {
	...
	if (this._ta_size.h<=0) this._ta_size.h = 250; // hacked by Raymond
	...
	iframe.style.width = "100%"; // hacked by Alex :)
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
	    ...
	    case "about"    : this._popupDialog("about.php", null, this); break;
	    case "showhelp" : window.open(_editor_url + "reference.php", "ha_help"); break;
 	...
 	// for modx 
 	var exclude = ",htmlmode,about,showhelp,";
	if (exclude.indexOf(","+cmdID+",")) {
...
HTMLArea.prototype._editorEvent = function(ev) {
	...
	var keyEvent = (HTMLArea.is_ie && ev.type == "keydown") || (ev.type == "keypress");
 	...
 	// for modx 
 	documentDirty = true;
	if (keyEvent && !ev.altKey) this._textArea.onchange();
	// end modx
