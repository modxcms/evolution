...
#:::::::::::::::::::::::::::::::::::::::::
	...
	$mp[] = array("QM+","<strong>1.1.1</strong> Enables QuickManager front end content editing support.",0,"$setupPath/plugin.qm.tpl","&jqpath=Path to jQuery;text;assets/js/jquery.js &loadmanagerjq=Load jQuery in manager;list;true,false;false &loadfrontendjq=Load jQuery in front-end;list;true,false;true &loadtb=Load ThickBox in front-end;list;true,false;true &usemm=Use with ManagerManager plugin;list;true,false;true &tbwidth=ThickBox window width;int;800 &tbheight=ThickBox window height;int;500 &hidefields=Hide document fields from front-end editors;text;parent &addbutton=Show add document here button;list;true,false;true &tpltype=New document template type;list;parent,id,selected;parent &tplid=New document template id;int;3","OnWebPagePrerender,OnDocFormPrerender,OnDocFormSave,OnManagerPageInit");
    ...
    $mp[] = array("TransAlias", "<strong>1.0</strong> - Transliterate document alias",0,"$setupPath/plugin.transalias.tpl","&table_name=Name;text;common &override_tv=Override TV name;string;","OnStripAlias");
