...
//$_lang['DM_date_deletedon'] = 'Дата удаления ресурса';
...
$_lang['DM_select_range_text'] = '<p><b>Можно использовать следующий синтаксис при задании диапазона (вместо "n" указывайте число ID ресурса):</b><br />
							  <ul><li><b>n*</b> - изменить свойства ресурса с ID=n и непосредственных дочерних ресурсов;</li>
							  ...
							  <p><b>Пример:</b> 1*,4**,2-20,25 - будут изменены свойства для ресурса с ID=1 и его непосредственных дочерних ресурсов, ресурса с ID=4 и всех его дочерних ресурсов, ресурсов с ID в диапазоне от 2 до 20, и ресурса с ID=25.</p>';
