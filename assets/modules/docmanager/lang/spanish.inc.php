<?php
/**
 * Modulo Admisitrador de Documentos (Document Manager Module) - spanish.inc.php
 *
 * Prop�sito: Contiene las secuencias de la lengua para el uso en el m�dulo.
 * Autores: Traducido por LucianoAFerrer, verificado y corregido por ARES1983
 * Para: MODX CMS (www.modx.com)
 * Fecha:18/04/2007 Version: 1.6
 *
 */

//-- ARCHIVO DE LENGUA EN ESPA�OL

//-- titles
$_lang['DM_module_title'] = "Administrador de documentos";
$_lang['DM_action_title'] = "Seleccione una acci�n";
$_lang['DM_range_title'] = "Especifique un rango de IDs de los documentos";
$_lang['DM_tree_title'] = "Seleccione documentos desde el �rbol";
$_lang['DM_update_title'] = "Actualizaci�n completada";
$_lang['DM_sort_title'] = "Editor de �ndice del men�";

//-- tabs
$_lang['DM_doc_permissions'] = "Permisos de documento";
$_lang['DM_template_variables'] = "Variables del template";
$_lang['DM_sort_menu'] = "Ordenar items del men�";
...
//-- templates tab
$_lang['DM_tpl_desc'] = "Seleccione el template requerido utilizando la tabla inferior, y especifique los IDs de documentos que necesitan ser cambiados. Especificando un rango de IDs o utilizando el �rbol opcional aqu� debajo.";
$_lang['DM_tpl_no_templates'] = "No se han encontrado Templates";
$_lang['DM_tpl_column_id'] = "ID";
$_lang['DM_tpl_column_name'] = "Nombre";
$_lang['DM_tpl_column_description'] = "Descripci�n";
$_lang['DM_tpl_blank_template'] = "Template en blanco";

$_lang['DM_tpl_results_message'] = "Utilice el bot�n volver si necesita realizar m�s cambios. El cache del sitio ha sido autom�ticamente limpiado.";

//-- template variables tab
$_lang['DM_tv_desc'] = "Especifique los IDs de documento que necesitan ser cambiados, especificando un rango de IDs o utilizando el �rbol opcional aqu� debajo, luego seleccione el template requerido desde la tabla y las variables asociadas al mismo ser�n cargadas. Ingrese los valores de las Variables del Template deseados y guarde los cambios.";
...
$_lang['DM_tv_loading'] = "Se est�n cargando las Variables del Template...";
...
$_lang['DM_doc_desc'] = "Seleccione el grupo de documento desde la tabla inferior y lo que desee agregar o quitar del mismo. Luego especifique los IDs de los documentos que necesitan ser cambiados. Especificando un rango de IDs o utilizando el �rbol opcional aqu� debajo.";
...
//-- sort menu tab
$_lang['DM_sort_pick_item'] = "Por favor presione en el ra�z del sitio o el documento padre que desea ordenar, de el �rbol principal de documentos.";
$_lang['DM_sort_updating'] = "Actualizando ...";
$_lang['DM_sort_updated'] = "Actualizado";
$_lang['DM_sort_nochildren'] = "El padre no contiene ning�n hijo";
...
$_lang['DM_misc_desc'] = "Seleccione una configuraci�n del men� desplegable y luego la opci�n requerida. Note que solamente una configuraci�n puede ser cambiada a la vez.";

$_lang['DM_other_dropdown_publish'] = "Publicar/Despublicar";
$_lang['DM_other_dropdown_show'] = "Mostrar/Ocultar en men�";
...
$_lang['DM_other_show_radio1'] = "Ocultar del men�";
$_lang['DM_other_show_radio2'] = "Mostrar en men�";
...
$_lang['DM_adjust_dates_desc'] = "Cualquiera de los siguientes ajustes de fecha del documento pueden ser cambiados. Utilice la opci�n \"Ver calendario\" para cambiar las fechas.";
...
$_lang['DM_adjust_authors_noselection'] = "Sin cambio";
 ...
 //-- labels
$_lang['DM_date_pubdate'] = "Fecha de publicaci�n:";
$_lang['DM_date_unpubdate'] = "Fecha de despublicaci�n:";
...
$_lang['DM_select_range_text'] = "<p><strong>Llave (donde n es el numero ID del documento):</strong><br /><br />
							  ...
							  n - Cambiar el ajuste para un s�lo documento</p>
							  <p>Ejemplo: 1*,4**,2-20,25 - Esto cambiar� el ajuste seleccionado para
						      documentos 1 y sus hijos, documento 4 y todos sus hijos, documentos 2
						      a 20 y documento 25.</p>";
$_lang['DM_select_tree'] = "Vea y seleccione documentos utilizando el �rbol de documentos";

//-- process tree/range messages
$_lang['DM_process_noselection'] = "No se ha realizado una selecci�n. ";
$_lang['DM_process_novalues'] = "No se han especificado valores.";
$_lang['DM_process_limits_error'] = "L�mite superior menor que l�mite inferior:";
$_lang['DM_process_invalid_error'] = "Valor no v�lido:";
$_lang['DM_process_update_success'] = "La actualizaci�n se ha completado correctamente, sin errores.";
$_lang['DM_process_update_error'] = "La actualizaci�n se ha completado, pero se han encontrado errores:";
...
$_lang['DM_log_sortmenu'] = "Administrador de documentos: Operaci�n de men� �ndice completada.";
$_lang['DM_log_publish'] = "Administrador de documentos: Ajustes de Publicaci�n/Despublicaci�n de documentos cambiados.";
$_lang['DM_log_hidemenu'] = "Administrador de documentos: Ajustes de Ocultar/Mostrar documentos en men� cambiados.";
