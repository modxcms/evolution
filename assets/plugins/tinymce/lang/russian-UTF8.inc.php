...
$_lang['mce_theme_full'] = 'Все возможности';
$_lang['mce_theme_advanced'] = 'Продвинутая';
$_lang['mce_theme_editor'] = 'Редактор контента';
$_lang['mce_theme_custom'] = 'Индивидуальная';
$_lang['mce_theme_creative'] = 'Творческая';
$_lang['mce_theme_logic'] = 'xhtml';
$_lang['mce_theme_legacy'] = 'legacy-стиль';
$_lang['mce_theme_global_settings'] = 'Использовать глобальные настройки';
$_lang['mce_editor_skin_title'] = 'Тема оформления';
$_lang['mce_editor_skin_message'] = 'Варианты оформления панели инструментов смотрите тут
tinymce/tiny_mce/themes/advanced/skins/<br />';
$_lang['mce_editor_entermode_title'] = 'Действие клавиши Enter';
$_lang['mce_editor_entermode_message'] = 'Устанавливает действие, которое выполняется при нажатии клавиши Enter';
$_lang['mce_entermode_opt1'] = 'Обернуть в &lt;p&gt;&lt;/p&gt;';
$_lang['mce_entermode_opt2'] = 'Добавить &lt;br /&gt;';

$_lang['mce_element_format_title'] = 'Формат элемента';
$_lang['mce_element_format_message'] = 'Эта настройка задает формат элементов: html или xhtml. По умолчанию выбран xhtml. Это значит, что &lt;br /&gt; будет &lt;br&gt; если выбран &quot;html&quot;.';
$_lang['mce_schema_title'] = 'Схема';
$_lang['mce_schema_message'] = 'Эта настройка позволяет выбрать стандарт HTML4 или HTML5. Выбор стандарта определяет допустимые в разметке элементы и атрибуты.';
