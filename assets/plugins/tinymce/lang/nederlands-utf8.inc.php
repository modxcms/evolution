...
$_lang['tinymce_editor_custom_plugins_message'] = "Vul in welke plugins u wilt gebruiken voor het 'aangepaste' thema en scheidt de waarden door komma's.";
$_lang['tinymce_editor_custom_buttons_title'] = "Aangepaste knoppen:";
$_lang['tinymce_editor_custom_buttons_message'] = "Vul in welke knoppen u wilt gebruiken voor het 'aangepaste' thema en scheidt de waarden door komma's voor elke rij. Wees er zeker van dat voor elke knop de vereiste plugin aangezet is in de 'Aangepaste plugins' instelling.";
$_lang['tinymce_editor_css_selectors_title'] = "CSS selectors:";
$_lang['tinymce_editor_css_selectors_message'] = "Vul een lijst van selectors in die beschikbaar moeten zijn in de editor. Vul dit als volgt in:<br />'displayNaam1=selectorNaam1;displayNaam2=selectorNaam2'<br />Bijvoorbeeld: je hebt de <b>.mono</b> en <b>.smallText</b> selectors in uw CSS bestand, dan kunt u die hier invullen als:<br />'Monospaced text=mono;Small text=smallText'<br />Let erop dat de laatste waarde <b>niet</b> wordt afgesloten door een punt-komma.";
$_lang['tinymce_settings'] = "TinyMCE instellingen";
$_lang['tinymce_theme_simple'] = "Eenvoudig";
