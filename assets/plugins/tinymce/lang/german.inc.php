...
$_lang['tinymce_editor_theme_message'] = "Hier k旦nnen Sie ein Template aussuchen, das im TinyMCE verwendet werden soll. Es handelt sich nicht um das Aussehen, sondern um die Anzahl an Plugins/Funktionen (wie Bilder hochladen, Links einf端gen etc.), die f端r den Nutzer verf端gbar sein sollen.";
...
$_lang['tinymce_editor_custom_buttons_message'] = "Geben Sie die Buttons an, die Sie bei Auswahl des \'individuellen\' Templates verwenden wollen. Bitte Buttons f端r jede Reihe durch Komma trennen.Stellen Sie sicher, dass die f端r Buttons ben旦tigten Plugins aktiviert sind unter \'Individuelle Plugins\'.";
$_lang['tinymce_editor_css_selectors_title'] = "CSS Selektoren:";
$_lang['tinymce_editor_css_selectors_message'] = "Hier k旦nnen Sie eine Auswahl an Selektoren definieren, die im TinyMCE verf端gbar sein sollen. Bitte so eintragen:<br />'displayName=selectorName;displayName2=selectorName2'<br />Zum Beispiel mit <b>.mono</b> und <b>.smallText</b> als Selektoren in der CSS Datei, tragen Sie diese ein als:<br />'Monospaced text=mono;Small text=smallText'<br />Bitte achten Sie darauf, dass der letzte Eintrag nicht mit Semikolon abgeschlossen werden darf.";
