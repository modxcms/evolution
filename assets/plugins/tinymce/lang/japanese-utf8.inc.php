...
$_lang['mce_theme_creative'] = 'クリエイティブ';
$_lang['mce_theme_logic'] = 'ロジック';
$_lang['mce_theme_legacy'] = '旧タイプ';
$_lang['mce_theme_global_settings'] = 'グローバル設定を利用';
$_lang['mce_editor_skin_title'] = 'スキン';
$_lang['mce_editor_skin_message'] = 'ツールバーのデザイン。tinymce/tiny_mce/themes/advanced/skins/ ディレクトリ内のスキンを選択します。<br />';
$_lang['mce_editor_entermode_title'] = '改行キーの動作';
