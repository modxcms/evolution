<?php
//TinyMCE RichText Editor Plugin v3.2.7p2
...
class TinyMCE
{
	...
	function get_mce_script($params)
	{
		...
		case 'editor':
		    ...
		    break;
		case 'creative':
			$plugins = 'layer,style,fullscreen,advimage,advhr,paste,advlink,media,contextmenu,table';
		    ...
		    break;
		case 'logic':
			$plugins = 'xhtmlxtras,style,fullscreen,advimage,paste,advlink,media,contextmenu,table';
	...
	function build_mce_init($params,$plugins,$buttons1,$buttons2,$buttons3,$buttons4)
	{
		...
		$ph['blockFormats']            = (empty($params['blockFormats'])) ? 'p,h2,h3,h4,h5,h6,div,blockquote,code,pre,address' : $params['blockFormats'];
		...
		$ph['customparams']            = $params['customparams'];
