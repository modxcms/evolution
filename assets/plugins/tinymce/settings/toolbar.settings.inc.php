<?php
$set['simple']['p']  = 'autolink,inlinepopups,save,emotions,advimage,advlink,paste,contextmenu';
$set['simple']['b1'] = 'undo,redo,|,bold,strikethrough,|,justifyleft,justifycenter,justifyright,|,link,unlink,image,emotions,|,hr,|,help';
$set['simple']['b2'] = '';
$set['simple']['b4'] = '';
$set['simple']['b4'] = '';

$set['creative']['p'] = 'autolink,inlinepopups,autosave,advlist,layer,style,fullscreen,advimage,advhr,paste,advlink,media,contextmenu,table';
$set['creative']['b1'] = 'undo,undo,redo,|,bold,forecolor,backcolor,strikethrough,formatselect,styleselect,fontsizeselect,code';
$set['creative']['b2'] = 'image,media,link,unlink,anchor,|,bullist,numlist,|,blockquote,outdent,indent,|,justifyleft,justifycenter,justifyright,|,advhr,|,styleprops,removeformat,|,pastetext,pasteword';
$set['creative']['b3'] = 'insertlayer,absolute,moveforward,movebackward,|,tablecontrols,|,fullscreen,help';
$set['creative']['b4'] = '';

$set['logic']['p'] = 'autolink,inlinepopups,autosave,advlist,xhtmlxtras,style,fullscreen,advimage,paste,advlink,media,contextmenu,table';
...
$set['legacy']['p']  = 'autosave,advlist,style,advimage,advlink,searchreplace,print,contextmenu,paste,fullscreen,nonbreaking,xhtmlxtras,visualchars,media';
...
$set['advanced']['p']  = '';
$set['advanced']['b1'] = 'bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect';
$set['advanced']['b2'] = 'bullist,numlist,|,outdent,indent,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code';
$set['advanced']['b3'] = 'hr,removeformat,visualaid,|,sub,sup,|,charmap';
$set['advanced']['b4'] = '';

$set['full']['p']  = 'autolink,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,wordcount,advlist,autosave';
...
$set['default']['p']  = 'template,visualblocks,autolink,inlinepopups,autosave,save,advlist,style,fullscreen,advimage,paste,advlink,media,contextmenu,table';
