<?php
/**
 * Function:       Norsk language file for custom settings
 * Encoding:       UTF-8
 * Author:
 * Date:           2016/02/19
 * Version:        4.5.7.0
...
$_lang['editor_css_selectors_message'] = 'Here you can enter a list of selectors that should be available in the editor. Enter them as follows:<br />[+editor_css_selectors_schema+]<br />For instance, say you have <b>.mono</b> and <b>.smallText</b> selectors in your CSS file, you could add them here as:<br />[+editor_css_selectors_example+]<br />Note that the last entry should not have a &quot;[+editor_css_selectors_separator+]&quot; after it.';
