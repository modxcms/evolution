...
if(parent.tree) {
    ...
    var checkModxTreeUpdate = function () {
        ...
        if (parent.tree.itemToChange != modxOldRessourceId) {
            ...
            document.getElementById("mceu_103").value = modxLinkTitle;
        }
    };
}
	...
	function showDialog(linkList) {
		...
		win = editor.windowManager.open({
			...
			onSubmit: function(e) {
				...
				function insertLink() {
                    ...
                    if(parent.tree) {
                        parent.tree.ca = "";
                        delete checkModxTreeUpdateInterval;
                    };
		...
		autoComplt.enable(input, {
			...
			hintsFetcher : function (v, openList) {
				_resultDataset = {};
				var xhr = new XMLHttpRequest(), _link = encodeURI('/../assets/plugins/tinymce4/tinymce/plugins/modxlink/search.php'+'?q='+v);
				xhr.open('GET', _link);
				xhr.onload = function() {
					if (xhr.status === 200) {
