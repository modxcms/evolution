...
function mm_widget_template($fields, $other_param = 'defaultValue', $roles = '', $templates = ''){
	...
	if ($e->name == 'OnDocFormPrerender'){
		...
		$output .= includeJsCss(MODX_BASE_URL.'assets/plugins/managermanager/widgets/template/javascript.js', 'html');
		$output .= includeJsCss(MODX_BASE_URL.'assets/plugins/managermanager/widgets/template/styles.css', 'html');
