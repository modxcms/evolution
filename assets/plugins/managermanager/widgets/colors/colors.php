...
function mm_widget_colors($fields, $default = '#ffffff', $roles = '', $templates = ''){
	...
	if ($e->name == 'OnDocFormPrerender'){
		$output .= includeJsCss(MODX_BASE_URL .'assets/plugins/managermanager/widgets/colors/farbtastic.js', 'html', 'farbtastic', '1.2');
		$output .= includeJsCss(MODX_BASE_URL .'assets/plugins/managermanager/widgets/colors/farbtastic.css', 'html');
