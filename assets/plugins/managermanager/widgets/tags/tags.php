...
function mm_widget_tags($fields, $delimiter = ',', $source = '', $display_count = false, $roles = '', $templates = ''){
	...
	if ($e->name == 'OnDocFormPrerender'){
		$output .= includeJsCss(MODX_BASE_URL.'assets/plugins/managermanager/widgets/tags/tags.js', 'html', 'mm_widget_tags', '1.0');
		$output .= includeJsCss(MODX_BASE_URL.'assets/plugins/managermanager/widgets/tags/tags.css', 'html');
