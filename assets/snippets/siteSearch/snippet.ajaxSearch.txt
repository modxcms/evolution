...
MORE : See the siteSearch.readme.txt file for more informations. 
...
// &debug = [ 0 | 1 | 2 | 3 ]
// 1,2,3 : File mode - Output logged into a file named ajaxSearch_log.txt in siteSearch/debug/ directory.
...
if ($cfg['ajaxSearch']) {
    ...
    // to use an another library, use this parameter and change the siteSearch/js/ajaxSearch1/ajaxSearch-mootools2.js file
