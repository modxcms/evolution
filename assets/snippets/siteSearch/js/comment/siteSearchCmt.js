...
var _asbase = 'assets/snippets/siteSearch/';
...
var ascmt=document.getElementById('ajaxSearch_cmtArea').value;var hfld=document.getElementById('ajaxSearch_cmtHField').value;if((ascmt!='')&&(hfld=='')){var logid=document.getElementById('ajaxSearch_logid').value;var url='index-ajax.php';var q=_asbase+"classes/siteSearchLog.class.inc.php";var params="q="+q+"&ascmt="+ascmt+"&logid="+logid;xmlHttp.open("POST",url,true);xmlHttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");xmlHttp.setRequestHeader("Content-length",params.length);xmlHttp.setRequestHeader("Connection","close");xmlHttp.send(params);}}
