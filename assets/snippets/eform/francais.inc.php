...
$_lang['ef_multiple_submit'] = "<p>Ce formukaire a déjà été soumis avec succès. Il est inutile de soumettre le même formulaire plusieurs fois.</p>";
$_lang['ef_submit_time_limit'] = "<p>Ce formukaire a déjà été soumis avec succès. La soumission du formulaire est bloquée pour ".($submitLimit/60)." minutes.</p>";
