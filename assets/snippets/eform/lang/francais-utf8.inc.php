...
* Fichier langue en français pour eForm - Corrigé le 28/07/09
*
*/
...
$_lang['ef_version_error'] = '<strong>ATTENTION!</strong> La version du Snippet eForum (version:&nbsp;$version) est différente de celle des fichiers eForm présents sur votre serveur (version:&nbsp;$fileVersion). Pensez à mettre à jour les fichiers lorsque vous mettez à jour le Snippet.';
