...
$_lang["ef_error_filter_rule"] = "Tekst filteret blev ikke genkendt. ";
$_lang["ef_error_formid"] = "Ugyldigt Formular ID. ";
...
$_lang["ef_failed_list"] = "Det indtastede er ikke i listen over korrekte værdier. ";
$_lang["ef_failed_range"] = "Det indtastede er ikke inden for det korrekte område. ";
...
$_lang["ef_is_own_id"] = "<span class=\"ef-form-error\">Formularens skabelon er sat til samme ID som ressourcen der indeholder kaldet til Eform snippet'en! Du kan ikke have formularen i samme ressource som snippet kaldet til Eform. </span> ID = ";
...
$_lang["ef_mail_abuse_subject"] = "Potentiel misbrug af e-mail formularen med formular ID ";
