...
* local revision: $Id: nederlands.inc.php,v 1.2 2006/11/22 14:47:54 jelle Exp $
*/
...
//$_lang["ef_validation_message"] = "<strong>Er zijn fouten gevonden in uw formulier:</strong><br />";
$_lang["ef_validation_message"] = "<div class=\"errors\"><strong>Er zijn fouten gevonden in uw formulier:</strong><br />[+ef_wrapper+]</div>"; //changed
$_lang['ef_rule_passed'] = 'Gelukt met gebruikte regel [+rule+] (input="[+input+]").';
$_lang['ef_rule_failed'] = '<span style="color:red;">Mislukt</span> met gebruikte regel [+rule+] (input="[+input+]")';
$_lang["ef_required_message"] = " De volgende verplichte veld(en) ontbreken: {fields}<br />";
$_lang['ef_error_list_rule'] = 'Fout bij het valideren van het veld! #LIST regel gedeclareerd maar geen waarden gevonden: ';
...
$_lang["ef_upload_error"] = ": fout bij uploaden bestand."; //NEW
...
$_lang["ef_error_filter_rule"] = "Tekst filter niet herkend";
...
$_lang['ef_multiple_submit'] = "<p>Dit formulier was al succesvol verzonden. Het is niet nodig uw informatie vaker te verzenden.</p>";
$_lang['ef_submit_time_limit'] = "<p>Dit formulier was al succesvol verzonden. Opnieuw verzenden van het formulier is uitgezet voor ".($submitLimit/60)." minuten.</p>";
$_lang['ef_version_error'] = "<strong>WAARSCHUWING!</strong> De versie van de eForm snippet (versie:&nbsp;$version) wijkt af van het gebruikte eForm bestand (versie:&nbsp;$fileVersion). Zorg er a.u.b. voor dat u voor beiden dezelfde versie gebruikt.";
...
$_lang['ef_mail_error'] = 'De mailer kon geen mail verzenden';
