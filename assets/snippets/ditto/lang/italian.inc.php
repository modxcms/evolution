...
$_lang['blank_tpl'] = "Il tuo template per Ditto � vuoto o c'� un errore nel nome del chunk, per favore controlla.";
...
$_lang['invalid_class'] = "La classe di Ditto non � valida. Per favore controllala.";
