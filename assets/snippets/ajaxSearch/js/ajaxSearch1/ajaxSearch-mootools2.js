/*
 * AjaxSearch 1.11.0 - package AjaxSearch 1 - Mootools 1.2.4
...
var _version='1.11.0';var _opacity=1;var _liveSearch=0;var _minChars=3;var _init='none';var _pagingType=1;function activateSearch(){for(ias=0;ias<asvar.length;ias++){var asv=eval('('+asvar[ias]+')');activateAsInstance(asv);}}
...
as['adv']=adv;var pars={q:_base+'ajaxSearchPopup.php',search:as['s'],as_version:as['vsn'],advsearch:encodeURI(as['adv']),subsearch:encodeURI(as['sub']),ucfg:as['cfg']};as['sc'].setStyle('opacity','0');as['sl'].setStyle('opacity','1');asr=new Request({url:_base+'ajaxSearchPopup.php',method:'post',data:pars,onComplete:function(text){doSearchResp(text,as);}});asr.send();}
...
function nextResults(gr,grnm,as,pgn){var pars={q:_base+'ajaxSearchPopup.php',search:as['s'],as_version:as['vsn'],advsearch:encodeURI(as['adv']),subsearch:encodeURI(as['sub']),ucfg:as['cfg'],pgn:pgn};asr=new Request({url:_base+'ajaxSearchPopup.php',method:'post',data:pars,onComplete:function(text){nextResultsResp(text,gr,grnm,as);}});asr.send();}
