<?php
/*
slovak-utf8.inc.php - for AjaxSearch 1.10.2
...
$_lang['as_maxWords'] = 'Vyhľadávanie može obsahovať maximálne %d slov';
$_lang['as_minChars'] = 'Hľadný výraz musí obsahovať minimálne %d znakov';
$_lang['as_maxChars'] = 'Hľadný výraz môže obsahovať maximálne %d znakov';
$_lang['oneword'] = 'Jedno slovo';
$_lang['allwords'] = 'Všetky slová';
$_lang['exactphrase'] = 'Presná fráza';
$_lang['nowords'] = 'Žiadne slová';
$_lang['as_cmtHiddenFieldIntro'] = 'Toto pole by malo byť prázdne. <br />Nezadávajte žiadny text.';
$_lang['as_cmtIntroMessage'] = 'Našli ste čo ste hľadali? Napíšte Váš komentár!';
