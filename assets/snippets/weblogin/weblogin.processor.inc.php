...
# process login
    ...
    $username = $modx->db->escape(htmlspecialchars($_POST['username'], ENT_QUOTES, $modx->config['modx_charset']));
    $givenPassword = $modx->db->escape(htmlspecialchars($_POST['password'], ENT_NOQUOTES, $modx->config['modx_charset']));
